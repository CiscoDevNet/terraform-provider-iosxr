...
- Add `redundancy` to `iosxr_l2vpn` resource and data source
- Add `redundancy_iccp_groups` list to `iosxr_l2vpn` resource and data source
- Add `flexible_xconnect_service_vlan_unawares` list to `iosxr_l2vpn` resource and data source
- Add `flexible_xconnect_service_vlan_aware_evis` list to `iosxr_l2vpn` resource and data source
...
- BREAKING CHANGE: Decompose `iosxr_mpls_ldp` into `iosxr_mpls_ldp`, `iosxr_ldp_address_family`, `iosxr_mpls_ldp_interface`, `iosxr_mpls_ldp_mldp`, `iosxr_mpls_ldp_vrf` resource and data source
...
- Add `fast_reroute_per_prefix_tiebreaker_default_backup_path` to `router_isis_interface_address_family` resource and data source
- Add `fast_reroute_per_prefix_tiebreaker_default_backup_path_levels` list to `router_isis_interface_address_family` resource and data source
- Add `fast_reroute_per_prefix_tiebreaker_node_protecting_index` to `router_isis_interface_address_family` resource and data source
- Add `fast_reroute_per_prefix_tiebreaker_node_protecting_levels` list to `router_isis_interface_address_family` resource and data source
- Add `fast_reroute_per_prefix_tiebreaker_srlg_disjoint_index` to `router_isis_interface_address_family` resource and data source
- Add `fast_reroute_per_prefix_tiebreaker_srlg_disjoint_levels` list to `router_isis_interface_address_family` resource and data source
- Add `fast_reroute_per_prefix_tiebreaker_lc_disjoint_index` to `router_isis_interface_address_family` resource and data source
- Add `fast_reroute_per_prefix_tiebreaker_lc_disjoint_levels` list to `router_isis_interface_address_family` resource and data source
- Add `fast_reroute_per_prefix_remote_lfa_maximum_metric` to `router_isis_interface_address_family` resource and data source
- Add `fast_reroute_per_prefix_remote_lfa_maximum_metric_levels` list to `router_isis_interface_address_family` resource and data source
- Add `fast_reroute_per_prefix_remote_lfa_tunnel_mpls_ldp` to `router_isis_interface_address_family` resource and data source
- Add `fast_reroute_per_prefix_remote_lfa_tunnel_mpls_ldp_levels` list to `router_isis_interface_address_family` resource and data source
- Add `fast_reroute_per_prefix_ti_lfa` to `router_isis_interface_address_family` resource and data source
- Add `fast_reroute_per_prefix_ti_lfa_levels` list to `router_isis_interface_address_family` resource and data source
- Add `fast_reroute_per_prefix_exclude_interfaces` list to `router_isis_interface_address_family` resource and data source
- Add `fast_reroute_per_prefix_lfa_candidate_interfaces` list to `router_isis_interface_address_family` resource and data source
- Add `tunnel_bfd_destination_ipv4`, `tunnel_bfd_destination_ipv6`, `tunnel_bfd_period`, `tunnel_bfd_retry`, `tunnel_bfd_minimum_interval`, `tunnel_bfd_multiplier` to `iosxr_interface_tunnel` resource and data source
- Add `tunnel_mode_gre_ipv4`, `tunnel_mode_gre_ipv6`, `tunnel_mode_gre_multipoint_ipv4`, `tunnel_mode_gre_multipoint_ipv6`, `tunnel_mode_ipv4`, `tunnel_mode_ipv6`, `tunnel_mode_ipsec_ipv4`, `tunnel_mode_encapsulation_mode` to `iosxr_interface_tunnel` resource and data source
- Add `match_cos`, `match_destination_address_ipv4`, `match_destination_address_ipv6`, `match_destination_mac`, `match_destination_port`, `match_dscp_ipv4`, `match_dscp_ipv6`, `match_mpls_experimental_topmost`, `match_precedence`, `match_precedence_ipv4`, `match_precedence_ipv6`, `match_protocol`, `match_qos_group`, `match_source_address_ipv4`, `match_source_address_ipv6`, `match_source_mac`, `match_source_port`, `match_traffic_class`, `match_vlan` to `iosxr_class_map_qos` resource and data source
...
- Add `ipv4_unicast_import_from_bridge_domain_advertise_as_vpn`, `ipv6_unicast_import_from_bridge_domain_advertise_as_vpn` to `iosxr_vrf` resource and data source
- Add `archive_disk0`, `archive_disk1`, `archive_harddisk`, `archive_frequency_daily`, `archive_frequency_weekly`, `archive_filesize`, `archive_size`, `archive_length`, `archive_severity`, `archive_threshold` to `iosxr_logging` resource and data source
...
- Add `timeout`, `server_v1`, `server_port`, `server_port_forwarding_local`, `server_rekey_time`, `server_rekey_volume`, `server_tcp_window_scale`, `server_max_auth_limit`, `server_netconf_xml`, `server_netconf_port` to `iosxr_ssh` resource and data source
- Add `server_disable_hmac_sha2_512`, `server_disable_hmac_sha1`, `server_disable_hmac_sha2_256`, `server_enable_cipher_aes_cbc`, `server_enable_cipher_3des_cbc`, `server_algorithms_key_exchanges`, `server_algorithms_ciphers`, `server_algorithms_host_key_ecdsa_nistp256`, `server_algorithms_host_key_ecdsa_nistp384`, `server_algorithms_host_key_ecdsa_nistp521`, `server_algorithms_host_key_rsa`, `server_algorithms_host_key_dsa`, `server_algorithms_host_key_x509v3_ssh_rsa`, `server_algorithms_host_key_ed25519`, `server_algorithms_host_key_rsa_sha512`, `server_algorithms_host_key_rsa_sha256`, `server_algorithms_host_key_ssh_rsa` to `iosxr_ssh` resource and data source
- Add `server_usernames`, `server_netconf_vrfs` lists to `iosxr_ssh` resource and data source
- Add `client_knownhost`, `client_source_interface`, `client_vrf`, `client_dscp`, `client_rekey_time`, `client_rekey_volume`, `client_tcp_window_scale`, `client_v2`, `client_v1` to `iosxr_ssh` resource and data source
- Add `client_disable_hmac_sha1`, `client_disable_hmac_sha2_512`, `client_disable_hmac_sha2_256`, `client_enable_cipher_aes_cbc`, `client_enable_cipher_3des_cbc`, `client_algorithms_key_exchanges`, `client_algorithms_ciphers` to `iosxr_ssh` resource and data source
...
- Add `lsp-password-levels/lsp-password-level` list to `iosxr_router_isis` resource and data source
