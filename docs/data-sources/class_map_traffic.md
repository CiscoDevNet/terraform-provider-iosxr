...
page_title: "iosxr_class_map_traffic Data Source - terraform-provider-iosxr"
subcategory: "QoS"
description: |-
  This data source can read the Class Map Traffic configuration.
---

# iosxr_class_map_traffic (Data Source)
...
- `match_flow_tag` (List of String) flow-tag number
