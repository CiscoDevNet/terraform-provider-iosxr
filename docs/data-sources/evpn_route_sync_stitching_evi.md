...
page_title: "iosxr_evpn_route_sync_stitching_evi Data Source - terraform-provider-iosxr"
subcategory: "EVPN"
description: |-
  This data source can read the EVPN Route Sync Stitching EVI configuration.
---

# iosxr_evpn_route_sync_stitching_evi (Data Source)
...
```terraform
data "iosxr_evpn_route_sync_stitching_evi" "example" {
  vpn_id = 108
}
```
