...
page_title: "iosxr_evpn_stitching_evi Data Source - terraform-provider-iosxr"
subcategory: "EVPN"
description: |-
  This data source can read the EVPN Stitching EVI configuration.
---

# iosxr_evpn_stitching_evi (Data Source)
...
```terraform
data "iosxr_evpn_stitching_evi" "example" {
  vpn_id = 102
}
```
