...
page_title: "iosxr_router_bgp_af_group Data Source - terraform-provider-iosxr"
subcategory: "BGP"
description: |-
  This data source can read the Router BGP AF Group configuration.
---

# iosxr_router_bgp_af_group (Data Source)
