...
page_title: "iosxr_router_static_ipv6_multicast Data Source - terraform-provider-iosxr"
subcategory: "Static Routing"
description: |-
  This data source can read the Router Static IPv6 Multicast configuration.
---

# iosxr_router_static_ipv6_multicast (Data Source)
