...
page_title: "iosxr_router_static_vrf_ipv6_unicast Data Source - terraform-provider-iosxr"
subcategory: "Static Routing"
description: |-
  This data source can read the Router Static VRF IPv6 Unicast configuration.
---

# iosxr_router_static_vrf_ipv6_unicast (Data Source)
