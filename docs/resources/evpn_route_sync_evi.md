...
page_title: "iosxr_evpn_route_sync_evi Resource - terraform-provider-iosxr"
subcategory: "EVPN"
description: |-
  This resource can manage the EVPN Route Sync EVI configuration.
---

# iosxr_evpn_route_sync_evi (Resource)
...
```shell
terraform import iosxr_evpn_route_sync_evi.example "<vpn_id>"
```
