...
page_title: "iosxr_evpn_stitching_evi Resource - terraform-provider-iosxr"
subcategory: "EVPN"
description: |-
  This resource can manage the EVPN Stitching EVI configuration.
---

# iosxr_evpn_stitching_evi (Resource)
...
```shell
terraform import iosxr_evpn_stitching_evi.example "<vpn_id>"
```
