...
- `router_id_ipv6_address` (String) router-id in IPv6 address format
- `source` (String) Source interface whose address can be used as source address for export packets
- `source_address_ipv4_address` (String) Source IPv4 address
- `source_address_ipv6_address` (String) Source IPv6 address
