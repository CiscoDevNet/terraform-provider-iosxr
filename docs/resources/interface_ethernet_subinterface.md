...
page_title: "iosxr_interface_ethernet_subinterface Resource - terraform-provider-iosxr"
subcategory: "Interface"
description: |-
  This resource can manage the Interface Ethernet Subinterface configuration.
---

# iosxr_interface_ethernet_subinterface (Resource)
...
- `name` (String) Ethernet subinterface ID
- `type` (String) Interface type
  - Choices: `FastEthernet`, `GigabitEthernet`, `TenGigE`, `TwentyFiveGigE`, `FortyGigE`, `FiftyGigE`, `HundredGigE`, `TwoHundredGigE`, `FourHundredGigE`, `EightHundredGigE`
...
```shell
terraform import iosxr_interface_ethernet_subinterface.example "<type>,<name>"
```
