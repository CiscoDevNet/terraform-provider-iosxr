...
page_title: "iosxr_router_bgp_af_group Resource - terraform-provider-iosxr"
subcategory: "BGP"
description: |-
  This resource can manage the Router BGP AF Group configuration.
---

# iosxr_router_bgp_af_group (Resource)
...
- `af_group_name` (String) AF group name
- `af_name` (String) Specify a AF name
...
```shell
terraform import iosxr_router_bgp_af_group.example "<as_number>,<af_group_name>,<af_name>"
```
