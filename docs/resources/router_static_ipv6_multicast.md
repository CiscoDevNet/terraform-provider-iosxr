...
page_title: "iosxr_router_static_ipv6_multicast Resource - terraform-provider-iosxr"
subcategory: "Static Routing"
description: |-
  This resource can manage the Router Static IPv6 Multicast configuration.
---

# iosxr_router_static_ipv6_multicast (Resource)
