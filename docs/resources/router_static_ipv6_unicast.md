...
page_title: "iosxr_router_static_ipv6_unicast Resource - terraform-provider-iosxr"
subcategory: "Static Routing"
description: |-
  This resource can manage the Router Static IPv6 Unicast configuration.
---

# iosxr_router_static_ipv6_unicast (Resource)
