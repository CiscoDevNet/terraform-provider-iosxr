...
page_title: "iosxr_router_static_vrf_ipv6_multicast Resource - terraform-provider-iosxr"
subcategory: "Static Routing"
description: |-
  This resource can manage the Router Static VRF IPv6 Multicast configuration.
---

# iosxr_router_static_vrf_ipv6_multicast (Resource)
