...
var (
	_ datasource.DataSource              = &ASPathSetDataSource{}
	_ datasource.DataSourceWithConfigure = &ASPathSetDataSource{}
)

func NewASPathSetDataSource() datasource.DataSource {
	return &ASPathSetDataSource{}
}
...
func (d *ASPathSetDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the AS Path Set configuration.",
