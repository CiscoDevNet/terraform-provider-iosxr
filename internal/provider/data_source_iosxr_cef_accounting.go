...
var (
	_ datasource.DataSource              = &CEFAccountingDataSource{}
	_ datasource.DataSourceWithConfigure = &CEFAccountingDataSource{}
)

func NewCEFAccountingDataSource() datasource.DataSource {
	return &CEFAccountingDataSource{}
}

type CEFAccountingDataSource struct {
	data *IosxrProviderData
}

func (d *CEFAccountingDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *CEFAccountingDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *CEFAccountingDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config CEFAccountingData
