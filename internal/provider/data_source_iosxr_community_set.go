...
var (
	_ datasource.DataSource              = &CommunitySetDataSource{}
	_ datasource.DataSourceWithConfigure = &CommunitySetDataSource{}
)

func NewCommunitySetDataSource() datasource.DataSource {
	return &CommunitySetDataSource{}
}
...
func (d *CommunitySetDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the Community Set configuration.",
