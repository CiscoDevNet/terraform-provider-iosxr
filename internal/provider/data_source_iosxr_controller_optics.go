...
var (
	_ datasource.DataSource              = &ControllerOpticsDataSource{}
	_ datasource.DataSourceWithConfigure = &ControllerOpticsDataSource{}
)

func NewControllerOpticsDataSource() datasource.DataSource {
	return &ControllerOpticsDataSource{}
}

type ControllerOpticsDataSource struct {
	data *IosxrProviderData
}

func (d *ControllerOpticsDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_controller_optics"
}

func (d *ControllerOpticsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Controller Optics configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"type": schema.StringAttribute{
				MarkdownDescription: "Controller type",
				Required:            true,
			},
			...
			"active": schema.StringAttribute{
				MarkdownDescription: "Interface active state",
				Required:            true,
			},
			"shutdown": schema.BoolAttribute{
				MarkdownDescription: "The existence of this configuration indicates the interface is shut down",
				Computed:            true,
			},
			...
			"description": schema.StringAttribute{
				MarkdownDescription: "The description of this interface",
				Computed:            true,
			},
			"performance_monitoring": schema.BoolAttribute{
				MarkdownDescription: "Select Performance Monitoring as Enable or Disable",
				Computed:            true,
			},
			"transceiver_disable": schema.BoolAttribute{
				MarkdownDescription: "Disable the transceiver module, treating it as not inserted.  When the configuration is removed, the transceiver module on that port, if present, would be initialized as if it is just inserted",
				Computed:            true,
			},
			"speed": schema.StringAttribute{
				MarkdownDescription: "optics speed set configuration",
				Computed:            true,
			},
			"breakout": schema.StringAttribute{
				MarkdownDescription: "breakout mode configuration",
				Computed:            true,
			},
		},
	}
...
func (d *ControllerOpticsDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *ControllerOpticsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config ControllerOpticsData
