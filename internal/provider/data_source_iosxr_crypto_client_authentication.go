...
var (
	_ datasource.DataSource              = &CryptoClientAuthenticationDataSource{}
	_ datasource.DataSourceWithConfigure = &CryptoClientAuthenticationDataSource{}
)

func NewCryptoClientAuthenticationDataSource() datasource.DataSource {
	return &CryptoClientAuthenticationDataSource{}
}

type CryptoClientAuthenticationDataSource struct {
	data *IosxrProviderData
}

func (d *CryptoClientAuthenticationDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *CryptoClientAuthenticationDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *CryptoClientAuthenticationDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config CryptoClientAuthenticationData
