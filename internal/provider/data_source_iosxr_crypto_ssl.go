...
var (
	_ datasource.DataSource              = &CryptoSSLDataSource{}
	_ datasource.DataSourceWithConfigure = &CryptoSSLDataSource{}
)

func NewCryptoSSLDataSource() datasource.DataSource {
	return &CryptoSSLDataSource{}
}

type CryptoSSLDataSource struct {
	data *IosxrProviderData
}

func (d *CryptoSSLDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"certificate": schema.StringAttribute{
							MarkdownDescription: "Router certificate to be used in mTLS session, only during enrollment or bootstrap phase.",
							Computed:            true,
						},
					},
				},
...
func (d *CryptoSSLDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *CryptoSSLDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config CryptoSSLData
