...
func TestAccDataSourceIosxrCryptoSSL(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceIosxrCryptoSSLConfig(),
...
func testAccDataSourceIosxrCryptoSSLConfig() string {
	...
	config += `
		data "iosxr_crypto_ssl" "test" {
			depends_on = [iosxr_crypto_ssl.test]
		}
	`
	return config
}
