		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.iosxr_domain_vrf.test", "list_domain.0.domain_name", "WORD"),
					resource.TestCheckResourceAttr("data.iosxr_domain_vrf.test", "list_domain.0.order", "0"),
					...
					resource.TestCheckResourceAttr("data.iosxr_domain_vrf.test", "name", "WORD"),
					resource.TestCheckResourceAttr("data.iosxr_domain_vrf.test", "ipv4_host.0.host_name", "WORD"),
					...
					resource.TestCheckResourceAttr("data.iosxr_domain_vrf.test", "ipv6_host.0.host_name", "WORD"),
					resource.TestCheckResourceAttr("data.iosxr_domain_vrf.test", "ipv6_host.0.ipv6_address.0", "10::10"),
					resource.TestCheckResourceAttr("data.iosxr_domain_vrf.test", "multicast", "WORD"),
				),
			},
		},
	})
