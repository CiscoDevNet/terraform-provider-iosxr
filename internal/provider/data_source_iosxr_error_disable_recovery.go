...
var (
	_ datasource.DataSource              = &ErrorDisableRecoveryDataSource{}
	_ datasource.DataSourceWithConfigure = &ErrorDisableRecoveryDataSource{}
)

func NewErrorDisableRecoveryDataSource() datasource.DataSource {
	return &ErrorDisableRecoveryDataSource{}
}
...
func (d *ErrorDisableRecoveryDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the Error Disable Recovery configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"link_oam_session_down_interval": schema.Int64Attribute{
				MarkdownDescription: "Configure an interval for the auto-recovery period",
				Computed:            true,
			},
...
func (d *ErrorDisableRecoveryDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config ErrorDisableRecoveryData
