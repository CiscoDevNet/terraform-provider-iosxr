...
var (
	_ datasource.DataSource              = &EVPNEVIDataSource{}
	_ datasource.DataSourceWithConfigure = &EVPNEVIDataSource{}
)

func NewEVPNEVIDataSource() datasource.DataSource {
	return &EVPNEVIDataSource{}
}
...
func (d *EVPNEVIDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the EVPN EVI configuration.",
