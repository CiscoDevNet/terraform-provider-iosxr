...
var (
	_ datasource.DataSource              = &EVPNSegmentRoutingSRv6StitchingEVIDataSource{}
	_ datasource.DataSourceWithConfigure = &EVPNSegmentRoutingSRv6StitchingEVIDataSource{}
)

func NewEVPNSegmentRoutingSRv6StitchingEVIDataSource() datasource.DataSource {
	return &EVPNSegmentRoutingSRv6StitchingEVIDataSource{}
}

type EVPNSegmentRoutingSRv6StitchingEVIDataSource struct {
	data *IosxrProviderData
}

func (d *EVPNSegmentRoutingSRv6StitchingEVIDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_evpn_segment_routing_srv6_stitching_evi"
}

func (d *EVPNSegmentRoutingSRv6StitchingEVIDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the EVPN Segment Routing SRv6 Stitching EVI configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"advertise_mac": schema.BoolAttribute{
				MarkdownDescription: "Configure locally-learned MAC advertisement",
				Computed:            true,
			},
			...
			"ignore_mtu_mismatch_disable": schema.BoolAttribute{
				MarkdownDescription: "Disables ingoring mismatch of local and remote MTUs",
				Computed:            true,
			},
			...
			"transmit_mtu_zero_disable": schema.BoolAttribute{
				MarkdownDescription: "Disables transmitting MTU zero to remote instead of actual local MTU",
				Computed:            true,
			},
...
func (d *EVPNSegmentRoutingSRv6StitchingEVIDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *EVPNSegmentRoutingSRv6StitchingEVIDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config EVPNSegmentRoutingSRv6StitchingEVIData
