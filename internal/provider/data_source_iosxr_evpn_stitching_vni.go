...
var (
	_ datasource.DataSource              = &EVPNStitchingVNIDataSource{}
	_ datasource.DataSourceWithConfigure = &EVPNStitchingVNIDataSource{}
)

func NewEVPNStitchingVNIDataSource() datasource.DataSource {
	return &EVPNStitchingVNIDataSource{}
}

type EVPNStitchingVNIDataSource struct {
	data *IosxrProviderData
}

func (d *EVPNStitchingVNIDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_evpn_stitching_vni"
}

func (d *EVPNStitchingVNIDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the EVPN Stitching VNI configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"vni_id": schema.Int64Attribute{
				MarkdownDescription: "Configure EVPN VNI",
				Required:            true,
			},
...
func (d *EVPNStitchingVNIDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *EVPNStitchingVNIDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config EVPNStitchingVNIData
