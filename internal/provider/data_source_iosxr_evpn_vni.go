...
var (
	_ datasource.DataSource              = &EVPNVNIDataSource{}
	_ datasource.DataSourceWithConfigure = &EVPNVNIDataSource{}
)

func NewEVPNVNIDataSource() datasource.DataSource {
	return &EVPNVNIDataSource{}
}
...
func (d *EVPNVNIDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the EVPN VNI configuration.",
