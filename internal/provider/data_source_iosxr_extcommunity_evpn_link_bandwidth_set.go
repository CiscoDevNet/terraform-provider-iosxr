...
var (
	_ datasource.DataSource              = &ExtcommunityEVPNLinkBandwidthSetDataSource{}
	_ datasource.DataSourceWithConfigure = &ExtcommunityEVPNLinkBandwidthSetDataSource{}
)

func NewExtcommunityEVPNLinkBandwidthSetDataSource() datasource.DataSource {
	return &ExtcommunityEVPNLinkBandwidthSetDataSource{}
}

type ExtcommunityEVPNLinkBandwidthSetDataSource struct {
	data *IosxrProviderData
}

func (d *ExtcommunityEVPNLinkBandwidthSetDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_extcommunity_evpn_link_bandwidth_set"
}

func (d *ExtcommunityEVPNLinkBandwidthSetDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Extcommunity EVPN Link Bandwidth Set configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"rpl": schema.StringAttribute{
				MarkdownDescription: "Configures an extended community EVPN link bandwidth set",
				Computed:            true,
			},
		},
	}
...
func (d *ExtcommunityEVPNLinkBandwidthSetDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *ExtcommunityEVPNLinkBandwidthSetDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config ExtcommunityEVPNLinkBandwidthSetData
