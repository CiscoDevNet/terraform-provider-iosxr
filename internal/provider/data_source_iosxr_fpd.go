...
var (
	_ datasource.DataSource              = &FPDDataSource{}
	_ datasource.DataSourceWithConfigure = &FPDDataSource{}
)

func NewFPDDataSource() datasource.DataSource {
	return &FPDDataSource{}
}
...
func (d *FPDDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the FPD configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"auto_upgrade_enable": schema.BoolAttribute{
				MarkdownDescription: "Enable fpd auto upgrade",
				Computed:            true,
			},
			"auto_upgrade_disable": schema.BoolAttribute{
				MarkdownDescription: "Disable fpd auto upgrade",
				Computed:            true,
			},
			"auto_reload_enable": schema.BoolAttribute{
				MarkdownDescription: "Enable fpd auto reload`",
				Computed:            true,
			},
			"auto_reload_disable": schema.BoolAttribute{
				MarkdownDescription: "Disable fpd auto reload`",
				Computed:            true,
			},
		},
	}
