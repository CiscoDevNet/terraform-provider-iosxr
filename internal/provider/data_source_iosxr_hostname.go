...
type dataSourceHostnameType struct{}

func (t dataSourceHostnameType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Hostname configuration.",
...
func (t dataSourceHostnameType) NewDataSource(ctx context.Context, in tfsdk.Provider) (tfsdk.DataSource, diag.Diagnostics) {
...
type dataSourceHostname struct {
	provider provider
}
