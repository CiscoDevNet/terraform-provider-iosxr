...
var (
	_ datasource.DataSource              = &ICMPDataSource{}
	_ datasource.DataSourceWithConfigure = &ICMPDataSource{}
)

func NewICMPDataSource() datasource.DataSource {
	return &ICMPDataSource{}
}

type ICMPDataSource struct {
	data *IosxrProviderData
}

func (d *ICMPDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_icmp"
}

func (d *ICMPDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the ICMP configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"ipv4_source_vrf": schema.BoolAttribute{
				MarkdownDescription: "Enable Strct VRF source address selection",
				Computed:            true,
			},
			"ipv4_source_rfc": schema.BoolAttribute{
				MarkdownDescription: "Enable RFC compliance for source address selection",
				Computed:            true,
			},
			"ipv4_rate_limit_unreachable_rate": schema.Int64Attribute{
				MarkdownDescription: "One ICMP unreachable message in x milliseconds(default is 500ms)",
				Computed:            true,
			},
			"ipv4_rate_limit_unreachable_disable": schema.BoolAttribute{
				MarkdownDescription: "Disable rate limit of ICMP messages",
				Computed:            true,
			},
			"ipv4_rate_limit_unreachable_df_rate": schema.Int64Attribute{
				MarkdownDescription: "One ICMP unreachable message in x milliseconds(default is 500ms)",
				Computed:            true,
			},
			"ipv4_rate_limit_unreachable_df_disable": schema.BoolAttribute{
				MarkdownDescription: "Disable rate limit of ICMP messages",
				Computed:            true,
			},
			"ipv6_source_vrf": schema.BoolAttribute{
				MarkdownDescription: "Enable Strct VRF source address selection",
				Computed:            true,
			},
			"ipv6_source_rfc": schema.BoolAttribute{
				MarkdownDescription: "Enable RFC compliance for source address selection",
				Computed:            true,
			},
		},
...
func (d *ICMPDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *ICMPDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config ICMPData
