...
func TestAccDataSourceIosxrICMP(t *testing.T) {
	var checks []resource.TestCheckFunc
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxr_icmp.test", "ipv4_source_vrf", "true"))
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceIosxrICMPConfig(),
...
func testAccDataSourceIosxrICMPConfig() string {
	...
	config += `
		data "iosxr_icmp" "test" {
			depends_on = [iosxr_icmp.test]
		}
	`
	return config
}
