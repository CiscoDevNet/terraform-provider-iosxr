	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"carrier_delay_up": schema.Int64Attribute{
				MarkdownDescription: "Set the carrier delay up value",
				Computed:            true,
			},
			"carrier_delay_down": schema.Int64Attribute{
				MarkdownDescription: "Set the carrier delay down value",
				Computed:            true,
			},
			"mac_address": schema.StringAttribute{
			...
			"speed": schema.StringAttribute{
				MarkdownDescription: "Set the ethernet speed on an interface",
				Computed:            true,
			},
			"duplex": schema.StringAttribute{
				MarkdownDescription: "Configure duplex operational mode",
				Computed:            true,
			},
			"flow_control": schema.StringAttribute{
				MarkdownDescription: "Set the flow control mode on an interface",
				Computed:            true,
			},
			"fec": schema.StringAttribute{
				MarkdownDescription: "Set the Forward Error Correction on an interface",
				Computed:            true,
			},
			"negotiation_auto": schema.BoolAttribute{
				MarkdownDescription: "Perform link autonegotiation",
				Computed:            true,
			},
			"negotiation_auto_allow_overrides": schema.BoolAttribute{
				MarkdownDescription: "Allow configured values to override negotiated settings",
				Computed:            true,
			},
