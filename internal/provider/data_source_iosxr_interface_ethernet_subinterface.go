...
var (
	_ datasource.DataSource              = &InterfaceEthernetSubinterfaceDataSource{}
	_ datasource.DataSourceWithConfigure = &InterfaceEthernetSubinterfaceDataSource{}
)

func NewInterfaceEthernetSubinterfaceDataSource() datasource.DataSource {
...
func (d *InterfaceEthernetSubinterfaceDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_interface_ethernet_subinterface"
}

func (d *InterfaceEthernetSubinterfaceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Interface Ethernet Subinterface configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"name": schema.StringAttribute{
				MarkdownDescription: "Ethernet subinterface ID",
				Required:            true,
			},
...
func (d *InterfaceEthernetSubinterfaceDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *InterfaceEthernetSubinterfaceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config InterfaceEthernetSubinterfaceData
