...
type dataSourceInterfaceIPv6Type struct{}

func (t dataSourceInterfaceIPv6Type) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Interface IPv6 configuration.",
...
func (t dataSourceInterfaceIPv6Type) NewDataSource(ctx context.Context, in tfsdk.Provider) (tfsdk.DataSource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return dataSourceInterfaceIPv6{
		provider: provider,
	}, diags
}

type dataSourceInterfaceIPv6 struct {
	provider provider
}
