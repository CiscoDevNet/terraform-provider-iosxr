...
var (
	_ datasource.DataSource              = &IPv4AccessListOptionsDataSource{}
	_ datasource.DataSourceWithConfigure = &IPv4AccessListOptionsDataSource{}
)

func NewIPv4AccessListOptionsDataSource() datasource.DataSource {
	return &IPv4AccessListOptionsDataSource{}
}
...
func (d *IPv4AccessListOptionsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the IPv4 Access List Options configuration.",
