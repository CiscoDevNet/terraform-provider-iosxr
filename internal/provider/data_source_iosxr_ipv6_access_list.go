...
var (
	_ datasource.DataSource              = &IPv6AccessListDataSource{}
	_ datasource.DataSourceWithConfigure = &IPv6AccessListDataSource{}
)

func NewIPv6AccessListDataSource() datasource.DataSource {
	return &IPv6AccessListDataSource{}
}
...
func (d *IPv6AccessListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the IPv6 Access List configuration.",
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"permit_source_wildcard_mask": schema.StringAttribute{
							MarkdownDescription: "Source IP address mask. Either wildcard-mask or prefix-length is supported along with address.",
							Computed:            true,
						},
						"permit_source_prefix_length": schema.Int64Attribute{
							MarkdownDescription: "Source IP address prefix length.Either wildcard-mask or prefix-length is supported along with address.",
							Computed:            true,
						},
						...
						"permit_source_net_group": schema.StringAttribute{
							MarkdownDescription: "IPv6 source network object group",
							Computed:            true,
						},
						...
						"permit_destination_wildcard_mask": schema.StringAttribute{
							MarkdownDescription: "Destination IP address mask. Either wildcard-mask or prefix-length is supported along with address.",
							Computed:            true,
						},
						"permit_destination_prefix_length": schema.Int64Attribute{
							MarkdownDescription: "Destination IP address prefix length.Either wildcard-mask or prefix-length is supported along with address.",
							Computed:            true,
						},
						...
						"permit_destination_net_group": schema.StringAttribute{
							MarkdownDescription: "IPv6 destination network object group",
							Computed:            true,
						},
						...
						"permit_nexthop1_ipv6": schema.StringAttribute{
							MarkdownDescription: "nexthop1 ipv6 address",
							Computed:            true,
						},
						...
						"permit_nexthop2_ipv6": schema.StringAttribute{
							MarkdownDescription: "nexthop2 ipv6 address",
							Computed:            true,
						},
						...
						"permit_nexthop3_ipv6": schema.StringAttribute{
							MarkdownDescription: "nexthop3 ipv6 address",
							Computed:            true,
						},
