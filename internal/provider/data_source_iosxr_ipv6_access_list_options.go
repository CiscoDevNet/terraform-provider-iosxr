...
var (
	_ datasource.DataSource              = &IPv6AccessListOptionsDataSource{}
	_ datasource.DataSourceWithConfigure = &IPv6AccessListOptionsDataSource{}
)

func NewIPv6AccessListOptionsDataSource() datasource.DataSource {
	return &IPv6AccessListOptionsDataSource{}
}
...
func (d *IPv6AccessListOptionsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the IPv6 Access List Options configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"log_update_threshold": schema.Int64Attribute{
				MarkdownDescription: "Set access-list logging threshold",
				Computed:            true,
			},
...
func (d *IPv6AccessListOptionsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config IPv6AccessListOptionsData
