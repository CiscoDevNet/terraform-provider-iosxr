...
var (
	_ datasource.DataSource              = &L2VPNBridgeGroupDataSource{}
	_ datasource.DataSourceWithConfigure = &L2VPNBridgeGroupDataSource{}
)

func NewL2VPNBridgeGroupDataSource() datasource.DataSource {
	return &L2VPNBridgeGroupDataSource{}
}
...
func (d *L2VPNBridgeGroupDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the L2VPN Bridge Group configuration.",
