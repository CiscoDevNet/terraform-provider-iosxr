...
var (
	_ datasource.DataSource              = &LoggingEventsLinkStatusDataSource{}
	_ datasource.DataSourceWithConfigure = &LoggingEventsLinkStatusDataSource{}
)

func NewLoggingEventsLinkStatusDataSource() datasource.DataSource {
	return &LoggingEventsLinkStatusDataSource{}
}

type LoggingEventsLinkStatusDataSource struct {
	data *IosxrProviderData
}

func (d *LoggingEventsLinkStatusDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_logging_events_link_status"
}

func (d *LoggingEventsLinkStatusDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Logging Events Link Status configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"software_interfaces": schema.BoolAttribute{
				MarkdownDescription: "Enable state UP/DOWN notification for software interfaces",
				Computed:            true,
			},
			"disable": schema.BoolAttribute{
				MarkdownDescription: "Disable state UP/DOWN notifications for all interfaces",
				Computed:            true,
			},
		},
	}
...
func (d *LoggingEventsLinkStatusDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *LoggingEventsLinkStatusDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config LoggingEventsLinkStatusData
