...
var (
	_ datasource.DataSource              = &LPTSPuntPoliceDataSource{}
	_ datasource.DataSourceWithConfigure = &LPTSPuntPoliceDataSource{}
)

func NewLPTSPuntPoliceDataSource() datasource.DataSource {
	return &LPTSPuntPoliceDataSource{}
}

type LPTSPuntPoliceDataSource struct {
	data *IosxrProviderData
}

func (d *LPTSPuntPoliceDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_lpts_punt_police"
}

func (d *LPTSPuntPoliceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the LPTS Punt Police configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"mcast_rate": schema.Int64Attribute{
				MarkdownDescription: "Rate in PPS",
				Computed:            true,
			},
			...
			"domains": schema.ListNestedAttribute{
				MarkdownDescription: "LPTS Domain",
				Computed:            true,
			...
			"interfaces": schema.ListNestedAttribute{
				MarkdownDescription: "Per interface level policer configuration",
				Computed:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"mcast_disabled": schema.BoolAttribute{
							MarkdownDescription: "disable punt policer",
							Computed:            true,
						},
						"bcast_rate": schema.Int64Attribute{
							MarkdownDescription: "Rate in PPS",
...
func (d *LPTSPuntPoliceDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *LPTSPuntPoliceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config LPTSPuntPoliceData
