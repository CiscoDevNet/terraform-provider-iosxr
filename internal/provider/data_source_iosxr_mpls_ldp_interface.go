...
var (
	...
	_ datasource.DataSourceWithConfigure = &MPLSLDPInterfaceDataSource{}
)

func NewMPLSLDPInterfaceDataSource() datasource.DataSource {
	return &MPLSLDPInterfaceDataSource{}
}

type MPLSLDPInterfaceDataSource struct {
...
func (d *MPLSLDPInterfaceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"discovery_hello_dual_stack_tlv": schema.StringAttribute{
				MarkdownDescription: "Change AF preference in Dual Stack TLV",
				Computed:            true,
			},
			...
			"igp_sync_delay_on_session_up": schema.Int64Attribute{
				MarkdownDescription: "Interface sync-up delay (seconds)",
				Computed:            true,
			},
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"mldp_disable": schema.BoolAttribute{
							MarkdownDescription: "Disable mLDP on LDP enabled interface",
							Computed:            true,
						},
					},
				},
...
func (d *MPLSLDPInterfaceDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *MPLSLDPInterfaceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config MPLSLDPInterfaceData
