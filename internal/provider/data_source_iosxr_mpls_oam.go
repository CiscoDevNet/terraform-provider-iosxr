...
var (
	_ datasource.DataSource              = &MPLSOAMDataSource{}
	_ datasource.DataSourceWithConfigure = &MPLSOAMDataSource{}
)

func NewMPLSOAMDataSource() datasource.DataSource {
	return &MPLSOAMDataSource{}
}
...
func (d *MPLSOAMDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the MPLS OAM configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"oam": schema.BoolAttribute{
				MarkdownDescription: "OAM configuration",
				Computed:            true,
			},
			"oam_echo_disable_vendor_extension": schema.BoolAttribute{
				MarkdownDescription: "Disable sending vendor extension TLV with echo req",
				Computed:            true,
			},
