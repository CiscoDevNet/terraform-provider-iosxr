...
var (
	_ datasource.DataSource              = &MPLSTrafficEngDataSource{}
	_ datasource.DataSourceWithConfigure = &MPLSTrafficEngDataSource{}
)

func NewMPLSTrafficEngDataSource() datasource.DataSource {
	return &MPLSTrafficEngDataSource{}
}
...
func (d *MPLSTrafficEngDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_mpls_traffic_eng"
}
...
func (d *MPLSTrafficEngDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the MPLS Traffic Eng configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"traffic_eng": schema.BoolAttribute{
