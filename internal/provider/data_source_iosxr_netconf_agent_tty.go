...
var (
	_ datasource.DataSource              = &NetconfAgentTTYDataSource{}
	_ datasource.DataSourceWithConfigure = &NetconfAgentTTYDataSource{}
)

func NewNetconfAgentTTYDataSource() datasource.DataSource {
	return &NetconfAgentTTYDataSource{}
}

type NetconfAgentTTYDataSource struct {
	data *IosxrProviderData
}

func (d *NetconfAgentTTYDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_netconf_agent_tty"
}

func (d *NetconfAgentTTYDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Netconf Agent TTY configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"throttle_offload_memory": schema.Int64Attribute{
				MarkdownDescription: "Memory offload to clients in Mbytes (0-12000)",
				Computed:            true,
			},
			"session_timeout": schema.Int64Attribute{
				MarkdownDescription: "Session timeout in minutes (1-1440)",
				Computed:            true,
			},
		},
	}
...
func (d *NetconfAgentTTYDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *NetconfAgentTTYDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config NetconfAgentTTYData
