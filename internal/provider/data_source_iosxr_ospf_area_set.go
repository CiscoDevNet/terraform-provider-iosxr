...
var (
	_ datasource.DataSource              = &OSPFAreaSetDataSource{}
	_ datasource.DataSourceWithConfigure = &OSPFAreaSetDataSource{}
)

func NewOSPFAreaSetDataSource() datasource.DataSource {
	return &OSPFAreaSetDataSource{}
}

type OSPFAreaSetDataSource struct {
	data *IosxrProviderData
}

func (d *OSPFAreaSetDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ospf_area_set"
}

func (d *OSPFAreaSetDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the OSPF Area Set configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"rpl": schema.StringAttribute{
				MarkdownDescription: "Configures an OSPF area set",
				Computed:            true,
			},
		},
	}
...
func (d *OSPFAreaSetDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *OSPFAreaSetDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config OSPFAreaSetData
