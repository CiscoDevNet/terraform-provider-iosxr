...
var (
	_ datasource.DataSource              = &PolicyGlobalSetDataSource{}
	_ datasource.DataSourceWithConfigure = &PolicyGlobalSetDataSource{}
)

func NewPolicyGlobalSetDataSource() datasource.DataSource {
	return &PolicyGlobalSetDataSource{}
}

type PolicyGlobalSetDataSource struct {
	data *IosxrProviderData
}

func (d *PolicyGlobalSetDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_policy_global_set"
}

func (d *PolicyGlobalSetDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Policy Global Set configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"rpl": schema.StringAttribute{
				MarkdownDescription: "Configures a policy global set",
				Computed:            true,
			},
		},
	}
...
func (d *PolicyGlobalSetDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *PolicyGlobalSetDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config PolicyGlobalSetData
