...
func TestAccDataSourceIosxrRouterBGPAddressFamily(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxr_router_bgp_address_family.test", "redistribute_isis.0.level_one_two_level_one_inter_area", "true"))
