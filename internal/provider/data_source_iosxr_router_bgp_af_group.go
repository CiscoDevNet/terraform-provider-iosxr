...
var (
	_ datasource.DataSource              = &RouterBGPAFGroupDataSource{}
	_ datasource.DataSourceWithConfigure = &RouterBGPAFGroupDataSource{}
)

func NewRouterBGPAFGroupDataSource() datasource.DataSource {
	return &RouterBGPAFGroupDataSource{}
}

type RouterBGPAFGroupDataSource struct {
	data *IosxrProviderData
}

func (d *RouterBGPAFGroupDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_router_bgp_af_group"
}

func (d *RouterBGPAFGroupDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Router BGP AF Group configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"af_group_name": schema.StringAttribute{
				MarkdownDescription: "AF group name",
				Required:            true,
			},
			"af_name": schema.StringAttribute{
				MarkdownDescription: "Specify a AF name",
				Required:            true,
			},
...
func (d *RouterBGPAFGroupDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *RouterBGPAFGroupDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config RouterBGPAFGroupData
