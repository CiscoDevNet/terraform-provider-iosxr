...
var (
	_ datasource.DataSource              = &RouterBGPNeighborDataSource{}
	_ datasource.DataSourceWithConfigure = &RouterBGPNeighborDataSource{}
)

func NewRouterBGPNeighborDataSource() datasource.DataSource {
	return &RouterBGPNeighborDataSource{}
}

type RouterBGPNeighborDataSource struct {
	data *IosxrProviderData
}

func (d *RouterBGPNeighborDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_router_bgp_neighbor"
}

func (d *RouterBGPNeighborDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *RouterBGPNeighborDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *RouterBGPNeighborDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config RouterBGPNeighborData
