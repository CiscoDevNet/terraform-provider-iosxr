...
func TestAccDataSourceIosxrRouterBGPNeighborGroup(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxr_router_bgp_neighbor_group.test", "bfd_fast_detect_disable", "false"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxr_router_bgp_neighbor_group.test", "timers_holdtime_number", "20"))
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxr_router_bgp_neighbor_group.test", "timers_holdtime_minimum_acceptable_holdtime", "20"))
