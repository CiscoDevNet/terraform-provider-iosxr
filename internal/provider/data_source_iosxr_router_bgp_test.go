		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.iosxr_router_bgp.test", "timers_bgp_keepalive_interval", "1"),
					resource.TestCheckResourceAttr("data.iosxr_router_bgp.test", "timers_bgp_holdtime", "3"),
					...
					resource.TestCheckResourceAttr("data.iosxr_router_bgp.test", "neighbors.0.local_as", "65005"),
