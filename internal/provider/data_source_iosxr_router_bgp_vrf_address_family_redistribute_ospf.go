...
type dataSourceRouterBGPVRFAddressFamilyRedistributeOSPFType struct{}

func (t dataSourceRouterBGPVRFAddressFamilyRedistributeOSPFType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Router BGP VRF Address Family Redistribute OSPF configuration.",
...
func (t dataSourceRouterBGPVRFAddressFamilyRedistributeOSPFType) NewDataSource(ctx context.Context, in tfsdk.Provider) (tfsdk.DataSource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return dataSourceRouterBGPVRFAddressFamilyRedistributeOSPF{
		provider: provider,
	}, diags
}

type dataSourceRouterBGPVRFAddressFamilyRedistributeOSPF struct {
	provider provider
}
