...
var (
	_ datasource.DataSource              = &RouterBGPVRFNeighborDataSource{}
	_ datasource.DataSourceWithConfigure = &RouterBGPVRFNeighborDataSource{}
)

func NewRouterBGPVRFNeighborDataSource() datasource.DataSource {
	return &RouterBGPVRFNeighborDataSource{}
}

type RouterBGPVRFNeighborDataSource struct {
	data *IosxrProviderData
}

func (d *RouterBGPVRFNeighborDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_router_bgp_vrf_neighbor"
}

func (d *RouterBGPVRFNeighborDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Router BGP VRF Neighbor configuration.",
...
func (d *RouterBGPVRFNeighborDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *RouterBGPVRFNeighborDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config RouterBGPVRFNeighborData
