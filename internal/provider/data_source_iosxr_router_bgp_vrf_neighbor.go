...
type dataSourceRouterBGPVRFNeighborType struct{}

func (t dataSourceRouterBGPVRFNeighborType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
...
func (t dataSourceRouterBGPVRFNeighborType) NewDataSource(ctx context.Context, in tfsdk.Provider) (tfsdk.DataSource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return dataSourceRouterBGPVRFNeighbor{
		provider: provider,
	}, diags
}

type dataSourceRouterBGPVRFNeighbor struct {
	provider provider
}

func (d dataSourceRouterBGPVRFNeighbor) Read(ctx context.Context, req tfsdk.ReadDataSourceRequest, resp *tfsdk.ReadDataSourceResponse) {
	var config, state RouterBGPVRFNeighbor
