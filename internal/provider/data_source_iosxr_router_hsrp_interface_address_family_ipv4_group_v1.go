...
var (
	_ datasource.DataSource              = &RouterHSRPInterfaceAddressFamilyIPv4GroupV1DataSource{}
	_ datasource.DataSourceWithConfigure = &RouterHSRPInterfaceAddressFamilyIPv4GroupV1DataSource{}
)

func NewRouterHSRPInterfaceAddressFamilyIPv4GroupV1DataSource() datasource.DataSource {
	return &RouterHSRPInterfaceAddressFamilyIPv4GroupV1DataSource{}
}

type RouterHSRPInterfaceAddressFamilyIPv4GroupV1DataSource struct {
	client *client.Client
}

func (d *RouterHSRPInterfaceAddressFamilyIPv4GroupV1DataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_router_hsrp_interface_address_family_ipv4_group_v1"
}

func (d *RouterHSRPInterfaceAddressFamilyIPv4GroupV1DataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Router HSRP Interface Address Family IPv4 Group V1 configuration.",
...
func (d *RouterHSRPInterfaceAddressFamilyIPv4GroupV1DataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *RouterHSRPInterfaceAddressFamilyIPv4GroupV1DataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config RouterHSRPInterfaceAddressFamilyIPv4GroupV1Data
