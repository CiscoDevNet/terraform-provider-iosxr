...
var (
	_ datasource.DataSource              = &RouterHSRPInterfaceAddressFamilyIPv4GroupV2DataSource{}
	_ datasource.DataSourceWithConfigure = &RouterHSRPInterfaceAddressFamilyIPv4GroupV2DataSource{}
)

func NewRouterHSRPInterfaceAddressFamilyIPv4GroupV2DataSource() datasource.DataSource {
	return &RouterHSRPInterfaceAddressFamilyIPv4GroupV2DataSource{}
}

type RouterHSRPInterfaceAddressFamilyIPv4GroupV2DataSource struct {
	client *client.Client
}

func (d *RouterHSRPInterfaceAddressFamilyIPv4GroupV2DataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_router_hsrp_interface_address_family_ipv4_group_v2"
}

func (d *RouterHSRPInterfaceAddressFamilyIPv4GroupV2DataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Router HSRP Interface Address Family IPv4 Group V2 configuration.",
...
func (d *RouterHSRPInterfaceAddressFamilyIPv4GroupV2DataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *RouterHSRPInterfaceAddressFamilyIPv4GroupV2DataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config RouterHSRPInterfaceAddressFamilyIPv4GroupV2Data
