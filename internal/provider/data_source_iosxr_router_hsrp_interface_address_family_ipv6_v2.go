...
var (
	_ datasource.DataSource              = &RouterHSRPInterfaceAddressFamilyIPv6V2DataSource{}
	_ datasource.DataSourceWithConfigure = &RouterHSRPInterfaceAddressFamilyIPv6V2DataSource{}
)

func NewRouterHSRPInterfaceAddressFamilyIPv6V2DataSource() datasource.DataSource {
	return &RouterHSRPInterfaceAddressFamilyIPv6V2DataSource{}
}

type RouterHSRPInterfaceAddressFamilyIPv6V2DataSource struct {
	client *client.Client
}

func (d *RouterHSRPInterfaceAddressFamilyIPv6V2DataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_router_hsrp_interface_address_family_ipv6_v2"
}

func (d *RouterHSRPInterfaceAddressFamilyIPv6V2DataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Router HSRP Interface Address Family IPv6 V2 configuration.",
...
func (d *RouterHSRPInterfaceAddressFamilyIPv6V2DataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *RouterHSRPInterfaceAddressFamilyIPv6V2DataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config RouterHSRPInterfaceAddressFamilyIPv6V2Data
