...
var (
	_ datasource.DataSource              = &RouterHSRPInterfaceIPv4GroupV1DataSource{}
	_ datasource.DataSourceWithConfigure = &RouterHSRPInterfaceIPv4GroupV1DataSource{}
)

func NewRouterHSRPInterfaceIPv4GroupV1DataSource() datasource.DataSource {
	return &RouterHSRPInterfaceIPv4GroupV1DataSource{}
}
...
func (d *RouterHSRPInterfaceIPv4GroupV1DataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the Router HSRP Interface IPv4 Group V1 configuration.",
...
func (d *RouterHSRPInterfaceIPv4GroupV1DataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config RouterHSRPInterfaceIPv4GroupV1Data
