		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.iosxr_router_isis.test", "lsp_password_keychain_keychain_name", "ISIS-KEY"),
					resource.TestCheckResourceAttr("data.iosxr_router_isis.test", "distribute_link_state_instance_id", "32"),
					resource.TestCheckResourceAttr("data.iosxr_router_isis.test", "affinity_maps.0.affinity_map_name", "22"),
