...
var (
	_ datasource.DataSource              = &RouterMLDInterfaceDataSource{}
	_ datasource.DataSourceWithConfigure = &RouterMLDInterfaceDataSource{}
)

func NewRouterMLDInterfaceDataSource() datasource.DataSource {
...
func (d *RouterMLDInterfaceDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_router_mld_interface"
}

func (d *RouterMLDInterfaceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Router MLD Interface configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"explicit_tracking_enable": schema.BoolAttribute{
				MarkdownDescription: "Enable MLD explicit host tracking",
				Computed:            true,
			},
...
func (d *RouterMLDInterfaceDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *RouterMLDInterfaceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config RouterMLDInterfaceData
