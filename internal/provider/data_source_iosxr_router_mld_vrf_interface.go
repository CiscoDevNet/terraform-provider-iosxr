...
var (
	_ datasource.DataSource              = &RouterMLDVRFInterfaceDataSource{}
	_ datasource.DataSourceWithConfigure = &RouterMLDVRFInterfaceDataSource{}
)

func NewRouterMLDVRFInterfaceDataSource() datasource.DataSource {
	return &RouterMLDVRFInterfaceDataSource{}
}

type RouterMLDVRFInterfaceDataSource struct {
	data *IosxrProviderData
}

func (d *RouterMLDVRFInterfaceDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_router_mld_vrf_interface"
}

func (d *RouterMLDVRFInterfaceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Router MLD VRF Interface configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"router_enable": schema.BoolAttribute{
				MarkdownDescription: "Enable Router side functionality in MLD",
				Computed:            true,
			},
			"router_disable": schema.BoolAttribute{
				MarkdownDescription: "Disable Router side functionality in MLD",
				Computed:            true,
			},
			...
			"explicit_tracking_enable": schema.BoolAttribute{
				MarkdownDescription: "Enable IGMPv3 explicit host tracking",
				Computed:            true,
			},
			...
			"static_groups": schema.ListNestedAttribute{
				MarkdownDescription: "MLD static multicast group",
				Computed:            true,
			...
			"join_groups": schema.ListNestedAttribute{
				MarkdownDescription: "MLD join multicast group",
				Computed:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"group_address": schema.StringAttribute{
			...
			"dvmrp_enable": schema.BoolAttribute{
				MarkdownDescription: "MLD Enable dvmrp on specific interface",
				Computed:            true,
			},
		},
	}
...
func (d *RouterMLDVRFInterfaceDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *RouterMLDVRFInterfaceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config RouterMLDVRFInterfaceData
