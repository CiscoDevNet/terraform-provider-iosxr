	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"domain_id_type": schema.StringAttribute{
				MarkdownDescription: "Primary OSPF domain ID type in Hex format",
				Computed:            true,
			},
			"domain_id_value": schema.StringAttribute{
				MarkdownDescription: "OSPF domain ID value in Hex format",
				Computed:            true,
			},
			"domain_id_secondaries": schema.ListNestedAttribute{
				MarkdownDescription: "OSPF domain ID type in Hex format",
				Computed:            true,
			...
			"disable_dn_bit_check": schema.BoolAttribute{
				MarkdownDescription: "Disable DN bit check",
				Computed:            true,
			},
			...
			"snmp_trap": schema.BoolAttribute{
				MarkdownDescription: "Enable SNMP trap for OSPF instance",
				Computed:            true,
			},
			...
			"exchange_timer": schema.Int64Attribute{
				MarkdownDescription: "Time in minutes after which interface will be brought down if adjacency is stuck in exchange/loading",
				Computed:            true,
			},
			"exchange_timer_hold_time": schema.Int64Attribute{
				MarkdownDescription: "Time in minutes after which interface will be brought up to recover adjacencies",
				Computed:            true,
			},
			"exchange_timer_recovery_count": schema.Int64Attribute{
				MarkdownDescription: "Number of times recovery will be attempted before the interface is made permanently down",
				Computed:            true,
			},
		},
	}
