...
func TestAccDataSourceIosxrRouterStaticVRFIPv6Multicast(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.iosxr_router_static_vrf_ipv6_multicast.test", "nexthop_interface_addresses.0.permanent", "true"))
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceIosxrRouterStaticVRFIPv6MulticastConfig(),
