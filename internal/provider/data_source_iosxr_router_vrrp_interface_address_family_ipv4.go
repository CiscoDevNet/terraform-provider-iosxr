...
var (
	_ datasource.DataSource              = &RouterVRRPInterfaceAddressFamilyIPv4DataSource{}
	_ datasource.DataSourceWithConfigure = &RouterVRRPInterfaceAddressFamilyIPv4DataSource{}
)

func NewRouterVRRPInterfaceAddressFamilyIPv4DataSource() datasource.DataSource {
	return &RouterVRRPInterfaceAddressFamilyIPv4DataSource{}
}

type RouterVRRPInterfaceAddressFamilyIPv4DataSource struct {
	client *client.Client
}

func (d *RouterVRRPInterfaceAddressFamilyIPv4DataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_router_vrrp_interface_address_family_ipv4"
}

func (d *RouterVRRPInterfaceAddressFamilyIPv4DataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Router VRRP Interface Address Family IPv4 configuration.",
...
func (d *RouterVRRPInterfaceAddressFamilyIPv4DataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *RouterVRRPInterfaceAddressFamilyIPv4DataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config RouterVRRPInterfaceAddressFamilyIPv4Data
