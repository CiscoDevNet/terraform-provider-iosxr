...
var (
	_ datasource.DataSource              = &SegmentRoutingMappingServerDataSource{}
	_ datasource.DataSourceWithConfigure = &SegmentRoutingMappingServerDataSource{}
)

func NewSegmentRoutingMappingServerDataSource() datasource.DataSource {
...
func (d *SegmentRoutingMappingServerDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_segment_routing_mapping_server"
}

func (d *SegmentRoutingMappingServerDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Segment Routing Mapping Server configuration.",
...
func (d *SegmentRoutingMappingServerDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *SegmentRoutingMappingServerDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config SegmentRoutingMappingServerData
