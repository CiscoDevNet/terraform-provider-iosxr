...
var (
	_ datasource.DataSource              = &SegmentRoutingTEOnDemandColorDataSource{}
	_ datasource.DataSourceWithConfigure = &SegmentRoutingTEOnDemandColorDataSource{}
)

func NewSegmentRoutingTEOnDemandColorDataSource() datasource.DataSource {
...
func (d *SegmentRoutingTEOnDemandColorDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_segment_routing_te_on_demand_color"
}

func (d *SegmentRoutingTEOnDemandColorDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Segment Routing TE On Demand Color configuration.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"dynamic_pcep": schema.BoolAttribute{
				MarkdownDescription: "Use Path Computation Element. Applicable for SR-MPLS and SRv6 policies",
				Computed:            true,
			},
...
func (d *SegmentRoutingTEOnDemandColorDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *SegmentRoutingTEOnDemandColorDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config SegmentRoutingTEOnDemandColorData
