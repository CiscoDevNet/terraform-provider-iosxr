		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "logging_pcep_peer_status", "true"),
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "logging_policy_status", "true"),
					...
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "on_demand_colors.0.srv6_locator_binding_sid_type", "srv6-dynamic"),
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "on_demand_colors.0.source_address", "fccc:0:213::1"),
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "on_demand_colors.0.source_address_type", "end-point-type-ipv6"),
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "on_demand_colors.0.effective_metric_value", "4444"),
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "on_demand_colors.0.effective_metric_type", "igp"),
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "on_demand_colors.0.constraint_segments_protection_type", "protected-only"),
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "on_demand_colors.0.constraint_segments_sid_algorithm", "128"),
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "policies.0.policy_name", "POLICY1"),
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "policies.0.srv6_locator_name", "Locator11"),
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "policies.0.srv6_locator_binding_sid_type", "srv6-dynamic"),
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "policies.0.srv6_locator_behavior", "ub6-insert-reduced"),
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "policies.0.source_address", "fccc:0:103::1"),
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "policies.0.source_address_type", "end-point-type-ipv6"),
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "policies.0.policy_color_endpoint_color", "65534"),
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "policies.0.policy_color_endpoint_type", "end-point-type-ipv6"),
					resource.TestCheckResourceAttr("data.iosxr_segment_routing_te.test", "policies.0.policy_color_endpoint_address", "fccc:0:215::1"),
				),
			},
		},
	})
