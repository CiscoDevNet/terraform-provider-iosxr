...
var (
	_ datasource.DataSource              = &SNMPMIBDataSource{}
	_ datasource.DataSourceWithConfigure = &SNMPMIBDataSource{}
)

func NewSNMPMIBDataSource() datasource.DataSource {
...
func (d *SNMPMIBDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *SNMPMIBDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the SNMP MIB configuration.",
...
func (d *SNMPMIBDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
