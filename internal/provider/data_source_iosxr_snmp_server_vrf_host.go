...
var (
	_ datasource.DataSource              = &SNMPServerVRFHostDataSource{}
	_ datasource.DataSourceWithConfigure = &SNMPServerVRFHostDataSource{}
)

func NewSNMPServerVRFHostDataSource() datasource.DataSource {
	return &SNMPServerVRFHostDataSource{}
}
...
func (d *SNMPServerVRFHostDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the SNMP Server VRF Host configuration.",
