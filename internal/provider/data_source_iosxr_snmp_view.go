...
var (
	_ datasource.DataSource              = &SNMPViewDataSource{}
	_ datasource.DataSourceWithConfigure = &SNMPViewDataSource{}
)

func NewSNMPViewDataSource() datasource.DataSource {
...
func (d *SNMPViewDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *SNMPViewDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the SNMP View configuration.",
...
func (d *SNMPViewDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
