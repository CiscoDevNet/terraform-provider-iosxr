...
var (
	_ datasource.DataSource              = &SyslogDataSource{}
	_ datasource.DataSourceWithConfigure = &SyslogDataSource{}
)

func NewSyslogDataSource() datasource.DataSource {
...
func (d *SyslogDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_syslog"
}

func (d *SyslogDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the syslog configuration.",
...
func (d *SyslogDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *SyslogDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config Syslog
