...
var (
	_ datasource.DataSource              = &TagSetDataSource{}
	_ datasource.DataSourceWithConfigure = &TagSetDataSource{}
)

func NewTagSetDataSource() datasource.DataSource {
	return &TagSetDataSource{}
}
...
func (d *TagSetDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the Tag Set configuration.",
