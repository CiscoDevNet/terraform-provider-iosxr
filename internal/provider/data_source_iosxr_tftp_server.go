...
var (
	_ datasource.DataSource              = &TFTPServerDataSource{}
	_ datasource.DataSourceWithConfigure = &TFTPServerDataSource{}
)

func NewTFTPServerDataSource() datasource.DataSource {
	return &TFTPServerDataSource{}
}

type TFTPServerDataSource struct {
	data *IosxrProviderData
}

func (d *TFTPServerDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_tftp_server"
}

func (d *TFTPServerDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the TFTP Server configuration.",
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"ipv4_server_max_servers": schema.StringAttribute{
							MarkdownDescription: "Set number of allowable UDP max servers",
							Computed:            true,
						},
						...
						"ipv4_server_dscp": schema.StringAttribute{
							MarkdownDescription: "Set IP DSCP (DiffServ CodePoint) for TFTP Server Packets",
							Computed:            true,
						},
...
func (d *TFTPServerDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *TFTPServerDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config TFTPServerData
