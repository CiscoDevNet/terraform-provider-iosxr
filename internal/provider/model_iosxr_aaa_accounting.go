...
func (data AAAAccounting) toBodyXML(ctx context.Context) string {
	...
	if len(data.Exec) > 0 {
		for _, item := range data.Exec {
			...
			if !item.StartStop.IsNull() && !item.StartStop.IsUnknown() {
				if item.StartStop.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/start-stop", "")
				}
			}
			if !item.StopOnly.IsNull() && !item.StopOnly.IsUnknown() {
				if item.StopOnly.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/stop-only", "")
				}
			}
			if !item.A1None.IsNull() && !item.A1None.IsUnknown() {
				if item.A1None.ValueBool() {
	...
	if len(data.System) > 0 {
		for _, item := range data.System {
			...
			if !item.Broadcast.IsNull() && !item.Broadcast.IsUnknown() {
				if item.Broadcast.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/broadcast", "")
				}
			}
			if !item.A1None.IsNull() && !item.A1None.IsUnknown() {
				if item.A1None.ValueBool() {
...
func (data *AAAAccounting) updateFromBodyXML(ctx context.Context, res xmldot.Result) {
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/update/periodic"); value.Exists() && !data.UpdatePeriodic.IsNull() {
		data.UpdatePeriodic = types.Int64Value(value.Int())
	} else if data.UpdatePeriodic.IsNull() {
		data.UpdatePeriodic = types.Int64Null()
	}
	for i := range data.Exec {
		...
		if value := helpers.GetFromXPath(r, "list-name"); value.Exists() && !data.Exec[i].List.IsNull() {
			data.Exec[i].List = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-1/server-group-name"); value.Exists() && !data.Exec[i].A1Group.IsNull() {
			data.Exec[i].A1Group = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-2/server-group-name"); value.Exists() && !data.Exec[i].A2Group.IsNull() {
			data.Exec[i].A2Group = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-3/server-group-name"); value.Exists() && !data.Exec[i].A3Group.IsNull() {
			data.Exec[i].A3Group = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-4/server-group-name"); value.Exists() && !data.Exec[i].A4Group.IsNull() {
			data.Exec[i].A4Group = types.StringValue(value.String())
	...
	for i := range data.Commands {
		...
		if value := helpers.GetFromXPath(r, "list-name"); value.Exists() && !data.Commands[i].List.IsNull() {
			data.Commands[i].List = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-1/server-group-name"); value.Exists() && !data.Commands[i].A1Group.IsNull() {
			data.Commands[i].A1Group = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-2/server-group-name"); value.Exists() && !data.Commands[i].A2Group.IsNull() {
			data.Commands[i].A2Group = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-3/server-group-name"); value.Exists() && !data.Commands[i].A3Group.IsNull() {
			data.Commands[i].A3Group = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-4/server-group-name"); value.Exists() && !data.Commands[i].A4Group.IsNull() {
			data.Commands[i].A4Group = types.StringValue(value.String())
	...
	for i := range data.System {
		...
		if value := helpers.GetFromXPath(r, "list-name"); value.Exists() && !data.System[i].List.IsNull() {
			data.System[i].List = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-1/server-group-name"); value.Exists() && !data.System[i].A1Group.IsNull() {
			data.System[i].A1Group = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-2/server-group-name"); value.Exists() && !data.System[i].A2Group.IsNull() {
			data.System[i].A2Group = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-3/server-group-name"); value.Exists() && !data.System[i].A3Group.IsNull() {
			data.System[i].A3Group = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-4/server-group-name"); value.Exists() && !data.System[i].A4Group.IsNull() {
			data.System[i].A4Group = types.StringValue(value.String())
	...
	for i := range data.Network {
		...
		if value := helpers.GetFromXPath(r, "list-name"); value.Exists() && !data.Network[i].List.IsNull() {
			data.Network[i].List = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-1/server-group-name"); value.Exists() && !data.Network[i].A1Group.IsNull() {
			data.Network[i].A1Group = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-2/server-group-name"); value.Exists() && !data.Network[i].A2Group.IsNull() {
			data.Network[i].A2Group = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-3/server-group-name"); value.Exists() && !data.Network[i].A3Group.IsNull() {
			data.Network[i].A3Group = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-4/server-group-name"); value.Exists() && !data.Network[i].A4Group.IsNull() {
			data.Network[i].A4Group = types.StringValue(value.String())
...
func (data *AAAAccounting) addDeletedItemsXML(ctx context.Context, state AAAAccounting, body string) string {
	...
	for i := range state.Network {
		...
		for j := range data.Network {
			...
			if found {
				if !state.Network[i].A4Group.IsNull() && data.Network[j].A4Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/groups/group-4/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A4Radius.IsNull() && state.Network[i].A4Radius.ValueBool() && data.Network[j].A4Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/groups/group-4/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A4Tacacs.IsNull() && state.Network[i].A4Tacacs.ValueBool() && data.Network[j].A4Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/groups/group-4/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A4None.IsNull() && state.Network[i].A4None.ValueBool() && data.Network[j].A4None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/groups/group-4/none", predicates))
				}
				if !state.Network[i].A3Group.IsNull() && data.Network[j].A3Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/groups/group-3/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A3Radius.IsNull() && state.Network[i].A3Radius.ValueBool() && data.Network[j].A3Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/groups/group-3/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A3Tacacs.IsNull() && state.Network[i].A3Tacacs.ValueBool() && data.Network[j].A3Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/groups/group-3/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A3None.IsNull() && state.Network[i].A3None.ValueBool() && data.Network[j].A3None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/groups/group-3/none", predicates))
				}
				if !state.Network[i].A2Group.IsNull() && data.Network[j].A2Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/groups/group-2/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A2Radius.IsNull() && state.Network[i].A2Radius.ValueBool() && data.Network[j].A2Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/groups/group-2/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A2Tacacs.IsNull() && state.Network[i].A2Tacacs.ValueBool() && data.Network[j].A2Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/groups/group-2/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A2None.IsNull() && state.Network[i].A2None.ValueBool() && data.Network[j].A2None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/groups/group-2/none", predicates))
				}
				if !state.Network[i].A1Group.IsNull() && data.Network[j].A1Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/groups/group-1/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A1Radius.IsNull() && state.Network[i].A1Radius.ValueBool() && data.Network[j].A1Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/groups/group-1/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A1Tacacs.IsNull() && state.Network[i].A1Tacacs.ValueBool() && data.Network[j].A1Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/groups/group-1/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A1None.IsNull() && state.Network[i].A1None.ValueBool() && data.Network[j].A1None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].StopOnly.IsNull() && state.Network[i].StopOnly.ValueBool() && data.Network[j].StopOnly.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/stop-only", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].StartStop.IsNull() && state.Network[i].StartStop.ValueBool() && data.Network[j].StartStop.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v/start-stop", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/accounting-list%v", predicates))
		}
	}
	for i := range state.System {
		stateKeys := [...]string{"list-name"}
		...
		for j := range data.System {
			...
			if found {
				if !state.System[i].A4Group.IsNull() && data.System[j].A4Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/groups/group-4/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.System[i].A4Radius.IsNull() && state.System[i].A4Radius.ValueBool() && data.System[j].A4Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/groups/group-4/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.System[i].A4Tacacs.IsNull() && state.System[i].A4Tacacs.ValueBool() && data.System[j].A4Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/groups/group-4/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.System[i].A4None.IsNull() && state.System[i].A4None.ValueBool() && data.System[j].A4None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/groups/group-4/none", predicates))
				}
				if !state.System[i].A3Group.IsNull() && data.System[j].A3Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/groups/group-3/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.System[i].A3Radius.IsNull() && state.System[i].A3Radius.ValueBool() && data.System[j].A3Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/groups/group-3/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.System[i].A3Tacacs.IsNull() && state.System[i].A3Tacacs.ValueBool() && data.System[j].A3Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/groups/group-3/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.System[i].A3None.IsNull() && state.System[i].A3None.ValueBool() && data.System[j].A3None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/groups/group-3/none", predicates))
				}
				if !state.System[i].A2Group.IsNull() && data.System[j].A2Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/groups/group-2/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.System[i].A2Radius.IsNull() && state.System[i].A2Radius.ValueBool() && data.System[j].A2Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/groups/group-2/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.System[i].A2Tacacs.IsNull() && state.System[i].A2Tacacs.ValueBool() && data.System[j].A2Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/groups/group-2/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.System[i].A2None.IsNull() && state.System[i].A2None.ValueBool() && data.System[j].A2None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/groups/group-2/none", predicates))
				}
				if !state.System[i].A1Group.IsNull() && data.System[j].A1Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/groups/group-1/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.System[i].A1Radius.IsNull() && state.System[i].A1Radius.ValueBool() && data.System[j].A1Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/groups/group-1/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.System[i].A1Tacacs.IsNull() && state.System[i].A1Tacacs.ValueBool() && data.System[j].A1Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/groups/group-1/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.System[i].A1None.IsNull() && state.System[i].A1None.ValueBool() && data.System[j].A1None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.System[i].Broadcast.IsNull() && state.System[i].Broadcast.ValueBool() && data.System[j].Broadcast.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/broadcast", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.System[i].StartStop.IsNull() && state.System[i].StartStop.ValueBool() && data.System[j].StartStop.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v/start-stop", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/system/accounting-list%v", predicates))
		}
	}
	for i := range state.Commands {
		stateKeys := [...]string{"list-name"}
		...
		for j := range data.Commands {
			...
			if found {
				if !state.Commands[i].A4Group.IsNull() && data.Commands[j].A4Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-4/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A4Radius.IsNull() && state.Commands[i].A4Radius.ValueBool() && data.Commands[j].A4Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-4/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A4Tacacs.IsNull() && state.Commands[i].A4Tacacs.ValueBool() && data.Commands[j].A4Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-4/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A4None.IsNull() && state.Commands[i].A4None.ValueBool() && data.Commands[j].A4None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-4/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A4Local.IsNull() && state.Commands[i].A4Local.ValueBool() && data.Commands[j].A4Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-4/local", predicates))
				}
				if !state.Commands[i].A3Group.IsNull() && data.Commands[j].A3Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-3/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A3Radius.IsNull() && state.Commands[i].A3Radius.ValueBool() && data.Commands[j].A3Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-3/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A3Tacacs.IsNull() && state.Commands[i].A3Tacacs.ValueBool() && data.Commands[j].A3Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-3/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A3None.IsNull() && state.Commands[i].A3None.ValueBool() && data.Commands[j].A3None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-3/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A3Local.IsNull() && state.Commands[i].A3Local.ValueBool() && data.Commands[j].A3Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-3/local", predicates))
				}
				if !state.Commands[i].A2Group.IsNull() && data.Commands[j].A2Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-2/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A2Radius.IsNull() && state.Commands[i].A2Radius.ValueBool() && data.Commands[j].A2Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-2/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A2Tacacs.IsNull() && state.Commands[i].A2Tacacs.ValueBool() && data.Commands[j].A2Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-2/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A2None.IsNull() && state.Commands[i].A2None.ValueBool() && data.Commands[j].A2None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-2/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A2Local.IsNull() && state.Commands[i].A2Local.ValueBool() && data.Commands[j].A2Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-2/local", predicates))
				}
				if !state.Commands[i].A1Group.IsNull() && data.Commands[j].A1Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-1/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A1Radius.IsNull() && state.Commands[i].A1Radius.ValueBool() && data.Commands[j].A1Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-1/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A1Tacacs.IsNull() && state.Commands[i].A1Tacacs.ValueBool() && data.Commands[j].A1Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/groups/group-1/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A1Local.IsNull() && state.Commands[i].A1Local.ValueBool() && data.Commands[j].A1Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/local", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A1None.IsNull() && state.Commands[i].A1None.ValueBool() && data.Commands[j].A1None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].StopOnly.IsNull() && state.Commands[i].StopOnly.ValueBool() && data.Commands[j].StopOnly.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/stop-only", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].StartStop.IsNull() && state.Commands[i].StartStop.ValueBool() && data.Commands[j].StartStop.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v/start-stop", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/accounting-list%v", predicates))
		}
	}
	for i := range state.Exec {
		stateKeys := [...]string{"list-name"}
		...
		for j := range data.Exec {
			...
			if found {
				if !state.Exec[i].A4Group.IsNull() && data.Exec[j].A4Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/groups/group-4/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A4Radius.IsNull() && state.Exec[i].A4Radius.ValueBool() && data.Exec[j].A4Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/groups/group-4/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A4Tacacs.IsNull() && state.Exec[i].A4Tacacs.ValueBool() && data.Exec[j].A4Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/groups/group-4/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A4None.IsNull() && state.Exec[i].A4None.ValueBool() && data.Exec[j].A4None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/groups/group-4/none", predicates))
				}
				if !state.Exec[i].A3Group.IsNull() && data.Exec[j].A3Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/groups/group-3/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A3Radius.IsNull() && state.Exec[i].A3Radius.ValueBool() && data.Exec[j].A3Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/groups/group-3/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A3Tacacs.IsNull() && state.Exec[i].A3Tacacs.ValueBool() && data.Exec[j].A3Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/groups/group-3/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A3None.IsNull() && state.Exec[i].A3None.ValueBool() && data.Exec[j].A3None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/groups/group-3/none", predicates))
				}
				if !state.Exec[i].A2Group.IsNull() && data.Exec[j].A2Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/groups/group-2/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A2Radius.IsNull() && state.Exec[i].A2Radius.ValueBool() && data.Exec[j].A2Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/groups/group-2/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A2Tacacs.IsNull() && state.Exec[i].A2Tacacs.ValueBool() && data.Exec[j].A2Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/groups/group-2/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A2None.IsNull() && state.Exec[i].A2None.ValueBool() && data.Exec[j].A2None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/groups/group-2/none", predicates))
				}
				if !state.Exec[i].A1Group.IsNull() && data.Exec[j].A1Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/groups/group-1/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A1Radius.IsNull() && state.Exec[i].A1Radius.ValueBool() && data.Exec[j].A1Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/groups/group-1/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A1Tacacs.IsNull() && state.Exec[i].A1Tacacs.ValueBool() && data.Exec[j].A1Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/groups/group-1/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A1None.IsNull() && state.Exec[i].A1None.ValueBool() && data.Exec[j].A1None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].StopOnly.IsNull() && state.Exec[i].StopOnly.ValueBool() && data.Exec[j].StopOnly.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/stop-only", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].StartStop.IsNull() && state.Exec[i].StartStop.ValueBool() && data.Exec[j].StartStop.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v/start-stop", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/accounting-list%v", predicates))
		}
	}
	if !state.UpdatePeriodic.IsNull() && data.UpdatePeriodic.IsNull() {
