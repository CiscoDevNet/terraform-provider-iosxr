...
func (data *AAAAuthorization) updateFromBodyXML(ctx context.Context, res xmldot.Result) {
	...
	for i := range data.Eventmanager {
		...
		if value := helpers.GetFromXPath(r, "list-name"); value.Exists() && !data.Eventmanager[i].List.IsNull() {
			data.Eventmanager[i].List = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-1/server-group-name"); value.Exists() && !data.Eventmanager[i].A1Group.IsNull() {
			data.Eventmanager[i].A1Group = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "groups/group-2/server-group-name"); value.Exists() && !data.Eventmanager[i].A2Group.IsNull() {
			data.Eventmanager[i].A2Group = types.StringValue(value.String())
...
func (data *AAAAuthorization) addDeletedItemsXML(ctx context.Context, state AAAAuthorization, body string) string {
	...
	for i := range state.Network {
		...
		for j := range data.Network {
			...
			if found {
				if !state.Network[i].A4Group.IsNull() && data.Network[j].A4Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-4/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A4Radius.IsNull() && state.Network[i].A4Radius.ValueBool() && data.Network[j].A4Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-4/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A4Tacacs.IsNull() && state.Network[i].A4Tacacs.ValueBool() && data.Network[j].A4Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-4/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A4None.IsNull() && state.Network[i].A4None.ValueBool() && data.Network[j].A4None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-4/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A4Local.IsNull() && state.Network[i].A4Local.ValueBool() && data.Network[j].A4Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-4/local", predicates))
				}
				if !state.Network[i].A3Group.IsNull() && data.Network[j].A3Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-3/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A3Radius.IsNull() && state.Network[i].A3Radius.ValueBool() && data.Network[j].A3Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-3/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A3Tacacs.IsNull() && state.Network[i].A3Tacacs.ValueBool() && data.Network[j].A3Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-3/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A3None.IsNull() && state.Network[i].A3None.ValueBool() && data.Network[j].A3None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-3/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A3Local.IsNull() && state.Network[i].A3Local.ValueBool() && data.Network[j].A3Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-3/local", predicates))
				}
				if !state.Network[i].A2Group.IsNull() && data.Network[j].A2Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-2/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A2Radius.IsNull() && state.Network[i].A2Radius.ValueBool() && data.Network[j].A2Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-2/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A2Tacacs.IsNull() && state.Network[i].A2Tacacs.ValueBool() && data.Network[j].A2Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-2/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A2None.IsNull() && state.Network[i].A2None.ValueBool() && data.Network[j].A2None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-2/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A2Local.IsNull() && state.Network[i].A2Local.ValueBool() && data.Network[j].A2Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-2/local", predicates))
				}
				if !state.Network[i].A1Group.IsNull() && data.Network[j].A1Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-1/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A1Radius.IsNull() && state.Network[i].A1Radius.ValueBool() && data.Network[j].A1Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-1/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A1Tacacs.IsNull() && state.Network[i].A1Tacacs.ValueBool() && data.Network[j].A1Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/groups/group-1/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A1None.IsNull() && state.Network[i].A1None.ValueBool() && data.Network[j].A1None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Network[i].A1Local.IsNull() && state.Network[i].A1Local.ValueBool() && data.Network[j].A1Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v/local", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/network/authorization-list%v", predicates))
		}
	}
	for i := range state.Commands {
		stateKeys := [...]string{"list-name"}
		...
		for j := range data.Commands {
			...
			if found {
				if !state.Commands[i].A4Group.IsNull() && data.Commands[j].A4Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/authorization-list%v/groups/group-4/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A4Tacacs.IsNull() && state.Commands[i].A4Tacacs.ValueBool() && data.Commands[j].A4Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/authorization-list%v/groups/group-4/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A4None.IsNull() && state.Commands[i].A4None.ValueBool() && data.Commands[j].A4None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/authorization-list%v/groups/group-4/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A4Local.IsNull() && state.Commands[i].A4Local.ValueBool() && data.Commands[j].A4Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/authorization-list%v/groups/group-4/local", predicates))
				}
				if !state.Commands[i].A3Group.IsNull() && data.Commands[j].A3Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/authorization-list%v/groups/group-3/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A3Tacacs.IsNull() && state.Commands[i].A3Tacacs.ValueBool() && data.Commands[j].A3Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/authorization-list%v/groups/group-3/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A3None.IsNull() && state.Commands[i].A3None.ValueBool() && data.Commands[j].A3None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/authorization-list%v/groups/group-3/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A3Local.IsNull() && state.Commands[i].A3Local.ValueBool() && data.Commands[j].A3Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/authorization-list%v/groups/group-3/local", predicates))
				}
				if !state.Commands[i].A2Group.IsNull() && data.Commands[j].A2Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/authorization-list%v/groups/group-2/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A2Tacacs.IsNull() && state.Commands[i].A2Tacacs.ValueBool() && data.Commands[j].A2Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/authorization-list%v/groups/group-2/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A2None.IsNull() && state.Commands[i].A2None.ValueBool() && data.Commands[j].A2None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/authorization-list%v/groups/group-2/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A2Local.IsNull() && state.Commands[i].A2Local.ValueBool() && data.Commands[j].A2Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/authorization-list%v/groups/group-2/local", predicates))
				}
				if !state.Commands[i].A1Group.IsNull() && data.Commands[j].A1Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/authorization-list%v/groups/group-1/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A1Tacacs.IsNull() && state.Commands[i].A1Tacacs.ValueBool() && data.Commands[j].A1Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/authorization-list%v/groups/group-1/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A1None.IsNull() && state.Commands[i].A1None.ValueBool() && data.Commands[j].A1None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/authorization-list%v/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Commands[i].A1Local.IsNull() && state.Commands[i].A1Local.ValueBool() && data.Commands[j].A1Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/authorization-list%v/local", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/commands/authorization-list%v", predicates))
		}
	}
	for i := range state.Eventmanager {
		stateKeys := [...]string{"list-name"}
		...
		for j := range data.Eventmanager {
			...
			if found {
				if !state.Eventmanager[i].A2Group.IsNull() && data.Eventmanager[j].A2Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/eventmanager/authorization-list%v/groups/group-2/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Eventmanager[i].A2Tacacs.IsNull() && state.Eventmanager[i].A2Tacacs.ValueBool() && data.Eventmanager[j].A2Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/eventmanager/authorization-list%v/groups/group-2/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Eventmanager[i].A2Local.IsNull() && state.Eventmanager[i].A2Local.ValueBool() && data.Eventmanager[j].A2Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/eventmanager/authorization-list%v/groups/group-2/local", predicates))
				}
				if !state.Eventmanager[i].A1Group.IsNull() && data.Eventmanager[j].A1Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/eventmanager/authorization-list%v/groups/group-1/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Eventmanager[i].A1Tacacs.IsNull() && state.Eventmanager[i].A1Tacacs.ValueBool() && data.Eventmanager[j].A1Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/eventmanager/authorization-list%v/groups/group-1/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Eventmanager[i].A1Local.IsNull() && state.Eventmanager[i].A1Local.ValueBool() && data.Eventmanager[j].A1Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/eventmanager/authorization-list%v/local", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/eventmanager/authorization-list%v", predicates))
		}
	}
	for i := range state.Exec {
		stateKeys := [...]string{"list-name"}
		...
		for j := range data.Exec {
			...
			if found {
				if !state.Exec[i].A4Group.IsNull() && data.Exec[j].A4Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-4/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A4Radius.IsNull() && state.Exec[i].A4Radius.ValueBool() && data.Exec[j].A4Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-4/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A4Tacacs.IsNull() && state.Exec[i].A4Tacacs.ValueBool() && data.Exec[j].A4Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-4/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A4None.IsNull() && state.Exec[i].A4None.ValueBool() && data.Exec[j].A4None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-4/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A4Local.IsNull() && state.Exec[i].A4Local.ValueBool() && data.Exec[j].A4Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-4/local", predicates))
				}
				if !state.Exec[i].A3Group.IsNull() && data.Exec[j].A3Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-3/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A3Radius.IsNull() && state.Exec[i].A3Radius.ValueBool() && data.Exec[j].A3Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-3/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A3Tacacs.IsNull() && state.Exec[i].A3Tacacs.ValueBool() && data.Exec[j].A3Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-3/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A3None.IsNull() && state.Exec[i].A3None.ValueBool() && data.Exec[j].A3None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-3/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A3Local.IsNull() && state.Exec[i].A3Local.ValueBool() && data.Exec[j].A3Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-3/local", predicates))
				}
				if !state.Exec[i].A2Group.IsNull() && data.Exec[j].A2Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-2/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A2Radius.IsNull() && state.Exec[i].A2Radius.ValueBool() && data.Exec[j].A2Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-2/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A2Tacacs.IsNull() && state.Exec[i].A2Tacacs.ValueBool() && data.Exec[j].A2Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-2/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A2None.IsNull() && state.Exec[i].A2None.ValueBool() && data.Exec[j].A2None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-2/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A2Local.IsNull() && state.Exec[i].A2Local.ValueBool() && data.Exec[j].A2Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-2/local", predicates))
				}
				if !state.Exec[i].A1Group.IsNull() && data.Exec[j].A1Group.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-1/server-group-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A1Radius.IsNull() && state.Exec[i].A1Radius.ValueBool() && data.Exec[j].A1Radius.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-1/radius", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A1Tacacs.IsNull() && state.Exec[i].A1Tacacs.ValueBool() && data.Exec[j].A1Tacacs.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/groups/group-1/tacacs", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A1None.IsNull() && state.Exec[i].A1None.ValueBool() && data.Exec[j].A1None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/none", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Exec[i].A1Local.IsNull() && state.Exec[i].A1Local.ValueBool() && data.Exec[j].A1Local.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v/local", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/exec/authorization-list%v", predicates))
		}
	}
