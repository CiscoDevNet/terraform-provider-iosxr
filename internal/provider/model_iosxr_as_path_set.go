...
func (data ASPathSet) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data ASPathSet) GetVersionConstraints() []helpers.FieldVersionConstraint {
...
func (data ASPathSet) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
