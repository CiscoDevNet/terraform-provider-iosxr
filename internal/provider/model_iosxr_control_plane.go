...
type ControlPlane struct {
	...
	MgmtInbandInterfaces              []ControlPlaneMgmtInbandInterfaces              `tfsdk:"mgmt_inband_interfaces"`
	MgmtInbandAllSsh                  types.Bool                                      `tfsdk:"mgmt_inband_all_ssh"`
	MgmtInbandAllSshIpv4Prefixes      []ControlPlaneMgmtInbandAllSshIpv4Prefixes      `tfsdk:"mgmt_inband_all_ssh_ipv4_prefixes"`
	MgmtInbandAllSshIpv4Hosts         []ControlPlaneMgmtInbandAllSshIpv4Hosts         `tfsdk:"mgmt_inband_all_ssh_ipv4_hosts"`
	MgmtInbandAllSshIpv6Prefixes      []ControlPlaneMgmtInbandAllSshIpv6Prefixes      `tfsdk:"mgmt_inband_all_ssh_ipv6_prefixes"`
	MgmtInbandAllSshIpv6Hosts         []ControlPlaneMgmtInbandAllSshIpv6Hosts         `tfsdk:"mgmt_inband_all_ssh_ipv6_hosts"`
	MgmtInbandAllTelnet               types.Bool                                      `tfsdk:"mgmt_inband_all_telnet"`
	MgmtInbandAllTelnetIpv4Prefixes   []ControlPlaneMgmtInbandAllTelnetIpv4Prefixes   `tfsdk:"mgmt_inband_all_telnet_ipv4_prefixes"`
	MgmtInbandAllTelnetIpv4Hosts      []ControlPlaneMgmtInbandAllTelnetIpv4Hosts      `tfsdk:"mgmt_inband_all_telnet_ipv4_hosts"`
	MgmtInbandAllTelnetIpv6Prefixes   []ControlPlaneMgmtInbandAllTelnetIpv6Prefixes   `tfsdk:"mgmt_inband_all_telnet_ipv6_prefixes"`
	MgmtInbandAllTelnetIpv6Hosts      []ControlPlaneMgmtInbandAllTelnetIpv6Hosts      `tfsdk:"mgmt_inband_all_telnet_ipv6_hosts"`
	MgmtInbandAllSnmp                 types.Bool                                      `tfsdk:"mgmt_inband_all_snmp"`
	MgmtInbandAllSnmpIpv4Prefixes     []ControlPlaneMgmtInbandAllSnmpIpv4Prefixes     `tfsdk:"mgmt_inband_all_snmp_ipv4_prefixes"`
	MgmtInbandAllSnmpIpv4Hosts        []ControlPlaneMgmtInbandAllSnmpIpv4Hosts        `tfsdk:"mgmt_inband_all_snmp_ipv4_hosts"`
	MgmtInbandAllSnmpIpv6Prefixes     []ControlPlaneMgmtInbandAllSnmpIpv6Prefixes     `tfsdk:"mgmt_inband_all_snmp_ipv6_prefixes"`
	MgmtInbandAllSnmpIpv6Hosts        []ControlPlaneMgmtInbandAllSnmpIpv6Hosts        `tfsdk:"mgmt_inband_all_snmp_ipv6_hosts"`
	MgmtInbandAllTftp                 types.Bool                                      `tfsdk:"mgmt_inband_all_tftp"`
	MgmtInbandAllTftpIpv4Prefixes     []ControlPlaneMgmtInbandAllTftpIpv4Prefixes     `tfsdk:"mgmt_inband_all_tftp_ipv4_prefixes"`
	MgmtInbandAllTftpIpv4Hosts        []ControlPlaneMgmtInbandAllTftpIpv4Hosts        `tfsdk:"mgmt_inband_all_tftp_ipv4_hosts"`
	MgmtInbandAllTftpIpv6Prefixes     []ControlPlaneMgmtInbandAllTftpIpv6Prefixes     `tfsdk:"mgmt_inband_all_tftp_ipv6_prefixes"`
	MgmtInbandAllTftpIpv6Hosts        []ControlPlaneMgmtInbandAllTftpIpv6Hosts        `tfsdk:"mgmt_inband_all_tftp_ipv6_hosts"`
	MgmtInbandAllHttp                 types.Bool                                      `tfsdk:"mgmt_inband_all_http"`
	MgmtInbandAllHttpIpv4Prefixes     []ControlPlaneMgmtInbandAllHttpIpv4Prefixes     `tfsdk:"mgmt_inband_all_http_ipv4_prefixes"`
	MgmtInbandAllHttpIpv4Hosts        []ControlPlaneMgmtInbandAllHttpIpv4Hosts        `tfsdk:"mgmt_inband_all_http_ipv4_hosts"`
	MgmtInbandAllXml                  types.Bool                                      `tfsdk:"mgmt_inband_all_xml"`
	MgmtInbandAllXmlIpv4Prefixes      []ControlPlaneMgmtInbandAllXmlIpv4Prefixes      `tfsdk:"mgmt_inband_all_xml_ipv4_prefixes"`
	MgmtInbandAllXmlIpv4Hosts         []ControlPlaneMgmtInbandAllXmlIpv4Hosts         `tfsdk:"mgmt_inband_all_xml_ipv4_hosts"`
	MgmtInbandAllXmlIpv6Prefixes      []ControlPlaneMgmtInbandAllXmlIpv6Prefixes      `tfsdk:"mgmt_inband_all_xml_ipv6_prefixes"`
	MgmtInbandAllXmlIpv6Hosts         []ControlPlaneMgmtInbandAllXmlIpv6Hosts         `tfsdk:"mgmt_inband_all_xml_ipv6_hosts"`
	MgmtInbandAllNetconf              types.Bool                                      `tfsdk:"mgmt_inband_all_netconf"`
	MgmtInbandAllNetconfIpv4Prefixes  []ControlPlaneMgmtInbandAllNetconfIpv4Prefixes  `tfsdk:"mgmt_inband_all_netconf_ipv4_prefixes"`
	MgmtInbandAllNetconfIpv4Hosts     []ControlPlaneMgmtInbandAllNetconfIpv4Hosts     `tfsdk:"mgmt_inband_all_netconf_ipv4_hosts"`
	MgmtInbandAllNetconfIpv6Prefixes  []ControlPlaneMgmtInbandAllNetconfIpv6Prefixes  `tfsdk:"mgmt_inband_all_netconf_ipv6_prefixes"`
	MgmtInbandAllNetconfIpv6Hosts     []ControlPlaneMgmtInbandAllNetconfIpv6Hosts     `tfsdk:"mgmt_inband_all_netconf_ipv6_hosts"`
	MgmtInbandAllAllowAll             types.Bool                                      `tfsdk:"mgmt_inband_all_allow_all"`
	MgmtInbandAllAllowAllIpv4Prefixes []ControlPlaneMgmtInbandAllAllowAllIpv4Prefixes `tfsdk:"mgmt_inband_all_allow_all_ipv4_prefixes"`
	MgmtInbandAllAllowAllIpv4Hosts    []ControlPlaneMgmtInbandAllAllowAllIpv4Hosts    `tfsdk:"mgmt_inband_all_allow_all_ipv4_hosts"`
	MgmtInbandAllAllowAllIpv6Prefixes []ControlPlaneMgmtInbandAllAllowAllIpv6Prefixes `tfsdk:"mgmt_inband_all_allow_all_ipv6_prefixes"`
	MgmtInbandAllAllowAllIpv6Hosts    []ControlPlaneMgmtInbandAllAllowAllIpv6Hosts    `tfsdk:"mgmt_inband_all_allow_all_ipv6_hosts"`
	MgmtOobInterfaces                 []ControlPlaneMgmtOobInterfaces                 `tfsdk:"mgmt_oob_interfaces"`
	MgmtOobVrf                        types.String                                    `tfsdk:"mgmt_oob_vrf"`
	MgmtOobInbandBehavior             types.Bool                                      `tfsdk:"mgmt_oob_inband_behavior"`
	MgmtOobAllSsh                     types.Bool                                      `tfsdk:"mgmt_oob_all_ssh"`
	MgmtOobAllSshIpv4Prefixes         []ControlPlaneMgmtOobAllSshIpv4Prefixes         `tfsdk:"mgmt_oob_all_ssh_ipv4_prefixes"`
	MgmtOobAllSshIpv4Hosts            []ControlPlaneMgmtOobAllSshIpv4Hosts            `tfsdk:"mgmt_oob_all_ssh_ipv4_hosts"`
	MgmtOobAllSshIpv6Prefixes         []ControlPlaneMgmtOobAllSshIpv6Prefixes         `tfsdk:"mgmt_oob_all_ssh_ipv6_prefixes"`
	MgmtOobAllSshIpv6Hosts            []ControlPlaneMgmtOobAllSshIpv6Hosts            `tfsdk:"mgmt_oob_all_ssh_ipv6_hosts"`
	MgmtOobAllTelnet                  types.Bool                                      `tfsdk:"mgmt_oob_all_telnet"`
	MgmtOobAllTelnetIpv4Prefixes      []ControlPlaneMgmtOobAllTelnetIpv4Prefixes      `tfsdk:"mgmt_oob_all_telnet_ipv4_prefixes"`
	MgmtOobAllTelnetIpv4Hosts         []ControlPlaneMgmtOobAllTelnetIpv4Hosts         `tfsdk:"mgmt_oob_all_telnet_ipv4_hosts"`
	MgmtOobAllTelnetIpv6Prefixes      []ControlPlaneMgmtOobAllTelnetIpv6Prefixes      `tfsdk:"mgmt_oob_all_telnet_ipv6_prefixes"`
	MgmtOobAllTelnetIpv6Hosts         []ControlPlaneMgmtOobAllTelnetIpv6Hosts         `tfsdk:"mgmt_oob_all_telnet_ipv6_hosts"`
	MgmtOobAllSnmp                    types.Bool                                      `tfsdk:"mgmt_oob_all_snmp"`
	MgmtOobAllSnmpIpv4Prefixes        []ControlPlaneMgmtOobAllSnmpIpv4Prefixes        `tfsdk:"mgmt_oob_all_snmp_ipv4_prefixes"`
	MgmtOobAllSnmpIpv4Hosts           []ControlPlaneMgmtOobAllSnmpIpv4Hosts           `tfsdk:"mgmt_oob_all_snmp_ipv4_hosts"`
	MgmtOobAllSnmpIpv6Prefixes        []ControlPlaneMgmtOobAllSnmpIpv6Prefixes        `tfsdk:"mgmt_oob_all_snmp_ipv6_prefixes"`
	MgmtOobAllSnmpIpv6Hosts           []ControlPlaneMgmtOobAllSnmpIpv6Hosts           `tfsdk:"mgmt_oob_all_snmp_ipv6_hosts"`
	MgmtOobAllTftp                    types.Bool                                      `tfsdk:"mgmt_oob_all_tftp"`
	MgmtOobAllTftpIpv4Prefixes        []ControlPlaneMgmtOobAllTftpIpv4Prefixes        `tfsdk:"mgmt_oob_all_tftp_ipv4_prefixes"`
	MgmtOobAllTftpIpv4Hosts           []ControlPlaneMgmtOobAllTftpIpv4Hosts           `tfsdk:"mgmt_oob_all_tftp_ipv4_hosts"`
	MgmtOobAllTftpIpv6Prefixes        []ControlPlaneMgmtOobAllTftpIpv6Prefixes        `tfsdk:"mgmt_oob_all_tftp_ipv6_prefixes"`
	MgmtOobAllTftpIpv6Hosts           []ControlPlaneMgmtOobAllTftpIpv6Hosts           `tfsdk:"mgmt_oob_all_tftp_ipv6_hosts"`
	MgmtOobAllHttp                    types.Bool                                      `tfsdk:"mgmt_oob_all_http"`
	MgmtOobAllHttpIpv4Prefixes        []ControlPlaneMgmtOobAllHttpIpv4Prefixes        `tfsdk:"mgmt_oob_all_http_ipv4_prefixes"`
	MgmtOobAllHttpIpv4Hosts           []ControlPlaneMgmtOobAllHttpIpv4Hosts           `tfsdk:"mgmt_oob_all_http_ipv4_hosts"`
	MgmtOobAllXml                     types.Bool                                      `tfsdk:"mgmt_oob_all_xml"`
	MgmtOobAllXmlIpv4Prefixes         []ControlPlaneMgmtOobAllXmlIpv4Prefixes         `tfsdk:"mgmt_oob_all_xml_ipv4_prefixes"`
	MgmtOobAllXmlIpv4Hosts            []ControlPlaneMgmtOobAllXmlIpv4Hosts            `tfsdk:"mgmt_oob_all_xml_ipv4_hosts"`
	MgmtOobAllXmlIpv6Prefixes         []ControlPlaneMgmtOobAllXmlIpv6Prefixes         `tfsdk:"mgmt_oob_all_xml_ipv6_prefixes"`
	MgmtOobAllXmlIpv6Hosts            []ControlPlaneMgmtOobAllXmlIpv6Hosts            `tfsdk:"mgmt_oob_all_xml_ipv6_hosts"`
	MgmtOobAllNetconf                 types.Bool                                      `tfsdk:"mgmt_oob_all_netconf"`
	MgmtOobAllNetconfIpv4Prefixes     []ControlPlaneMgmtOobAllNetconfIpv4Prefixes     `tfsdk:"mgmt_oob_all_netconf_ipv4_prefixes"`
	MgmtOobAllNetconfIpv4Hosts        []ControlPlaneMgmtOobAllNetconfIpv4Hosts        `tfsdk:"mgmt_oob_all_netconf_ipv4_hosts"`
	MgmtOobAllNetconfIpv6Prefixes     []ControlPlaneMgmtOobAllNetconfIpv6Prefixes     `tfsdk:"mgmt_oob_all_netconf_ipv6_prefixes"`
	MgmtOobAllNetconfIpv6Hosts        []ControlPlaneMgmtOobAllNetconfIpv6Hosts        `tfsdk:"mgmt_oob_all_netconf_ipv6_hosts"`
	MgmtOobAllAllowAll                types.Bool                                      `tfsdk:"mgmt_oob_all_allow_all"`
	MgmtOobAllAllowAllIpv4Prefixes    []ControlPlaneMgmtOobAllAllowAllIpv4Prefixes    `tfsdk:"mgmt_oob_all_allow_all_ipv4_prefixes"`
	MgmtOobAllAllowAllIpv4Hosts       []ControlPlaneMgmtOobAllAllowAllIpv4Hosts       `tfsdk:"mgmt_oob_all_allow_all_ipv4_hosts"`
	MgmtOobAllAllowAllIpv6Prefixes    []ControlPlaneMgmtOobAllAllowAllIpv6Prefixes    `tfsdk:"mgmt_oob_all_allow_all_ipv6_prefixes"`
	MgmtOobAllAllowAllIpv6Hosts       []ControlPlaneMgmtOobAllAllowAllIpv6Hosts       `tfsdk:"mgmt_oob_all_allow_all_ipv6_hosts"`
}
...
type ControlPlaneMgmtInbandInterfaces struct {
	InterfaceName        types.String                                           `tfsdk:"interface_name"`
	Ssh                  types.Bool                                             `tfsdk:"ssh"`
	SshIpv4Prefixes      []ControlPlaneMgmtInbandInterfacesSshIpv4Prefixes      `tfsdk:"ssh_ipv4_prefixes"`
	SshIpv4Hosts         []ControlPlaneMgmtInbandInterfacesSshIpv4Hosts         `tfsdk:"ssh_ipv4_hosts"`
	SshIpv6Prefixes      []ControlPlaneMgmtInbandInterfacesSshIpv6Prefixes      `tfsdk:"ssh_ipv6_prefixes"`
	SshIpv6Hosts         []ControlPlaneMgmtInbandInterfacesSshIpv6Hosts         `tfsdk:"ssh_ipv6_hosts"`
	Telnet               types.Bool                                             `tfsdk:"telnet"`
	TelnetIpv4Prefixes   []ControlPlaneMgmtInbandInterfacesTelnetIpv4Prefixes   `tfsdk:"telnet_ipv4_prefixes"`
	TelnetIpv4Hosts      []ControlPlaneMgmtInbandInterfacesTelnetIpv4Hosts      `tfsdk:"telnet_ipv4_hosts"`
	TelnetIpv6Prefixes   []ControlPlaneMgmtInbandInterfacesTelnetIpv6Prefixes   `tfsdk:"telnet_ipv6_prefixes"`
	TelnetIpv6Hosts      []ControlPlaneMgmtInbandInterfacesTelnetIpv6Hosts      `tfsdk:"telnet_ipv6_hosts"`
	Snmp                 types.Bool                                             `tfsdk:"snmp"`
	SnmpIpv4Prefixes     []ControlPlaneMgmtInbandInterfacesSnmpIpv4Prefixes     `tfsdk:"snmp_ipv4_prefixes"`
	SnmpIpv4Hosts        []ControlPlaneMgmtInbandInterfacesSnmpIpv4Hosts        `tfsdk:"snmp_ipv4_hosts"`
	SnmpIpv6Prefixes     []ControlPlaneMgmtInbandInterfacesSnmpIpv6Prefixes     `tfsdk:"snmp_ipv6_prefixes"`
	SnmpIpv6Hosts        []ControlPlaneMgmtInbandInterfacesSnmpIpv6Hosts        `tfsdk:"snmp_ipv6_hosts"`
	Tftp                 types.Bool                                             `tfsdk:"tftp"`
	TftpIpv4Prefixes     []ControlPlaneMgmtInbandInterfacesTftpIpv4Prefixes     `tfsdk:"tftp_ipv4_prefixes"`
	TftpIpv4Hosts        []ControlPlaneMgmtInbandInterfacesTftpIpv4Hosts        `tfsdk:"tftp_ipv4_hosts"`
	TftpIpv6Prefixes     []ControlPlaneMgmtInbandInterfacesTftpIpv6Prefixes     `tfsdk:"tftp_ipv6_prefixes"`
	TftpIpv6Hosts        []ControlPlaneMgmtInbandInterfacesTftpIpv6Hosts        `tfsdk:"tftp_ipv6_hosts"`
	Http                 types.Bool                                             `tfsdk:"http"`
	HttpIpv4Prefixes     []ControlPlaneMgmtInbandInterfacesHttpIpv4Prefixes     `tfsdk:"http_ipv4_prefixes"`
	HttpIpv4Hosts        []ControlPlaneMgmtInbandInterfacesHttpIpv4Hosts        `tfsdk:"http_ipv4_hosts"`
	Xml                  types.Bool                                             `tfsdk:"xml"`
	XmlIpv4Prefixes      []ControlPlaneMgmtInbandInterfacesXmlIpv4Prefixes      `tfsdk:"xml_ipv4_prefixes"`
	XmlIpv4Hosts         []ControlPlaneMgmtInbandInterfacesXmlIpv4Hosts         `tfsdk:"xml_ipv4_hosts"`
	XmlIpv6Prefixes      []ControlPlaneMgmtInbandInterfacesXmlIpv6Prefixes      `tfsdk:"xml_ipv6_prefixes"`
	XmlIpv6Hosts         []ControlPlaneMgmtInbandInterfacesXmlIpv6Hosts         `tfsdk:"xml_ipv6_hosts"`
	Netconf              types.Bool                                             `tfsdk:"netconf"`
	NetconfIpv4Prefixes  []ControlPlaneMgmtInbandInterfacesNetconfIpv4Prefixes  `tfsdk:"netconf_ipv4_prefixes"`
	NetconfIpv4Hosts     []ControlPlaneMgmtInbandInterfacesNetconfIpv4Hosts     `tfsdk:"netconf_ipv4_hosts"`
	NetconfIpv6Prefixes  []ControlPlaneMgmtInbandInterfacesNetconfIpv6Prefixes  `tfsdk:"netconf_ipv6_prefixes"`
	NetconfIpv6Hosts     []ControlPlaneMgmtInbandInterfacesNetconfIpv6Hosts     `tfsdk:"netconf_ipv6_hosts"`
	AllowAll             types.Bool                                             `tfsdk:"allow_all"`
	AllowAllIpv4Prefixes []ControlPlaneMgmtInbandInterfacesAllowAllIpv4Prefixes `tfsdk:"allow_all_ipv4_prefixes"`
	AllowAllIpv4Hosts    []ControlPlaneMgmtInbandInterfacesAllowAllIpv4Hosts    `tfsdk:"allow_all_ipv4_hosts"`
	AllowAllIpv6Prefixes []ControlPlaneMgmtInbandInterfacesAllowAllIpv6Prefixes `tfsdk:"allow_all_ipv6_prefixes"`
	AllowAllIpv6Hosts    []ControlPlaneMgmtInbandInterfacesAllowAllIpv6Hosts    `tfsdk:"allow_all_ipv6_hosts"`
}
type ControlPlaneMgmtInbandAllSshIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandAllSshIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandAllSshIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandAllSshIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandAllTelnetIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandAllTelnetIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandAllTelnetIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandAllTelnetIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandAllSnmpIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandAllSnmpIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandAllSnmpIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandAllSnmpIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandAllTftpIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandAllTftpIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandAllTftpIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandAllTftpIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandAllHttpIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandAllHttpIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandAllXmlIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandAllXmlIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandAllXmlIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandAllXmlIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandAllNetconfIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandAllNetconfIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandAllNetconfIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandAllNetconfIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandAllAllowAllIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandAllAllowAllIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandAllAllowAllIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandAllAllowAllIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobInterfaces struct {
	InterfaceName        types.String                                        `tfsdk:"interface_name"`
	Ssh                  types.Bool                                          `tfsdk:"ssh"`
	SshIpv4Prefixes      []ControlPlaneMgmtOobInterfacesSshIpv4Prefixes      `tfsdk:"ssh_ipv4_prefixes"`
	SshIpv4Hosts         []ControlPlaneMgmtOobInterfacesSshIpv4Hosts         `tfsdk:"ssh_ipv4_hosts"`
	SshIpv6Prefixes      []ControlPlaneMgmtOobInterfacesSshIpv6Prefixes      `tfsdk:"ssh_ipv6_prefixes"`
	SshIpv6Hosts         []ControlPlaneMgmtOobInterfacesSshIpv6Hosts         `tfsdk:"ssh_ipv6_hosts"`
	Telnet               types.Bool                                          `tfsdk:"telnet"`
	TelnetIpv4Prefixes   []ControlPlaneMgmtOobInterfacesTelnetIpv4Prefixes   `tfsdk:"telnet_ipv4_prefixes"`
	TelnetIpv4Hosts      []ControlPlaneMgmtOobInterfacesTelnetIpv4Hosts      `tfsdk:"telnet_ipv4_hosts"`
	TelnetIpv6Prefixes   []ControlPlaneMgmtOobInterfacesTelnetIpv6Prefixes   `tfsdk:"telnet_ipv6_prefixes"`
	TelnetIpv6Hosts      []ControlPlaneMgmtOobInterfacesTelnetIpv6Hosts      `tfsdk:"telnet_ipv6_hosts"`
	Snmp                 types.Bool                                          `tfsdk:"snmp"`
	SnmpIpv4Prefixes     []ControlPlaneMgmtOobInterfacesSnmpIpv4Prefixes     `tfsdk:"snmp_ipv4_prefixes"`
	SnmpIpv4Hosts        []ControlPlaneMgmtOobInterfacesSnmpIpv4Hosts        `tfsdk:"snmp_ipv4_hosts"`
	SnmpIpv6Prefixes     []ControlPlaneMgmtOobInterfacesSnmpIpv6Prefixes     `tfsdk:"snmp_ipv6_prefixes"`
	SnmpIpv6Hosts        []ControlPlaneMgmtOobInterfacesSnmpIpv6Hosts        `tfsdk:"snmp_ipv6_hosts"`
	Tftp                 types.Bool                                          `tfsdk:"tftp"`
	TftpIpv4Prefixes     []ControlPlaneMgmtOobInterfacesTftpIpv4Prefixes     `tfsdk:"tftp_ipv4_prefixes"`
	TftpIpv4Hosts        []ControlPlaneMgmtOobInterfacesTftpIpv4Hosts        `tfsdk:"tftp_ipv4_hosts"`
	TftpIpv6Prefixes     []ControlPlaneMgmtOobInterfacesTftpIpv6Prefixes     `tfsdk:"tftp_ipv6_prefixes"`
	TftpIpv6Hosts        []ControlPlaneMgmtOobInterfacesTftpIpv6Hosts        `tfsdk:"tftp_ipv6_hosts"`
	Http                 types.Bool                                          `tfsdk:"http"`
	HttpIpv4Prefixes     []ControlPlaneMgmtOobInterfacesHttpIpv4Prefixes     `tfsdk:"http_ipv4_prefixes"`
	HttpIpv4Hosts        []ControlPlaneMgmtOobInterfacesHttpIpv4Hosts        `tfsdk:"http_ipv4_hosts"`
	Xml                  types.Bool                                          `tfsdk:"xml"`
	XmlIpv4Prefixes      []ControlPlaneMgmtOobInterfacesXmlIpv4Prefixes      `tfsdk:"xml_ipv4_prefixes"`
	XmlIpv4Hosts         []ControlPlaneMgmtOobInterfacesXmlIpv4Hosts         `tfsdk:"xml_ipv4_hosts"`
	XmlIpv6Prefixes      []ControlPlaneMgmtOobInterfacesXmlIpv6Prefixes      `tfsdk:"xml_ipv6_prefixes"`
	XmlIpv6Hosts         []ControlPlaneMgmtOobInterfacesXmlIpv6Hosts         `tfsdk:"xml_ipv6_hosts"`
	Netconf              types.Bool                                          `tfsdk:"netconf"`
	NetconfIpv4Prefixes  []ControlPlaneMgmtOobInterfacesNetconfIpv4Prefixes  `tfsdk:"netconf_ipv4_prefixes"`
	NetconfIpv4Hosts     []ControlPlaneMgmtOobInterfacesNetconfIpv4Hosts     `tfsdk:"netconf_ipv4_hosts"`
	NetconfIpv6Prefixes  []ControlPlaneMgmtOobInterfacesNetconfIpv6Prefixes  `tfsdk:"netconf_ipv6_prefixes"`
	NetconfIpv6Hosts     []ControlPlaneMgmtOobInterfacesNetconfIpv6Hosts     `tfsdk:"netconf_ipv6_hosts"`
	AllowAll             types.Bool                                          `tfsdk:"allow_all"`
	AllowAllIpv4Prefixes []ControlPlaneMgmtOobInterfacesAllowAllIpv4Prefixes `tfsdk:"allow_all_ipv4_prefixes"`
	AllowAllIpv4Hosts    []ControlPlaneMgmtOobInterfacesAllowAllIpv4Hosts    `tfsdk:"allow_all_ipv4_hosts"`
	AllowAllIpv6Prefixes []ControlPlaneMgmtOobInterfacesAllowAllIpv6Prefixes `tfsdk:"allow_all_ipv6_prefixes"`
	AllowAllIpv6Hosts    []ControlPlaneMgmtOobInterfacesAllowAllIpv6Hosts    `tfsdk:"allow_all_ipv6_hosts"`
}
type ControlPlaneMgmtOobAllSshIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobAllSshIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobAllSshIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobAllSshIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobAllTelnetIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobAllTelnetIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobAllTelnetIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobAllTelnetIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobAllSnmpIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobAllSnmpIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobAllSnmpIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobAllSnmpIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobAllTftpIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobAllTftpIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobAllTftpIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobAllTftpIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobAllHttpIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobAllHttpIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobAllXmlIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobAllXmlIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobAllXmlIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobAllXmlIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobAllNetconfIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobAllNetconfIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobAllNetconfIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobAllNetconfIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobAllAllowAllIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobAllAllowAllIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobAllAllowAllIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobAllAllowAllIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandInterfacesSshIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandInterfacesSshIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandInterfacesSshIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandInterfacesSshIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandInterfacesTelnetIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandInterfacesTelnetIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandInterfacesTelnetIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandInterfacesTelnetIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandInterfacesSnmpIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandInterfacesSnmpIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandInterfacesSnmpIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandInterfacesSnmpIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandInterfacesTftpIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandInterfacesTftpIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandInterfacesTftpIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandInterfacesTftpIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandInterfacesHttpIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandInterfacesHttpIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandInterfacesXmlIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandInterfacesXmlIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandInterfacesXmlIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandInterfacesXmlIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandInterfacesNetconfIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandInterfacesNetconfIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandInterfacesNetconfIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandInterfacesNetconfIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandInterfacesAllowAllIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandInterfacesAllowAllIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtInbandInterfacesAllowAllIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtInbandInterfacesAllowAllIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobInterfacesSshIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobInterfacesSshIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobInterfacesSshIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobInterfacesSshIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobInterfacesTelnetIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobInterfacesTelnetIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobInterfacesTelnetIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobInterfacesTelnetIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobInterfacesSnmpIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobInterfacesSnmpIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobInterfacesSnmpIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobInterfacesSnmpIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobInterfacesTftpIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobInterfacesTftpIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobInterfacesTftpIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobInterfacesTftpIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobInterfacesHttpIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobInterfacesHttpIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobInterfacesXmlIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobInterfacesXmlIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobInterfacesXmlIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobInterfacesXmlIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobInterfacesNetconfIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobInterfacesNetconfIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobInterfacesNetconfIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobInterfacesNetconfIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobInterfacesAllowAllIpv4Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobInterfacesAllowAllIpv4Hosts struct {
	Address types.String `tfsdk:"address"`
}
type ControlPlaneMgmtOobInterfacesAllowAllIpv6Prefixes struct {
	Address types.String `tfsdk:"address"`
	Length  types.Int64  `tfsdk:"length"`
}
type ControlPlaneMgmtOobInterfacesAllowAllIpv6Hosts struct {
	Address types.String `tfsdk:"address"`
}
...
func (data ControlPlane) getPath() string {
	return "Cisco-IOS-XR-um-control-plane-cfg:/control-plane"
}

func (data ControlPlaneData) getPath() string {
	return "Cisco-IOS-XR-um-control-plane-cfg:/control-plane"
}
...
func (data ControlPlane) toBody(ctx context.Context) string {
	...
	if !data.MgmtInbandAllSsh.IsNull() && !data.MgmtInbandAllSsh.IsUnknown() {
		if data.MgmtInbandAllSsh.ValueBool() {
			body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.ssh", map[string]string{})
		}
	}
	if !data.MgmtInbandAllTelnet.IsNull() && !data.MgmtInbandAllTelnet.IsUnknown() {
		if data.MgmtInbandAllTelnet.ValueBool() {
			body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.telnet", map[string]string{})
		}
	}
	if !data.MgmtInbandAllSnmp.IsNull() && !data.MgmtInbandAllSnmp.IsUnknown() {
		if data.MgmtInbandAllSnmp.ValueBool() {
			body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.snmp", map[string]string{})
		}
	}
	if !data.MgmtInbandAllTftp.IsNull() && !data.MgmtInbandAllTftp.IsUnknown() {
		if data.MgmtInbandAllTftp.ValueBool() {
			body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.tftp", map[string]string{})
		}
	}
	if !data.MgmtInbandAllHttp.IsNull() && !data.MgmtInbandAllHttp.IsUnknown() {
		if data.MgmtInbandAllHttp.ValueBool() {
			body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.http", map[string]string{})
		}
	}
	if !data.MgmtInbandAllXml.IsNull() && !data.MgmtInbandAllXml.IsUnknown() {
		if data.MgmtInbandAllXml.ValueBool() {
			body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.xr-xml", map[string]string{})
		}
	}
	if !data.MgmtInbandAllNetconf.IsNull() && !data.MgmtInbandAllNetconf.IsUnknown() {
		if data.MgmtInbandAllNetconf.ValueBool() {
			body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.netconf", map[string]string{})
		}
	}
	if !data.MgmtInbandAllAllowAll.IsNull() && !data.MgmtInbandAllAllowAll.IsUnknown() {
		if data.MgmtInbandAllAllowAll.ValueBool() {
			body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.all", map[string]string{})
		}
	}
	if !data.MgmtOobVrf.IsNull() && !data.MgmtOobVrf.IsUnknown() {
		body, _ = sjson.Set(body, "management-plane.out-of-band.vrf", data.MgmtOobVrf.ValueString())
	}
	if !data.MgmtOobInbandBehavior.IsNull() && !data.MgmtOobInbandBehavior.IsUnknown() {
		if data.MgmtOobInbandBehavior.ValueBool() {
			body, _ = sjson.Set(body, "management-plane.out-of-band.enable-inband-behavior", map[string]string{})
		}
	}
	if !data.MgmtOobAllSsh.IsNull() && !data.MgmtOobAllSsh.IsUnknown() {
		if data.MgmtOobAllSsh.ValueBool() {
			body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.ssh", map[string]string{})
		}
	}
	if !data.MgmtOobAllTelnet.IsNull() && !data.MgmtOobAllTelnet.IsUnknown() {
		if data.MgmtOobAllTelnet.ValueBool() {
			body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.telnet", map[string]string{})
		}
	}
	if !data.MgmtOobAllSnmp.IsNull() && !data.MgmtOobAllSnmp.IsUnknown() {
		if data.MgmtOobAllSnmp.ValueBool() {
			body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.snmp", map[string]string{})
		}
	}
	if !data.MgmtOobAllTftp.IsNull() && !data.MgmtOobAllTftp.IsUnknown() {
		if data.MgmtOobAllTftp.ValueBool() {
			body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.tftp", map[string]string{})
		}
	}
	if !data.MgmtOobAllHttp.IsNull() && !data.MgmtOobAllHttp.IsUnknown() {
		if data.MgmtOobAllHttp.ValueBool() {
			body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.http", map[string]string{})
		}
	}
	if !data.MgmtOobAllXml.IsNull() && !data.MgmtOobAllXml.IsUnknown() {
		if data.MgmtOobAllXml.ValueBool() {
			body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.xr-xml", map[string]string{})
		}
	}
	if !data.MgmtOobAllNetconf.IsNull() && !data.MgmtOobAllNetconf.IsUnknown() {
		if data.MgmtOobAllNetconf.ValueBool() {
			body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.netconf", map[string]string{})
		}
	}
	if !data.MgmtOobAllAllowAll.IsNull() && !data.MgmtOobAllAllowAll.IsUnknown() {
		if data.MgmtOobAllAllowAll.ValueBool() {
			body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.all", map[string]string{})
		}
	}
	if len(data.MgmtInbandInterfaces) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface", []interface{}{})
		for index, item := range data.MgmtInbandInterfaces {
			if !item.InterfaceName.IsNull() && !item.InterfaceName.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"interface-name", item.InterfaceName.ValueString())
			}
			if !item.Ssh.IsNull() && !item.Ssh.IsUnknown() {
				if item.Ssh.ValueBool() {
					body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.ssh", map[string]string{})
				}
			}
			if !item.Telnet.IsNull() && !item.Telnet.IsUnknown() {
				if item.Telnet.ValueBool() {
					body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.telnet", map[string]string{})
				}
			}
			if !item.Snmp.IsNull() && !item.Snmp.IsUnknown() {
				if item.Snmp.ValueBool() {
					body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.snmp", map[string]string{})
				}
			}
			if !item.Tftp.IsNull() && !item.Tftp.IsUnknown() {
				if item.Tftp.ValueBool() {
					body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.tftp", map[string]string{})
				}
			}
			if !item.Http.IsNull() && !item.Http.IsUnknown() {
				if item.Http.ValueBool() {
					body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.http", map[string]string{})
				}
			}
			if !item.Xml.IsNull() && !item.Xml.IsUnknown() {
				if item.Xml.ValueBool() {
					body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.xr-xml", map[string]string{})
				}
			}
			if !item.Netconf.IsNull() && !item.Netconf.IsUnknown() {
				if item.Netconf.ValueBool() {
					body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.netconf", map[string]string{})
				}
			}
			if !item.AllowAll.IsNull() && !item.AllowAll.IsUnknown() {
				if item.AllowAll.ValueBool() {
					body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.all", map[string]string{})
				}
			}
			if len(item.SshIpv4Prefixes) > 0 {
				...
				for cindex, citem := range item.SshIpv4Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.ssh-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			...
			if len(item.SshIpv6Prefixes) > 0 {
				...
				for cindex, citem := range item.SshIpv6Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.ssh-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			...
			if len(item.TelnetIpv4Prefixes) > 0 {
				...
				for cindex, citem := range item.TelnetIpv4Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.telnet-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			...
			if len(item.TelnetIpv6Prefixes) > 0 {
				...
				for cindex, citem := range item.TelnetIpv6Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.telnet-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			...
			if len(item.SnmpIpv4Prefixes) > 0 {
				...
				for cindex, citem := range item.SnmpIpv4Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.snmp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			...
			if len(item.SnmpIpv6Prefixes) > 0 {
				...
				for cindex, citem := range item.SnmpIpv6Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.snmp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			...
			if len(item.TftpIpv4Prefixes) > 0 {
				...
				for cindex, citem := range item.TftpIpv4Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.tftp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			...
			if len(item.TftpIpv6Prefixes) > 0 {
				...
				for cindex, citem := range item.TftpIpv6Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.tftp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			...
			if len(item.HttpIpv4Prefixes) > 0 {
				...
				for cindex, citem := range item.HttpIpv4Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.http-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			...
			if len(item.XmlIpv4Prefixes) > 0 {
				...
				for cindex, citem := range item.XmlIpv4Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.xr-xml-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			...
			if len(item.XmlIpv6Prefixes) > 0 {
				...
				for cindex, citem := range item.XmlIpv6Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.xr-xml-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			...
			if len(item.NetconfIpv4Prefixes) > 0 {
				...
				for cindex, citem := range item.NetconfIpv4Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.netconf-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			...
			if len(item.NetconfIpv6Prefixes) > 0 {
				...
				for cindex, citem := range item.NetconfIpv6Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.netconf-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			...
			if len(item.AllowAllIpv4Prefixes) > 0 {
				...
				for cindex, citem := range item.AllowAllIpv4Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.all-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			...
			if len(item.AllowAllIpv6Prefixes) > 0 {
				...
				for cindex, citem := range item.AllowAllIpv6Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.inband.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.all-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
	...
	if len(data.MgmtInbandAllSshIpv4Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.ssh-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix", []interface{}{})
		for index, item := range data.MgmtInbandAllSshIpv4Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.ssh-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.ssh-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtInbandAllSshIpv4Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.ssh-peer.address.ipv4.ipv4-addresses.ipv4-address", []interface{}{})
		for index, item := range data.MgmtInbandAllSshIpv4Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.ssh-peer.address.ipv4.ipv4-addresses.ipv4-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtInbandAllSshIpv6Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.ssh-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix", []interface{}{})
		for index, item := range data.MgmtInbandAllSshIpv6Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.ssh-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.ssh-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtInbandAllSshIpv6Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.ssh-peer.address.ipv6.ipv6-addresses.ipv6-address", []interface{}{})
		for index, item := range data.MgmtInbandAllSshIpv6Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.ssh-peer.address.ipv6.ipv6-addresses.ipv6-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtInbandAllTelnetIpv4Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.telnet-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix", []interface{}{})
		for index, item := range data.MgmtInbandAllTelnetIpv4Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.telnet-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.telnet-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtInbandAllTelnetIpv4Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.telnet-peer.address.ipv4.ipv4-addresses.ipv4-address", []interface{}{})
		for index, item := range data.MgmtInbandAllTelnetIpv4Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.telnet-peer.address.ipv4.ipv4-addresses.ipv4-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtInbandAllTelnetIpv6Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.telnet-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix", []interface{}{})
		for index, item := range data.MgmtInbandAllTelnetIpv6Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.telnet-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.telnet-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtInbandAllTelnetIpv6Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.telnet-peer.address.ipv6.ipv6-addresses.ipv6-address", []interface{}{})
		for index, item := range data.MgmtInbandAllTelnetIpv6Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.telnet-peer.address.ipv6.ipv6-addresses.ipv6-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtInbandAllSnmpIpv4Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.snmp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix", []interface{}{})
		for index, item := range data.MgmtInbandAllSnmpIpv4Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.snmp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.snmp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtInbandAllSnmpIpv4Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.snmp-peer.address.ipv4.ipv4-addresses.ipv4-address", []interface{}{})
		for index, item := range data.MgmtInbandAllSnmpIpv4Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.snmp-peer.address.ipv4.ipv4-addresses.ipv4-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtInbandAllSnmpIpv6Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.snmp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix", []interface{}{})
		for index, item := range data.MgmtInbandAllSnmpIpv6Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.snmp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.snmp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtInbandAllSnmpIpv6Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.snmp-peer.address.ipv6.ipv6-addresses.ipv6-address", []interface{}{})
		for index, item := range data.MgmtInbandAllSnmpIpv6Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.snmp-peer.address.ipv6.ipv6-addresses.ipv6-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtInbandAllTftpIpv4Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.tftp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix", []interface{}{})
		for index, item := range data.MgmtInbandAllTftpIpv4Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.tftp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.tftp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtInbandAllTftpIpv4Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.tftp-peer.address.ipv4.ipv4-addresses.ipv4-address", []interface{}{})
		for index, item := range data.MgmtInbandAllTftpIpv4Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.tftp-peer.address.ipv4.ipv4-addresses.ipv4-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtInbandAllTftpIpv6Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.tftp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix", []interface{}{})
		for index, item := range data.MgmtInbandAllTftpIpv6Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.tftp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.tftp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtInbandAllTftpIpv6Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.tftp-peer.address.ipv6.ipv6-addresses.ipv6-address", []interface{}{})
		for index, item := range data.MgmtInbandAllTftpIpv6Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.tftp-peer.address.ipv6.ipv6-addresses.ipv6-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtInbandAllHttpIpv4Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.http-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix", []interface{}{})
		for index, item := range data.MgmtInbandAllHttpIpv4Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.http-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.http-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtInbandAllHttpIpv4Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.http-peer.address.ipv4.ipv4-addresses.ipv4-address", []interface{}{})
		for index, item := range data.MgmtInbandAllHttpIpv4Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.http-peer.address.ipv4.ipv4-addresses.ipv4-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtInbandAllXmlIpv4Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.xr-xml-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix", []interface{}{})
		for index, item := range data.MgmtInbandAllXmlIpv4Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.xr-xml-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.xr-xml-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtInbandAllXmlIpv4Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.xr-xml-peer.address.ipv4.ipv4-addresses.ipv4-address", []interface{}{})
		for index, item := range data.MgmtInbandAllXmlIpv4Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.xr-xml-peer.address.ipv4.ipv4-addresses.ipv4-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtInbandAllXmlIpv6Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.xr-xml-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix", []interface{}{})
		for index, item := range data.MgmtInbandAllXmlIpv6Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.xr-xml-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.xr-xml-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtInbandAllXmlIpv6Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.xr-xml-peer.address.ipv6.ipv6-addresses.ipv6-address", []interface{}{})
		for index, item := range data.MgmtInbandAllXmlIpv6Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.xr-xml-peer.address.ipv6.ipv6-addresses.ipv6-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtInbandAllNetconfIpv4Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.netconf-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix", []interface{}{})
		for index, item := range data.MgmtInbandAllNetconfIpv4Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.netconf-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.netconf-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtInbandAllNetconfIpv4Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.netconf-peer.address.ipv4.ipv4-addresses.ipv4-address", []interface{}{})
		for index, item := range data.MgmtInbandAllNetconfIpv4Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.netconf-peer.address.ipv4.ipv4-addresses.ipv4-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtInbandAllNetconfIpv6Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.netconf-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix", []interface{}{})
		for index, item := range data.MgmtInbandAllNetconfIpv6Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.netconf-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.netconf-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtInbandAllNetconfIpv6Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.netconf-peer.address.ipv6.ipv6-addresses.ipv6-address", []interface{}{})
		for index, item := range data.MgmtInbandAllNetconfIpv6Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.netconf-peer.address.ipv6.ipv6-addresses.ipv6-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtInbandAllAllowAllIpv4Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.all-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix", []interface{}{})
		for index, item := range data.MgmtInbandAllAllowAllIpv4Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.all-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.all-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtInbandAllAllowAllIpv4Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.all-peer.address.ipv4.ipv4-addresses.ipv4-address", []interface{}{})
		for index, item := range data.MgmtInbandAllAllowAllIpv4Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.all-peer.address.ipv4.ipv4-addresses.ipv4-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtInbandAllAllowAllIpv6Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.all-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix", []interface{}{})
		for index, item := range data.MgmtInbandAllAllowAllIpv6Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.all-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.all-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtInbandAllAllowAllIpv6Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.all-peer.address.ipv6.ipv6-addresses.ipv6-address", []interface{}{})
		for index, item := range data.MgmtInbandAllAllowAllIpv6Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.inband.interfaces.all.allow.all-peer.address.ipv6.ipv6-addresses.ipv6-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtOobInterfaces) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface", []interface{}{})
		for index, item := range data.MgmtOobInterfaces {
			if !item.InterfaceName.IsNull() && !item.InterfaceName.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"interface-name", item.InterfaceName.ValueString())
			}
			if !item.Ssh.IsNull() && !item.Ssh.IsUnknown() {
				if item.Ssh.ValueBool() {
					body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.ssh", map[string]string{})
				}
			}
			if !item.Telnet.IsNull() && !item.Telnet.IsUnknown() {
				if item.Telnet.ValueBool() {
					body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.telnet", map[string]string{})
				}
			}
			if !item.Snmp.IsNull() && !item.Snmp.IsUnknown() {
				if item.Snmp.ValueBool() {
					body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.snmp", map[string]string{})
				}
			}
			if !item.Tftp.IsNull() && !item.Tftp.IsUnknown() {
				if item.Tftp.ValueBool() {
					body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.tftp", map[string]string{})
				}
			}
			if !item.Http.IsNull() && !item.Http.IsUnknown() {
				if item.Http.ValueBool() {
					body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.http", map[string]string{})
				}
			}
			if !item.Xml.IsNull() && !item.Xml.IsUnknown() {
				if item.Xml.ValueBool() {
					body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.xr-xml", map[string]string{})
				}
			}
			if !item.Netconf.IsNull() && !item.Netconf.IsUnknown() {
				if item.Netconf.ValueBool() {
					body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.netconf", map[string]string{})
				}
			}
			if !item.AllowAll.IsNull() && !item.AllowAll.IsUnknown() {
				if item.AllowAll.ValueBool() {
					body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.all", map[string]string{})
				}
			}
			if len(item.SshIpv4Prefixes) > 0 {
				...
				for cindex, citem := range item.SshIpv4Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.ssh-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			if len(item.SshIpv4Hosts) > 0 {
			...
			if len(item.SshIpv6Prefixes) > 0 {
				...
				for cindex, citem := range item.SshIpv6Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.ssh-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			if len(item.SshIpv6Hosts) > 0 {
			...
			if len(item.TelnetIpv4Prefixes) > 0 {
				...
				for cindex, citem := range item.TelnetIpv4Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.telnet-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			if len(item.TelnetIpv4Hosts) > 0 {
			...
			if len(item.TelnetIpv6Prefixes) > 0 {
				...
				for cindex, citem := range item.TelnetIpv6Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.telnet-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			if len(item.TelnetIpv6Hosts) > 0 {
			...
			if len(item.SnmpIpv4Prefixes) > 0 {
				...
				for cindex, citem := range item.SnmpIpv4Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.snmp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			if len(item.SnmpIpv4Hosts) > 0 {
			...
			if len(item.SnmpIpv6Prefixes) > 0 {
				...
				for cindex, citem := range item.SnmpIpv6Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.snmp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			if len(item.SnmpIpv6Hosts) > 0 {
			...
			if len(item.TftpIpv4Prefixes) > 0 {
				...
				for cindex, citem := range item.TftpIpv4Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.tftp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			if len(item.TftpIpv4Hosts) > 0 {
			...
			if len(item.TftpIpv6Prefixes) > 0 {
				...
				for cindex, citem := range item.TftpIpv6Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.tftp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			if len(item.TftpIpv6Hosts) > 0 {
			...
			if len(item.HttpIpv4Prefixes) > 0 {
				...
				for cindex, citem := range item.HttpIpv4Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.http-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			if len(item.HttpIpv4Hosts) > 0 {
			...
			if len(item.XmlIpv4Prefixes) > 0 {
				...
				for cindex, citem := range item.XmlIpv4Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.xr-xml-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			if len(item.XmlIpv4Hosts) > 0 {
			...
			if len(item.XmlIpv6Prefixes) > 0 {
				...
				for cindex, citem := range item.XmlIpv6Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.xr-xml-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			if len(item.XmlIpv6Hosts) > 0 {
			...
			if len(item.NetconfIpv4Prefixes) > 0 {
				...
				for cindex, citem := range item.NetconfIpv4Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.netconf-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			if len(item.NetconfIpv4Hosts) > 0 {
			...
			if len(item.NetconfIpv6Prefixes) > 0 {
				...
				for cindex, citem := range item.NetconfIpv6Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.netconf-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			if len(item.NetconfIpv6Hosts) > 0 {
			...
			if len(item.AllowAllIpv4Prefixes) > 0 {
				...
				for cindex, citem := range item.AllowAllIpv4Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.all-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			if len(item.AllowAllIpv4Hosts) > 0 {
			...
			if len(item.AllowAllIpv6Prefixes) > 0 {
				...
				for cindex, citem := range item.AllowAllIpv6Prefixes {
					...
					if !citem.Length.IsNull() && !citem.Length.IsUnknown() {
						body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.interface"+"."+strconv.Itoa(index)+"."+"allow.all-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(cindex)+"."+"length", strconv.FormatInt(citem.Length.ValueInt64(), 10))
					}
				}
			}
			if len(item.AllowAllIpv6Hosts) > 0 {
	...
	if len(data.MgmtOobAllSshIpv4Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.ssh-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix", []interface{}{})
		for index, item := range data.MgmtOobAllSshIpv4Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.ssh-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.ssh-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtOobAllSshIpv4Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.ssh-peer.address.ipv4.ipv4-addresses.ipv4-address", []interface{}{})
		for index, item := range data.MgmtOobAllSshIpv4Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.ssh-peer.address.ipv4.ipv4-addresses.ipv4-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtOobAllSshIpv6Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.ssh-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix", []interface{}{})
		for index, item := range data.MgmtOobAllSshIpv6Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.ssh-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.ssh-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtOobAllSshIpv6Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.ssh-peer.address.ipv6.ipv6-addresses.ipv6-address", []interface{}{})
		for index, item := range data.MgmtOobAllSshIpv6Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.ssh-peer.address.ipv6.ipv6-addresses.ipv6-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtOobAllTelnetIpv4Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.telnet-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix", []interface{}{})
		for index, item := range data.MgmtOobAllTelnetIpv4Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.telnet-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.telnet-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtOobAllTelnetIpv4Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.telnet-peer.address.ipv4.ipv4-addresses.ipv4-address", []interface{}{})
		for index, item := range data.MgmtOobAllTelnetIpv4Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.telnet-peer.address.ipv4.ipv4-addresses.ipv4-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtOobAllTelnetIpv6Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.telnet-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix", []interface{}{})
		for index, item := range data.MgmtOobAllTelnetIpv6Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.telnet-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.telnet-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtOobAllTelnetIpv6Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.telnet-peer.address.ipv6.ipv6-addresses.ipv6-address", []interface{}{})
		for index, item := range data.MgmtOobAllTelnetIpv6Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.telnet-peer.address.ipv6.ipv6-addresses.ipv6-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtOobAllSnmpIpv4Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.snmp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix", []interface{}{})
		for index, item := range data.MgmtOobAllSnmpIpv4Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.snmp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.snmp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtOobAllSnmpIpv4Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.snmp-peer.address.ipv4.ipv4-addresses.ipv4-address", []interface{}{})
		for index, item := range data.MgmtOobAllSnmpIpv4Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.snmp-peer.address.ipv4.ipv4-addresses.ipv4-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtOobAllSnmpIpv6Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.snmp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix", []interface{}{})
		for index, item := range data.MgmtOobAllSnmpIpv6Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.snmp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.snmp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtOobAllSnmpIpv6Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.snmp-peer.address.ipv6.ipv6-addresses.ipv6-address", []interface{}{})
		for index, item := range data.MgmtOobAllSnmpIpv6Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.snmp-peer.address.ipv6.ipv6-addresses.ipv6-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtOobAllTftpIpv4Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.tftp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix", []interface{}{})
		for index, item := range data.MgmtOobAllTftpIpv4Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.tftp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.tftp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtOobAllTftpIpv4Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.tftp-peer.address.ipv4.ipv4-addresses.ipv4-address", []interface{}{})
		for index, item := range data.MgmtOobAllTftpIpv4Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.tftp-peer.address.ipv4.ipv4-addresses.ipv4-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtOobAllTftpIpv6Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.tftp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix", []interface{}{})
		for index, item := range data.MgmtOobAllTftpIpv6Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.tftp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.tftp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtOobAllTftpIpv6Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.tftp-peer.address.ipv6.ipv6-addresses.ipv6-address", []interface{}{})
		for index, item := range data.MgmtOobAllTftpIpv6Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.tftp-peer.address.ipv6.ipv6-addresses.ipv6-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtOobAllHttpIpv4Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.http-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix", []interface{}{})
		for index, item := range data.MgmtOobAllHttpIpv4Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.http-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.http-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtOobAllHttpIpv4Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.http-peer.address.ipv4.ipv4-addresses.ipv4-address", []interface{}{})
		for index, item := range data.MgmtOobAllHttpIpv4Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.http-peer.address.ipv4.ipv4-addresses.ipv4-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtOobAllXmlIpv4Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.xr-xml-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix", []interface{}{})
		for index, item := range data.MgmtOobAllXmlIpv4Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.xr-xml-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.xr-xml-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtOobAllXmlIpv4Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.xr-xml-peer.address.ipv4.ipv4-addresses.ipv4-address", []interface{}{})
		for index, item := range data.MgmtOobAllXmlIpv4Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.xr-xml-peer.address.ipv4.ipv4-addresses.ipv4-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtOobAllXmlIpv6Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.xr-xml-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix", []interface{}{})
		for index, item := range data.MgmtOobAllXmlIpv6Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.xr-xml-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.xr-xml-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtOobAllXmlIpv6Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.xr-xml-peer.address.ipv6.ipv6-addresses.ipv6-address", []interface{}{})
		for index, item := range data.MgmtOobAllXmlIpv6Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.xr-xml-peer.address.ipv6.ipv6-addresses.ipv6-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtOobAllNetconfIpv4Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.netconf-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix", []interface{}{})
		for index, item := range data.MgmtOobAllNetconfIpv4Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.netconf-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.netconf-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtOobAllNetconfIpv4Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.netconf-peer.address.ipv4.ipv4-addresses.ipv4-address", []interface{}{})
		for index, item := range data.MgmtOobAllNetconfIpv4Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.netconf-peer.address.ipv4.ipv4-addresses.ipv4-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtOobAllNetconfIpv6Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.netconf-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix", []interface{}{})
		for index, item := range data.MgmtOobAllNetconfIpv6Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.netconf-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.netconf-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtOobAllNetconfIpv6Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.netconf-peer.address.ipv6.ipv6-addresses.ipv6-address", []interface{}{})
		for index, item := range data.MgmtOobAllNetconfIpv6Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.netconf-peer.address.ipv6.ipv6-addresses.ipv6-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtOobAllAllowAllIpv4Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.all-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix", []interface{}{})
		for index, item := range data.MgmtOobAllAllowAllIpv4Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.all-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.all-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtOobAllAllowAllIpv4Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.all-peer.address.ipv4.ipv4-addresses.ipv4-address", []interface{}{})
		for index, item := range data.MgmtOobAllAllowAllIpv4Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.all-peer.address.ipv4.ipv4-addresses.ipv4-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	if len(data.MgmtOobAllAllowAllIpv6Prefixes) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.all-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix", []interface{}{})
		for index, item := range data.MgmtOobAllAllowAllIpv6Prefixes {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.all-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
			if !item.Length.IsNull() && !item.Length.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.all-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"+"."+strconv.Itoa(index)+"."+"length", strconv.FormatInt(item.Length.ValueInt64(), 10))
			}
		}
	}
	if len(data.MgmtOobAllAllowAllIpv6Hosts) > 0 {
		body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.all-peer.address.ipv6.ipv6-addresses.ipv6-address", []interface{}{})
		for index, item := range data.MgmtOobAllAllowAllIpv6Hosts {
			if !item.Address.IsNull() && !item.Address.IsUnknown() {
				body, _ = sjson.Set(body, "management-plane.out-of-band.interfaces.all.allow.all-peer.address.ipv6.ipv6-addresses.ipv6-address"+"."+strconv.Itoa(index)+"."+"address", item.Address.ValueString())
			}
		}
	}
	return body
...
func (data *ControlPlane) updateFromBody(ctx context.Context, res []byte) {
	for i := range data.MgmtInbandInterfaces {
		...
		if value := r.Get("interface-name"); value.Exists() && !data.MgmtInbandInterfaces[i].InterfaceName.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].SshIpv4Prefixes {
			...
			var cr gjson.Result
			r.Get("allow.ssh-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].SshIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].SshIpv4Hosts {
			...
			var cr gjson.Result
			r.Get("allow.ssh-peer.address.ipv4.ipv4-addresses.ipv4-address").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].SshIpv4Hosts[ci].Address.IsNull() {
				data.MgmtInbandInterfaces[i].SshIpv4Hosts[ci].Address = types.StringValue(value.String())
			} else {
				data.MgmtInbandInterfaces[i].SshIpv4Hosts[ci].Address = types.StringNull()
			}
		}
		for ci := range data.MgmtInbandInterfaces[i].SshIpv6Prefixes {
			...
			var cr gjson.Result
			r.Get("allow.ssh-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].SshIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].SshIpv6Hosts {
			...
			var cr gjson.Result
			r.Get("allow.ssh-peer.address.ipv6.ipv6-addresses.ipv6-address").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].SshIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].TelnetIpv4Prefixes {
			...
			var cr gjson.Result
			r.Get("allow.telnet-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].TelnetIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].TelnetIpv4Hosts {
			...
			var cr gjson.Result
			r.Get("allow.telnet-peer.address.ipv4.ipv4-addresses.ipv4-address").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].TelnetIpv4Hosts[ci].Address.IsNull() {
				data.MgmtInbandInterfaces[i].TelnetIpv4Hosts[ci].Address = types.StringValue(value.String())
			} else {
				data.MgmtInbandInterfaces[i].TelnetIpv4Hosts[ci].Address = types.StringNull()
			}
		}
		for ci := range data.MgmtInbandInterfaces[i].TelnetIpv6Prefixes {
			...
			var cr gjson.Result
			r.Get("allow.telnet-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].TelnetIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].TelnetIpv6Hosts {
			...
			var cr gjson.Result
			r.Get("allow.telnet-peer.address.ipv6.ipv6-addresses.ipv6-address").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].TelnetIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].SnmpIpv4Prefixes {
			...
			var cr gjson.Result
			r.Get("allow.snmp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].SnmpIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].SnmpIpv4Hosts {
			...
			var cr gjson.Result
			r.Get("allow.snmp-peer.address.ipv4.ipv4-addresses.ipv4-address").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].SnmpIpv4Hosts[ci].Address.IsNull() {
				data.MgmtInbandInterfaces[i].SnmpIpv4Hosts[ci].Address = types.StringValue(value.String())
			} else {
				data.MgmtInbandInterfaces[i].SnmpIpv4Hosts[ci].Address = types.StringNull()
			}
		}
		for ci := range data.MgmtInbandInterfaces[i].SnmpIpv6Prefixes {
			...
			var cr gjson.Result
			r.Get("allow.snmp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].SnmpIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].SnmpIpv6Hosts {
			...
			var cr gjson.Result
			r.Get("allow.snmp-peer.address.ipv6.ipv6-addresses.ipv6-address").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].SnmpIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].TftpIpv4Prefixes {
			...
			var cr gjson.Result
			r.Get("allow.tftp-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].TftpIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].TftpIpv4Hosts {
			...
			var cr gjson.Result
			r.Get("allow.tftp-peer.address.ipv4.ipv4-addresses.ipv4-address").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].TftpIpv4Hosts[ci].Address.IsNull() {
				data.MgmtInbandInterfaces[i].TftpIpv4Hosts[ci].Address = types.StringValue(value.String())
			} else {
				data.MgmtInbandInterfaces[i].TftpIpv4Hosts[ci].Address = types.StringNull()
			}
		}
		for ci := range data.MgmtInbandInterfaces[i].TftpIpv6Prefixes {
			...
			var cr gjson.Result
			r.Get("allow.tftp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].TftpIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].TftpIpv6Hosts {
			...
			var cr gjson.Result
			r.Get("allow.tftp-peer.address.ipv6.ipv6-addresses.ipv6-address").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].TftpIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].HttpIpv4Prefixes {
			...
			var cr gjson.Result
			r.Get("allow.http-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].HttpIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].HttpIpv4Hosts {
			...
			var cr gjson.Result
			r.Get("allow.http-peer.address.ipv4.ipv4-addresses.ipv4-address").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].HttpIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].XmlIpv4Prefixes {
			...
			var cr gjson.Result
			r.Get("allow.xr-xml-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].XmlIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].XmlIpv4Hosts {
			...
			var cr gjson.Result
			r.Get("allow.xr-xml-peer.address.ipv4.ipv4-addresses.ipv4-address").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].XmlIpv4Hosts[ci].Address.IsNull() {
				data.MgmtInbandInterfaces[i].XmlIpv4Hosts[ci].Address = types.StringValue(value.String())
			} else {
				data.MgmtInbandInterfaces[i].XmlIpv4Hosts[ci].Address = types.StringNull()
			}
		}
		for ci := range data.MgmtInbandInterfaces[i].XmlIpv6Prefixes {
			...
			var cr gjson.Result
			r.Get("allow.xr-xml-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].XmlIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].XmlIpv6Hosts {
			...
			var cr gjson.Result
			r.Get("allow.xr-xml-peer.address.ipv6.ipv6-addresses.ipv6-address").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].XmlIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].NetconfIpv4Prefixes {
			...
			var cr gjson.Result
			r.Get("allow.netconf-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].NetconfIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].NetconfIpv4Hosts {
			...
			var cr gjson.Result
			r.Get("allow.netconf-peer.address.ipv4.ipv4-addresses.ipv4-address").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].NetconfIpv4Hosts[ci].Address.IsNull() {
				data.MgmtInbandInterfaces[i].NetconfIpv4Hosts[ci].Address = types.StringValue(value.String())
			} else {
				data.MgmtInbandInterfaces[i].NetconfIpv4Hosts[ci].Address = types.StringNull()
			}
		}
		for ci := range data.MgmtInbandInterfaces[i].NetconfIpv6Prefixes {
			...
			var cr gjson.Result
			r.Get("allow.netconf-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].NetconfIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].NetconfIpv6Hosts {
			...
			var cr gjson.Result
			r.Get("allow.netconf-peer.address.ipv6.ipv6-addresses.ipv6-address").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].NetconfIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].AllowAllIpv4Prefixes {
			...
			var cr gjson.Result
			r.Get("allow.all-peer.address.ipv4.ipv4-address-prefixes.ipv4-address-prefix").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].AllowAllIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].AllowAllIpv4Hosts {
			...
			var cr gjson.Result
			r.Get("allow.all-peer.address.ipv4.ipv4-addresses.ipv4-address").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].AllowAllIpv4Hosts[ci].Address.IsNull() {
				data.MgmtInbandInterfaces[i].AllowAllIpv4Hosts[ci].Address = types.StringValue(value.String())
			} else {
				data.MgmtInbandInterfaces[i].AllowAllIpv4Hosts[ci].Address = types.StringNull()
			}
		}
		for ci := range data.MgmtInbandInterfaces[i].AllowAllIpv6Prefixes {
			...
			var cr gjson.Result
			r.Get("allow.all-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].AllowAllIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtInbandInterfaces[i].AllowAllIpv6Hosts {
			...
			var cr gjson.Result
			r.Get("allow.all-peer.address.ipv6.ipv6-addresses.ipv6-address").ForEach(
				func(_, v gjson.Result) bool {
					found := false
					for ik := range keys {
						if v.Get(keys[ik]).String() == keyValues[ik] {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtInbandInterfaces[i].AllowAllIpv6Hosts[ci].Address.IsNull() {
				data.MgmtInbandInterfaces[i].AllowAllIpv6Hosts[ci].Address = types.StringValue(value.String())
			} else {
				data.MgmtInbandInterfaces[i].AllowAllIpv6Hosts[ci].Address = types.StringNull()
			}
		}
	}
	...
	for i := range data.MgmtInbandAllSshIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllSshIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllSshIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllSshIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllSshIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllSshIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllSshIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllSshIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllTelnetIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllTelnetIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllTelnetIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllTelnetIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllTelnetIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllTelnetIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllTelnetIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllTelnetIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllSnmpIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllSnmpIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllSnmpIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllSnmpIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllSnmpIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllSnmpIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllSnmpIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllSnmpIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllTftpIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllTftpIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllTftpIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllTftpIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllTftpIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllTftpIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllTftpIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllTftpIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllHttpIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllHttpIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllHttpIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllHttpIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllXmlIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllXmlIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllXmlIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllXmlIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllXmlIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllXmlIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllXmlIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllXmlIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllNetconfIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllNetconfIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllNetconfIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllNetconfIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllNetconfIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllNetconfIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllNetconfIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllNetconfIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllAllowAllIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllAllowAllIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllAllowAllIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllAllowAllIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllAllowAllIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllAllowAllIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtInbandAllAllowAllIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtInbandAllAllowAllIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobInterfaces {
		...
		if value := r.Get("interface-name"); value.Exists() && !data.MgmtOobInterfaces[i].InterfaceName.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].SshIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].SshIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].SshIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].SshIpv4Hosts[ci].Address.IsNull() {
				data.MgmtOobInterfaces[i].SshIpv4Hosts[ci].Address = types.StringValue(value.String())
			} else {
				data.MgmtOobInterfaces[i].SshIpv4Hosts[ci].Address = types.StringNull()
			}
		}
		for ci := range data.MgmtOobInterfaces[i].SshIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].SshIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].SshIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].SshIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].TelnetIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].TelnetIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].TelnetIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].TelnetIpv4Hosts[ci].Address.IsNull() {
				data.MgmtOobInterfaces[i].TelnetIpv4Hosts[ci].Address = types.StringValue(value.String())
			} else {
				data.MgmtOobInterfaces[i].TelnetIpv4Hosts[ci].Address = types.StringNull()
			}
		}
		for ci := range data.MgmtOobInterfaces[i].TelnetIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].TelnetIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].TelnetIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].TelnetIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].SnmpIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].SnmpIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].SnmpIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].SnmpIpv4Hosts[ci].Address.IsNull() {
				data.MgmtOobInterfaces[i].SnmpIpv4Hosts[ci].Address = types.StringValue(value.String())
			} else {
				data.MgmtOobInterfaces[i].SnmpIpv4Hosts[ci].Address = types.StringNull()
			}
		}
		for ci := range data.MgmtOobInterfaces[i].SnmpIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].SnmpIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].SnmpIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].SnmpIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].TftpIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].TftpIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].TftpIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].TftpIpv4Hosts[ci].Address.IsNull() {
				data.MgmtOobInterfaces[i].TftpIpv4Hosts[ci].Address = types.StringValue(value.String())
			} else {
				data.MgmtOobInterfaces[i].TftpIpv4Hosts[ci].Address = types.StringNull()
			}
		}
		for ci := range data.MgmtOobInterfaces[i].TftpIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].TftpIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].TftpIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].TftpIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].HttpIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].HttpIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].HttpIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].HttpIpv4Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].XmlIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].XmlIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].XmlIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].XmlIpv4Hosts[ci].Address.IsNull() {
				data.MgmtOobInterfaces[i].XmlIpv4Hosts[ci].Address = types.StringValue(value.String())
			} else {
				data.MgmtOobInterfaces[i].XmlIpv4Hosts[ci].Address = types.StringNull()
			}
		}
		for ci := range data.MgmtOobInterfaces[i].XmlIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].XmlIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].XmlIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].XmlIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].NetconfIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].NetconfIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].NetconfIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].NetconfIpv4Hosts[ci].Address.IsNull() {
				data.MgmtOobInterfaces[i].NetconfIpv4Hosts[ci].Address = types.StringValue(value.String())
			} else {
				data.MgmtOobInterfaces[i].NetconfIpv4Hosts[ci].Address = types.StringNull()
			}
		}
		for ci := range data.MgmtOobInterfaces[i].NetconfIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].NetconfIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].NetconfIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].NetconfIpv6Hosts[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].AllowAllIpv4Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].AllowAllIpv4Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].AllowAllIpv4Hosts {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].AllowAllIpv4Hosts[ci].Address.IsNull() {
				data.MgmtOobInterfaces[i].AllowAllIpv4Hosts[ci].Address = types.StringValue(value.String())
			} else {
				data.MgmtOobInterfaces[i].AllowAllIpv4Hosts[ci].Address = types.StringNull()
			}
		}
		for ci := range data.MgmtOobInterfaces[i].AllowAllIpv6Prefixes {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].AllowAllIpv6Prefixes[ci].Address.IsNull() {
		...
		for ci := range data.MgmtOobInterfaces[i].AllowAllIpv6Hosts {
			...
			if value := cr.Get("address"); value.Exists() && !data.MgmtOobInterfaces[i].AllowAllIpv6Hosts[ci].Address.IsNull() {
				data.MgmtOobInterfaces[i].AllowAllIpv6Hosts[ci].Address = types.StringValue(value.String())
			} else {
				data.MgmtOobInterfaces[i].AllowAllIpv6Hosts[ci].Address = types.StringNull()
			}
		}
	}
	...
	for i := range data.MgmtOobAllSshIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllSshIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllSshIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllSshIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllSshIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllSshIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllSshIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllSshIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllTelnetIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllTelnetIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllTelnetIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllTelnetIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllTelnetIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllTelnetIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllTelnetIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllTelnetIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllSnmpIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllSnmpIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllSnmpIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllSnmpIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllSnmpIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllSnmpIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllSnmpIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllSnmpIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllTftpIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllTftpIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllTftpIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllTftpIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllTftpIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllTftpIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllTftpIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllTftpIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllHttpIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllHttpIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllHttpIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllHttpIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllXmlIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllXmlIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllXmlIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllXmlIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllXmlIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllXmlIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllXmlIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllXmlIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllNetconfIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllNetconfIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllNetconfIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllNetconfIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllNetconfIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllNetconfIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllNetconfIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllNetconfIpv6Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllAllowAllIpv4Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllAllowAllIpv4Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllAllowAllIpv4Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllAllowAllIpv4Hosts[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllAllowAllIpv6Prefixes {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllAllowAllIpv6Prefixes[i].Address.IsNull() {
	...
	for i := range data.MgmtOobAllAllowAllIpv6Hosts {
		...
		if value := r.Get("address"); value.Exists() && !data.MgmtOobAllAllowAllIpv6Hosts[i].Address.IsNull() {
...
func (data *ControlPlane) fromBody(ctx context.Context, res []byte) {
	if value := gjson.GetBytes(res, "management-plane.inband.interfaces.interface"); value.Exists() {
		...
		value.ForEach(func(k, v gjson.Result) bool {
			...
			if cValue := v.Get("allow.ssh-peer.address.ipv4.ipv4-addresses.ipv4-address"); cValue.Exists() {
			...
			if cValue := v.Get("allow.ssh-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"); cValue.Exists() {
			...
			if cValue := v.Get("allow.ssh-peer.address.ipv6.ipv6-addresses.ipv6-address"); cValue.Exists() {
			...
			if cValue := v.Get("allow.telnet-peer.address.ipv4.ipv4-addresses.ipv4-address"); cValue.Exists() {
			...
			if cValue := v.Get("allow.telnet-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"); cValue.Exists() {
			...
			if cValue := v.Get("allow.telnet-peer.address.ipv6.ipv6-addresses.ipv6-address"); cValue.Exists() {
			...
			if cValue := v.Get("allow.snmp-peer.address.ipv4.ipv4-addresses.ipv4-address"); cValue.Exists() {
			...
			if cValue := v.Get("allow.snmp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"); cValue.Exists() {
			...
			if cValue := v.Get("allow.snmp-peer.address.ipv6.ipv6-addresses.ipv6-address"); cValue.Exists() {
			...
			if cValue := v.Get("allow.tftp-peer.address.ipv4.ipv4-addresses.ipv4-address"); cValue.Exists() {
			...
			if cValue := v.Get("allow.tftp-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"); cValue.Exists() {
			...
			if cValue := v.Get("allow.tftp-peer.address.ipv6.ipv6-addresses.ipv6-address"); cValue.Exists() {
			...
			if cValue := v.Get("allow.http-peer.address.ipv4.ipv4-addresses.ipv4-address"); cValue.Exists() {
			...
			if cValue := v.Get("allow.xr-xml-peer.address.ipv4.ipv4-addresses.ipv4-address"); cValue.Exists() {
			...
			if cValue := v.Get("allow.xr-xml-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"); cValue.Exists() {
			...
			if cValue := v.Get("allow.xr-xml-peer.address.ipv6.ipv6-addresses.ipv6-address"); cValue.Exists() {
			...
			if cValue := v.Get("allow.netconf-peer.address.ipv4.ipv4-addresses.ipv4-address"); cValue.Exists() {
			...
			if cValue := v.Get("allow.netconf-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"); cValue.Exists() {
			...
			if cValue := v.Get("allow.netconf-peer.address.ipv6.ipv6-addresses.ipv6-address"); cValue.Exists() {
			...
			if cValue := v.Get("allow.all-peer.address.ipv4.ipv4-addresses.ipv4-address"); cValue.Exists() {
			...
			if cValue := v.Get("allow.all-peer.address.ipv6.ipv6-address-prefixes.ipv6-address-prefix"); cValue.Exists() {
			...
			if cValue := v.Get("allow.all-peer.address.ipv6.ipv6-addresses.ipv6-address"); cValue.Exists() {
...
func (data *ControlPlane) getDeletedItems(ctx context.Context, state ControlPlane) []string {
	...
	if !state.MgmtOobAllAllowAll.IsNull() && data.MgmtOobAllAllowAll.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/interfaces/all/allow/all", state.getPath()))
	}
	...
	if !state.MgmtOobAllNetconf.IsNull() && data.MgmtOobAllNetconf.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/interfaces/all/allow/netconf", state.getPath()))
	}
	...
	if !state.MgmtOobAllXml.IsNull() && data.MgmtOobAllXml.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/interfaces/all/allow/xr-xml", state.getPath()))
	}
	...
	if !state.MgmtOobAllHttp.IsNull() && data.MgmtOobAllHttp.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/interfaces/all/allow/http", state.getPath()))
	}
	...
	if !state.MgmtOobAllTftp.IsNull() && data.MgmtOobAllTftp.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/interfaces/all/allow/tftp", state.getPath()))
	}
	...
	if !state.MgmtOobAllSnmp.IsNull() && data.MgmtOobAllSnmp.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/interfaces/all/allow/snmp", state.getPath()))
	}
	...
	if !state.MgmtOobAllTelnet.IsNull() && data.MgmtOobAllTelnet.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/interfaces/all/allow/telnet", state.getPath()))
	}
	...
	if !state.MgmtOobAllSsh.IsNull() && data.MgmtOobAllSsh.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/interfaces/all/allow/ssh", state.getPath()))
	}
	if !state.MgmtOobInbandBehavior.IsNull() && data.MgmtOobInbandBehavior.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/enable-inband-behavior", state.getPath()))
	}
	if !state.MgmtOobVrf.IsNull() && data.MgmtOobVrf.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/vrf", state.getPath()))
	}
		...
		for j := range data.MgmtOobInterfaces {
			...
			if found {
				...
				if !state.MgmtOobInterfaces[i].AllowAll.IsNull() && data.MgmtOobInterfaces[j].AllowAll.IsNull() {
					deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/interfaces/interface%v/allow/all", state.getPath(), keyString))
				}
				...
				if !state.MgmtOobInterfaces[i].Netconf.IsNull() && data.MgmtOobInterfaces[j].Netconf.IsNull() {
					deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/interfaces/interface%v/allow/netconf", state.getPath(), keyString))
				}
				...
				if !state.MgmtOobInterfaces[i].Xml.IsNull() && data.MgmtOobInterfaces[j].Xml.IsNull() {
					deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/interfaces/interface%v/allow/xr-xml", state.getPath(), keyString))
				}
				...
				if !state.MgmtOobInterfaces[i].Http.IsNull() && data.MgmtOobInterfaces[j].Http.IsNull() {
					deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/interfaces/interface%v/allow/http", state.getPath(), keyString))
				}
				...
				if !state.MgmtOobInterfaces[i].Tftp.IsNull() && data.MgmtOobInterfaces[j].Tftp.IsNull() {
					deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/interfaces/interface%v/allow/tftp", state.getPath(), keyString))
				}
				...
				if !state.MgmtOobInterfaces[i].Snmp.IsNull() && data.MgmtOobInterfaces[j].Snmp.IsNull() {
					deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/interfaces/interface%v/allow/snmp", state.getPath(), keyString))
				}
				...
				if !state.MgmtOobInterfaces[i].Telnet.IsNull() && data.MgmtOobInterfaces[j].Telnet.IsNull() {
					deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/interfaces/interface%v/allow/telnet", state.getPath(), keyString))
				}
				...
				if !state.MgmtOobInterfaces[i].Ssh.IsNull() && data.MgmtOobInterfaces[j].Ssh.IsNull() {
					deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/out-of-band/interfaces/interface%v/allow/ssh", state.getPath(), keyString))
				}
				break
			}
		}
	...
	if !state.MgmtInbandAllAllowAll.IsNull() && data.MgmtInbandAllAllowAll.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/inband/interfaces/all/allow/all", state.getPath()))
	}
	...
	if !state.MgmtInbandAllNetconf.IsNull() && data.MgmtInbandAllNetconf.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/inband/interfaces/all/allow/netconf", state.getPath()))
	}
	...
	if !state.MgmtInbandAllXml.IsNull() && data.MgmtInbandAllXml.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/inband/interfaces/all/allow/xr-xml", state.getPath()))
	}
	...
	if !state.MgmtInbandAllHttp.IsNull() && data.MgmtInbandAllHttp.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/inband/interfaces/all/allow/http", state.getPath()))
	}
	...
	if !state.MgmtInbandAllTftp.IsNull() && data.MgmtInbandAllTftp.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/inband/interfaces/all/allow/tftp", state.getPath()))
	}
	...
	if !state.MgmtInbandAllSnmp.IsNull() && data.MgmtInbandAllSnmp.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/inband/interfaces/all/allow/snmp", state.getPath()))
	}
	...
	if !state.MgmtInbandAllTelnet.IsNull() && data.MgmtInbandAllTelnet.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/inband/interfaces/all/allow/telnet", state.getPath()))
	}
	...
	if !state.MgmtInbandAllSsh.IsNull() && data.MgmtInbandAllSsh.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/inband/interfaces/all/allow/ssh", state.getPath()))
	}
		...
		for j := range data.MgmtInbandInterfaces {
			...
			if found {
				...
				if !state.MgmtInbandInterfaces[i].AllowAll.IsNull() && data.MgmtInbandInterfaces[j].AllowAll.IsNull() {
					deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/inband/interfaces/interface%v/allow/all", state.getPath(), keyString))
				}
				...
				if !state.MgmtInbandInterfaces[i].Netconf.IsNull() && data.MgmtInbandInterfaces[j].Netconf.IsNull() {
					deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/inband/interfaces/interface%v/allow/netconf", state.getPath(), keyString))
				}
				...
				if !state.MgmtInbandInterfaces[i].Xml.IsNull() && data.MgmtInbandInterfaces[j].Xml.IsNull() {
					deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/inband/interfaces/interface%v/allow/xr-xml", state.getPath(), keyString))
				}
				...
				if !state.MgmtInbandInterfaces[i].Http.IsNull() && data.MgmtInbandInterfaces[j].Http.IsNull() {
					deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/inband/interfaces/interface%v/allow/http", state.getPath(), keyString))
				}
				...
				if !state.MgmtInbandInterfaces[i].Tftp.IsNull() && data.MgmtInbandInterfaces[j].Tftp.IsNull() {
					deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/inband/interfaces/interface%v/allow/tftp", state.getPath(), keyString))
				}
				...
				if !state.MgmtInbandInterfaces[i].Snmp.IsNull() && data.MgmtInbandInterfaces[j].Snmp.IsNull() {
					deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/inband/interfaces/interface%v/allow/snmp", state.getPath(), keyString))
				}
				...
				if !state.MgmtInbandInterfaces[i].Telnet.IsNull() && data.MgmtInbandInterfaces[j].Telnet.IsNull() {
					deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/inband/interfaces/interface%v/allow/telnet", state.getPath(), keyString))
				}
				...
				if !state.MgmtInbandInterfaces[i].Ssh.IsNull() && data.MgmtInbandInterfaces[j].Ssh.IsNull() {
					deletedItems = append(deletedItems, fmt.Sprintf("%v/management-plane/inband/interfaces/interface%v/allow/ssh", state.getPath(), keyString))
				}
				break
			}
		}
...
func (data *ControlPlane) getEmptyLeafsDelete(ctx context.Context) []string {
	...
	for i := range data.MgmtOobInterfaces {
		...
		for ci := range data.MgmtOobInterfaces[i].AllowAllIpv6Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].AllowAllIpv6Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
		...
		for ci := range data.MgmtOobInterfaces[i].AllowAllIpv6Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].AllowAllIpv6Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtOobInterfaces[i].AllowAllIpv6Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].AllowAllIpv4Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].AllowAllIpv4Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].AllowAllIpv4Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].AllowAllIpv4Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtOobInterfaces[i].AllowAllIpv4Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].NetconfIpv6Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].NetconfIpv6Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].NetconfIpv6Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].NetconfIpv6Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtOobInterfaces[i].NetconfIpv6Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].NetconfIpv4Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].NetconfIpv4Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].NetconfIpv4Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].NetconfIpv4Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtOobInterfaces[i].NetconfIpv4Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].XmlIpv6Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].XmlIpv6Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].XmlIpv6Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].XmlIpv6Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtOobInterfaces[i].XmlIpv6Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].XmlIpv4Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].XmlIpv4Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].XmlIpv4Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].XmlIpv4Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtOobInterfaces[i].XmlIpv4Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].HttpIpv4Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].HttpIpv4Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].HttpIpv4Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].HttpIpv4Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtOobInterfaces[i].HttpIpv4Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].TftpIpv6Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].TftpIpv6Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].TftpIpv6Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].TftpIpv6Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtOobInterfaces[i].TftpIpv6Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].TftpIpv4Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].TftpIpv4Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].TftpIpv4Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].TftpIpv4Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtOobInterfaces[i].TftpIpv4Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].SnmpIpv6Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].SnmpIpv6Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].SnmpIpv6Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].SnmpIpv6Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtOobInterfaces[i].SnmpIpv6Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].SnmpIpv4Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].SnmpIpv4Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].SnmpIpv4Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].SnmpIpv4Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtOobInterfaces[i].SnmpIpv4Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].TelnetIpv6Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].TelnetIpv6Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].TelnetIpv6Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].TelnetIpv6Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtOobInterfaces[i].TelnetIpv6Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].TelnetIpv4Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].TelnetIpv4Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].TelnetIpv4Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].TelnetIpv4Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtOobInterfaces[i].TelnetIpv4Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].SshIpv6Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].SshIpv6Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].SshIpv6Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].SshIpv6Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtOobInterfaces[i].SshIpv6Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].SshIpv4Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].SshIpv4Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtOobInterfaces[i].SshIpv4Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtOobInterfaces[i].SshIpv4Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtOobInterfaces[i].SshIpv4Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
	...
	for i := range data.MgmtInbandInterfaces {
		...
		for ci := range data.MgmtInbandInterfaces[i].AllowAllIpv6Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].AllowAllIpv6Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].AllowAllIpv6Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].AllowAllIpv6Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtInbandInterfaces[i].AllowAllIpv6Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].AllowAllIpv4Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].AllowAllIpv4Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].AllowAllIpv4Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].AllowAllIpv4Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtInbandInterfaces[i].AllowAllIpv4Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].NetconfIpv6Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].NetconfIpv6Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].NetconfIpv6Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].NetconfIpv6Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtInbandInterfaces[i].NetconfIpv6Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].NetconfIpv4Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].NetconfIpv4Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].NetconfIpv4Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].NetconfIpv4Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtInbandInterfaces[i].NetconfIpv4Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].XmlIpv6Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].XmlIpv6Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].XmlIpv6Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].XmlIpv6Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtInbandInterfaces[i].XmlIpv6Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].XmlIpv4Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].XmlIpv4Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].XmlIpv4Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].XmlIpv4Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtInbandInterfaces[i].XmlIpv4Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].HttpIpv4Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].HttpIpv4Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].HttpIpv4Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].HttpIpv4Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtInbandInterfaces[i].HttpIpv4Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].TftpIpv6Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].TftpIpv6Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].TftpIpv6Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].TftpIpv6Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtInbandInterfaces[i].TftpIpv6Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].TftpIpv4Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].TftpIpv4Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].TftpIpv4Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].TftpIpv4Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtInbandInterfaces[i].TftpIpv4Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].SnmpIpv6Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].SnmpIpv6Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].SnmpIpv6Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].SnmpIpv6Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtInbandInterfaces[i].SnmpIpv6Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].SnmpIpv4Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].SnmpIpv4Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].SnmpIpv4Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].SnmpIpv4Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtInbandInterfaces[i].SnmpIpv4Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].TelnetIpv6Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].TelnetIpv6Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].TelnetIpv6Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].TelnetIpv6Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtInbandInterfaces[i].TelnetIpv6Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].TelnetIpv4Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].TelnetIpv4Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].TelnetIpv4Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].TelnetIpv4Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtInbandInterfaces[i].TelnetIpv4Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].SshIpv6Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].SshIpv6Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].SshIpv6Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].SshIpv6Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtInbandInterfaces[i].SshIpv6Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].SshIpv4Hosts {
			ckeys := [...]string{"address"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].SshIpv4Hosts[ci].Address.ValueString()}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
		...
		for ci := range data.MgmtInbandInterfaces[i].SshIpv4Prefixes {
			ckeys := [...]string{"address", "length"}
			ckeyValues := [...]string{data.MgmtInbandInterfaces[i].SshIpv4Prefixes[ci].Address.ValueString(), strconv.FormatInt(data.MgmtInbandInterfaces[i].SshIpv4Prefixes[ci].Length.ValueInt64(), 10)}
			ckeyString := ""
			for cki := range ckeys {
				ckeyString += "[" + ckeys[cki] + "=" + ckeyValues[cki] + "]"
			}
...
func (data *ControlPlane) getDeletePaths(ctx context.Context) []string {
	...
	if !data.MgmtOobInbandBehavior.IsNull() {
		deletePaths = append(deletePaths, fmt.Sprintf("%v/management-plane/out-of-band/enable-inband-behavior", data.getPath()))
	}
