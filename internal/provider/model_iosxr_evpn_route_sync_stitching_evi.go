...
func (data EVPNRouteSyncStitchingEVI) toBodyXML(ctx context.Context, stateArg ...*EVPNRouteSyncStitchingEVI) string {
	var state *EVPNRouteSyncStitchingEVI
	if len(stateArg) > 0 {
		state = stateArg[0]
	}
	body := netconf.Body{}
...
func (data *EVPNRouteSyncStitchingEVI) updateFromBody(ctx context.Context, res gjson.Result) {
