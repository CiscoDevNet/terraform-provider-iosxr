...
func (data EVPNStitchingEVI) toBodyXML(ctx context.Context, stateArg ...*EVPNStitchingEVI) string {
	var state *EVPNStitchingEVI
	if len(stateArg) > 0 {
		state = stateArg[0]
	}
	body := netconf.Body{}
...
func (data *EVPNStitchingEVI) updateFromBody(ctx context.Context, res gjson.Result) {
