...
func (data EVPNStitchingVNI) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data EVPNStitchingVNI) GetVersionConstraints() []helpers.FieldVersionConstraint {
...
func (data EVPNStitchingVNI) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
...
func (data *EVPNStitchingVNI) fromBody(ctx context.Context, res []byte) {
...
func (data *EVPNStitchingVNIData) fromBody(ctx context.Context, res []byte) {
	if value := gjson.GetBytes(res, "description"); value.Exists() {
		data.Description = types.StringValue(value.String())
	}
	if value := gjson.GetBytes(res, "bgp.rd.two-byte-as-number"); value.Exists() {
...
func (data *EVPNStitchingVNI) getEmptyLeafsDelete(ctx context.Context) []string {
