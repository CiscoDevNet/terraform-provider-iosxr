...
func (data EVPNStitchingVNI) toBodyXML(ctx context.Context, stateArg ...*EVPNStitchingVNI) string {
...
func (data *EVPNStitchingVNI) updateFromBody(ctx context.Context, res gjson.Result) {
