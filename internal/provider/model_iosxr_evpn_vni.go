...
func (data EVPNVNI) getXPath() string {
	path := "Cisco-IOS-XR-um-l2vpn-cfg:/evpn/vnis/vni[vni-id=%v]"
	path = fmt.Sprintf(path, data.VniId.ValueInt64())
	return path
}

func (data EVPNVNIData) getXPath() string {
	path := "Cisco-IOS-XR-um-l2vpn-cfg:/evpn/vnis/vni[vni-id=%v]"
	path = fmt.Sprintf(path, data.VniId.ValueInt64())
	return path
}
...
func (data EVPNVNI) toBodyXML(ctx context.Context, stateArg ...*EVPNVNI) string {
	var state *EVPNVNI
	if len(stateArg) > 0 {
		state = stateArg[0]
	}
...
func (data *EVPNVNI) updateFromBody(ctx context.Context, res gjson.Result) {
...
func (data *EVPNVNI) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *EVPNVNI) getEmptyLeafsDelete(ctx context.Context, state *EVPNVNI) []string {
...
func (data *EVPNVNI) addDeletePathsXML(ctx context.Context, body string) string {
