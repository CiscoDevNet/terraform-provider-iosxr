...
func (data ExtcommunityBandwidthSet) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data ExtcommunityBandwidthSet) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
