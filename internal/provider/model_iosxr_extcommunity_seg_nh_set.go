...
type ExtcommunitySegNHSet struct {
...
type ExtcommunitySegNHSetData struct {
	Device  types.String `tfsdk:"device"`
	Id      types.String `tfsdk:"id"`
	SetName types.String `tfsdk:"set_name"`
	Rpl     types.String `tfsdk:"rpl"`
...
func (data ExtcommunitySegNHSet) getPath() string {
...
func (data ExtcommunitySegNHSet) toBody(ctx context.Context) string {
	body := "{}"
	...
	if !data.Rpl.IsNull() && !data.Rpl.IsUnknown() {
		body, _ = sjson.Set(body, "rpl-extended-community-seg-nh-set", data.Rpl.ValueString())
	}
	return body
}
...
func (data *ExtcommunitySegNHSet) updateFromBody(ctx context.Context, res gjson.Result) {
	if value := res.Get("rpl-extended-community-seg-nh-set"); value.Exists() && !data.Rpl.IsNull() {
...
func (data *ExtcommunitySegNHSet) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(prefix + "rpl-extended-community-seg-nh-set"); value.Exists() {
		data.Rpl = types.StringValue(value.String())
	}
}
...
func (data *ExtcommunitySegNHSetData) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *ExtcommunitySegNHSet) getDeletedItems(ctx context.Context, state ExtcommunitySegNHSet) []string {
	deletedItems := make([]string, 0)
	if !state.Rpl.IsNull() && data.Rpl.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/rpl-extended-community-seg-nh-set", state.getPath()))
	}
	return deletedItems
}
...
func (data *ExtcommunitySegNHSet) getEmptyLeafsDelete(ctx context.Context, state *ExtcommunitySegNHSet) []string {
...
func (data *ExtcommunitySegNHSet) getDeletePaths(ctx context.Context) []string {
	var deletePaths []string
	if !data.Rpl.IsNull() {
		deletePaths = append(deletePaths, fmt.Sprintf("%v/rpl-extended-community-seg-nh-set", data.getPath()))
	}
