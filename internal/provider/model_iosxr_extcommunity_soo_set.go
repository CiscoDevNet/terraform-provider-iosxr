...
func (data ExtcommunitySOOSet) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data ExtcommunitySOOSet) GetVersionConstraints() []helpers.FieldVersionConstraint {
...
func (data ExtcommunitySOOSet) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
