...
func (data ExtcommunitySOOSet) toBodyXML(ctx context.Context, stateArg ...*ExtcommunitySOOSet) string {
...
func (data *ExtcommunitySOOSet) updateFromBody(ctx context.Context, res gjson.Result) {
	if value := res.Get("rpl-extended-community-soo-set"); value.Exists() && !data.Rpl.IsNull() {
