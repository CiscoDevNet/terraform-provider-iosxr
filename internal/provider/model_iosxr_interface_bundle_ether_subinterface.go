...
func (data InterfaceBundleEtherSubinterface) getXPath() string {
...
func (data InterfaceBundleEtherSubinterfaceData) getXPath() string {
	path := "Cisco-IOS-XR-um-interface-cfg:/interfaces/interface[interface-name=Bundle-Ether%s]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.Name.ValueString()))
	return path
}
...
func (data *InterfaceBundleEtherSubinterface) updateFromBody(ctx context.Context, res gjson.Result) {
	if value := res.Get("sub-interface-type.l2transport"); value.Exists() {
	...
	if value := res.Get("Cisco-IOS-XR-um-l2-ethernet-cfg:encapsulation.dot1q.vlan-id"); value.Exists() && !data.EncapsulationDot1qVlanId.IsNull() {
	...
	if value := res.Get("Cisco-IOS-XR-um-l2-ethernet-cfg:encapsulation.dot1q.second-dot1q"); value.Exists() && !data.EncapsulationDot1qSecondDot1q.IsNull() {
	...
	if value := res.Get("Cisco-IOS-XR-um-l2-ethernet-cfg:l2transport-encapsulation.dot1q.vlan-id"); value.Exists() && !data.L2transportEncapsulationDot1qVlanId.IsNull() {
	...
	if value := res.Get("Cisco-IOS-XR-um-l2-ethernet-cfg:l2transport-encapsulation.dot1q.second-dot1q"); value.Exists() && !data.L2transportEncapsulationDot1qSecondDot1q.IsNull() {
	...
	if value := res.Get("Cisco-IOS-XR-um-l2-ethernet-cfg:rewrite.ingress.tag.pop.one"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
	...
	if value := res.Get("Cisco-IOS-XR-um-l2-ethernet-cfg:rewrite.ingress.tag.pop.two"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
	...
	for i := range data.EthernetCfmMepDomains {
		...
		if value := r.Get("loss-measurement.counters.aggregate"); value.Exists() {
			// Only set to true if it was already in the plan (not null)
	...
	for i := range data.MonitorSessions {
		...
		if value := r.Get("ethernet"); value.Exists() {
			// Only set to true if it was already in the plan (not null)
		...
		if value := r.Get("direction.rx-only"); value.Exists() {
			// Only set to true if it was already in the plan (not null)
		...
		if value := r.Get("direction.tx-only"); value.Exists() {
			// Only set to true if it was already in the plan (not null)
		...
		if value := r.Get("acl"); value.Exists() {
			// Only set to true if it was already in the plan (not null)
...
func (data InterfaceBundleEtherSubinterface) toBodyXML(ctx context.Context, stateArg ...*InterfaceBundleEtherSubinterface) string {
	...
	if len(data.MonitorSessions) > 0 {
		for _, item := range data.MonitorSessions {
			...
			if !item.Ethernet.IsNull() && !item.Ethernet.IsUnknown() {
				if item.Ethernet.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/ethernet", "")
				}
			}
			if !item.DirectionRxOnly.IsNull() && !item.DirectionRxOnly.IsUnknown() {
				if item.DirectionRxOnly.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/direction/rx-only", "")
				}
			}
			if !item.DirectionTxOnly.IsNull() && !item.DirectionTxOnly.IsUnknown() {
				if item.DirectionTxOnly.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/direction/tx-only", "")
				}
			}
			if !item.Acl.IsNull() && !item.Acl.IsUnknown() {
				if item.Acl.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/acl", "")
				}
			}
			if !item.AclIpv4Name.IsNull() && !item.AclIpv4Name.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/acl-ipv4/acl-name", item.AclIpv4Name.ValueString())
			}
			if !item.AclIpv6Name.IsNull() && !item.AclIpv6Name.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/acl-ipv6/acl-name", item.AclIpv6Name.ValueString())
			}
			if !item.MirrorFirst.IsNull() && !item.MirrorFirst.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/mirror/first", strconv.FormatInt(item.MirrorFirst.ValueInt64(), 10))
			}
			if !item.MirrorInterval.IsNull() && !item.MirrorInterval.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/mirror/interval", item.MirrorInterval.ValueString())
			}
		}
	}
	...
	// injected as a single raw XML sibling into the final root element produced above.
	{
		...
		if len(data.ServicePolicyInput) > 0 {
			for _, item := range data.ServicePolicyInput {
				...
				if !item.Name.IsNull() && !item.Name.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/service-policy-name", item.Name.ValueString())
				}
			}
		}
		if len(data.ServicePolicyOutput) > 0 {
	...
	}
	{
		nsBody := netconf.Body{}
		if !data.EncapsulationDot1qVlanId.IsNull() && !data.EncapsulationDot1qVlanId.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-l2-ethernet-cfg:encapsulation/dot1q/vlan-id", strconv.FormatInt(data.EncapsulationDot1qVlanId.ValueInt64(), 10))
		}
		if !data.EncapsulationDot1qSecondDot1q.IsNull() && !data.EncapsulationDot1qSecondDot1q.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-l2-ethernet-cfg:encapsulation/dot1q/second-dot1q", strconv.FormatInt(data.EncapsulationDot1qSecondDot1q.ValueInt64(), 10))
		}
		nsBodyXML, nsErr := helpers.BodyToNestedXML(nsBody)
		if nsErr != nil {
			// Check if the error is due to invalid path syntax (e.g., xmlns attributes)
	...
	}
	{
		nsBody := netconf.Body{}
		if !data.L2transportEncapsulationDot1qVlanId.IsNull() && !data.L2transportEncapsulationDot1qVlanId.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-l2-ethernet-cfg:l2transport-encapsulation/dot1q/vlan-id", data.L2transportEncapsulationDot1qVlanId.ValueString())
		}
		if !data.L2transportEncapsulationDot1qSecondDot1q.IsNull() && !data.L2transportEncapsulationDot1qSecondDot1q.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-l2-ethernet-cfg:l2transport-encapsulation/dot1q/second-dot1q", data.L2transportEncapsulationDot1qSecondDot1q.ValueString())
		}
		nsBodyXML, nsErr := helpers.BodyToNestedXML(nsBody)
		if nsErr != nil {
			// Check if the error is due to invalid path syntax (e.g., xmlns attributes)
	...
	}
	{
		...
		if !data.RewriteIngressTagPopOne.IsNull() && !data.RewriteIngressTagPopOne.IsUnknown() {
			if data.RewriteIngressTagPopOne.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-l2-ethernet-cfg:rewrite/ingress/tag/pop/one", "")
			}
		}
		if !data.RewriteIngressTagPopTwo.IsNull() && !data.RewriteIngressTagPopTwo.IsUnknown() {
			if data.RewriteIngressTagPopTwo.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-l2-ethernet-cfg:rewrite/ingress/tag/pop/two", "")
			}
		}
		nsBodyXML, nsErr := helpers.BodyToNestedXML(nsBody)
		if nsErr != nil {
	...
	}
	{
		...
		if !data.Ipv4PointToPoint.IsNull() && !data.Ipv4PointToPoint.IsUnknown() {
			if data.Ipv4PointToPoint.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv4/Cisco-IOS-XR-um-if-ipv4-cfg:point-to-point", "")
			}
		}
		if !data.Ipv4Mtu.IsNull() && !data.Ipv4Mtu.IsUnknown() {
		...
		if !data.Ipv4UnreachablesDisable.IsNull() && !data.Ipv4UnreachablesDisable.IsUnknown() {
			if data.Ipv4UnreachablesDisable.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv4/Cisco-IOS-XR-um-if-ipv4-cfg:unreachables/disable", "")
			}
		}
		if !data.Ipv4TcpMssAdjust.IsNull() && !data.Ipv4TcpMssAdjust.IsUnknown() {
			if data.Ipv4TcpMssAdjust.ValueBool() {
		...
		if !data.Ipv4AccessGroupIngressHardwareCount.IsNull() && !data.Ipv4AccessGroupIngressHardwareCount.IsUnknown() {
			if data.Ipv4AccessGroupIngressHardwareCount.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv4/Cisco-IOS-XR-um-if-access-group-cfg:access-group/ingress/hardware-count", "")
			}
		}
		if !data.Ipv4AccessGroupIngressInterfaceStatistics.IsNull() && !data.Ipv4AccessGroupIngressInterfaceStatistics.IsUnknown() {
			if data.Ipv4AccessGroupIngressInterfaceStatistics.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv4/Cisco-IOS-XR-um-if-access-group-cfg:access-group/ingress/interface-statistics", "")
			}
		}
		if !data.Ipv4AccessGroupIngressCompress.IsNull() && !data.Ipv4AccessGroupIngressCompress.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv4/Cisco-IOS-XR-um-if-access-group-cfg:access-group/ingress/compress", strconv.FormatInt(data.Ipv4AccessGroupIngressCompress.ValueInt64(), 10))
		}
		if !data.Ipv4AccessGroupEgressAcl.IsNull() && !data.Ipv4AccessGroupEgressAcl.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv4/Cisco-IOS-XR-um-if-access-group-cfg:access-group/egress/access-list-name/name", data.Ipv4AccessGroupEgressAcl.ValueString())
		}
		if !data.Ipv4AccessGroupEgressHardwareCount.IsNull() && !data.Ipv4AccessGroupEgressHardwareCount.IsUnknown() {
			if data.Ipv4AccessGroupEgressHardwareCount.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv4/Cisco-IOS-XR-um-if-access-group-cfg:access-group/egress/hardware-count", "")
			}
		}
		if !data.Ipv4AccessGroupEgressInterfaceStatistics.IsNull() && !data.Ipv4AccessGroupEgressInterfaceStatistics.IsUnknown() {
			if data.Ipv4AccessGroupEgressInterfaceStatistics.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv4/Cisco-IOS-XR-um-if-access-group-cfg:access-group/egress/interface-statistics", "")
			}
		}
		if !data.Ipv4AccessGroupEgressCompress.IsNull() && !data.Ipv4AccessGroupEgressCompress.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv4/Cisco-IOS-XR-um-if-access-group-cfg:access-group/egress/compress", strconv.FormatInt(data.Ipv4AccessGroupEgressCompress.ValueInt64(), 10))
		}
		nsBodyXML, nsErr := helpers.BodyToNestedXML(nsBody)
		if nsErr != nil {
			// Check if the error is due to invalid path syntax (e.g., xmlns attributes)
	...
	}
	{
		...
		if !data.Ipv6AccessGroupIngressInterfaceStatistics.IsNull() && !data.Ipv6AccessGroupIngressInterfaceStatistics.IsUnknown() {
			if data.Ipv6AccessGroupIngressInterfaceStatistics.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-if-access-group-cfg:access-group/ingress/interface-statistics", "")
			}
		}
		if !data.Ipv6AccessGroupIngressCompress.IsNull() && !data.Ipv6AccessGroupIngressCompress.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-if-access-group-cfg:access-group/ingress/compress", strconv.FormatInt(data.Ipv6AccessGroupIngressCompress.ValueInt64(), 10))
		}
		if !data.Ipv6AccessGroupEgressAcl.IsNull() && !data.Ipv6AccessGroupEgressAcl.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-if-access-group-cfg:access-group/egress/access-list-name/name", data.Ipv6AccessGroupEgressAcl.ValueString())
		}
		if !data.Ipv6AccessGroupEgressInterfaceStatistics.IsNull() && !data.Ipv6AccessGroupEgressInterfaceStatistics.IsUnknown() {
			if data.Ipv6AccessGroupEgressInterfaceStatistics.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-if-access-group-cfg:access-group/egress/interface-statistics", "")
			}
		}
		if !data.Ipv6AccessGroupEgressCompress.IsNull() && !data.Ipv6AccessGroupEgressCompress.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-if-access-group-cfg:access-group/egress/compress", strconv.FormatInt(data.Ipv6AccessGroupEgressCompress.ValueInt64(), 10))
		}
		if !data.Ipv6Enable.IsNull() && !data.Ipv6Enable.IsUnknown() {
			if data.Ipv6Enable.ValueBool() {
		...
		if !data.Ipv6Dhcp.IsNull() && !data.Ipv6Dhcp.IsUnknown() {
			if data.Ipv6Dhcp.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-if-ip-address-cfg:addresses/dhcp", "")
			}
		}
		if !data.Ipv6Mtu.IsNull() && !data.Ipv6Mtu.IsUnknown() {
		...
		if !data.Ipv6UnreachablesDisable.IsNull() && !data.Ipv6UnreachablesDisable.IsUnknown() {
			if data.Ipv6UnreachablesDisable.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-if-ipv6-cfg:unreachables/disable", "")
			}
		}
		if !data.Ipv6TcpMssAdjust.IsNull() && !data.Ipv6TcpMssAdjust.IsUnknown() {
			if data.Ipv6TcpMssAdjust.ValueBool() {
		...
		if !data.Ipv6NdReachableTime.IsNull() && !data.Ipv6NdReachableTime.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/reachable-time", strconv.FormatInt(data.Ipv6NdReachableTime.ValueInt64(), 10))
		}
		if !data.Ipv6NdCacheLimit.IsNull() && !data.Ipv6NdCacheLimit.IsUnknown() {
		...
		if !data.Ipv6NdDadAttempts.IsNull() && !data.Ipv6NdDadAttempts.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/dad/attempts", strconv.FormatInt(data.Ipv6NdDadAttempts.ValueInt64(), 10))
		}
		if !data.Ipv6NdUnicastRa.IsNull() && !data.Ipv6NdUnicastRa.IsUnknown() {
			if data.Ipv6NdUnicastRa.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/unicast-ra", "")
			}
		}
		if !data.Ipv6NdSuppressRa.IsNull() && !data.Ipv6NdSuppressRa.IsUnknown() {
			if data.Ipv6NdSuppressRa.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/suppress-ra", "")
			}
		}
		if !data.Ipv6NdManagedConfigFlag.IsNull() && !data.Ipv6NdManagedConfigFlag.IsUnknown() {
			if data.Ipv6NdManagedConfigFlag.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/managed-config-flag", "")
			}
		}
		if !data.Ipv6NdOtherConfigFlag.IsNull() && !data.Ipv6NdOtherConfigFlag.IsUnknown() {
			if data.Ipv6NdOtherConfigFlag.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/other-config-flag", "")
			}
		}
		if !data.Ipv6NdNsInterval.IsNull() && !data.Ipv6NdNsInterval.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/ns-interval", strconv.FormatInt(data.Ipv6NdNsInterval.ValueInt64(), 10))
		}
		if !data.Ipv6NdRaIntervalMax.IsNull() && !data.Ipv6NdRaIntervalMax.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/ra-interval/maximum-ra-interval", strconv.FormatInt(data.Ipv6NdRaIntervalMax.ValueInt64(), 10))
		}
		if !data.Ipv6NdRaIntervalMin.IsNull() && !data.Ipv6NdRaIntervalMin.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/ra-interval/minimum-ra-interval", strconv.FormatInt(data.Ipv6NdRaIntervalMin.ValueInt64(), 10))
		}
		if !data.Ipv6NdRaLifetime.IsNull() && !data.Ipv6NdRaLifetime.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/ra-lifetime", strconv.FormatInt(data.Ipv6NdRaLifetime.ValueInt64(), 10))
		}
		if !data.Ipv6NdRedirects.IsNull() && !data.Ipv6NdRedirects.IsUnknown() {
			if data.Ipv6NdRedirects.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/redirects", "")
			}
		}
		if !data.Ipv6NdPrefixDefaultNoAdv.IsNull() && !data.Ipv6NdPrefixDefaultNoAdv.IsUnknown() {
			if data.Ipv6NdPrefixDefaultNoAdv.ValueBool() {
	...
	}
	{
		...
		if len(data.EthernetCfmMepDomains) > 0 {
			for _, item := range data.EthernetCfmMepDomains {
				basePath := data.getXPath() + "/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain[domain-name='" + item.DomainName.ValueString() + "']"
				if !item.DomainName.IsNull() && !item.DomainName.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/domain-name", item.DomainName.ValueString())
				}
				if !item.Service.IsNull() && !item.Service.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/service", item.Service.ValueString())
				}
				if !item.MepId.IsNull() && !item.MepId.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/mep-id", strconv.FormatInt(item.MepId.ValueInt64(), 10))
				}
				if !item.Cos.IsNull() && !item.Cos.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/cos", strconv.FormatInt(item.Cos.ValueInt64(), 10))
				}
				if !item.LossMeasurementCountersAggregate.IsNull() && !item.LossMeasurementCountersAggregate.IsUnknown() {
					if item.LossMeasurementCountersAggregate.ValueBool() {
						nsBody = helpers.SetFromXPath(nsBody, basePath+"/loss-measurement/counters/aggregate", "")
					}
				}
				if !item.LossMeasurementCountersPriorityCosRangeStart.IsNull() && !item.LossMeasurementCountersPriorityCosRangeStart.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/loss-measurement/counters/priority/cos-range/start-of-cos-range", strconv.FormatInt(item.LossMeasurementCountersPriorityCosRangeStart.ValueInt64(), 10))
				}
				if !item.LossMeasurementCountersPriorityCosRangeEnd.IsNull() && !item.LossMeasurementCountersPriorityCosRangeEnd.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/loss-measurement/counters/priority/cos-range/end-of-cos-range", strconv.FormatInt(item.LossMeasurementCountersPriorityCosRangeEnd.ValueInt64(), 10))
				}
				if !item.LossMeasurementCountersPriorityCosValue1.IsNull() && !item.LossMeasurementCountersPriorityCosValue1.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/loss-measurement/counters/priority/cos-values/cos-value1", strconv.FormatInt(item.LossMeasurementCountersPriorityCosValue1.ValueInt64(), 10))
				}
				if !item.LossMeasurementCountersPriorityCosValue2.IsNull() && !item.LossMeasurementCountersPriorityCosValue2.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/loss-measurement/counters/priority/cos-values/cos-value2", strconv.FormatInt(item.LossMeasurementCountersPriorityCosValue2.ValueInt64(), 10))
				}
				if !item.LossMeasurementCountersPriorityCosValue3.IsNull() && !item.LossMeasurementCountersPriorityCosValue3.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/loss-measurement/counters/priority/cos-values/cos-value3", strconv.FormatInt(item.LossMeasurementCountersPriorityCosValue3.ValueInt64(), 10))
				}
				if !item.LossMeasurementCountersPriorityCosValue4.IsNull() && !item.LossMeasurementCountersPriorityCosValue4.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/loss-measurement/counters/priority/cos-values/cos-value4", strconv.FormatInt(item.LossMeasurementCountersPriorityCosValue4.ValueInt64(), 10))
				}
				if !item.LossMeasurementCountersPriorityCosValue5.IsNull() && !item.LossMeasurementCountersPriorityCosValue5.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/loss-measurement/counters/priority/cos-values/cos-value5", strconv.FormatInt(item.LossMeasurementCountersPriorityCosValue5.ValueInt64(), 10))
				}
				if !item.LossMeasurementCountersPriorityCosValue6.IsNull() && !item.LossMeasurementCountersPriorityCosValue6.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/loss-measurement/counters/priority/cos-values/cos-value6", strconv.FormatInt(item.LossMeasurementCountersPriorityCosValue6.ValueInt64(), 10))
				}
				if !item.LossMeasurementCountersPriorityCosValue7.IsNull() && !item.LossMeasurementCountersPriorityCosValue7.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/loss-measurement/counters/priority/cos-values/cos-value7", strconv.FormatInt(item.LossMeasurementCountersPriorityCosValue7.ValueInt64(), 10))
				}
				if len(item.SlaOperationProfileTargetMepIds) > 0 {
					for _, citem := range item.SlaOperationProfileTargetMepIds {
						cbasePath := basePath + "/sla/operation/profile/target/mep-id/profile-target-mep-id[profile-name='" + citem.ProfileName.ValueString() + "' and mep-id='" + strconv.FormatInt(citem.MepId.ValueInt64(), 10) + "']"
						if !citem.ProfileName.IsNull() && !citem.ProfileName.IsUnknown() {
							nsBody = helpers.SetFromXPath(nsBody, cbasePath+"/profile-name", citem.ProfileName.ValueString())
						}
						if !citem.MepId.IsNull() && !citem.MepId.IsUnknown() {
							nsBody = helpers.SetFromXPath(nsBody, cbasePath+"/mep-id", strconv.FormatInt(citem.MepId.ValueInt64(), 10))
						}
					}
				}
				if len(item.SlaOperationProfileTargetMacAddresses) > 0 {
					for _, citem := range item.SlaOperationProfileTargetMacAddresses {
						cbasePath := basePath + "/sla/operation/profile/target/mac-address/profile-target-mac-address[profile-name='" + citem.ProfileName.ValueString() + "' and mac-address='" + citem.MacAddress.ValueString() + "']"
						if !citem.ProfileName.IsNull() && !citem.ProfileName.IsUnknown() {
							nsBody = helpers.SetFromXPath(nsBody, cbasePath+"/profile-name", citem.ProfileName.ValueString())
						}
						if !citem.MacAddress.IsNull() && !citem.MacAddress.IsUnknown() {
		...
		if !data.EthernetCfmAisTransmissionUpInterval.IsNull() && !data.EthernetCfmAisTransmissionUpInterval.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/ais/transmission/up/interval", data.EthernetCfmAisTransmissionUpInterval.ValueString())
		}
		if !data.EthernetCfmAisTransmissionUpCos.IsNull() && !data.EthernetCfmAisTransmissionUpCos.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/ais/transmission/up/cos", strconv.FormatInt(data.EthernetCfmAisTransmissionUpCos.ValueInt64(), 10))
		}
		if !data.EthernetCfmBandwidthNotificationsHoldOff.IsNull() && !data.EthernetCfmBandwidthNotificationsHoldOff.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/bandwidth-notifications/hold-off", strconv.FormatInt(data.EthernetCfmBandwidthNotificationsHoldOff.ValueInt64(), 10))
		}
		if !data.EthernetCfmBandwidthNotificationsWaitToRestore.IsNull() && !data.EthernetCfmBandwidthNotificationsWaitToRestore.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/bandwidth-notifications/wait-to-restore", strconv.FormatInt(data.EthernetCfmBandwidthNotificationsWaitToRestore.ValueInt64(), 10))
		}
		if !data.EthernetCfmBandwidthNotificationsLossThreshold.IsNull() && !data.EthernetCfmBandwidthNotificationsLossThreshold.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/bandwidth-notifications/loss-threshold", strconv.FormatInt(data.EthernetCfmBandwidthNotificationsLossThreshold.ValueInt64(), 10))
		}
		if !data.EthernetCfmBandwidthNotificationsLogChanges.IsNull() && !data.EthernetCfmBandwidthNotificationsLogChanges.IsUnknown() {
			if data.EthernetCfmBandwidthNotificationsLogChanges.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/bandwidth-notifications/log/changes", "")
			}
		}
		nsBodyXML, nsErr := helpers.BodyToNestedXML(nsBody)
		if nsErr != nil {
	...
	}
	{
		...
		if len(data.FlowIpv4IngressMonitors) > 0 {
			for _, item := range data.FlowIpv4IngressMonitors {
				basePath := data.getXPath() + "/Cisco-IOS-XR-um-flow-cfg:flow/ipv4/monitor/ingress-monitors/ingress-monitor[monitor-map-name='" + item.MonitorMapName.ValueString() + "']"
				if !item.MonitorMapName.IsNull() && !item.MonitorMapName.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/monitor-map-name", item.MonitorMapName.ValueString())
				}
			}
		}
		if len(data.FlowIpv4IngressMonitorSamplers) > 0 {
			for _, item := range data.FlowIpv4IngressMonitorSamplers {
				basePath := data.getXPath() + "/Cisco-IOS-XR-um-flow-cfg:flow/ipv4/monitor/ingress-monitor-samplers/ingress-monitor-sampler[monitor-map-name='" + item.MonitorMapName.ValueString() + "' and sampler-map-name='" + item.SamplerMapName.ValueString() + "']"
				if !item.MonitorMapName.IsNull() && !item.MonitorMapName.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/monitor-map-name", item.MonitorMapName.ValueString())
				}
				if !item.SamplerMapName.IsNull() && !item.SamplerMapName.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/sampler-map-name", item.SamplerMapName.ValueString())
				}
			}
		}
		if len(data.FlowIpv4EgressMonitors) > 0 {
			for _, item := range data.FlowIpv4EgressMonitors {
				basePath := data.getXPath() + "/Cisco-IOS-XR-um-flow-cfg:flow/ipv4/monitor/egress-monitors/egress-monitor[monitor-map-name='" + item.MonitorMapName.ValueString() + "']"
				if !item.MonitorMapName.IsNull() && !item.MonitorMapName.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/monitor-map-name", item.MonitorMapName.ValueString())
				}
			}
		...
		if len(data.FlowIpv4EgressMonitorSamplers) > 0 {
			for _, item := range data.FlowIpv4EgressMonitorSamplers {
				basePath := data.getXPath() + "/Cisco-IOS-XR-um-flow-cfg:flow/ipv4/monitor/egress-monitor-samplers/egress-monitor-sampler[monitor-map-name='" + item.MonitorMapName.ValueString() + "' and sampler-map-name='" + item.SamplerMapName.ValueString() + "']"
				if !item.MonitorMapName.IsNull() && !item.MonitorMapName.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/monitor-map-name", item.MonitorMapName.ValueString())
				}
				if !item.SamplerMapName.IsNull() && !item.SamplerMapName.IsUnknown() {
		...
		if len(data.FlowIpv6IngressMonitors) > 0 {
			for _, item := range data.FlowIpv6IngressMonitors {
				basePath := data.getXPath() + "/Cisco-IOS-XR-um-flow-cfg:flow/ipv6/monitor/ingress-monitors/ingress-monitor[monitor-map-name='" + item.MonitorMapName.ValueString() + "']"
				if !item.MonitorMapName.IsNull() && !item.MonitorMapName.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/monitor-map-name", item.MonitorMapName.ValueString())
				}
			}
		...
		if len(data.FlowIpv6IngressMonitorSamplers) > 0 {
			for _, item := range data.FlowIpv6IngressMonitorSamplers {
				basePath := data.getXPath() + "/Cisco-IOS-XR-um-flow-cfg:flow/ipv6/monitor/ingress-monitor-samplers/ingress-monitor-sampler[monitor-map-name='" + item.MonitorMapName.ValueString() + "' and sampler-map-name='" + item.SamplerMapName.ValueString() + "']"
				if !item.MonitorMapName.IsNull() && !item.MonitorMapName.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/monitor-map-name", item.MonitorMapName.ValueString())
				}
				if !item.SamplerMapName.IsNull() && !item.SamplerMapName.IsUnknown() {
		...
		if len(data.FlowIpv6EgressMonitors) > 0 {
			for _, item := range data.FlowIpv6EgressMonitors {
				basePath := data.getXPath() + "/Cisco-IOS-XR-um-flow-cfg:flow/ipv6/monitor/egress-monitors/egress-monitor[monitor-map-name='" + item.MonitorMapName.ValueString() + "']"
				if !item.MonitorMapName.IsNull() && !item.MonitorMapName.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/monitor-map-name", item.MonitorMapName.ValueString())
				}
			}
		...
		if len(data.FlowIpv6EgressMonitorSamplers) > 0 {
			for _, item := range data.FlowIpv6EgressMonitorSamplers {
				basePath := data.getXPath() + "/Cisco-IOS-XR-um-flow-cfg:flow/ipv6/monitor/egress-monitor-samplers/egress-monitor-sampler[monitor-map-name='" + item.MonitorMapName.ValueString() + "' and sampler-map-name='" + item.SamplerMapName.ValueString() + "']"
				if !item.MonitorMapName.IsNull() && !item.MonitorMapName.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/monitor-map-name", item.MonitorMapName.ValueString())
				}
				if !item.SamplerMapName.IsNull() && !item.SamplerMapName.IsUnknown() {
	...
	}
	{
		nsBody := netconf.Body{}
		if !data.ArpTimeout.IsNull() && !data.ArpTimeout.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-if-arp-cfg:arp/timeout", strconv.FormatInt(data.ArpTimeout.ValueInt64(), 10))
		}
		if !data.ArpLearningDisable.IsNull() && !data.ArpLearningDisable.IsUnknown() {
			if data.ArpLearningDisable.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-if-arp-cfg:arp/learning/disable", "")
			}
		}
		if !data.ArpLearningLocal.IsNull() && !data.ArpLearningLocal.IsUnknown() {
			if data.ArpLearningLocal.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-if-arp-cfg:arp/learning/local", "")
			}
		}
		if !data.ArpGratuitousIgnore.IsNull() && !data.ArpGratuitousIgnore.IsUnknown() {
			if data.ArpGratuitousIgnore.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-if-arp-cfg:arp/gratuitous/ignore", "")
			}
		}
		if !data.ArpCacheLimit.IsNull() && !data.ArpCacheLimit.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-if-arp-cfg:arp/cache-limit", strconv.FormatInt(data.ArpCacheLimit.ValueInt64(), 10))
		}
		nsBodyXML, nsErr := helpers.BodyToNestedXML(nsBody)
		if nsErr != nil {
			// Check if the error is due to invalid path syntax (e.g., xmlns attributes)
	...
	}
	{
		...
		if !data.Lldp.IsNull() && !data.Lldp.IsUnknown() {
			if data.Lldp.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-lldp-cfg:lldp", "")
			}
		}
		if !data.LldpTransmitDisable.IsNull() && !data.LldpTransmitDisable.IsUnknown() {
			if data.LldpTransmitDisable.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-lldp-cfg:lldp/transmit/disable", "")
			}
		}
		if !data.LldpReceiveDisable.IsNull() && !data.LldpReceiveDisable.IsUnknown() {
			if data.LldpReceiveDisable.ValueBool() {
	...
	}
	{
		...
		if !data.Ptp.IsNull() && !data.Ptp.IsUnknown() {
			if data.Ptp.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp", "")
			}
		}
		if !data.PtpProfile.IsNull() && !data.PtpProfile.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/profile", data.PtpProfile.ValueString())
		}
		if !data.PtpTransportIpv4.IsNull() && !data.PtpTransportIpv4.IsUnknown() {
			if data.PtpTransportIpv4.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/transport/ipv4", "")
			}
		}
		if !data.PtpTransportEthernet.IsNull() && !data.PtpTransportEthernet.IsUnknown() {
			if data.PtpTransportEthernet.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/transport/ethernet", "")
			}
		}
		if !data.PtpTransportIpv6.IsNull() && !data.PtpTransportIpv6.IsUnknown() {
			if data.PtpTransportIpv6.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/transport/ipv6", "")
			}
		}
		if !data.PtpClockOperationOneStep.IsNull() && !data.PtpClockOperationOneStep.IsUnknown() {
			if data.PtpClockOperationOneStep.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/clock/operation/one-step", "")
			}
		}
		if !data.PtpClockOperationTwoStep.IsNull() && !data.PtpClockOperationTwoStep.IsUnknown() {
			if data.PtpClockOperationTwoStep.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/clock/operation/two-step", "")
			}
		}
		if !data.PtpAnnounceInterval.IsNull() && !data.PtpAnnounceInterval.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/announce/interval", data.PtpAnnounceInterval.ValueString())
		}
		if !data.PtpAnnounceFrequency.IsNull() && !data.PtpAnnounceFrequency.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/announce/frequency", data.PtpAnnounceFrequency.ValueString())
		}
		if !data.PtpAnnounceTimeout.IsNull() && !data.PtpAnnounceTimeout.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/announce/timeout", strconv.FormatInt(data.PtpAnnounceTimeout.ValueInt64(), 10))
		}
		if !data.PtpAnnounceGrantDuration.IsNull() && !data.PtpAnnounceGrantDuration.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/announce/grant-duration", strconv.FormatInt(data.PtpAnnounceGrantDuration.ValueInt64(), 10))
		}
		if !data.PtpSyncInterval.IsNull() && !data.PtpSyncInterval.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/sync/interval", data.PtpSyncInterval.ValueString())
		}
		if !data.PtpSyncFrequency.IsNull() && !data.PtpSyncFrequency.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/sync/frequency", data.PtpSyncFrequency.ValueString())
		}
		if !data.PtpSyncGrantDuration.IsNull() && !data.PtpSyncGrantDuration.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/sync/grant-duration", strconv.FormatInt(data.PtpSyncGrantDuration.ValueInt64(), 10))
		}
		if !data.PtpSyncTimeout.IsNull() && !data.PtpSyncTimeout.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/sync/timeout", strconv.FormatInt(data.PtpSyncTimeout.ValueInt64(), 10))
		}
		if !data.PtpDelayRequestInterval.IsNull() && !data.PtpDelayRequestInterval.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/delay-request/interval", data.PtpDelayRequestInterval.ValueString())
		}
		if !data.PtpDelayRequestFrequency.IsNull() && !data.PtpDelayRequestFrequency.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/delay-request/frequency", data.PtpDelayRequestFrequency.ValueString())
		}
		if !data.PtpCos.IsNull() && !data.PtpCos.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/cos", strconv.FormatInt(data.PtpCos.ValueInt64(), 10))
		}
		if !data.PtpCosEvent.IsNull() && !data.PtpCosEvent.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/event-cos", strconv.FormatInt(data.PtpCosEvent.ValueInt64(), 10))
		}
		if !data.PtpCosGeneral.IsNull() && !data.PtpCosGeneral.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/general-cos", strconv.FormatInt(data.PtpCosGeneral.ValueInt64(), 10))
		}
		if !data.PtpDscp.IsNull() && !data.PtpDscp.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/dscp", strconv.FormatInt(data.PtpDscp.ValueInt64(), 10))
		}
		if !data.PtpDscpEvent.IsNull() && !data.PtpDscpEvent.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/event-dscp", strconv.FormatInt(data.PtpDscpEvent.ValueInt64(), 10))
		}
		if !data.PtpDscpGeneral.IsNull() && !data.PtpDscpGeneral.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/general-dscp", strconv.FormatInt(data.PtpDscpGeneral.ValueInt64(), 10))
		}
		if !data.PtpIpv4Ttl.IsNull() && !data.PtpIpv4Ttl.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/ipv4-ttl", strconv.FormatInt(data.PtpIpv4Ttl.ValueInt64(), 10))
		}
		if !data.PtpIpv6HopLimit.IsNull() && !data.PtpIpv6HopLimit.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/ipv6-hop-limit", strconv.FormatInt(data.PtpIpv6HopLimit.ValueInt64(), 10))
		}
		if !data.PtpDelayAsymmetryValue.IsNull() && !data.PtpDelayAsymmetryValue.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/delay-asymmetry", strconv.FormatInt(data.PtpDelayAsymmetryValue.ValueInt64(), 10))
		}
		if !data.PtpDelayAsymmetryUnitNanoseconds.IsNull() && !data.PtpDelayAsymmetryUnitNanoseconds.IsUnknown() {
			if data.PtpDelayAsymmetryUnitNanoseconds.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/nanoseconds", "")
			}
		}
		if !data.PtpDelayAsymmetryUnitMicroseconds.IsNull() && !data.PtpDelayAsymmetryUnitMicroseconds.IsUnknown() {
			if data.PtpDelayAsymmetryUnitMicroseconds.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/microseconds", "")
			}
		}
		if !data.PtpDelayAsymmetryUnitMilliseconds.IsNull() && !data.PtpDelayAsymmetryUnitMilliseconds.IsUnknown() {
			if data.PtpDelayAsymmetryUnitMilliseconds.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/milliseconds", "")
			}
		}
		if !data.PtpDelayResponseGrantDuration.IsNull() && !data.PtpDelayResponseGrantDuration.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/delay-response/grant-duration", strconv.FormatInt(data.PtpDelayResponseGrantDuration.ValueInt64(), 10))
		}
		if !data.PtpDelayResponseTimeout.IsNull() && !data.PtpDelayResponseTimeout.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/delay-response/timeout", strconv.FormatInt(data.PtpDelayResponseTimeout.ValueInt64(), 10))
		}
		if !data.PtpUnicastGrantInvalidRequestReduce.IsNull() && !data.PtpUnicastGrantInvalidRequestReduce.IsUnknown() {
			if data.PtpUnicastGrantInvalidRequestReduce.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/unicast-grant/invalid-request/reduce", "")
			}
		}
		if !data.PtpUnicastGrantInvalidRequestDeny.IsNull() && !data.PtpUnicastGrantInvalidRequestDeny.IsUnknown() {
			if data.PtpUnicastGrantInvalidRequestDeny.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/unicast-grant/invalid-request/deny", "")
			}
		}
		if !data.PtpMulticast.IsNull() && !data.PtpMulticast.IsUnknown() {
			if data.PtpMulticast.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/multicast", "")
			}
		}
		if !data.PtpMulticastMixed.IsNull() && !data.PtpMulticastMixed.IsUnknown() {
			if data.PtpMulticastMixed.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/multicast/mixed", "")
			}
		}
		if !data.PtpMulticastDisable.IsNull() && !data.PtpMulticastDisable.IsUnknown() {
			if data.PtpMulticastDisable.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/multicast/disable", "")
			}
		}
		if !data.PtpMulticastTargetAddressMacForwardable.IsNull() && !data.PtpMulticastTargetAddressMacForwardable.IsUnknown() {
			if data.PtpMulticastTargetAddressMacForwardable.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/multicast/target-address/ethernet/mac-address-01-1b-19-00-00-00", "")
			}
		}
		if !data.PtpMulticastTargetAddressMacNonForwardable.IsNull() && !data.PtpMulticastTargetAddressMacNonForwardable.IsUnknown() {
			if data.PtpMulticastTargetAddressMacNonForwardable.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/multicast/target-address/ethernet/mac-address-01-80-c2-00-00-0e", "")
			}
		}
		if !data.PtpPortStateSlaveOnly.IsNull() && !data.PtpPortStateSlaveOnly.IsUnknown() {
			if data.PtpPortStateSlaveOnly.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/port/state/subordinate-only", "")
			}
		}
		if !data.PtpPortStateMasterOnly.IsNull() && !data.PtpPortStateMasterOnly.IsUnknown() {
			if data.PtpPortStateMasterOnly.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/port/state/primary-only", "")
			}
		}
		if !data.PtpPortStateAny.IsNull() && !data.PtpPortStateAny.IsUnknown() {
			if data.PtpPortStateAny.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/port/state/any", "")
			}
		}
		if !data.PtpSourceIpv4Address.IsNull() && !data.PtpSourceIpv4Address.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/source/ipv4/address/ipv4-address", data.PtpSourceIpv4Address.ValueString())
		}
		if !data.PtpSourceIpv4AddressDisable.IsNull() && !data.PtpSourceIpv4AddressDisable.IsUnknown() {
			if data.PtpSourceIpv4AddressDisable.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/source/ipv4/address/disable", "")
			}
		}
		if !data.PtpSourceIpv6Address.IsNull() && !data.PtpSourceIpv6Address.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/source/ipv6/address/ipv6-address", data.PtpSourceIpv6Address.ValueString())
		}
		if !data.PtpSourceIpv6AddressDisable.IsNull() && !data.PtpSourceIpv6AddressDisable.IsUnknown() {
			if data.PtpSourceIpv6AddressDisable.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/source/ipv6/address/disable", "")
			}
		}
		if !data.PtpLocalPriority.IsNull() && !data.PtpLocalPriority.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/local-priority", strconv.FormatInt(data.PtpLocalPriority.ValueInt64(), 10))
		}
		if len(data.PtpSlaveIpv4s) > 0 {
			for _, item := range data.PtpSlaveIpv4s {
				...
				if !item.NonNegotiated.IsNull() && !item.NonNegotiated.IsUnknown() {
					if item.NonNegotiated.ValueBool() {
						nsBody = helpers.SetFromXPath(nsBody, basePath+"/non-negotiated", "")
					}
				}
			}
		}
		...
		if len(data.PtpMasterIpv4s) > 0 {
			for _, item := range data.PtpMasterIpv4s {
				...
				if !item.Priority.IsNull() && !item.Priority.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/priority", strconv.FormatInt(item.Priority.ValueInt64(), 10))
				}
				if !item.ClockClass.IsNull() && !item.ClockClass.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/clock-class", strconv.FormatInt(item.ClockClass.ValueInt64(), 10))
				}
				if !item.Multicast.IsNull() && !item.Multicast.IsUnknown() {
					if item.Multicast.ValueBool() {
						nsBody = helpers.SetFromXPath(nsBody, basePath+"/multicast", "")
					}
				}
				if !item.MulticastMixed.IsNull() && !item.MulticastMixed.IsUnknown() {
					if item.MulticastMixed.ValueBool() {
						nsBody = helpers.SetFromXPath(nsBody, basePath+"/multicast/mixed", "")
					}
				}
				if !item.NonNegotiated.IsNull() && !item.NonNegotiated.IsUnknown() {
					if item.NonNegotiated.ValueBool() {
				...
				if !item.DelayAsymmetry.IsNull() && !item.DelayAsymmetry.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/delay-asymmetry", strconv.FormatInt(item.DelayAsymmetry.ValueInt64(), 10))
				}
				if !item.Nanoseconds.IsNull() && !item.Nanoseconds.IsUnknown() {
					if item.Nanoseconds.ValueBool() {
						nsBody = helpers.SetFromXPath(nsBody, basePath+"/nanoseconds", "")
					}
				}
				if !item.Microseconds.IsNull() && !item.Microseconds.IsUnknown() {
					if item.Microseconds.ValueBool() {
						nsBody = helpers.SetFromXPath(nsBody, basePath+"/microseconds", "")
					}
				}
				if !item.Milliseconds.IsNull() && !item.Milliseconds.IsUnknown() {
					if item.Milliseconds.ValueBool() {
						nsBody = helpers.SetFromXPath(nsBody, basePath+"/milliseconds", "")
					}
				}
			}
		}
		...
		if !data.PtpInteropProfileDefault.IsNull() && !data.PtpInteropProfileDefault.IsUnknown() {
			if data.PtpInteropProfileDefault.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/profile/default", "")
			}
		}
		if !data.PtpInteropProfileG82651.IsNull() && !data.PtpInteropProfileG82651.IsUnknown() {
			if data.PtpInteropProfileG82651.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/profile/g-8265-1", "")
			}
		}
		if !data.PtpInteropProfileG82751.IsNull() && !data.PtpInteropProfileG82751.IsUnknown() {
			if data.PtpInteropProfileG82751.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/profile/g-8275-1", "")
			}
		}
		if !data.PtpInteropProfileG82752.IsNull() && !data.PtpInteropProfileG82752.IsUnknown() {
			if data.PtpInteropProfileG82752.ValueBool() {
				nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/profile/g-8275-2", "")
			}
		}
		if !data.PtpInteropDomain.IsNull() && !data.PtpInteropDomain.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/domain", strconv.FormatInt(data.PtpInteropDomain.ValueInt64(), 10))
		}
		if !data.PtpInteropEgressConversionPriority1.IsNull() && !data.PtpInteropEgressConversionPriority1.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/egress-conversion/priority1", strconv.FormatInt(data.PtpInteropEgressConversionPriority1.ValueInt64(), 10))
		}
		if !data.PtpInteropEgressConversionPriority2.IsNull() && !data.PtpInteropEgressConversionPriority2.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/egress-conversion/priority2", strconv.FormatInt(data.PtpInteropEgressConversionPriority2.ValueInt64(), 10))
		}
		if !data.PtpInteropEgressConversionClockAccuracy.IsNull() && !data.PtpInteropEgressConversionClockAccuracy.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/egress-conversion/clock-accuracy", strconv.FormatInt(data.PtpInteropEgressConversionClockAccuracy.ValueInt64(), 10))
		}
		if !data.PtpInteropEgressConversionOffsetScaledLogVariance.IsNull() && !data.PtpInteropEgressConversionOffsetScaledLogVariance.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/egress-conversion/offset-scaled-log-variance", strconv.FormatInt(data.PtpInteropEgressConversionOffsetScaledLogVariance.ValueInt64(), 10))
		}
		if !data.PtpInteropEgressConversionClockClassDefault.IsNull() && !data.PtpInteropEgressConversionClockClassDefault.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/egress-conversion/clock-class/default", strconv.FormatInt(data.PtpInteropEgressConversionClockClassDefault.ValueInt64(), 10))
		}
		if len(data.PtpInteropEgressConversionClockClassMappings) > 0 {
			for _, item := range data.PtpInteropEgressConversionClockClassMappings {
				...
				if !item.ClockClassToMapFrom.IsNull() && !item.ClockClassToMapFrom.IsUnknown() {
					nsBody = helpers.SetFromXPath(nsBody, basePath+"/clock-class-to-map-from", strconv.FormatInt(item.ClockClassToMapFrom.ValueInt64(), 10))
				}
				if !item.ClockClassToMapTo.IsNull() && !item.ClockClassToMapTo.IsUnknown() {
		...
		if !data.PtpInteropIngressConversionPriority1.IsNull() && !data.PtpInteropIngressConversionPriority1.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/ingress-conversion/priority1", strconv.FormatInt(data.PtpInteropIngressConversionPriority1.ValueInt64(), 10))
		}
		if !data.PtpInteropIngressConversionPriority2.IsNull() && !data.PtpInteropIngressConversionPriority2.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/ingress-conversion/priority2", strconv.FormatInt(data.PtpInteropIngressConversionPriority2.ValueInt64(), 10))
		}
		if !data.PtpInteropIngressConversionClockAccuracy.IsNull() && !data.PtpInteropIngressConversionClockAccuracy.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/ingress-conversion/clock-accuracy", strconv.FormatInt(data.PtpInteropIngressConversionClockAccuracy.ValueInt64(), 10))
		}
		if !data.PtpInteropIngressConversionOffsetScaledLogVariance.IsNull() && !data.PtpInteropIngressConversionOffsetScaledLogVariance.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/ingress-conversion/offset-scaled-log-variance", strconv.FormatInt(data.PtpInteropIngressConversionOffsetScaledLogVariance.ValueInt64(), 10))
		}
		if !data.PtpInteropIngressConversionClockClassDefault.IsNull() && !data.PtpInteropIngressConversionClockClassDefault.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/ingress-conversion/clock-class/default", strconv.FormatInt(data.PtpInteropIngressConversionClockClassDefault.ValueInt64(), 10))
		}
		if len(data.PtpInteropIngressConversionClockClassMappings) > 0 {
...
func (data *InterfaceBundleEtherSubinterface) updateFromBodyXML(ctx context.Context, res xmldot.Result) {
	...
	for i := range data.ServicePolicyInput {
		...
		if value := helpers.GetFromXPath(r, "service-policy-name"); value.Exists() && !data.ServicePolicyInput[i].Name.IsNull() {
			data.ServicePolicyInput[i].Name = types.StringValue(value.String())
	...
	for i := range data.ServicePolicyOutput {
		...
		if value := helpers.GetFromXPath(r, "service-policy-name"); value.Exists() && !data.ServicePolicyOutput[i].Name.IsNull() {
			data.ServicePolicyOutput[i].Name = types.StringValue(value.String())
		} else if data.ServicePolicyOutput[i].Name.IsNull() {
			data.ServicePolicyOutput[i].Name = types.StringNull()
		}
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-l2-ethernet-cfg:encapsulation/dot1q/vlan-id"); value.Exists() && !data.EncapsulationDot1qVlanId.IsNull() {
		data.EncapsulationDot1qVlanId = types.Int64Value(value.Int())
	} else if data.EncapsulationDot1qVlanId.IsNull() {
		data.EncapsulationDot1qVlanId = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-l2-ethernet-cfg:encapsulation/dot1q/second-dot1q"); value.Exists() && !data.EncapsulationDot1qSecondDot1q.IsNull() {
		data.EncapsulationDot1qSecondDot1q = types.Int64Value(value.Int())
	} else if data.EncapsulationDot1qSecondDot1q.IsNull() {
		data.EncapsulationDot1qSecondDot1q = types.Int64Null()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-l2-ethernet-cfg:l2transport-encapsulation/dot1q/second-dot1q"); value.Exists() && !data.L2transportEncapsulationDot1qSecondDot1q.IsNull() {
		data.L2transportEncapsulationDot1qSecondDot1q = types.StringValue(value.String())
	} else if data.L2transportEncapsulationDot1qSecondDot1q.IsNull() {
		data.L2transportEncapsulationDot1qSecondDot1q = types.StringNull()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/ipv4/Cisco-IOS-XR-um-if-access-group-cfg:access-group/ingress/access-list-name-1/name"); value.Exists() && !data.Ipv4AccessGroupIngressAcl1.IsNull() {
		data.Ipv4AccessGroupIngressAcl1 = types.StringValue(value.String())
	} else if data.Ipv4AccessGroupIngressAcl1.IsNull() {
		data.Ipv4AccessGroupIngressAcl1 = types.StringNull()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/ipv4/Cisco-IOS-XR-um-if-access-group-cfg:access-group/ingress/compress"); value.Exists() && !data.Ipv4AccessGroupIngressCompress.IsNull() {
		data.Ipv4AccessGroupIngressCompress = types.Int64Value(value.Int())
	} else if data.Ipv4AccessGroupIngressCompress.IsNull() {
		data.Ipv4AccessGroupIngressCompress = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/ipv4/Cisco-IOS-XR-um-if-access-group-cfg:access-group/egress/access-list-name/name"); value.Exists() && !data.Ipv4AccessGroupEgressAcl.IsNull() {
		data.Ipv4AccessGroupEgressAcl = types.StringValue(value.String())
	} else if data.Ipv4AccessGroupEgressAcl.IsNull() {
		data.Ipv4AccessGroupEgressAcl = types.StringNull()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/ipv4/Cisco-IOS-XR-um-if-access-group-cfg:access-group/egress/compress"); value.Exists() && !data.Ipv4AccessGroupEgressCompress.IsNull() {
		data.Ipv4AccessGroupEgressCompress = types.Int64Value(value.Int())
	} else if data.Ipv4AccessGroupEgressCompress.IsNull() {
		data.Ipv4AccessGroupEgressCompress = types.Int64Null()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/ipv6/Cisco-IOS-XR-um-if-access-group-cfg:access-group/ingress/access-list-name-1/name"); value.Exists() && !data.Ipv6AccessGroupIngressAcl1.IsNull() {
		data.Ipv6AccessGroupIngressAcl1 = types.StringValue(value.String())
	} else if data.Ipv6AccessGroupIngressAcl1.IsNull() {
		data.Ipv6AccessGroupIngressAcl1 = types.StringNull()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/ipv6/Cisco-IOS-XR-um-if-access-group-cfg:access-group/ingress/compress"); value.Exists() && !data.Ipv6AccessGroupIngressCompress.IsNull() {
		data.Ipv6AccessGroupIngressCompress = types.Int64Value(value.Int())
	} else if data.Ipv6AccessGroupIngressCompress.IsNull() {
		data.Ipv6AccessGroupIngressCompress = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/ipv6/Cisco-IOS-XR-um-if-access-group-cfg:access-group/egress/access-list-name/name"); value.Exists() && !data.Ipv6AccessGroupEgressAcl.IsNull() {
		data.Ipv6AccessGroupEgressAcl = types.StringValue(value.String())
	} else if data.Ipv6AccessGroupEgressAcl.IsNull() {
		data.Ipv6AccessGroupEgressAcl = types.StringNull()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/ipv6/Cisco-IOS-XR-um-if-access-group-cfg:access-group/egress/compress"); value.Exists() && !data.Ipv6AccessGroupEgressCompress.IsNull() {
		data.Ipv6AccessGroupEgressCompress = types.Int64Value(value.Int())
	} else if data.Ipv6AccessGroupEgressCompress.IsNull() {
		data.Ipv6AccessGroupEgressCompress = types.Int64Null()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/reachable-time"); value.Exists() && !data.Ipv6NdReachableTime.IsNull() {
		data.Ipv6NdReachableTime = types.Int64Value(value.Int())
	} else if data.Ipv6NdReachableTime.IsNull() {
		data.Ipv6NdReachableTime = types.Int64Null()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/dad/attempts"); value.Exists() && !data.Ipv6NdDadAttempts.IsNull() {
		data.Ipv6NdDadAttempts = types.Int64Value(value.Int())
	} else if data.Ipv6NdDadAttempts.IsNull() {
		data.Ipv6NdDadAttempts = types.Int64Null()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/ns-interval"); value.Exists() && !data.Ipv6NdNsInterval.IsNull() {
		data.Ipv6NdNsInterval = types.Int64Value(value.Int())
	} else if data.Ipv6NdNsInterval.IsNull() {
		data.Ipv6NdNsInterval = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/ra-interval/maximum-ra-interval"); value.Exists() && !data.Ipv6NdRaIntervalMax.IsNull() {
		data.Ipv6NdRaIntervalMax = types.Int64Value(value.Int())
	} else if data.Ipv6NdRaIntervalMax.IsNull() {
		data.Ipv6NdRaIntervalMax = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/ra-interval/minimum-ra-interval"); value.Exists() && !data.Ipv6NdRaIntervalMin.IsNull() {
		data.Ipv6NdRaIntervalMin = types.Int64Value(value.Int())
	} else if data.Ipv6NdRaIntervalMin.IsNull() {
		data.Ipv6NdRaIntervalMin = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/ra-lifetime"); value.Exists() && !data.Ipv6NdRaLifetime.IsNull() {
		data.Ipv6NdRaLifetime = types.Int64Value(value.Int())
	} else if data.Ipv6NdRaLifetime.IsNull() {
		data.Ipv6NdRaLifetime = types.Int64Null()
	}
	...
	for i := range data.EthernetCfmMepDomains {
		...
		if value := helpers.GetFromXPath(r, "domain-name"); value.Exists() && !data.EthernetCfmMepDomains[i].DomainName.IsNull() {
			data.EthernetCfmMepDomains[i].DomainName = types.StringValue(value.String())
		} else if data.EthernetCfmMepDomains[i].DomainName.IsNull() {
			data.EthernetCfmMepDomains[i].DomainName = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "service"); value.Exists() && !data.EthernetCfmMepDomains[i].Service.IsNull() {
			data.EthernetCfmMepDomains[i].Service = types.StringValue(value.String())
		} else if data.EthernetCfmMepDomains[i].Service.IsNull() {
			data.EthernetCfmMepDomains[i].Service = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "mep-id"); value.Exists() && !data.EthernetCfmMepDomains[i].MepId.IsNull() {
			data.EthernetCfmMepDomains[i].MepId = types.Int64Value(value.Int())
		} else if data.EthernetCfmMepDomains[i].MepId.IsNull() {
			data.EthernetCfmMepDomains[i].MepId = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "cos"); value.Exists() && !data.EthernetCfmMepDomains[i].Cos.IsNull() {
			data.EthernetCfmMepDomains[i].Cos = types.Int64Value(value.Int())
		...
		if value := helpers.GetFromXPath(r, "loss-measurement/counters/priority/cos-range/start-of-cos-range"); value.Exists() && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosRangeStart.IsNull() {
			data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosRangeStart = types.Int64Value(value.Int())
		} else if data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosRangeStart.IsNull() {
			data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosRangeStart = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "loss-measurement/counters/priority/cos-range/end-of-cos-range"); value.Exists() && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosRangeEnd.IsNull() {
			data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosRangeEnd = types.Int64Value(value.Int())
		} else if data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosRangeEnd.IsNull() {
			data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosRangeEnd = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "loss-measurement/counters/priority/cos-values/cos-value1"); value.Exists() && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue1.IsNull() {
			data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue1 = types.Int64Value(value.Int())
		} else if data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue1.IsNull() {
			data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue1 = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "loss-measurement/counters/priority/cos-values/cos-value2"); value.Exists() && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue2.IsNull() {
			data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue2 = types.Int64Value(value.Int())
		} else if data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue2.IsNull() {
			data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue2 = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "loss-measurement/counters/priority/cos-values/cos-value3"); value.Exists() && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue3.IsNull() {
			data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue3 = types.Int64Value(value.Int())
		} else if data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue3.IsNull() {
			data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue3 = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "loss-measurement/counters/priority/cos-values/cos-value4"); value.Exists() && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue4.IsNull() {
			data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue4 = types.Int64Value(value.Int())
		} else if data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue4.IsNull() {
			data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue4 = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "loss-measurement/counters/priority/cos-values/cos-value5"); value.Exists() && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue5.IsNull() {
			data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue5 = types.Int64Value(value.Int())
		} else if data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue5.IsNull() {
			data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue5 = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "loss-measurement/counters/priority/cos-values/cos-value6"); value.Exists() && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue6.IsNull() {
			data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue6 = types.Int64Value(value.Int())
		} else if data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue6.IsNull() {
			data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue6 = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "loss-measurement/counters/priority/cos-values/cos-value7"); value.Exists() && !data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue7.IsNull() {
			data.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue7 = types.Int64Value(value.Int())
		...
		for ci := range data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMepIds {
			...
			if value := helpers.GetFromXPath(cr, "profile-name"); value.Exists() && !data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMepIds[ci].ProfileName.IsNull() {
				data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMepIds[ci].ProfileName = types.StringValue(value.String())
			} else if data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMepIds[ci].ProfileName.IsNull() {
				data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMepIds[ci].ProfileName = types.StringNull()
			}
			if value := helpers.GetFromXPath(cr, "mep-id"); value.Exists() && !data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMepIds[ci].MepId.IsNull() {
				data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMepIds[ci].MepId = types.Int64Value(value.Int())
		...
		for ci := range data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMacAddresses {
			...
			if value := helpers.GetFromXPath(cr, "profile-name"); value.Exists() && !data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMacAddresses[ci].ProfileName.IsNull() {
				data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMacAddresses[ci].ProfileName = types.StringValue(value.String())
			} else if data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMacAddresses[ci].ProfileName.IsNull() {
				data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMacAddresses[ci].ProfileName = types.StringNull()
			}
			if value := helpers.GetFromXPath(cr, "mac-address"); value.Exists() && !data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMacAddresses[ci].MacAddress.IsNull() {
				data.EthernetCfmMepDomains[i].SlaOperationProfileTargetMacAddresses[ci].MacAddress = types.StringValue(value.String())
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/ais/transmission/up/cos"); value.Exists() && !data.EthernetCfmAisTransmissionUpCos.IsNull() {
		data.EthernetCfmAisTransmissionUpCos = types.Int64Value(value.Int())
	} else if data.EthernetCfmAisTransmissionUpCos.IsNull() {
		data.EthernetCfmAisTransmissionUpCos = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/bandwidth-notifications/hold-off"); value.Exists() && !data.EthernetCfmBandwidthNotificationsHoldOff.IsNull() {
		data.EthernetCfmBandwidthNotificationsHoldOff = types.Int64Value(value.Int())
	} else if data.EthernetCfmBandwidthNotificationsHoldOff.IsNull() {
		data.EthernetCfmBandwidthNotificationsHoldOff = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/bandwidth-notifications/wait-to-restore"); value.Exists() && !data.EthernetCfmBandwidthNotificationsWaitToRestore.IsNull() {
		data.EthernetCfmBandwidthNotificationsWaitToRestore = types.Int64Value(value.Int())
	} else if data.EthernetCfmBandwidthNotificationsWaitToRestore.IsNull() {
		data.EthernetCfmBandwidthNotificationsWaitToRestore = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/bandwidth-notifications/loss-threshold"); value.Exists() && !data.EthernetCfmBandwidthNotificationsLossThreshold.IsNull() {
		data.EthernetCfmBandwidthNotificationsLossThreshold = types.Int64Value(value.Int())
	} else if data.EthernetCfmBandwidthNotificationsLossThreshold.IsNull() {
		data.EthernetCfmBandwidthNotificationsLossThreshold = types.Int64Null()
	}
	...
	for i := range data.FlowIpv4IngressMonitors {
		...
		if value := helpers.GetFromXPath(r, "monitor-map-name"); value.Exists() && !data.FlowIpv4IngressMonitors[i].MonitorMapName.IsNull() {
			data.FlowIpv4IngressMonitors[i].MonitorMapName = types.StringValue(value.String())
	...
	for i := range data.FlowIpv4IngressMonitorSamplers {
		...
		if value := helpers.GetFromXPath(r, "monitor-map-name"); value.Exists() && !data.FlowIpv4IngressMonitorSamplers[i].MonitorMapName.IsNull() {
			data.FlowIpv4IngressMonitorSamplers[i].MonitorMapName = types.StringValue(value.String())
		} else if data.FlowIpv4IngressMonitorSamplers[i].MonitorMapName.IsNull() {
			data.FlowIpv4IngressMonitorSamplers[i].MonitorMapName = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "sampler-map-name"); value.Exists() && !data.FlowIpv4IngressMonitorSamplers[i].SamplerMapName.IsNull() {
			data.FlowIpv4IngressMonitorSamplers[i].SamplerMapName = types.StringValue(value.String())
	...
	for i := range data.FlowIpv4EgressMonitors {
		...
		if value := helpers.GetFromXPath(r, "monitor-map-name"); value.Exists() && !data.FlowIpv4EgressMonitors[i].MonitorMapName.IsNull() {
			data.FlowIpv4EgressMonitors[i].MonitorMapName = types.StringValue(value.String())
	...
	for i := range data.FlowIpv4EgressMonitorSamplers {
		...
		if value := helpers.GetFromXPath(r, "monitor-map-name"); value.Exists() && !data.FlowIpv4EgressMonitorSamplers[i].MonitorMapName.IsNull() {
			data.FlowIpv4EgressMonitorSamplers[i].MonitorMapName = types.StringValue(value.String())
		} else if data.FlowIpv4EgressMonitorSamplers[i].MonitorMapName.IsNull() {
			data.FlowIpv4EgressMonitorSamplers[i].MonitorMapName = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "sampler-map-name"); value.Exists() && !data.FlowIpv4EgressMonitorSamplers[i].SamplerMapName.IsNull() {
			data.FlowIpv4EgressMonitorSamplers[i].SamplerMapName = types.StringValue(value.String())
	...
	for i := range data.FlowIpv6IngressMonitors {
		...
		if value := helpers.GetFromXPath(r, "monitor-map-name"); value.Exists() && !data.FlowIpv6IngressMonitors[i].MonitorMapName.IsNull() {
			data.FlowIpv6IngressMonitors[i].MonitorMapName = types.StringValue(value.String())
	...
	for i := range data.FlowIpv6IngressMonitorSamplers {
		...
		if value := helpers.GetFromXPath(r, "monitor-map-name"); value.Exists() && !data.FlowIpv6IngressMonitorSamplers[i].MonitorMapName.IsNull() {
			data.FlowIpv6IngressMonitorSamplers[i].MonitorMapName = types.StringValue(value.String())
		} else if data.FlowIpv6IngressMonitorSamplers[i].MonitorMapName.IsNull() {
			data.FlowIpv6IngressMonitorSamplers[i].MonitorMapName = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "sampler-map-name"); value.Exists() && !data.FlowIpv6IngressMonitorSamplers[i].SamplerMapName.IsNull() {
			data.FlowIpv6IngressMonitorSamplers[i].SamplerMapName = types.StringValue(value.String())
	...
	for i := range data.FlowIpv6EgressMonitors {
		...
		if value := helpers.GetFromXPath(r, "monitor-map-name"); value.Exists() && !data.FlowIpv6EgressMonitors[i].MonitorMapName.IsNull() {
			data.FlowIpv6EgressMonitors[i].MonitorMapName = types.StringValue(value.String())
	...
	for i := range data.FlowIpv6EgressMonitorSamplers {
		...
		if value := helpers.GetFromXPath(r, "monitor-map-name"); value.Exists() && !data.FlowIpv6EgressMonitorSamplers[i].MonitorMapName.IsNull() {
			data.FlowIpv6EgressMonitorSamplers[i].MonitorMapName = types.StringValue(value.String())
		} else if data.FlowIpv6EgressMonitorSamplers[i].MonitorMapName.IsNull() {
			data.FlowIpv6EgressMonitorSamplers[i].MonitorMapName = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "sampler-map-name"); value.Exists() && !data.FlowIpv6EgressMonitorSamplers[i].SamplerMapName.IsNull() {
			data.FlowIpv6EgressMonitorSamplers[i].SamplerMapName = types.StringValue(value.String())
		} else if data.FlowIpv6EgressMonitorSamplers[i].SamplerMapName.IsNull() {
			data.FlowIpv6EgressMonitorSamplers[i].SamplerMapName = types.StringNull()
		}
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-if-arp-cfg:arp/timeout"); value.Exists() && !data.ArpTimeout.IsNull() {
		data.ArpTimeout = types.Int64Value(value.Int())
	} else if data.ArpTimeout.IsNull() {
		data.ArpTimeout = types.Int64Null()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-if-arp-cfg:arp/cache-limit"); value.Exists() && !data.ArpCacheLimit.IsNull() {
		data.ArpCacheLimit = types.Int64Value(value.Int())
	} else if data.ArpCacheLimit.IsNull() {
		data.ArpCacheLimit = types.Int64Null()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-if-mpls-cfg:mpls/mtu"); value.Exists() && !data.MplsMtu.IsNull() {
		data.MplsMtu = types.Int64Value(value.Int())
	} else if data.MplsMtu.IsNull() {
		data.MplsMtu = types.Int64Null()
	}
	...
	for i := range data.MonitorSessions {
		...
		if value := helpers.GetFromXPath(r, "session-name"); value.Exists() && !data.MonitorSessions[i].SessionName.IsNull() {
			data.MonitorSessions[i].SessionName = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "acl-ipv4/acl-name"); value.Exists() && !data.MonitorSessions[i].AclIpv4Name.IsNull() {
			data.MonitorSessions[i].AclIpv4Name = types.StringValue(value.String())
		} else if data.MonitorSessions[i].AclIpv4Name.IsNull() {
			data.MonitorSessions[i].AclIpv4Name = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "acl-ipv6/acl-name"); value.Exists() && !data.MonitorSessions[i].AclIpv6Name.IsNull() {
			data.MonitorSessions[i].AclIpv6Name = types.StringValue(value.String())
		} else if data.MonitorSessions[i].AclIpv6Name.IsNull() {
			data.MonitorSessions[i].AclIpv6Name = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "mirror/first"); value.Exists() && !data.MonitorSessions[i].MirrorFirst.IsNull() {
			data.MonitorSessions[i].MirrorFirst = types.Int64Value(value.Int())
		} else if data.MonitorSessions[i].MirrorFirst.IsNull() {
			data.MonitorSessions[i].MirrorFirst = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "mirror/interval"); value.Exists() && !data.MonitorSessions[i].MirrorInterval.IsNull() {
			data.MonitorSessions[i].MirrorInterval = types.StringValue(value.String())
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/profile"); value.Exists() && !data.PtpProfile.IsNull() {
		data.PtpProfile = types.StringValue(value.String())
	} else if data.PtpProfile.IsNull() {
		data.PtpProfile = types.StringNull()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/announce/interval"); value.Exists() && !data.PtpAnnounceInterval.IsNull() {
		data.PtpAnnounceInterval = types.StringValue(value.String())
	} else if data.PtpAnnounceInterval.IsNull() {
		data.PtpAnnounceInterval = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/announce/frequency"); value.Exists() && !data.PtpAnnounceFrequency.IsNull() {
		data.PtpAnnounceFrequency = types.StringValue(value.String())
	} else if data.PtpAnnounceFrequency.IsNull() {
		data.PtpAnnounceFrequency = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/announce/timeout"); value.Exists() && !data.PtpAnnounceTimeout.IsNull() {
		data.PtpAnnounceTimeout = types.Int64Value(value.Int())
	} else if data.PtpAnnounceTimeout.IsNull() {
		data.PtpAnnounceTimeout = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/announce/grant-duration"); value.Exists() && !data.PtpAnnounceGrantDuration.IsNull() {
		data.PtpAnnounceGrantDuration = types.Int64Value(value.Int())
	} else if data.PtpAnnounceGrantDuration.IsNull() {
		data.PtpAnnounceGrantDuration = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/sync/interval"); value.Exists() && !data.PtpSyncInterval.IsNull() {
		data.PtpSyncInterval = types.StringValue(value.String())
	} else if data.PtpSyncInterval.IsNull() {
		data.PtpSyncInterval = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/sync/frequency"); value.Exists() && !data.PtpSyncFrequency.IsNull() {
		data.PtpSyncFrequency = types.StringValue(value.String())
	} else if data.PtpSyncFrequency.IsNull() {
		data.PtpSyncFrequency = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/sync/grant-duration"); value.Exists() && !data.PtpSyncGrantDuration.IsNull() {
		data.PtpSyncGrantDuration = types.Int64Value(value.Int())
	} else if data.PtpSyncGrantDuration.IsNull() {
		data.PtpSyncGrantDuration = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/sync/timeout"); value.Exists() && !data.PtpSyncTimeout.IsNull() {
		data.PtpSyncTimeout = types.Int64Value(value.Int())
	} else if data.PtpSyncTimeout.IsNull() {
		data.PtpSyncTimeout = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/delay-request/interval"); value.Exists() && !data.PtpDelayRequestInterval.IsNull() {
		data.PtpDelayRequestInterval = types.StringValue(value.String())
	} else if data.PtpDelayRequestInterval.IsNull() {
		data.PtpDelayRequestInterval = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/delay-request/frequency"); value.Exists() && !data.PtpDelayRequestFrequency.IsNull() {
		data.PtpDelayRequestFrequency = types.StringValue(value.String())
	} else if data.PtpDelayRequestFrequency.IsNull() {
		data.PtpDelayRequestFrequency = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/cos"); value.Exists() && !data.PtpCos.IsNull() {
		data.PtpCos = types.Int64Value(value.Int())
	} else if data.PtpCos.IsNull() {
		data.PtpCos = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/event-cos"); value.Exists() && !data.PtpCosEvent.IsNull() {
		data.PtpCosEvent = types.Int64Value(value.Int())
	} else if data.PtpCosEvent.IsNull() {
		data.PtpCosEvent = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/general-cos"); value.Exists() && !data.PtpCosGeneral.IsNull() {
		data.PtpCosGeneral = types.Int64Value(value.Int())
	} else if data.PtpCosGeneral.IsNull() {
		data.PtpCosGeneral = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/dscp"); value.Exists() && !data.PtpDscp.IsNull() {
		data.PtpDscp = types.Int64Value(value.Int())
	} else if data.PtpDscp.IsNull() {
		data.PtpDscp = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/event-dscp"); value.Exists() && !data.PtpDscpEvent.IsNull() {
		data.PtpDscpEvent = types.Int64Value(value.Int())
	} else if data.PtpDscpEvent.IsNull() {
		data.PtpDscpEvent = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/general-dscp"); value.Exists() && !data.PtpDscpGeneral.IsNull() {
		data.PtpDscpGeneral = types.Int64Value(value.Int())
	} else if data.PtpDscpGeneral.IsNull() {
		data.PtpDscpGeneral = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/ipv4-ttl"); value.Exists() && !data.PtpIpv4Ttl.IsNull() {
		data.PtpIpv4Ttl = types.Int64Value(value.Int())
	} else if data.PtpIpv4Ttl.IsNull() {
		data.PtpIpv4Ttl = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/ipv6-hop-limit"); value.Exists() && !data.PtpIpv6HopLimit.IsNull() {
		data.PtpIpv6HopLimit = types.Int64Value(value.Int())
	} else if data.PtpIpv6HopLimit.IsNull() {
		data.PtpIpv6HopLimit = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/delay-asymmetry"); value.Exists() && !data.PtpDelayAsymmetryValue.IsNull() {
		data.PtpDelayAsymmetryValue = types.Int64Value(value.Int())
	} else if data.PtpDelayAsymmetryValue.IsNull() {
		data.PtpDelayAsymmetryValue = types.Int64Null()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/delay-response/grant-duration"); value.Exists() && !data.PtpDelayResponseGrantDuration.IsNull() {
		data.PtpDelayResponseGrantDuration = types.Int64Value(value.Int())
	} else if data.PtpDelayResponseGrantDuration.IsNull() {
		data.PtpDelayResponseGrantDuration = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/delay-response/timeout"); value.Exists() && !data.PtpDelayResponseTimeout.IsNull() {
		data.PtpDelayResponseTimeout = types.Int64Value(value.Int())
	} else if data.PtpDelayResponseTimeout.IsNull() {
		data.PtpDelayResponseTimeout = types.Int64Null()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/source/ipv4/address/ipv4-address"); value.Exists() && !data.PtpSourceIpv4Address.IsNull() {
		data.PtpSourceIpv4Address = types.StringValue(value.String())
	} else if data.PtpSourceIpv4Address.IsNull() {
		data.PtpSourceIpv4Address = types.StringNull()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/source/ipv6/address/ipv6-address"); value.Exists() && !data.PtpSourceIpv6Address.IsNull() {
		data.PtpSourceIpv6Address = types.StringValue(value.String())
	} else if data.PtpSourceIpv6Address.IsNull() {
		data.PtpSourceIpv6Address = types.StringNull()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/local-priority"); value.Exists() && !data.PtpLocalPriority.IsNull() {
		data.PtpLocalPriority = types.Int64Value(value.Int())
	} else if data.PtpLocalPriority.IsNull() {
		data.PtpLocalPriority = types.Int64Null()
	}
	for i := range data.PtpSlaveIpv4s {
		...
		if value := helpers.GetFromXPath(r, "address"); value.Exists() && !data.PtpSlaveIpv4s[i].Address.IsNull() {
			data.PtpSlaveIpv4s[i].Address = types.StringValue(value.String())
	...
	for i := range data.PtpSlaveIpv6s {
		...
		if value := helpers.GetFromXPath(r, "address"); value.Exists() && !data.PtpSlaveIpv6s[i].Address.IsNull() {
			data.PtpSlaveIpv6s[i].Address = types.StringValue(value.String())
	...
	for i := range data.PtpSlaveEthernets {
		...
		if value := helpers.GetFromXPath(r, "address"); value.Exists() && !data.PtpSlaveEthernets[i].Address.IsNull() {
			data.PtpSlaveEthernets[i].Address = types.StringValue(value.String())
	...
	for i := range data.PtpMasterIpv4s {
		...
		if value := helpers.GetFromXPath(r, "address"); value.Exists() && !data.PtpMasterIpv4s[i].Address.IsNull() {
			data.PtpMasterIpv4s[i].Address = types.StringValue(value.String())
		} else if data.PtpMasterIpv4s[i].Address.IsNull() {
			data.PtpMasterIpv4s[i].Address = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "priority"); value.Exists() && !data.PtpMasterIpv4s[i].Priority.IsNull() {
			data.PtpMasterIpv4s[i].Priority = types.Int64Value(value.Int())
		} else if data.PtpMasterIpv4s[i].Priority.IsNull() {
			data.PtpMasterIpv4s[i].Priority = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "clock-class"); value.Exists() && !data.PtpMasterIpv4s[i].ClockClass.IsNull() {
			data.PtpMasterIpv4s[i].ClockClass = types.Int64Value(value.Int())
		...
		if value := helpers.GetFromXPath(r, "delay-asymmetry"); value.Exists() && !data.PtpMasterIpv4s[i].DelayAsymmetry.IsNull() {
			data.PtpMasterIpv4s[i].DelayAsymmetry = types.Int64Value(value.Int())
	...
	for i := range data.PtpMasterIpv6s {
		...
		if value := helpers.GetFromXPath(r, "address"); value.Exists() && !data.PtpMasterIpv6s[i].Address.IsNull() {
			data.PtpMasterIpv6s[i].Address = types.StringValue(value.String())
		} else if data.PtpMasterIpv6s[i].Address.IsNull() {
			data.PtpMasterIpv6s[i].Address = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "priority"); value.Exists() && !data.PtpMasterIpv6s[i].Priority.IsNull() {
			data.PtpMasterIpv6s[i].Priority = types.Int64Value(value.Int())
		} else if data.PtpMasterIpv6s[i].Priority.IsNull() {
			data.PtpMasterIpv6s[i].Priority = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "clock-class"); value.Exists() && !data.PtpMasterIpv6s[i].ClockClass.IsNull() {
			data.PtpMasterIpv6s[i].ClockClass = types.Int64Value(value.Int())
		...
		if value := helpers.GetFromXPath(r, "delay-asymmetry"); value.Exists() && !data.PtpMasterIpv6s[i].DelayAsymmetry.IsNull() {
			data.PtpMasterIpv6s[i].DelayAsymmetry = types.Int64Value(value.Int())
	...
	for i := range data.PtpMasterEthernets {
		...
		if value := helpers.GetFromXPath(r, "address"); value.Exists() && !data.PtpMasterEthernets[i].Address.IsNull() {
			data.PtpMasterEthernets[i].Address = types.StringValue(value.String())
		} else if data.PtpMasterEthernets[i].Address.IsNull() {
			data.PtpMasterEthernets[i].Address = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "priority"); value.Exists() && !data.PtpMasterEthernets[i].Priority.IsNull() {
			data.PtpMasterEthernets[i].Priority = types.Int64Value(value.Int())
		} else if data.PtpMasterEthernets[i].Priority.IsNull() {
			data.PtpMasterEthernets[i].Priority = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "clock-class"); value.Exists() && !data.PtpMasterEthernets[i].ClockClass.IsNull() {
			data.PtpMasterEthernets[i].ClockClass = types.Int64Value(value.Int())
		...
		if value := helpers.GetFromXPath(r, "delay-asymmetry"); value.Exists() && !data.PtpMasterEthernets[i].DelayAsymmetry.IsNull() {
			data.PtpMasterEthernets[i].DelayAsymmetry = types.Int64Value(value.Int())
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/domain"); value.Exists() && !data.PtpInteropDomain.IsNull() {
		data.PtpInteropDomain = types.Int64Value(value.Int())
	} else if data.PtpInteropDomain.IsNull() {
		data.PtpInteropDomain = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/egress-conversion/priority1"); value.Exists() && !data.PtpInteropEgressConversionPriority1.IsNull() {
		data.PtpInteropEgressConversionPriority1 = types.Int64Value(value.Int())
	} else if data.PtpInteropEgressConversionPriority1.IsNull() {
		data.PtpInteropEgressConversionPriority1 = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/egress-conversion/priority2"); value.Exists() && !data.PtpInteropEgressConversionPriority2.IsNull() {
		data.PtpInteropEgressConversionPriority2 = types.Int64Value(value.Int())
	} else if data.PtpInteropEgressConversionPriority2.IsNull() {
		data.PtpInteropEgressConversionPriority2 = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/egress-conversion/clock-accuracy"); value.Exists() && !data.PtpInteropEgressConversionClockAccuracy.IsNull() {
		data.PtpInteropEgressConversionClockAccuracy = types.Int64Value(value.Int())
	} else if data.PtpInteropEgressConversionClockAccuracy.IsNull() {
		data.PtpInteropEgressConversionClockAccuracy = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/egress-conversion/offset-scaled-log-variance"); value.Exists() && !data.PtpInteropEgressConversionOffsetScaledLogVariance.IsNull() {
		data.PtpInteropEgressConversionOffsetScaledLogVariance = types.Int64Value(value.Int())
	} else if data.PtpInteropEgressConversionOffsetScaledLogVariance.IsNull() {
		data.PtpInteropEgressConversionOffsetScaledLogVariance = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/egress-conversion/clock-class/default"); value.Exists() && !data.PtpInteropEgressConversionClockClassDefault.IsNull() {
		data.PtpInteropEgressConversionClockClassDefault = types.Int64Value(value.Int())
	} else if data.PtpInteropEgressConversionClockClassDefault.IsNull() {
		data.PtpInteropEgressConversionClockClassDefault = types.Int64Null()
	}
	for i := range data.PtpInteropEgressConversionClockClassMappings {
		...
		if value := helpers.GetFromXPath(r, "clock-class-to-map-from"); value.Exists() && !data.PtpInteropEgressConversionClockClassMappings[i].ClockClassToMapFrom.IsNull() {
			data.PtpInteropEgressConversionClockClassMappings[i].ClockClassToMapFrom = types.Int64Value(value.Int())
		} else if data.PtpInteropEgressConversionClockClassMappings[i].ClockClassToMapFrom.IsNull() {
			data.PtpInteropEgressConversionClockClassMappings[i].ClockClassToMapFrom = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "clock-class-to-map-to"); value.Exists() && !data.PtpInteropEgressConversionClockClassMappings[i].ClockClassToMapTo.IsNull() {
			data.PtpInteropEgressConversionClockClassMappings[i].ClockClassToMapTo = types.Int64Value(value.Int())
		} else if data.PtpInteropEgressConversionClockClassMappings[i].ClockClassToMapTo.IsNull() {
			data.PtpInteropEgressConversionClockClassMappings[i].ClockClassToMapTo = types.Int64Null()
		}
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/ingress-conversion/priority1"); value.Exists() && !data.PtpInteropIngressConversionPriority1.IsNull() {
		data.PtpInteropIngressConversionPriority1 = types.Int64Value(value.Int())
	} else if data.PtpInteropIngressConversionPriority1.IsNull() {
		data.PtpInteropIngressConversionPriority1 = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/ingress-conversion/priority2"); value.Exists() && !data.PtpInteropIngressConversionPriority2.IsNull() {
		data.PtpInteropIngressConversionPriority2 = types.Int64Value(value.Int())
	} else if data.PtpInteropIngressConversionPriority2.IsNull() {
		data.PtpInteropIngressConversionPriority2 = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/ingress-conversion/clock-accuracy"); value.Exists() && !data.PtpInteropIngressConversionClockAccuracy.IsNull() {
		data.PtpInteropIngressConversionClockAccuracy = types.Int64Value(value.Int())
	} else if data.PtpInteropIngressConversionClockAccuracy.IsNull() {
		data.PtpInteropIngressConversionClockAccuracy = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/ingress-conversion/offset-scaled-log-variance"); value.Exists() && !data.PtpInteropIngressConversionOffsetScaledLogVariance.IsNull() {
		data.PtpInteropIngressConversionOffsetScaledLogVariance = types.Int64Value(value.Int())
	} else if data.PtpInteropIngressConversionOffsetScaledLogVariance.IsNull() {
		data.PtpInteropIngressConversionOffsetScaledLogVariance = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/ingress-conversion/clock-class/default"); value.Exists() && !data.PtpInteropIngressConversionClockClassDefault.IsNull() {
		data.PtpInteropIngressConversionClockClassDefault = types.Int64Value(value.Int())
	} else if data.PtpInteropIngressConversionClockClassDefault.IsNull() {
		data.PtpInteropIngressConversionClockClassDefault = types.Int64Null()
	}
	for i := range data.PtpInteropIngressConversionClockClassMappings {
		...
		if value := helpers.GetFromXPath(r, "clock-class-to-map-from"); value.Exists() && !data.PtpInteropIngressConversionClockClassMappings[i].ClockClassToMapFrom.IsNull() {
			data.PtpInteropIngressConversionClockClassMappings[i].ClockClassToMapFrom = types.Int64Value(value.Int())
		} else if data.PtpInteropIngressConversionClockClassMappings[i].ClockClassToMapFrom.IsNull() {
			data.PtpInteropIngressConversionClockClassMappings[i].ClockClassToMapFrom = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "clock-class-to-map-to"); value.Exists() && !data.PtpInteropIngressConversionClockClassMappings[i].ClockClassToMapTo.IsNull() {
			data.PtpInteropIngressConversionClockClassMappings[i].ClockClassToMapTo = types.Int64Value(value.Int())
...
func (data *InterfaceBundleEtherSubinterface) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *InterfaceBundleEtherSubinterfaceData) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *InterfaceBundleEtherSubinterface) fromBodyXML(ctx context.Context, res xmldot.Result) {
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/sub-interface-type/l2transport"); value.Exists() {
		data.L2transport = types.BoolValue(true)
	} else {
		data.L2transport = types.BoolValue(false)
...
func (data *InterfaceBundleEtherSubinterfaceData) fromBodyXML(ctx context.Context, res xmldot.Result) {
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/sub-interface-type/l2transport"); value.Exists() {
		data.L2transport = types.BoolValue(true)
	} else {
		data.L2transport = types.BoolValue(false)
...
func (data *InterfaceBundleEtherSubinterface) getEmptyLeafsDelete(ctx context.Context, state *InterfaceBundleEtherSubinterface) []string {
...
func (data *InterfaceBundleEtherSubinterface) addDeletedItemsXML(ctx context.Context, state InterfaceBundleEtherSubinterface, body string) string {
	...
	for i := range state.PtpInteropIngressConversionClockClassMappings {
		...
		for j := range data.PtpInteropIngressConversionClockClassMappings {
			...
			if found {
				if !state.PtpInteropIngressConversionClockClassMappings[i].ClockClassToMapTo.IsNull() && data.PtpInteropIngressConversionClockClassMappings[j].ClockClassToMapTo.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/ingress-conversion/clock-class/mappings/mapping%v/clock-class-to-map-to", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/ingress-conversion/clock-class/mappings/mapping%v", predicates))
		}
	}
	if !state.PtpInteropIngressConversionClockClassDefault.IsNull() && data.PtpInteropIngressConversionClockClassDefault.IsNull() {
	...
	for i := range state.PtpInteropEgressConversionClockClassMappings {
		...
		for j := range data.PtpInteropEgressConversionClockClassMappings {
			...
			if found {
				if !state.PtpInteropEgressConversionClockClassMappings[i].ClockClassToMapTo.IsNull() && data.PtpInteropEgressConversionClockClassMappings[j].ClockClassToMapTo.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/egress-conversion/clock-class/mappings/mapping%v/clock-class-to-map-to", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/interop/egress-conversion/clock-class/mappings/mapping%v", predicates))
		}
	}
	if !state.PtpInteropEgressConversionClockClassDefault.IsNull() && data.PtpInteropEgressConversionClockClassDefault.IsNull() {
		...
		for j := range data.PtpMasterEthernets {
			...
			if found {
				...
				if !state.PtpMasterEthernets[i].Milliseconds.IsNull() && state.PtpMasterEthernets[i].Milliseconds.ValueBool() && data.PtpMasterEthernets[j].Milliseconds.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ethernets/ethernet%v/milliseconds", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.PtpMasterEthernets[i].Microseconds.IsNull() && state.PtpMasterEthernets[i].Microseconds.ValueBool() && data.PtpMasterEthernets[j].Microseconds.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ethernets/ethernet%v/microseconds", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.PtpMasterEthernets[i].Nanoseconds.IsNull() && state.PtpMasterEthernets[i].Nanoseconds.ValueBool() && data.PtpMasterEthernets[j].Nanoseconds.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ethernets/ethernet%v/nanoseconds", predicates))
				}
				if !state.PtpMasterEthernets[i].DelayAsymmetry.IsNull() && data.PtpMasterEthernets[j].DelayAsymmetry.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ethernets/ethernet%v/delay-asymmetry", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.PtpMasterEthernets[i].NonNegotiated.IsNull() && state.PtpMasterEthernets[i].NonNegotiated.ValueBool() && data.PtpMasterEthernets[j].NonNegotiated.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ethernets/ethernet%v/non-negotiated", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.PtpMasterEthernets[i].MulticastMixed.IsNull() && state.PtpMasterEthernets[i].MulticastMixed.ValueBool() && data.PtpMasterEthernets[j].MulticastMixed.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ethernets/ethernet%v/multicast", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				...
				if !state.PtpMasterEthernets[i].ClockClass.IsNull() && data.PtpMasterEthernets[j].ClockClass.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ethernets/ethernet%v/clock-class", predicates))
				}
				if !state.PtpMasterEthernets[i].Priority.IsNull() && data.PtpMasterEthernets[j].Priority.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ethernets/ethernet%v/priority", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ethernets/ethernet%v", predicates))
		}
	}
	for i := range state.PtpMasterIpv6s {
		stateKeys := [...]string{"address"}
		...
		for j := range data.PtpMasterIpv6s {
			...
			if found {
				...
				if !state.PtpMasterIpv6s[i].Milliseconds.IsNull() && state.PtpMasterIpv6s[i].Milliseconds.ValueBool() && data.PtpMasterIpv6s[j].Milliseconds.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv6s/ipv6%v/milliseconds", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.PtpMasterIpv6s[i].Microseconds.IsNull() && state.PtpMasterIpv6s[i].Microseconds.ValueBool() && data.PtpMasterIpv6s[j].Microseconds.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv6s/ipv6%v/microseconds", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.PtpMasterIpv6s[i].Nanoseconds.IsNull() && state.PtpMasterIpv6s[i].Nanoseconds.ValueBool() && data.PtpMasterIpv6s[j].Nanoseconds.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv6s/ipv6%v/nanoseconds", predicates))
				}
				if !state.PtpMasterIpv6s[i].DelayAsymmetry.IsNull() && data.PtpMasterIpv6s[j].DelayAsymmetry.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv6s/ipv6%v/delay-asymmetry", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.PtpMasterIpv6s[i].NonNegotiated.IsNull() && state.PtpMasterIpv6s[i].NonNegotiated.ValueBool() && data.PtpMasterIpv6s[j].NonNegotiated.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv6s/ipv6%v/non-negotiated", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.PtpMasterIpv6s[i].MulticastMixed.IsNull() && state.PtpMasterIpv6s[i].MulticastMixed.ValueBool() && data.PtpMasterIpv6s[j].MulticastMixed.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv6s/ipv6%v/multicast", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				...
				if !state.PtpMasterIpv6s[i].ClockClass.IsNull() && data.PtpMasterIpv6s[j].ClockClass.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv6s/ipv6%v/clock-class", predicates))
				}
				if !state.PtpMasterIpv6s[i].Priority.IsNull() && data.PtpMasterIpv6s[j].Priority.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv6s/ipv6%v/priority", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv6s/ipv6%v", predicates))
		}
	}
	for i := range state.PtpMasterIpv4s {
		stateKeys := [...]string{"address"}
		...
		for j := range data.PtpMasterIpv4s {
			...
			if found {
				...
				if !state.PtpMasterIpv4s[i].Milliseconds.IsNull() && state.PtpMasterIpv4s[i].Milliseconds.ValueBool() && data.PtpMasterIpv4s[j].Milliseconds.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv4s/ipv4%v/milliseconds", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.PtpMasterIpv4s[i].Microseconds.IsNull() && state.PtpMasterIpv4s[i].Microseconds.ValueBool() && data.PtpMasterIpv4s[j].Microseconds.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv4s/ipv4%v/microseconds", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.PtpMasterIpv4s[i].Nanoseconds.IsNull() && state.PtpMasterIpv4s[i].Nanoseconds.ValueBool() && data.PtpMasterIpv4s[j].Nanoseconds.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv4s/ipv4%v/nanoseconds", predicates))
				}
				if !state.PtpMasterIpv4s[i].DelayAsymmetry.IsNull() && data.PtpMasterIpv4s[j].DelayAsymmetry.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv4s/ipv4%v/delay-asymmetry", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.PtpMasterIpv4s[i].NonNegotiated.IsNull() && state.PtpMasterIpv4s[i].NonNegotiated.ValueBool() && data.PtpMasterIpv4s[j].NonNegotiated.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv4s/ipv4%v/non-negotiated", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.PtpMasterIpv4s[i].MulticastMixed.IsNull() && state.PtpMasterIpv4s[i].MulticastMixed.ValueBool() && data.PtpMasterIpv4s[j].MulticastMixed.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv4s/ipv4%v/multicast", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				...
				if !state.PtpMasterIpv4s[i].ClockClass.IsNull() && data.PtpMasterIpv4s[j].ClockClass.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv4s/ipv4%v/clock-class", predicates))
				}
				if !state.PtpMasterIpv4s[i].Priority.IsNull() && data.PtpMasterIpv4s[j].Priority.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv4s/ipv4%v/priority", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/primary/ipv4s/ipv4%v", predicates))
		}
	}
	for i := range state.PtpSlaveEthernets {
		stateKeys := [...]string{"address"}
		...
		for j := range data.PtpSlaveEthernets {
			...
			if found {
				...
				if !state.PtpSlaveEthernets[i].NonNegotiated.IsNull() && state.PtpSlaveEthernets[i].NonNegotiated.ValueBool() && data.PtpSlaveEthernets[j].NonNegotiated.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/subordinate/ethernets/ethernet%v/non-negotiated", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/subordinate/ethernets/ethernet%v", predicates))
		}
	}
	for i := range state.PtpSlaveIpv6s {
		stateKeys := [...]string{"address"}
		...
		for j := range data.PtpSlaveIpv6s {
			...
			if found {
				...
				if !state.PtpSlaveIpv6s[i].NonNegotiated.IsNull() && state.PtpSlaveIpv6s[i].NonNegotiated.ValueBool() && data.PtpSlaveIpv6s[j].NonNegotiated.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/subordinate/ipv6s/ipv6%v/non-negotiated", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/subordinate/ipv6s/ipv6%v", predicates))
		}
	}
	for i := range state.PtpSlaveIpv4s {
		stateKeys := [...]string{"address"}
		...
		for j := range data.PtpSlaveIpv4s {
			...
			if found {
				...
				if !state.PtpSlaveIpv4s[i].NonNegotiated.IsNull() && state.PtpSlaveIpv4s[i].NonNegotiated.ValueBool() && data.PtpSlaveIpv4s[j].NonNegotiated.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/subordinate/ipv4s/ipv4-non-negotiated%v/non-negotiated", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ptp-cfg:ptp/subordinate/ipv4s/ipv4-non-negotiated%v", predicates))
		}
	}
	if !state.PtpLocalPriority.IsNull() && data.PtpLocalPriority.IsNull() {
	...
	for i := range state.MonitorSessions {
		...
		for j := range data.MonitorSessions {
			...
			if found {
				if !state.MonitorSessions[i].MirrorInterval.IsNull() && data.MonitorSessions[j].MirrorInterval.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-monitor-session-cfg:monitor-sessions/monitor-session%v/mirror/interval", predicates))
				}
				if !state.MonitorSessions[i].MirrorFirst.IsNull() && data.MonitorSessions[j].MirrorFirst.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-monitor-session-cfg:monitor-sessions/monitor-session%v/mirror/first", predicates))
				}
				if !state.MonitorSessions[i].AclIpv6Name.IsNull() && data.MonitorSessions[j].AclIpv6Name.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-monitor-session-cfg:monitor-sessions/monitor-session%v/acl-ipv6/acl-name", predicates))
				}
				if !state.MonitorSessions[i].AclIpv4Name.IsNull() && data.MonitorSessions[j].AclIpv4Name.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-monitor-session-cfg:monitor-sessions/monitor-session%v/acl-ipv4/acl-name", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.MonitorSessions[i].Acl.IsNull() && state.MonitorSessions[i].Acl.ValueBool() && data.MonitorSessions[j].Acl.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-monitor-session-cfg:monitor-sessions/monitor-session%v/acl", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.MonitorSessions[i].DirectionTxOnly.IsNull() && state.MonitorSessions[i].DirectionTxOnly.ValueBool() && data.MonitorSessions[j].DirectionTxOnly.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-monitor-session-cfg:monitor-sessions/monitor-session%v/direction/tx-only", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.MonitorSessions[i].DirectionRxOnly.IsNull() && state.MonitorSessions[i].DirectionRxOnly.ValueBool() && data.MonitorSessions[j].DirectionRxOnly.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-monitor-session-cfg:monitor-sessions/monitor-session%v/direction/rx-only", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.MonitorSessions[i].Ethernet.IsNull() && state.MonitorSessions[i].Ethernet.ValueBool() && data.MonitorSessions[j].Ethernet.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-monitor-session-cfg:monitor-sessions/monitor-session%v/ethernet", predicates))
				}
				break
			}
		}
	...
	for i := range state.FlowIpv6EgressMonitorSamplers {
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-flow-cfg:flow/ipv6/monitor/egress-monitor-samplers/egress-monitor-sampler%v", predicates))
		}
	}
	for i := range state.FlowIpv6EgressMonitors {
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-flow-cfg:flow/ipv6/monitor/egress-monitors/egress-monitor%v", predicates))
		}
	}
	for i := range state.FlowIpv6IngressMonitorSamplers {
		stateKeys := [...]string{"monitor-map-name", "sampler-map-name"}
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-flow-cfg:flow/ipv6/monitor/ingress-monitor-samplers/ingress-monitor-sampler%v", predicates))
		}
	}
	for i := range state.FlowIpv6IngressMonitors {
		stateKeys := [...]string{"monitor-map-name"}
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-flow-cfg:flow/ipv6/monitor/ingress-monitors/ingress-monitor%v", predicates))
		}
	}
	for i := range state.FlowIpv4EgressMonitorSamplers {
		stateKeys := [...]string{"monitor-map-name", "sampler-map-name"}
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-flow-cfg:flow/ipv4/monitor/egress-monitor-samplers/egress-monitor-sampler%v", predicates))
		}
	}
	for i := range state.FlowIpv4EgressMonitors {
		stateKeys := [...]string{"monitor-map-name"}
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-flow-cfg:flow/ipv4/monitor/egress-monitors/egress-monitor%v", predicates))
		}
	}
	for i := range state.FlowIpv4IngressMonitorSamplers {
		stateKeys := [...]string{"monitor-map-name", "sampler-map-name"}
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-flow-cfg:flow/ipv4/monitor/ingress-monitor-samplers/ingress-monitor-sampler%v", predicates))
		}
	}
	for i := range state.FlowIpv4IngressMonitors {
		stateKeys := [...]string{"monitor-map-name"}
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-flow-cfg:flow/ipv4/monitor/ingress-monitors/ingress-monitor%v", predicates))
		}
	}
	// For boolean fields, only delete if state was true (presence container was set)
	if !state.EthernetCfmBandwidthNotificationsLogChanges.IsNull() && state.EthernetCfmBandwidthNotificationsLogChanges.ValueBool() && data.EthernetCfmBandwidthNotificationsLogChanges.IsNull() {
		...
		deletePath := state.getXPath() + "/" + strconv.FormatBool(state.EthernetCfmBandwidthNotificationsLogChanges.ValueBool())
		// Check if a parent path is already marked for deletion
		parentAlreadyDeleted := false
		for dp := range deletedPaths {
			if strings.HasPrefix(deletePath, dp+"/") {
	...
	if !state.EthernetCfmBandwidthNotificationsLossThreshold.IsNull() && data.EthernetCfmBandwidthNotificationsLossThreshold.IsNull() {
		// For no_augment_config leaf with enum values, delete the specific child element (value)
		// Path should be: root-element/<value> where value is the enum value
		deletePath := state.getXPath() + "/" + strconv.FormatInt(state.EthernetCfmBandwidthNotificationsLossThreshold.ValueInt64(), 10)
		// Check if a parent path is already marked for deletion
		parentAlreadyDeleted := false
		for dp := range deletedPaths {
			if strings.HasPrefix(deletePath, dp+"/") {
	...
	if !state.EthernetCfmBandwidthNotificationsWaitToRestore.IsNull() && data.EthernetCfmBandwidthNotificationsWaitToRestore.IsNull() {
		// For no_augment_config leaf with enum values, delete the specific child element (value)
		// Path should be: root-element/<value> where value is the enum value
		deletePath := state.getXPath() + "/" + strconv.FormatInt(state.EthernetCfmBandwidthNotificationsWaitToRestore.ValueInt64(), 10)
		// Check if a parent path is already marked for deletion
		parentAlreadyDeleted := false
		for dp := range deletedPaths {
			if strings.HasPrefix(deletePath, dp+"/") {
	...
	if !state.EthernetCfmBandwidthNotificationsHoldOff.IsNull() && data.EthernetCfmBandwidthNotificationsHoldOff.IsNull() {
		// For no_augment_config leaf with enum values, delete the specific child element (value)
		// Path should be: root-element/<value> where value is the enum value
		deletePath := state.getXPath() + "/" + strconv.FormatInt(state.EthernetCfmBandwidthNotificationsHoldOff.ValueInt64(), 10)
		// Check if a parent path is already marked for deletion
		parentAlreadyDeleted := false
		for dp := range deletedPaths {
			if strings.HasPrefix(deletePath, dp+"/") {
	...
	if !state.EthernetCfmAisTransmissionUpCos.IsNull() && data.EthernetCfmAisTransmissionUpCos.IsNull() {
		// For no_augment_config leaf with enum values, delete the specific child element (value)
		// Path should be: root-element/<value> where value is the enum value
		deletePath := state.getXPath() + "/" + strconv.FormatInt(state.EthernetCfmAisTransmissionUpCos.ValueInt64(), 10)
		// Check if a parent path is already marked for deletion
		parentAlreadyDeleted := false
		for dp := range deletedPaths {
			if strings.HasPrefix(deletePath, dp+"/") {
	...
	if !state.EthernetCfmAisTransmissionUpInterval.IsNull() && data.EthernetCfmAisTransmissionUpInterval.IsNull() {
		// For no_augment_config leaf with enum values, delete the specific child element (value)
		// Path should be: root-element/<value> where value is the enum value
		deletePath := state.getXPath() + "/" + state.EthernetCfmAisTransmissionUpInterval.ValueString()
		// Check if a parent path is already marked for deletion
		parentAlreadyDeleted := false
		for dp := range deletedPaths {
			if strings.HasPrefix(deletePath, dp+"/") {
		...
		for j := range data.EthernetCfmMepDomains {
			...
			if found {
				for ci := range state.EthernetCfmMepDomains[i].SlaOperationProfileTargetMacAddresses {
					...
					if !found {
						b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v/sla/operation/profile/target/mac-address/profile-target-mac-address%v", predicates, cpredicates))
					}
				}
				for ci := range state.EthernetCfmMepDomains[i].SlaOperationProfileTargetMepIds {
					...
					if !found {
						b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v/sla/operation/profile/target/mep-id/profile-target-mep-id%v", predicates, cpredicates))
					}
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue7.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosValue7.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v/loss-measurement/counters/priority/cos-values/cos-value7", predicates))
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue6.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosValue6.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v/loss-measurement/counters/priority/cos-values/cos-value6", predicates))
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue5.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosValue5.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v/loss-measurement/counters/priority/cos-values/cos-value5", predicates))
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue4.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosValue4.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v/loss-measurement/counters/priority/cos-values/cos-value4", predicates))
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue3.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosValue3.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v/loss-measurement/counters/priority/cos-values/cos-value3", predicates))
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue2.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosValue2.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v/loss-measurement/counters/priority/cos-values/cos-value2", predicates))
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosValue1.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosValue1.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v/loss-measurement/counters/priority/cos-values/cos-value1", predicates))
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosRangeEnd.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosRangeEnd.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v/loss-measurement/counters/priority/cos-range/end-of-cos-range", predicates))
				}
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersPriorityCosRangeStart.IsNull() && data.EthernetCfmMepDomains[j].LossMeasurementCountersPriorityCosRangeStart.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v/loss-measurement/counters/priority/cos-range/start-of-cos-range", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.EthernetCfmMepDomains[i].LossMeasurementCountersAggregate.IsNull() && state.EthernetCfmMepDomains[i].LossMeasurementCountersAggregate.ValueBool() && data.EthernetCfmMepDomains[j].LossMeasurementCountersAggregate.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v/loss-measurement/counters/aggregate", predicates))
				}
				if !state.EthernetCfmMepDomains[i].Cos.IsNull() && data.EthernetCfmMepDomains[j].Cos.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v/cos", predicates))
				}
				if !state.EthernetCfmMepDomains[i].MepId.IsNull() && data.EthernetCfmMepDomains[j].MepId.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v/mep-id", predicates))
				}
				if !state.EthernetCfmMepDomains[i].Service.IsNull() && data.EthernetCfmMepDomains[j].Service.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v/service", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-ethernet-cfm-cfg:ethernet/cfm/mep/domain%v", predicates))
		}
	}
	// For boolean fields, only delete if state was true (presence container was set)
	...
	if !state.Ipv6NdRaIntervalMin.IsNull() && data.Ipv6NdRaIntervalMin.IsNull() {
		// Build predicates for delete_parent by finding sibling attributes with same parent path
		deletePath := state.getXPath() + "/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/ra-interval"
		predicates := make(map[string]string)
		if !state.Ipv6NdRaIntervalMax.IsNull() {
			predicates["maximum-ra-interval"] = fmt.Sprintf("%v", state.Ipv6NdRaIntervalMax.ValueInt64())
		}
		predicates["minimum-ra-interval"] = fmt.Sprintf("%v", state.Ipv6NdRaIntervalMin.ValueInt64())
		// Sort keys to ensure consistent ordering
		keys := make([]string, 0, len(predicates))
		for k := range predicates {
			keys = append(keys, k)
	...
	if !state.Ipv6NdRaIntervalMax.IsNull() && data.Ipv6NdRaIntervalMax.IsNull() {
		...
		deletePath := state.getXPath() + "/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/ra-interval"
		predicates := make(map[string]string)
		if !state.Ipv6NdRaIntervalMin.IsNull() {
			predicates["minimum-ra-interval"] = fmt.Sprintf("%v", state.Ipv6NdRaIntervalMin.ValueInt64())
		}
		predicates["maximum-ra-interval"] = fmt.Sprintf("%v", state.Ipv6NdRaIntervalMax.ValueInt64())
		// Sort keys to ensure consistent ordering
	...
	if !state.EncapsulationDot1qSecondDot1q.IsNull() && data.EncapsulationDot1qSecondDot1q.IsNull() {
		// For no_augment_config leaf with enum values, delete the specific child element (value)
		// Path should be: root-element/<value> where value is the enum value
		deletePath := state.getXPath() + "/" + strconv.FormatInt(state.EncapsulationDot1qSecondDot1q.ValueInt64(), 10)
		// Check if a parent path is already marked for deletion
		parentAlreadyDeleted := false
		for dp := range deletedPaths {
			if strings.HasPrefix(deletePath, dp+"/") {
	...
	if !state.EncapsulationDot1qVlanId.IsNull() && data.EncapsulationDot1qVlanId.IsNull() {
		// For no_augment_config leaf with enum values, delete the specific child element (value)
		// Path should be: root-element/<value> where value is the enum value
		deletePath := state.getXPath() + "/" + strconv.FormatInt(state.EncapsulationDot1qVlanId.ValueInt64(), 10)
		// Check if a parent path is already marked for deletion
		parentAlreadyDeleted := false
		for dp := range deletedPaths {
			if strings.HasPrefix(deletePath, dp+"/") {
	...
	for i := range state.ServicePolicyOutput {
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-if-service-policy-qos-cfg:service-policy/output%v", predicates))
		}
	}
	for i := range state.ServicePolicyInput {
		stateKeys := [...]string{"service-policy-name"}
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-if-service-policy-qos-cfg:service-policy/input%v", predicates))
		}
	}
	if !state.DampeningDecayHalfLife.IsNull() && data.DampeningDecayHalfLife.IsNull() {
		// Build predicates for delete_parent by finding sibling attributes with same parent path
...
func (data *InterfaceBundleEtherSubinterface) addDeletePathsXML(ctx context.Context, body string) string {
	...
	if !data.Ipv6NdRaIntervalMin.IsNull() {
		b = helpers.RemoveFromXPath(b, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/ra-interval")
	}
	if !data.Ipv6NdRaIntervalMax.IsNull() {
		b = helpers.RemoveFromXPath(b, data.getXPath()+"/ipv6/Cisco-IOS-XR-um-ipv6-nd-cfg:nd/ra-interval")
	}
