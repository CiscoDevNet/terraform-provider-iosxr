...
func (data IPv4AccessList) toBodyXML(ctx context.Context) string {
	...
	if len(data.Sequences) > 0 {
		for _, item := range data.Sequences {
			...
			if !item.PermitProtocol.IsNull() && !item.PermitProtocol.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/protocol", item.PermitProtocol.ValueString())
			}
			if !item.PermitEq.IsNull() && !item.PermitEq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/eq", item.PermitEq.ValueString())
			}
			if !item.PermitRangeStartProtocol.IsNull() && !item.PermitRangeStartProtocol.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/range/start-protocol", item.PermitRangeStartProtocol.ValueString())
			}
			if !item.PermitRangeEndProtocol.IsNull() && !item.PermitRangeEndProtocol.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/range/end-protocol", item.PermitRangeEndProtocol.ValueString())
			}
			if !item.PermitPrecedence.IsNull() && !item.PermitPrecedence.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/precedence", item.PermitPrecedence.ValueString())
			}
			if !item.PermitFragmentType.IsNull() && !item.PermitFragmentType.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/fragment-type", item.PermitFragmentType.ValueString())
			}
			if !item.PermitSourceAddress.IsNull() && !item.PermitSourceAddress.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/source/address", item.PermitSourceAddress.ValueString())
			}
			if !item.PermitSourceWildcardMask.IsNull() && !item.PermitSourceWildcardMask.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/source/wildcard-mask", item.PermitSourceWildcardMask.ValueString())
			}
			if !item.PermitSourcePrefixLength.IsNull() && !item.PermitSourcePrefixLength.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/source/prefix-length", strconv.FormatInt(item.PermitSourcePrefixLength.ValueInt64(), 10))
			}
			if !item.PermitSourceAny.IsNull() && !item.PermitSourceAny.IsUnknown() {
				if item.PermitSourceAny.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/permit/source/any", "")
				}
			}
			if !item.PermitSourceHost.IsNull() && !item.PermitSourceHost.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/source/host", item.PermitSourceHost.ValueString())
			}
			if !item.PermitSourceNetGroup.IsNull() && !item.PermitSourceNetGroup.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/source/net-group", item.PermitSourceNetGroup.ValueString())
			}
			if !item.PermitSourcePortGroup.IsNull() && !item.PermitSourcePortGroup.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/source/port-group", item.PermitSourcePortGroup.ValueString())
			}
			if !item.PermitSourcePortEq.IsNull() && !item.PermitSourcePortEq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/source/port/eq", item.PermitSourcePortEq.ValueString())
			}
			if !item.PermitSourcePortGt.IsNull() && !item.PermitSourcePortGt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/source/port/gt", item.PermitSourcePortGt.ValueString())
			}
			if !item.PermitSourcePortLt.IsNull() && !item.PermitSourcePortLt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/source/port/lt", item.PermitSourcePortLt.ValueString())
			}
			if !item.PermitSourcePortNeq.IsNull() && !item.PermitSourcePortNeq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/source/port/neq", item.PermitSourcePortNeq.ValueString())
			}
			if !item.PermitSourcePortRangeStart.IsNull() && !item.PermitSourcePortRangeStart.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/source/port/range/start-value", item.PermitSourcePortRangeStart.ValueString())
			}
			if !item.PermitSourcePortRangeEnd.IsNull() && !item.PermitSourcePortRangeEnd.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/source/port/range/end-value", item.PermitSourcePortRangeEnd.ValueString())
			}
			if !item.PermitDestinationAddress.IsNull() && !item.PermitDestinationAddress.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/destination/address", item.PermitDestinationAddress.ValueString())
			}
			if !item.PermitDestinationWildcardMask.IsNull() && !item.PermitDestinationWildcardMask.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/destination/wildcard-mask", item.PermitDestinationWildcardMask.ValueString())
			}
			if !item.PermitDestinationPrefixLength.IsNull() && !item.PermitDestinationPrefixLength.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/destination/prefix-length", strconv.FormatInt(item.PermitDestinationPrefixLength.ValueInt64(), 10))
			}
			if !item.PermitDestinationAny.IsNull() && !item.PermitDestinationAny.IsUnknown() {
				if item.PermitDestinationAny.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/permit/destination/any", "")
				}
			}
			if !item.PermitDestinationHost.IsNull() && !item.PermitDestinationHost.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/destination/host", item.PermitDestinationHost.ValueString())
			}
			if !item.PermitDestinationNetGroup.IsNull() && !item.PermitDestinationNetGroup.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/destination/net-group", item.PermitDestinationNetGroup.ValueString())
			}
			if !item.PermitDestinationPortGroup.IsNull() && !item.PermitDestinationPortGroup.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/destination/port-group", item.PermitDestinationPortGroup.ValueString())
			}
			if !item.PermitDestinationPortEq.IsNull() && !item.PermitDestinationPortEq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/destination/port/eq", item.PermitDestinationPortEq.ValueString())
			}
			if !item.PermitDestinationPortGt.IsNull() && !item.PermitDestinationPortGt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/destination/port/gt", item.PermitDestinationPortGt.ValueString())
			}
			if !item.PermitDestinationPortLt.IsNull() && !item.PermitDestinationPortLt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/destination/port/lt", item.PermitDestinationPortLt.ValueString())
			}
			if !item.PermitDestinationPortNeq.IsNull() && !item.PermitDestinationPortNeq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/destination/port/neq", item.PermitDestinationPortNeq.ValueString())
			}
			if !item.PermitDestinationPortRangeStart.IsNull() && !item.PermitDestinationPortRangeStart.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/destination/port/range/start-value", item.PermitDestinationPortRangeStart.ValueString())
			}
			if !item.PermitDestinationPortRangeEnd.IsNull() && !item.PermitDestinationPortRangeEnd.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/destination/port/range/end-value", item.PermitDestinationPortRangeEnd.ValueString())
			}
			if !item.PermitIcmpMessageTypeName.IsNull() && !item.PermitIcmpMessageTypeName.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/icmp/message-type-name", item.PermitIcmpMessageTypeName.ValueString())
			}
			if !item.PermitIcmpMessageType.IsNull() && !item.PermitIcmpMessageType.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/icmp/message-type", strconv.FormatInt(item.PermitIcmpMessageType.ValueInt64(), 10))
			}
			if !item.PermitIcmpMessageCode.IsNull() && !item.PermitIcmpMessageCode.IsUnknown() {
			...
			if !item.PermitDscp.IsNull() && !item.PermitDscp.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/dscp/dscp-value", item.PermitDscp.ValueString())
			}
			if !item.PermitDscpEq.IsNull() && !item.PermitDscpEq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/dscp/eq", item.PermitDscpEq.ValueString())
			}
			if !item.PermitDscpGt.IsNull() && !item.PermitDscpGt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/dscp/gt", item.PermitDscpGt.ValueString())
			}
			if !item.PermitDscpLt.IsNull() && !item.PermitDscpLt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/dscp/lt", item.PermitDscpLt.ValueString())
			}
			if !item.PermitDscpNeq.IsNull() && !item.PermitDscpNeq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/dscp/neq", item.PermitDscpNeq.ValueString())
			}
			if !item.PermitDscpRangeStart.IsNull() && !item.PermitDscpRangeStart.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/dscp/range/start-value", item.PermitDscpRangeStart.ValueString())
			}
			if !item.PermitDscpRangeEnd.IsNull() && !item.PermitDscpRangeEnd.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/dscp/range/end-value", item.PermitDscpRangeEnd.ValueString())
			}
			if !item.PermitPacketLengthEq.IsNull() && !item.PermitPacketLengthEq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/packet-length/eq", strconv.FormatInt(item.PermitPacketLengthEq.ValueInt64(), 10))
			}
			if !item.PermitPacketLengthGt.IsNull() && !item.PermitPacketLengthGt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/packet-length/gt", strconv.FormatInt(item.PermitPacketLengthGt.ValueInt64(), 10))
			}
			if !item.PermitPacketLengthLt.IsNull() && !item.PermitPacketLengthLt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/packet-length/lt", strconv.FormatInt(item.PermitPacketLengthLt.ValueInt64(), 10))
			}
			if !item.PermitPacketLengthNeq.IsNull() && !item.PermitPacketLengthNeq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/packet-length/neq", strconv.FormatInt(item.PermitPacketLengthNeq.ValueInt64(), 10))
			}
			if !item.PermitPacketLengthRangeStart.IsNull() && !item.PermitPacketLengthRangeStart.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/packet-length/range/start-value", strconv.FormatInt(item.PermitPacketLengthRangeStart.ValueInt64(), 10))
			}
			if !item.PermitPacketLengthRangeEnd.IsNull() && !item.PermitPacketLengthRangeEnd.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/packet-length/range/end-value", strconv.FormatInt(item.PermitPacketLengthRangeEnd.ValueInt64(), 10))
			}
			if !item.PermitTtlEq.IsNull() && !item.PermitTtlEq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/ttl/eq", strconv.FormatInt(item.PermitTtlEq.ValueInt64(), 10))
			}
			if !item.PermitTtlGt.IsNull() && !item.PermitTtlGt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/ttl/gt", strconv.FormatInt(item.PermitTtlGt.ValueInt64(), 10))
			}
			if !item.PermitTtlLt.IsNull() && !item.PermitTtlLt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/ttl/lt", strconv.FormatInt(item.PermitTtlLt.ValueInt64(), 10))
			}
			if !item.PermitTtlNeq.IsNull() && !item.PermitTtlNeq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/ttl/neq", strconv.FormatInt(item.PermitTtlNeq.ValueInt64(), 10))
			}
			if !item.PermitTtlRangeStart.IsNull() && !item.PermitTtlRangeStart.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/ttl/range/start-value", strconv.FormatInt(item.PermitTtlRangeStart.ValueInt64(), 10))
			}
			if !item.PermitTtlRangeEnd.IsNull() && !item.PermitTtlRangeEnd.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/ttl/range/end-value", strconv.FormatInt(item.PermitTtlRangeEnd.ValueInt64(), 10))
			}
			if !item.PermitFragmentOffsetEq.IsNull() && !item.PermitFragmentOffsetEq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/fragment-offset/eq", strconv.FormatInt(item.PermitFragmentOffsetEq.ValueInt64(), 10))
			}
			if !item.PermitFragmentOffsetGt.IsNull() && !item.PermitFragmentOffsetGt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/fragment-offset/gt", strconv.FormatInt(item.PermitFragmentOffsetGt.ValueInt64(), 10))
			}
			if !item.PermitFragmentOffsetLt.IsNull() && !item.PermitFragmentOffsetLt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/fragment-offset/lt", strconv.FormatInt(item.PermitFragmentOffsetLt.ValueInt64(), 10))
			}
			if !item.PermitFragmentOffsetNeq.IsNull() && !item.PermitFragmentOffsetNeq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/fragment-offset/neq", strconv.FormatInt(item.PermitFragmentOffsetNeq.ValueInt64(), 10))
			}
			if !item.PermitFragmentOffsetRangeStart.IsNull() && !item.PermitFragmentOffsetRangeStart.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/fragment-offset/range/start-value", strconv.FormatInt(item.PermitFragmentOffsetRangeStart.ValueInt64(), 10))
			}
			if !item.PermitFragmentOffsetRangeEnd.IsNull() && !item.PermitFragmentOffsetRangeEnd.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/fragment-offset/range/end-value", strconv.FormatInt(item.PermitFragmentOffsetRangeEnd.ValueInt64(), 10))
			}
			if !item.PermitFragments.IsNull() && !item.PermitFragments.IsUnknown() {
				if item.PermitFragments.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/permit/fragments", "")
				}
			}
			if !item.PermitPoliceValue.IsNull() && !item.PermitPoliceValue.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/police/value", strconv.FormatInt(item.PermitPoliceValue.ValueInt64(), 10))
			}
			if !item.PermitPoliceUnit.IsNull() && !item.PermitPoliceUnit.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/police/unit", item.PermitPoliceUnit.ValueString())
			}
			if !item.PermitPolicePeakRate.IsNull() && !item.PermitPolicePeakRate.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/police/peak-rate", strconv.FormatInt(item.PermitPolicePeakRate.ValueInt64(), 10))
			}
			if !item.PermitPolicePeakUnit.IsNull() && !item.PermitPolicePeakUnit.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/police/peak-unit", item.PermitPolicePeakUnit.ValueString())
			}
			if !item.PermitPolicePriority.IsNull() && !item.PermitPolicePriority.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/police/priority", item.PermitPolicePriority.ValueString())
			}
			if !item.PermitDefault.IsNull() && !item.PermitDefault.IsUnknown() {
				if item.PermitDefault.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/permit/default", "")
				}
			}
			if !item.PermitNexthop1Ipv4.IsNull() && !item.PermitNexthop1Ipv4.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/nexthop1/ipv4", item.PermitNexthop1Ipv4.ValueString())
			}
			if !item.PermitNexthop1Track.IsNull() && !item.PermitNexthop1Track.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/nexthop1/track", item.PermitNexthop1Track.ValueString())
			}
			if !item.PermitNexthop1Vrf.IsNull() && !item.PermitNexthop1Vrf.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/nexthop1/vrf", item.PermitNexthop1Vrf.ValueString())
			}
			if !item.PermitNexthop2Ipv4.IsNull() && !item.PermitNexthop2Ipv4.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/nexthop2/ipv4", item.PermitNexthop2Ipv4.ValueString())
			}
			if !item.PermitNexthop2Track.IsNull() && !item.PermitNexthop2Track.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/nexthop2/track", item.PermitNexthop2Track.ValueString())
			}
			if !item.PermitNexthop2Vrf.IsNull() && !item.PermitNexthop2Vrf.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/nexthop2/vrf", item.PermitNexthop2Vrf.ValueString())
			}
			if !item.PermitNexthop3Ipv4.IsNull() && !item.PermitNexthop3Ipv4.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/nexthop3/ipv4", item.PermitNexthop3Ipv4.ValueString())
			}
			if !item.PermitNexthop3Track.IsNull() && !item.PermitNexthop3Track.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/nexthop3/track", item.PermitNexthop3Track.ValueString())
			}
			if !item.PermitNexthop3Vrf.IsNull() && !item.PermitNexthop3Vrf.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/nexthop3/vrf", item.PermitNexthop3Vrf.ValueString())
			}
			if !item.PermitCapture.IsNull() && !item.PermitCapture.IsUnknown() {
				if item.PermitCapture.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/permit/capture", "")
				}
			}
			if !item.PermitCounter.IsNull() && !item.PermitCounter.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/counter", item.PermitCounter.ValueString())
			}
			if !item.PermitLog.IsNull() && !item.PermitLog.IsUnknown() {
				if item.PermitLog.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/permit/log", "")
				}
			}
			if !item.PermitLogInput.IsNull() && !item.PermitLogInput.IsUnknown() {
				if item.PermitLogInput.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/permit/log-input", "")
				}
			}
			if !item.PermitSetQosGroup.IsNull() && !item.PermitSetQosGroup.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/set/qos-group", strconv.FormatInt(item.PermitSetQosGroup.ValueInt64(), 10))
			}
			if !item.PermitSetTtl.IsNull() && !item.PermitSetTtl.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/set/ttl", strconv.FormatInt(item.PermitSetTtl.ValueInt64(), 10))
			}
			if !item.DenyProtocol.IsNull() && !item.DenyProtocol.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/protocol", item.DenyProtocol.ValueString())
			}
			if !item.DenyEq.IsNull() && !item.DenyEq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/eq", item.DenyEq.ValueString())
			}
			if !item.DenyPrecedence.IsNull() && !item.DenyPrecedence.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/precedence", item.DenyPrecedence.ValueString())
			}
			if !item.DenyFragmentType.IsNull() && !item.DenyFragmentType.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/fragment-type", item.DenyFragmentType.ValueString())
			}
			if !item.DenyCounter.IsNull() && !item.DenyCounter.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/counter", item.DenyCounter.ValueString())
			}
			if !item.DenyRangeStartProtocol.IsNull() && !item.DenyRangeStartProtocol.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/range/start-protocol", item.DenyRangeStartProtocol.ValueString())
			}
			if !item.DenyRangeEndProtocol.IsNull() && !item.DenyRangeEndProtocol.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/range/end-protocol", item.DenyRangeEndProtocol.ValueString())
			}
			if !item.DenySourceAddress.IsNull() && !item.DenySourceAddress.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/source/address", item.DenySourceAddress.ValueString())
			}
			if !item.DenySourceWildcardMask.IsNull() && !item.DenySourceWildcardMask.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/source/wildcard-mask", item.DenySourceWildcardMask.ValueString())
			}
			if !item.DenySourcePrefixLength.IsNull() && !item.DenySourcePrefixLength.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/source/prefix-length", strconv.FormatInt(item.DenySourcePrefixLength.ValueInt64(), 10))
			}
			if !item.DenySourceAny.IsNull() && !item.DenySourceAny.IsUnknown() {
				if item.DenySourceAny.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/deny/source/any", "")
				}
			}
			if !item.DenySourceHost.IsNull() && !item.DenySourceHost.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/source/host", item.DenySourceHost.ValueString())
			}
			if !item.DenySourceNetGroup.IsNull() && !item.DenySourceNetGroup.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/source/net-group", item.DenySourceNetGroup.ValueString())
			}
			if !item.DenySourcePortGroup.IsNull() && !item.DenySourcePortGroup.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/source/port-group", item.DenySourcePortGroup.ValueString())
			}
			if !item.DenySourcePortEq.IsNull() && !item.DenySourcePortEq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/source/port/eq", item.DenySourcePortEq.ValueString())
			}
			if !item.DenySourcePortGt.IsNull() && !item.DenySourcePortGt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/source/port/gt", item.DenySourcePortGt.ValueString())
			}
			if !item.DenySourcePortLt.IsNull() && !item.DenySourcePortLt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/source/port/lt", item.DenySourcePortLt.ValueString())
			}
			if !item.DenySourcePortNeq.IsNull() && !item.DenySourcePortNeq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/source/port/neq", item.DenySourcePortNeq.ValueString())
			}
			if !item.DenySourcePortRangeStart.IsNull() && !item.DenySourcePortRangeStart.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/source/port/range/start-value", item.DenySourcePortRangeStart.ValueString())
			}
			if !item.DenySourcePortRangeEnd.IsNull() && !item.DenySourcePortRangeEnd.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/source/port/range/end-value", item.DenySourcePortRangeEnd.ValueString())
			}
			if !item.DenyDestinationAddress.IsNull() && !item.DenyDestinationAddress.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/destination/address", item.DenyDestinationAddress.ValueString())
			}
			if !item.DenyDestinationWildcardMask.IsNull() && !item.DenyDestinationWildcardMask.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/destination/wildcard-mask", item.DenyDestinationWildcardMask.ValueString())
			}
			if !item.DenyDestinationPrefixLength.IsNull() && !item.DenyDestinationPrefixLength.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/destination/prefix-length", strconv.FormatInt(item.DenyDestinationPrefixLength.ValueInt64(), 10))
			}
			if !item.DenyDestinationAny.IsNull() && !item.DenyDestinationAny.IsUnknown() {
				if item.DenyDestinationAny.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/deny/destination/any", "")
				}
			}
			if !item.DenyDestinationHost.IsNull() && !item.DenyDestinationHost.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/destination/host", item.DenyDestinationHost.ValueString())
			}
			if !item.DenyDestinationNetGroup.IsNull() && !item.DenyDestinationNetGroup.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/destination/net-group", item.DenyDestinationNetGroup.ValueString())
			}
			if !item.DenyDestinationPortGroup.IsNull() && !item.DenyDestinationPortGroup.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/destination/port-group", item.DenyDestinationPortGroup.ValueString())
			}
			if !item.DenyDestinationPortEq.IsNull() && !item.DenyDestinationPortEq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/destination/port/eq", item.DenyDestinationPortEq.ValueString())
			}
			if !item.DenyDestinationPortGt.IsNull() && !item.DenyDestinationPortGt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/destination/port/gt", item.DenyDestinationPortGt.ValueString())
			}
			if !item.DenyDestinationPortLt.IsNull() && !item.DenyDestinationPortLt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/destination/port/lt", item.DenyDestinationPortLt.ValueString())
			}
			if !item.DenyDestinationPortNeq.IsNull() && !item.DenyDestinationPortNeq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/destination/port/neq", item.DenyDestinationPortNeq.ValueString())
			}
			if !item.DenyDestinationPortRangeStart.IsNull() && !item.DenyDestinationPortRangeStart.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/destination/port/range/start-value", item.DenyDestinationPortRangeStart.ValueString())
			}
			if !item.DenyDestinationPortRangeEnd.IsNull() && !item.DenyDestinationPortRangeEnd.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/destination/port/range/end-value", item.DenyDestinationPortRangeEnd.ValueString())
			}
			if !item.DenyIcmpMessageTypeName.IsNull() && !item.DenyIcmpMessageTypeName.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/icmp/message-type-name", item.DenyIcmpMessageTypeName.ValueString())
			}
			if !item.DenyIcmpMessageType.IsNull() && !item.DenyIcmpMessageType.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/icmp/message-type", strconv.FormatInt(item.DenyIcmpMessageType.ValueInt64(), 10))
			}
			if !item.DenyIcmpMessageCode.IsNull() && !item.DenyIcmpMessageCode.IsUnknown() {
			...
			if !item.DenyDscp.IsNull() && !item.DenyDscp.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/dscp/dscp-value", item.DenyDscp.ValueString())
			}
			if !item.DenyDscpEq.IsNull() && !item.DenyDscpEq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/dscp/eq", item.DenyDscpEq.ValueString())
			}
			if !item.DenyDscpGt.IsNull() && !item.DenyDscpGt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/dscp/gt", item.DenyDscpGt.ValueString())
			}
			if !item.DenyDscpLt.IsNull() && !item.DenyDscpLt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/dscp/lt", item.DenyDscpLt.ValueString())
			}
			if !item.DenyDscpNeq.IsNull() && !item.DenyDscpNeq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/dscp/neq", item.DenyDscpNeq.ValueString())
			}
			if !item.DenyDscpRangeStart.IsNull() && !item.DenyDscpRangeStart.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/dscp/range/start-value", item.DenyDscpRangeStart.ValueString())
			}
			if !item.DenyDscpRangeEnd.IsNull() && !item.DenyDscpRangeEnd.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/dscp/range/end-value", item.DenyDscpRangeEnd.ValueString())
			}
			if !item.DenyPacketLengthEq.IsNull() && !item.DenyPacketLengthEq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/packet-length/eq", strconv.FormatInt(item.DenyPacketLengthEq.ValueInt64(), 10))
			}
			if !item.DenyPacketLengthGt.IsNull() && !item.DenyPacketLengthGt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/packet-length/gt", strconv.FormatInt(item.DenyPacketLengthGt.ValueInt64(), 10))
			}
			if !item.DenyPacketLengthLt.IsNull() && !item.DenyPacketLengthLt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/packet-length/lt", strconv.FormatInt(item.DenyPacketLengthLt.ValueInt64(), 10))
			}
			if !item.DenyPacketLengthNeq.IsNull() && !item.DenyPacketLengthNeq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/packet-length/neq", strconv.FormatInt(item.DenyPacketLengthNeq.ValueInt64(), 10))
			}
			if !item.DenyPacketLengthRangeStart.IsNull() && !item.DenyPacketLengthRangeStart.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/packet-length/range/start-value", strconv.FormatInt(item.DenyPacketLengthRangeStart.ValueInt64(), 10))
			}
			if !item.DenyPacketLengthRangeEnd.IsNull() && !item.DenyPacketLengthRangeEnd.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/packet-length/range/end-value", strconv.FormatInt(item.DenyPacketLengthRangeEnd.ValueInt64(), 10))
			}
			if !item.DenyTtlEq.IsNull() && !item.DenyTtlEq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/ttl/eq", strconv.FormatInt(item.DenyTtlEq.ValueInt64(), 10))
			}
			if !item.DenyTtlGt.IsNull() && !item.DenyTtlGt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/ttl/gt", strconv.FormatInt(item.DenyTtlGt.ValueInt64(), 10))
			}
			if !item.DenyTtlLt.IsNull() && !item.DenyTtlLt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/ttl/lt", strconv.FormatInt(item.DenyTtlLt.ValueInt64(), 10))
			}
			if !item.DenyTtlNeq.IsNull() && !item.DenyTtlNeq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/ttl/neq", strconv.FormatInt(item.DenyTtlNeq.ValueInt64(), 10))
			}
			if !item.DenyTtlRangeStart.IsNull() && !item.DenyTtlRangeStart.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/ttl/range/start-value", strconv.FormatInt(item.DenyTtlRangeStart.ValueInt64(), 10))
			}
			if !item.DenyTtlRangeEnd.IsNull() && !item.DenyTtlRangeEnd.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/ttl/range/end-value", strconv.FormatInt(item.DenyTtlRangeEnd.ValueInt64(), 10))
			}
			if !item.DenyFragmentOffsetEq.IsNull() && !item.DenyFragmentOffsetEq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/fragment-offset/eq", strconv.FormatInt(item.DenyFragmentOffsetEq.ValueInt64(), 10))
			}
			if !item.DenyFragmentOffsetGt.IsNull() && !item.DenyFragmentOffsetGt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/fragment-offset/gt", strconv.FormatInt(item.DenyFragmentOffsetGt.ValueInt64(), 10))
			}
			if !item.DenyFragmentOffsetLt.IsNull() && !item.DenyFragmentOffsetLt.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/fragment-offset/lt", strconv.FormatInt(item.DenyFragmentOffsetLt.ValueInt64(), 10))
			}
			if !item.DenyFragmentOffsetNeq.IsNull() && !item.DenyFragmentOffsetNeq.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/fragment-offset/neq", strconv.FormatInt(item.DenyFragmentOffsetNeq.ValueInt64(), 10))
			}
			if !item.DenyFragmentOffsetRangeStart.IsNull() && !item.DenyFragmentOffsetRangeStart.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/fragment-offset/range/start-value", strconv.FormatInt(item.DenyFragmentOffsetRangeStart.ValueInt64(), 10))
			}
			if !item.DenyFragmentOffsetRangeEnd.IsNull() && !item.DenyFragmentOffsetRangeEnd.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/fragment-offset/range/end-value", strconv.FormatInt(item.DenyFragmentOffsetRangeEnd.ValueInt64(), 10))
			}
			if !item.DenyFragments.IsNull() && !item.DenyFragments.IsUnknown() {
				if item.DenyFragments.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/deny/fragments", "")
				}
			}
			if !item.DenyPoliceValue.IsNull() && !item.DenyPoliceValue.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/police/value", strconv.FormatInt(item.DenyPoliceValue.ValueInt64(), 10))
			}
			if !item.DenyPoliceUnit.IsNull() && !item.DenyPoliceUnit.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/police/unit", item.DenyPoliceUnit.ValueString())
			}
			if !item.DenyPolicePeakRate.IsNull() && !item.DenyPolicePeakRate.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/police/peak-rate", strconv.FormatInt(item.DenyPolicePeakRate.ValueInt64(), 10))
			}
			if !item.DenyPolicePeakUnit.IsNull() && !item.DenyPolicePeakUnit.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/police/peak-unit", item.DenyPolicePeakUnit.ValueString())
			}
			if !item.DenyPolicePriority.IsNull() && !item.DenyPolicePriority.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/police/priority", item.DenyPolicePriority.ValueString())
			}
			if !item.DenyDefault.IsNull() && !item.DenyDefault.IsUnknown() {
				if item.DenyDefault.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/deny/default", "")
				}
			}
			if !item.DenyNexthop1Ipv4.IsNull() && !item.DenyNexthop1Ipv4.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/nexthop1/ipv4", item.DenyNexthop1Ipv4.ValueString())
			}
			if !item.DenyNexthop1Track.IsNull() && !item.DenyNexthop1Track.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/nexthop1/track", item.DenyNexthop1Track.ValueString())
			}
			if !item.DenyNexthop1Vrf.IsNull() && !item.DenyNexthop1Vrf.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/nexthop1/vrf", item.DenyNexthop1Vrf.ValueString())
			}
			if !item.DenyNexthop2Ipv4.IsNull() && !item.DenyNexthop2Ipv4.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/nexthop2/ipv4", item.DenyNexthop2Ipv4.ValueString())
			}
			if !item.DenyNexthop2Track.IsNull() && !item.DenyNexthop2Track.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/nexthop2/track", item.DenyNexthop2Track.ValueString())
			}
			if !item.DenyNexthop2Vrf.IsNull() && !item.DenyNexthop2Vrf.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/nexthop2/vrf", item.DenyNexthop2Vrf.ValueString())
			}
			if !item.DenyNexthop3Ipv4.IsNull() && !item.DenyNexthop3Ipv4.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/nexthop3/ipv4", item.DenyNexthop3Ipv4.ValueString())
			}
			if !item.DenyNexthop3Track.IsNull() && !item.DenyNexthop3Track.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/nexthop3/track", item.DenyNexthop3Track.ValueString())
			}
			if !item.DenyNexthop3Vrf.IsNull() && !item.DenyNexthop3Vrf.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/nexthop3/vrf", item.DenyNexthop3Vrf.ValueString())
			}
			if !item.DenyCapture.IsNull() && !item.DenyCapture.IsUnknown() {
				if item.DenyCapture.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/deny/capture", "")
				}
			}
			if !item.DenyLog.IsNull() && !item.DenyLog.IsUnknown() {
				if item.DenyLog.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/deny/log", "")
				}
			}
			if !item.DenyLogInput.IsNull() && !item.DenyLogInput.IsUnknown() {
				if item.DenyLogInput.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/deny/log-input", "")
				}
			}
			if !item.DenySetQosGroup.IsNull() && !item.DenySetQosGroup.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/set/qos-group", strconv.FormatInt(item.DenySetQosGroup.ValueInt64(), 10))
			}
			if !item.DenySetTtl.IsNull() && !item.DenySetTtl.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/set/ttl", strconv.FormatInt(item.DenySetTtl.ValueInt64(), 10))
			}
			if !item.DenyIcmpOff.IsNull() && !item.DenyIcmpOff.IsUnknown() {
				if item.DenyIcmpOff.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/deny/icmp-off", "")
				}
			}
			if !item.DenyIcmpOn.IsNull() && !item.DenyIcmpOn.IsUnknown() {
				if item.DenyIcmpOn.ValueBool() {
					body = helpers.SetFromXPath(body, basePath+"/deny/icmp-on", "")
				}
			}
		}
	}
...
func (data *IPv4AccessList) updateFromBodyXML(ctx context.Context, res xmldot.Result) {
	for i := range data.Sequences {
		...
		if value := helpers.GetFromXPath(r, "sequence-number"); value.Exists() && !data.Sequences[i].SequenceNumber.IsNull() {
			data.Sequences[i].SequenceNumber = types.Int64Value(value.Int())
		} else if data.Sequences[i].SequenceNumber.IsNull() {
			data.Sequences[i].SequenceNumber = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "remark"); value.Exists() && !data.Sequences[i].Remark.IsNull() {
			data.Sequences[i].Remark = types.StringValue(value.String())
		} else if data.Sequences[i].Remark.IsNull() {
			data.Sequences[i].Remark = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/protocol"); value.Exists() && !data.Sequences[i].PermitProtocol.IsNull() {
			data.Sequences[i].PermitProtocol = types.StringValue(value.String())
		} else if data.Sequences[i].PermitProtocol.IsNull() {
			data.Sequences[i].PermitProtocol = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/eq"); value.Exists() && !data.Sequences[i].PermitEq.IsNull() {
			data.Sequences[i].PermitEq = types.StringValue(value.String())
		} else if data.Sequences[i].PermitEq.IsNull() {
			data.Sequences[i].PermitEq = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/range/start-protocol"); value.Exists() && !data.Sequences[i].PermitRangeStartProtocol.IsNull() {
			data.Sequences[i].PermitRangeStartProtocol = types.StringValue(value.String())
		} else if data.Sequences[i].PermitRangeStartProtocol.IsNull() {
			data.Sequences[i].PermitRangeStartProtocol = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/range/end-protocol"); value.Exists() && !data.Sequences[i].PermitRangeEndProtocol.IsNull() {
			data.Sequences[i].PermitRangeEndProtocol = types.StringValue(value.String())
		} else if data.Sequences[i].PermitRangeEndProtocol.IsNull() {
			data.Sequences[i].PermitRangeEndProtocol = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/precedence"); value.Exists() && !data.Sequences[i].PermitPrecedence.IsNull() {
			data.Sequences[i].PermitPrecedence = types.StringValue(value.String())
		} else if data.Sequences[i].PermitPrecedence.IsNull() {
			data.Sequences[i].PermitPrecedence = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/fragment-type"); value.Exists() && !data.Sequences[i].PermitFragmentType.IsNull() {
			data.Sequences[i].PermitFragmentType = types.StringValue(value.String())
		} else if data.Sequences[i].PermitFragmentType.IsNull() {
			data.Sequences[i].PermitFragmentType = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/source/address"); value.Exists() && !data.Sequences[i].PermitSourceAddress.IsNull() {
			data.Sequences[i].PermitSourceAddress = types.StringValue(value.String())
		} else if data.Sequences[i].PermitSourceAddress.IsNull() {
			data.Sequences[i].PermitSourceAddress = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/source/wildcard-mask"); value.Exists() && !data.Sequences[i].PermitSourceWildcardMask.IsNull() {
			data.Sequences[i].PermitSourceWildcardMask = types.StringValue(value.String())
		} else if data.Sequences[i].PermitSourceWildcardMask.IsNull() {
			data.Sequences[i].PermitSourceWildcardMask = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/source/prefix-length"); value.Exists() && !data.Sequences[i].PermitSourcePrefixLength.IsNull() {
			data.Sequences[i].PermitSourcePrefixLength = types.Int64Value(value.Int())
		...
		if value := helpers.GetFromXPath(r, "permit/source/host"); value.Exists() && !data.Sequences[i].PermitSourceHost.IsNull() {
			data.Sequences[i].PermitSourceHost = types.StringValue(value.String())
		} else if data.Sequences[i].PermitSourceHost.IsNull() {
			data.Sequences[i].PermitSourceHost = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/source/net-group"); value.Exists() && !data.Sequences[i].PermitSourceNetGroup.IsNull() {
			data.Sequences[i].PermitSourceNetGroup = types.StringValue(value.String())
		} else if data.Sequences[i].PermitSourceNetGroup.IsNull() {
			data.Sequences[i].PermitSourceNetGroup = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/source/port-group"); value.Exists() && !data.Sequences[i].PermitSourcePortGroup.IsNull() {
			data.Sequences[i].PermitSourcePortGroup = types.StringValue(value.String())
		} else if data.Sequences[i].PermitSourcePortGroup.IsNull() {
			data.Sequences[i].PermitSourcePortGroup = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/source/port/eq"); value.Exists() && !data.Sequences[i].PermitSourcePortEq.IsNull() {
			data.Sequences[i].PermitSourcePortEq = types.StringValue(value.String())
		} else if data.Sequences[i].PermitSourcePortEq.IsNull() {
			data.Sequences[i].PermitSourcePortEq = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/source/port/gt"); value.Exists() && !data.Sequences[i].PermitSourcePortGt.IsNull() {
			data.Sequences[i].PermitSourcePortGt = types.StringValue(value.String())
		} else if data.Sequences[i].PermitSourcePortGt.IsNull() {
			data.Sequences[i].PermitSourcePortGt = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/source/port/lt"); value.Exists() && !data.Sequences[i].PermitSourcePortLt.IsNull() {
			data.Sequences[i].PermitSourcePortLt = types.StringValue(value.String())
		} else if data.Sequences[i].PermitSourcePortLt.IsNull() {
			data.Sequences[i].PermitSourcePortLt = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/source/port/neq"); value.Exists() && !data.Sequences[i].PermitSourcePortNeq.IsNull() {
			data.Sequences[i].PermitSourcePortNeq = types.StringValue(value.String())
		} else if data.Sequences[i].PermitSourcePortNeq.IsNull() {
			data.Sequences[i].PermitSourcePortNeq = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/source/port/range/start-value"); value.Exists() && !data.Sequences[i].PermitSourcePortRangeStart.IsNull() {
			data.Sequences[i].PermitSourcePortRangeStart = types.StringValue(value.String())
		} else if data.Sequences[i].PermitSourcePortRangeStart.IsNull() {
			data.Sequences[i].PermitSourcePortRangeStart = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/source/port/range/end-value"); value.Exists() && !data.Sequences[i].PermitSourcePortRangeEnd.IsNull() {
			data.Sequences[i].PermitSourcePortRangeEnd = types.StringValue(value.String())
		} else if data.Sequences[i].PermitSourcePortRangeEnd.IsNull() {
			data.Sequences[i].PermitSourcePortRangeEnd = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/destination/address"); value.Exists() && !data.Sequences[i].PermitDestinationAddress.IsNull() {
			data.Sequences[i].PermitDestinationAddress = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDestinationAddress.IsNull() {
			data.Sequences[i].PermitDestinationAddress = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/destination/wildcard-mask"); value.Exists() && !data.Sequences[i].PermitDestinationWildcardMask.IsNull() {
			data.Sequences[i].PermitDestinationWildcardMask = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDestinationWildcardMask.IsNull() {
			data.Sequences[i].PermitDestinationWildcardMask = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/destination/prefix-length"); value.Exists() && !data.Sequences[i].PermitDestinationPrefixLength.IsNull() {
			data.Sequences[i].PermitDestinationPrefixLength = types.Int64Value(value.Int())
		...
		if value := helpers.GetFromXPath(r, "permit/destination/host"); value.Exists() && !data.Sequences[i].PermitDestinationHost.IsNull() {
			data.Sequences[i].PermitDestinationHost = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDestinationHost.IsNull() {
			data.Sequences[i].PermitDestinationHost = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/destination/net-group"); value.Exists() && !data.Sequences[i].PermitDestinationNetGroup.IsNull() {
			data.Sequences[i].PermitDestinationNetGroup = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDestinationNetGroup.IsNull() {
			data.Sequences[i].PermitDestinationNetGroup = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/destination/port-group"); value.Exists() && !data.Sequences[i].PermitDestinationPortGroup.IsNull() {
			data.Sequences[i].PermitDestinationPortGroup = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDestinationPortGroup.IsNull() {
			data.Sequences[i].PermitDestinationPortGroup = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/destination/port/eq"); value.Exists() && !data.Sequences[i].PermitDestinationPortEq.IsNull() {
			data.Sequences[i].PermitDestinationPortEq = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDestinationPortEq.IsNull() {
			data.Sequences[i].PermitDestinationPortEq = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/destination/port/gt"); value.Exists() && !data.Sequences[i].PermitDestinationPortGt.IsNull() {
			data.Sequences[i].PermitDestinationPortGt = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDestinationPortGt.IsNull() {
			data.Sequences[i].PermitDestinationPortGt = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/destination/port/lt"); value.Exists() && !data.Sequences[i].PermitDestinationPortLt.IsNull() {
			data.Sequences[i].PermitDestinationPortLt = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDestinationPortLt.IsNull() {
			data.Sequences[i].PermitDestinationPortLt = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/destination/port/neq"); value.Exists() && !data.Sequences[i].PermitDestinationPortNeq.IsNull() {
			data.Sequences[i].PermitDestinationPortNeq = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDestinationPortNeq.IsNull() {
			data.Sequences[i].PermitDestinationPortNeq = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/destination/port/range/start-value"); value.Exists() && !data.Sequences[i].PermitDestinationPortRangeStart.IsNull() {
			data.Sequences[i].PermitDestinationPortRangeStart = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDestinationPortRangeStart.IsNull() {
			data.Sequences[i].PermitDestinationPortRangeStart = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/destination/port/range/end-value"); value.Exists() && !data.Sequences[i].PermitDestinationPortRangeEnd.IsNull() {
			data.Sequences[i].PermitDestinationPortRangeEnd = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDestinationPortRangeEnd.IsNull() {
			data.Sequences[i].PermitDestinationPortRangeEnd = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/icmp/message-type-name"); value.Exists() && !data.Sequences[i].PermitIcmpMessageTypeName.IsNull() {
			data.Sequences[i].PermitIcmpMessageTypeName = types.StringValue(value.String())
		} else if data.Sequences[i].PermitIcmpMessageTypeName.IsNull() {
			data.Sequences[i].PermitIcmpMessageTypeName = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/icmp/message-type"); value.Exists() && !data.Sequences[i].PermitIcmpMessageType.IsNull() {
			data.Sequences[i].PermitIcmpMessageType = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitIcmpMessageType.IsNull() {
			data.Sequences[i].PermitIcmpMessageType = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/icmp/message-code"); value.Exists() && !data.Sequences[i].PermitIcmpMessageCode.IsNull() {
			data.Sequences[i].PermitIcmpMessageCode = types.Int64Value(value.Int())
		...
		if value := helpers.GetFromXPath(r, "permit/dscp/dscp-value"); value.Exists() && !data.Sequences[i].PermitDscp.IsNull() {
			data.Sequences[i].PermitDscp = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDscp.IsNull() {
			data.Sequences[i].PermitDscp = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/dscp/eq"); value.Exists() && !data.Sequences[i].PermitDscpEq.IsNull() {
			data.Sequences[i].PermitDscpEq = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDscpEq.IsNull() {
			data.Sequences[i].PermitDscpEq = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/dscp/gt"); value.Exists() && !data.Sequences[i].PermitDscpGt.IsNull() {
			data.Sequences[i].PermitDscpGt = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDscpGt.IsNull() {
			data.Sequences[i].PermitDscpGt = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/dscp/lt"); value.Exists() && !data.Sequences[i].PermitDscpLt.IsNull() {
			data.Sequences[i].PermitDscpLt = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDscpLt.IsNull() {
			data.Sequences[i].PermitDscpLt = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/dscp/neq"); value.Exists() && !data.Sequences[i].PermitDscpNeq.IsNull() {
			data.Sequences[i].PermitDscpNeq = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDscpNeq.IsNull() {
			data.Sequences[i].PermitDscpNeq = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/dscp/range/start-value"); value.Exists() && !data.Sequences[i].PermitDscpRangeStart.IsNull() {
			data.Sequences[i].PermitDscpRangeStart = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDscpRangeStart.IsNull() {
			data.Sequences[i].PermitDscpRangeStart = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/dscp/range/end-value"); value.Exists() && !data.Sequences[i].PermitDscpRangeEnd.IsNull() {
			data.Sequences[i].PermitDscpRangeEnd = types.StringValue(value.String())
		} else if data.Sequences[i].PermitDscpRangeEnd.IsNull() {
			data.Sequences[i].PermitDscpRangeEnd = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/packet-length/eq"); value.Exists() && !data.Sequences[i].PermitPacketLengthEq.IsNull() {
			data.Sequences[i].PermitPacketLengthEq = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitPacketLengthEq.IsNull() {
			data.Sequences[i].PermitPacketLengthEq = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/packet-length/gt"); value.Exists() && !data.Sequences[i].PermitPacketLengthGt.IsNull() {
			data.Sequences[i].PermitPacketLengthGt = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitPacketLengthGt.IsNull() {
			data.Sequences[i].PermitPacketLengthGt = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/packet-length/lt"); value.Exists() && !data.Sequences[i].PermitPacketLengthLt.IsNull() {
			data.Sequences[i].PermitPacketLengthLt = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitPacketLengthLt.IsNull() {
			data.Sequences[i].PermitPacketLengthLt = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/packet-length/neq"); value.Exists() && !data.Sequences[i].PermitPacketLengthNeq.IsNull() {
			data.Sequences[i].PermitPacketLengthNeq = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitPacketLengthNeq.IsNull() {
			data.Sequences[i].PermitPacketLengthNeq = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/packet-length/range/start-value"); value.Exists() && !data.Sequences[i].PermitPacketLengthRangeStart.IsNull() {
			data.Sequences[i].PermitPacketLengthRangeStart = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitPacketLengthRangeStart.IsNull() {
			data.Sequences[i].PermitPacketLengthRangeStart = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/packet-length/range/end-value"); value.Exists() && !data.Sequences[i].PermitPacketLengthRangeEnd.IsNull() {
			data.Sequences[i].PermitPacketLengthRangeEnd = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitPacketLengthRangeEnd.IsNull() {
			data.Sequences[i].PermitPacketLengthRangeEnd = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/ttl/eq"); value.Exists() && !data.Sequences[i].PermitTtlEq.IsNull() {
			data.Sequences[i].PermitTtlEq = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitTtlEq.IsNull() {
			data.Sequences[i].PermitTtlEq = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/ttl/gt"); value.Exists() && !data.Sequences[i].PermitTtlGt.IsNull() {
			data.Sequences[i].PermitTtlGt = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitTtlGt.IsNull() {
			data.Sequences[i].PermitTtlGt = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/ttl/lt"); value.Exists() && !data.Sequences[i].PermitTtlLt.IsNull() {
			data.Sequences[i].PermitTtlLt = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitTtlLt.IsNull() {
			data.Sequences[i].PermitTtlLt = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/ttl/neq"); value.Exists() && !data.Sequences[i].PermitTtlNeq.IsNull() {
			data.Sequences[i].PermitTtlNeq = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitTtlNeq.IsNull() {
			data.Sequences[i].PermitTtlNeq = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/ttl/range/start-value"); value.Exists() && !data.Sequences[i].PermitTtlRangeStart.IsNull() {
			data.Sequences[i].PermitTtlRangeStart = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitTtlRangeStart.IsNull() {
			data.Sequences[i].PermitTtlRangeStart = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/ttl/range/end-value"); value.Exists() && !data.Sequences[i].PermitTtlRangeEnd.IsNull() {
			data.Sequences[i].PermitTtlRangeEnd = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitTtlRangeEnd.IsNull() {
			data.Sequences[i].PermitTtlRangeEnd = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/fragment-offset/eq"); value.Exists() && !data.Sequences[i].PermitFragmentOffsetEq.IsNull() {
			data.Sequences[i].PermitFragmentOffsetEq = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitFragmentOffsetEq.IsNull() {
			data.Sequences[i].PermitFragmentOffsetEq = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/fragment-offset/gt"); value.Exists() && !data.Sequences[i].PermitFragmentOffsetGt.IsNull() {
			data.Sequences[i].PermitFragmentOffsetGt = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitFragmentOffsetGt.IsNull() {
			data.Sequences[i].PermitFragmentOffsetGt = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/fragment-offset/lt"); value.Exists() && !data.Sequences[i].PermitFragmentOffsetLt.IsNull() {
			data.Sequences[i].PermitFragmentOffsetLt = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitFragmentOffsetLt.IsNull() {
			data.Sequences[i].PermitFragmentOffsetLt = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/fragment-offset/neq"); value.Exists() && !data.Sequences[i].PermitFragmentOffsetNeq.IsNull() {
			data.Sequences[i].PermitFragmentOffsetNeq = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitFragmentOffsetNeq.IsNull() {
			data.Sequences[i].PermitFragmentOffsetNeq = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/fragment-offset/range/start-value"); value.Exists() && !data.Sequences[i].PermitFragmentOffsetRangeStart.IsNull() {
			data.Sequences[i].PermitFragmentOffsetRangeStart = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitFragmentOffsetRangeStart.IsNull() {
			data.Sequences[i].PermitFragmentOffsetRangeStart = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/fragment-offset/range/end-value"); value.Exists() && !data.Sequences[i].PermitFragmentOffsetRangeEnd.IsNull() {
			data.Sequences[i].PermitFragmentOffsetRangeEnd = types.Int64Value(value.Int())
		...
		if value := helpers.GetFromXPath(r, "permit/police/value"); value.Exists() && !data.Sequences[i].PermitPoliceValue.IsNull() {
			data.Sequences[i].PermitPoliceValue = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitPoliceValue.IsNull() {
			data.Sequences[i].PermitPoliceValue = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/police/unit"); value.Exists() && !data.Sequences[i].PermitPoliceUnit.IsNull() {
			data.Sequences[i].PermitPoliceUnit = types.StringValue(value.String())
		} else if data.Sequences[i].PermitPoliceUnit.IsNull() {
			data.Sequences[i].PermitPoliceUnit = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/police/peak-rate"); value.Exists() && !data.Sequences[i].PermitPolicePeakRate.IsNull() {
			data.Sequences[i].PermitPolicePeakRate = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitPolicePeakRate.IsNull() {
			data.Sequences[i].PermitPolicePeakRate = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/police/peak-unit"); value.Exists() && !data.Sequences[i].PermitPolicePeakUnit.IsNull() {
			data.Sequences[i].PermitPolicePeakUnit = types.StringValue(value.String())
		} else if data.Sequences[i].PermitPolicePeakUnit.IsNull() {
			data.Sequences[i].PermitPolicePeakUnit = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/police/priority"); value.Exists() && !data.Sequences[i].PermitPolicePriority.IsNull() {
			data.Sequences[i].PermitPolicePriority = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "permit/nexthop1/ipv4"); value.Exists() && !data.Sequences[i].PermitNexthop1Ipv4.IsNull() {
			data.Sequences[i].PermitNexthop1Ipv4 = types.StringValue(value.String())
		} else if data.Sequences[i].PermitNexthop1Ipv4.IsNull() {
			data.Sequences[i].PermitNexthop1Ipv4 = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/nexthop1/track"); value.Exists() && !data.Sequences[i].PermitNexthop1Track.IsNull() {
			data.Sequences[i].PermitNexthop1Track = types.StringValue(value.String())
		} else if data.Sequences[i].PermitNexthop1Track.IsNull() {
			data.Sequences[i].PermitNexthop1Track = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/nexthop1/vrf"); value.Exists() && !data.Sequences[i].PermitNexthop1Vrf.IsNull() {
			data.Sequences[i].PermitNexthop1Vrf = types.StringValue(value.String())
		} else if data.Sequences[i].PermitNexthop1Vrf.IsNull() {
			data.Sequences[i].PermitNexthop1Vrf = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/nexthop2/ipv4"); value.Exists() && !data.Sequences[i].PermitNexthop2Ipv4.IsNull() {
			data.Sequences[i].PermitNexthop2Ipv4 = types.StringValue(value.String())
		} else if data.Sequences[i].PermitNexthop2Ipv4.IsNull() {
			data.Sequences[i].PermitNexthop2Ipv4 = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/nexthop2/track"); value.Exists() && !data.Sequences[i].PermitNexthop2Track.IsNull() {
			data.Sequences[i].PermitNexthop2Track = types.StringValue(value.String())
		} else if data.Sequences[i].PermitNexthop2Track.IsNull() {
			data.Sequences[i].PermitNexthop2Track = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/nexthop2/vrf"); value.Exists() && !data.Sequences[i].PermitNexthop2Vrf.IsNull() {
			data.Sequences[i].PermitNexthop2Vrf = types.StringValue(value.String())
		} else if data.Sequences[i].PermitNexthop2Vrf.IsNull() {
			data.Sequences[i].PermitNexthop2Vrf = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/nexthop3/ipv4"); value.Exists() && !data.Sequences[i].PermitNexthop3Ipv4.IsNull() {
			data.Sequences[i].PermitNexthop3Ipv4 = types.StringValue(value.String())
		} else if data.Sequences[i].PermitNexthop3Ipv4.IsNull() {
			data.Sequences[i].PermitNexthop3Ipv4 = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/nexthop3/track"); value.Exists() && !data.Sequences[i].PermitNexthop3Track.IsNull() {
			data.Sequences[i].PermitNexthop3Track = types.StringValue(value.String())
		} else if data.Sequences[i].PermitNexthop3Track.IsNull() {
			data.Sequences[i].PermitNexthop3Track = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "permit/nexthop3/vrf"); value.Exists() && !data.Sequences[i].PermitNexthop3Vrf.IsNull() {
			data.Sequences[i].PermitNexthop3Vrf = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "permit/counter"); value.Exists() && !data.Sequences[i].PermitCounter.IsNull() {
			data.Sequences[i].PermitCounter = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "permit/set/qos-group"); value.Exists() && !data.Sequences[i].PermitSetQosGroup.IsNull() {
			data.Sequences[i].PermitSetQosGroup = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitSetQosGroup.IsNull() {
			data.Sequences[i].PermitSetQosGroup = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "permit/set/ttl"); value.Exists() && !data.Sequences[i].PermitSetTtl.IsNull() {
			data.Sequences[i].PermitSetTtl = types.Int64Value(value.Int())
		} else if data.Sequences[i].PermitSetTtl.IsNull() {
			data.Sequences[i].PermitSetTtl = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/protocol"); value.Exists() && !data.Sequences[i].DenyProtocol.IsNull() {
			data.Sequences[i].DenyProtocol = types.StringValue(value.String())
		} else if data.Sequences[i].DenyProtocol.IsNull() {
			data.Sequences[i].DenyProtocol = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/eq"); value.Exists() && !data.Sequences[i].DenyEq.IsNull() {
			data.Sequences[i].DenyEq = types.StringValue(value.String())
		} else if data.Sequences[i].DenyEq.IsNull() {
			data.Sequences[i].DenyEq = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/precedence"); value.Exists() && !data.Sequences[i].DenyPrecedence.IsNull() {
			data.Sequences[i].DenyPrecedence = types.StringValue(value.String())
		} else if data.Sequences[i].DenyPrecedence.IsNull() {
			data.Sequences[i].DenyPrecedence = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/fragment-type"); value.Exists() && !data.Sequences[i].DenyFragmentType.IsNull() {
			data.Sequences[i].DenyFragmentType = types.StringValue(value.String())
		} else if data.Sequences[i].DenyFragmentType.IsNull() {
			data.Sequences[i].DenyFragmentType = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/counter"); value.Exists() && !data.Sequences[i].DenyCounter.IsNull() {
			data.Sequences[i].DenyCounter = types.StringValue(value.String())
		} else if data.Sequences[i].DenyCounter.IsNull() {
			data.Sequences[i].DenyCounter = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/range/start-protocol"); value.Exists() && !data.Sequences[i].DenyRangeStartProtocol.IsNull() {
			data.Sequences[i].DenyRangeStartProtocol = types.StringValue(value.String())
		} else if data.Sequences[i].DenyRangeStartProtocol.IsNull() {
			data.Sequences[i].DenyRangeStartProtocol = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/range/end-protocol"); value.Exists() && !data.Sequences[i].DenyRangeEndProtocol.IsNull() {
			data.Sequences[i].DenyRangeEndProtocol = types.StringValue(value.String())
		} else if data.Sequences[i].DenyRangeEndProtocol.IsNull() {
			data.Sequences[i].DenyRangeEndProtocol = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/source/address"); value.Exists() && !data.Sequences[i].DenySourceAddress.IsNull() {
			data.Sequences[i].DenySourceAddress = types.StringValue(value.String())
		} else if data.Sequences[i].DenySourceAddress.IsNull() {
			data.Sequences[i].DenySourceAddress = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/source/wildcard-mask"); value.Exists() && !data.Sequences[i].DenySourceWildcardMask.IsNull() {
			data.Sequences[i].DenySourceWildcardMask = types.StringValue(value.String())
		} else if data.Sequences[i].DenySourceWildcardMask.IsNull() {
			data.Sequences[i].DenySourceWildcardMask = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/source/prefix-length"); value.Exists() && !data.Sequences[i].DenySourcePrefixLength.IsNull() {
			data.Sequences[i].DenySourcePrefixLength = types.Int64Value(value.Int())
		...
		if value := helpers.GetFromXPath(r, "deny/source/host"); value.Exists() && !data.Sequences[i].DenySourceHost.IsNull() {
			data.Sequences[i].DenySourceHost = types.StringValue(value.String())
		} else if data.Sequences[i].DenySourceHost.IsNull() {
			data.Sequences[i].DenySourceHost = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/source/net-group"); value.Exists() && !data.Sequences[i].DenySourceNetGroup.IsNull() {
			data.Sequences[i].DenySourceNetGroup = types.StringValue(value.String())
		} else if data.Sequences[i].DenySourceNetGroup.IsNull() {
			data.Sequences[i].DenySourceNetGroup = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/source/port-group"); value.Exists() && !data.Sequences[i].DenySourcePortGroup.IsNull() {
			data.Sequences[i].DenySourcePortGroup = types.StringValue(value.String())
		} else if data.Sequences[i].DenySourcePortGroup.IsNull() {
			data.Sequences[i].DenySourcePortGroup = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/source/port/eq"); value.Exists() && !data.Sequences[i].DenySourcePortEq.IsNull() {
			data.Sequences[i].DenySourcePortEq = types.StringValue(value.String())
		} else if data.Sequences[i].DenySourcePortEq.IsNull() {
			data.Sequences[i].DenySourcePortEq = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/source/port/gt"); value.Exists() && !data.Sequences[i].DenySourcePortGt.IsNull() {
			data.Sequences[i].DenySourcePortGt = types.StringValue(value.String())
		} else if data.Sequences[i].DenySourcePortGt.IsNull() {
			data.Sequences[i].DenySourcePortGt = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/source/port/lt"); value.Exists() && !data.Sequences[i].DenySourcePortLt.IsNull() {
			data.Sequences[i].DenySourcePortLt = types.StringValue(value.String())
		} else if data.Sequences[i].DenySourcePortLt.IsNull() {
			data.Sequences[i].DenySourcePortLt = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/source/port/neq"); value.Exists() && !data.Sequences[i].DenySourcePortNeq.IsNull() {
			data.Sequences[i].DenySourcePortNeq = types.StringValue(value.String())
		} else if data.Sequences[i].DenySourcePortNeq.IsNull() {
			data.Sequences[i].DenySourcePortNeq = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/source/port/range/start-value"); value.Exists() && !data.Sequences[i].DenySourcePortRangeStart.IsNull() {
			data.Sequences[i].DenySourcePortRangeStart = types.StringValue(value.String())
		} else if data.Sequences[i].DenySourcePortRangeStart.IsNull() {
			data.Sequences[i].DenySourcePortRangeStart = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/source/port/range/end-value"); value.Exists() && !data.Sequences[i].DenySourcePortRangeEnd.IsNull() {
			data.Sequences[i].DenySourcePortRangeEnd = types.StringValue(value.String())
		} else if data.Sequences[i].DenySourcePortRangeEnd.IsNull() {
			data.Sequences[i].DenySourcePortRangeEnd = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/destination/address"); value.Exists() && !data.Sequences[i].DenyDestinationAddress.IsNull() {
			data.Sequences[i].DenyDestinationAddress = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDestinationAddress.IsNull() {
			data.Sequences[i].DenyDestinationAddress = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/destination/wildcard-mask"); value.Exists() && !data.Sequences[i].DenyDestinationWildcardMask.IsNull() {
			data.Sequences[i].DenyDestinationWildcardMask = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDestinationWildcardMask.IsNull() {
			data.Sequences[i].DenyDestinationWildcardMask = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/destination/prefix-length"); value.Exists() && !data.Sequences[i].DenyDestinationPrefixLength.IsNull() {
			data.Sequences[i].DenyDestinationPrefixLength = types.Int64Value(value.Int())
		...
		if value := helpers.GetFromXPath(r, "deny/destination/host"); value.Exists() && !data.Sequences[i].DenyDestinationHost.IsNull() {
			data.Sequences[i].DenyDestinationHost = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDestinationHost.IsNull() {
			data.Sequences[i].DenyDestinationHost = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/destination/net-group"); value.Exists() && !data.Sequences[i].DenyDestinationNetGroup.IsNull() {
			data.Sequences[i].DenyDestinationNetGroup = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDestinationNetGroup.IsNull() {
			data.Sequences[i].DenyDestinationNetGroup = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/destination/port-group"); value.Exists() && !data.Sequences[i].DenyDestinationPortGroup.IsNull() {
			data.Sequences[i].DenyDestinationPortGroup = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDestinationPortGroup.IsNull() {
			data.Sequences[i].DenyDestinationPortGroup = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/destination/port/eq"); value.Exists() && !data.Sequences[i].DenyDestinationPortEq.IsNull() {
			data.Sequences[i].DenyDestinationPortEq = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDestinationPortEq.IsNull() {
			data.Sequences[i].DenyDestinationPortEq = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/destination/port/gt"); value.Exists() && !data.Sequences[i].DenyDestinationPortGt.IsNull() {
			data.Sequences[i].DenyDestinationPortGt = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDestinationPortGt.IsNull() {
			data.Sequences[i].DenyDestinationPortGt = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/destination/port/lt"); value.Exists() && !data.Sequences[i].DenyDestinationPortLt.IsNull() {
			data.Sequences[i].DenyDestinationPortLt = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDestinationPortLt.IsNull() {
			data.Sequences[i].DenyDestinationPortLt = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/destination/port/neq"); value.Exists() && !data.Sequences[i].DenyDestinationPortNeq.IsNull() {
			data.Sequences[i].DenyDestinationPortNeq = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDestinationPortNeq.IsNull() {
			data.Sequences[i].DenyDestinationPortNeq = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/destination/port/range/start-value"); value.Exists() && !data.Sequences[i].DenyDestinationPortRangeStart.IsNull() {
			data.Sequences[i].DenyDestinationPortRangeStart = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDestinationPortRangeStart.IsNull() {
			data.Sequences[i].DenyDestinationPortRangeStart = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/destination/port/range/end-value"); value.Exists() && !data.Sequences[i].DenyDestinationPortRangeEnd.IsNull() {
			data.Sequences[i].DenyDestinationPortRangeEnd = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDestinationPortRangeEnd.IsNull() {
			data.Sequences[i].DenyDestinationPortRangeEnd = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/icmp/message-type-name"); value.Exists() && !data.Sequences[i].DenyIcmpMessageTypeName.IsNull() {
			data.Sequences[i].DenyIcmpMessageTypeName = types.StringValue(value.String())
		} else if data.Sequences[i].DenyIcmpMessageTypeName.IsNull() {
			data.Sequences[i].DenyIcmpMessageTypeName = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/icmp/message-type"); value.Exists() && !data.Sequences[i].DenyIcmpMessageType.IsNull() {
			data.Sequences[i].DenyIcmpMessageType = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyIcmpMessageType.IsNull() {
			data.Sequences[i].DenyIcmpMessageType = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/icmp/message-code"); value.Exists() && !data.Sequences[i].DenyIcmpMessageCode.IsNull() {
			data.Sequences[i].DenyIcmpMessageCode = types.Int64Value(value.Int())
		...
		if value := helpers.GetFromXPath(r, "deny/dscp/dscp-value"); value.Exists() && !data.Sequences[i].DenyDscp.IsNull() {
			data.Sequences[i].DenyDscp = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDscp.IsNull() {
			data.Sequences[i].DenyDscp = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/dscp/eq"); value.Exists() && !data.Sequences[i].DenyDscpEq.IsNull() {
			data.Sequences[i].DenyDscpEq = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDscpEq.IsNull() {
			data.Sequences[i].DenyDscpEq = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/dscp/gt"); value.Exists() && !data.Sequences[i].DenyDscpGt.IsNull() {
			data.Sequences[i].DenyDscpGt = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDscpGt.IsNull() {
			data.Sequences[i].DenyDscpGt = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/dscp/lt"); value.Exists() && !data.Sequences[i].DenyDscpLt.IsNull() {
			data.Sequences[i].DenyDscpLt = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDscpLt.IsNull() {
			data.Sequences[i].DenyDscpLt = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/dscp/neq"); value.Exists() && !data.Sequences[i].DenyDscpNeq.IsNull() {
			data.Sequences[i].DenyDscpNeq = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDscpNeq.IsNull() {
			data.Sequences[i].DenyDscpNeq = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/dscp/range/start-value"); value.Exists() && !data.Sequences[i].DenyDscpRangeStart.IsNull() {
			data.Sequences[i].DenyDscpRangeStart = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDscpRangeStart.IsNull() {
			data.Sequences[i].DenyDscpRangeStart = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/dscp/range/end-value"); value.Exists() && !data.Sequences[i].DenyDscpRangeEnd.IsNull() {
			data.Sequences[i].DenyDscpRangeEnd = types.StringValue(value.String())
		} else if data.Sequences[i].DenyDscpRangeEnd.IsNull() {
			data.Sequences[i].DenyDscpRangeEnd = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/packet-length/eq"); value.Exists() && !data.Sequences[i].DenyPacketLengthEq.IsNull() {
			data.Sequences[i].DenyPacketLengthEq = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyPacketLengthEq.IsNull() {
			data.Sequences[i].DenyPacketLengthEq = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/packet-length/gt"); value.Exists() && !data.Sequences[i].DenyPacketLengthGt.IsNull() {
			data.Sequences[i].DenyPacketLengthGt = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyPacketLengthGt.IsNull() {
			data.Sequences[i].DenyPacketLengthGt = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/packet-length/lt"); value.Exists() && !data.Sequences[i].DenyPacketLengthLt.IsNull() {
			data.Sequences[i].DenyPacketLengthLt = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyPacketLengthLt.IsNull() {
			data.Sequences[i].DenyPacketLengthLt = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/packet-length/neq"); value.Exists() && !data.Sequences[i].DenyPacketLengthNeq.IsNull() {
			data.Sequences[i].DenyPacketLengthNeq = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyPacketLengthNeq.IsNull() {
			data.Sequences[i].DenyPacketLengthNeq = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/packet-length/range/start-value"); value.Exists() && !data.Sequences[i].DenyPacketLengthRangeStart.IsNull() {
			data.Sequences[i].DenyPacketLengthRangeStart = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyPacketLengthRangeStart.IsNull() {
			data.Sequences[i].DenyPacketLengthRangeStart = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/packet-length/range/end-value"); value.Exists() && !data.Sequences[i].DenyPacketLengthRangeEnd.IsNull() {
			data.Sequences[i].DenyPacketLengthRangeEnd = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyPacketLengthRangeEnd.IsNull() {
			data.Sequences[i].DenyPacketLengthRangeEnd = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/ttl/eq"); value.Exists() && !data.Sequences[i].DenyTtlEq.IsNull() {
			data.Sequences[i].DenyTtlEq = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyTtlEq.IsNull() {
			data.Sequences[i].DenyTtlEq = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/ttl/gt"); value.Exists() && !data.Sequences[i].DenyTtlGt.IsNull() {
			data.Sequences[i].DenyTtlGt = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyTtlGt.IsNull() {
			data.Sequences[i].DenyTtlGt = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/ttl/lt"); value.Exists() && !data.Sequences[i].DenyTtlLt.IsNull() {
			data.Sequences[i].DenyTtlLt = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyTtlLt.IsNull() {
			data.Sequences[i].DenyTtlLt = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/ttl/neq"); value.Exists() && !data.Sequences[i].DenyTtlNeq.IsNull() {
			data.Sequences[i].DenyTtlNeq = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyTtlNeq.IsNull() {
			data.Sequences[i].DenyTtlNeq = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/ttl/range/start-value"); value.Exists() && !data.Sequences[i].DenyTtlRangeStart.IsNull() {
			data.Sequences[i].DenyTtlRangeStart = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyTtlRangeStart.IsNull() {
			data.Sequences[i].DenyTtlRangeStart = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/ttl/range/end-value"); value.Exists() && !data.Sequences[i].DenyTtlRangeEnd.IsNull() {
			data.Sequences[i].DenyTtlRangeEnd = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyTtlRangeEnd.IsNull() {
			data.Sequences[i].DenyTtlRangeEnd = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/fragment-offset/eq"); value.Exists() && !data.Sequences[i].DenyFragmentOffsetEq.IsNull() {
			data.Sequences[i].DenyFragmentOffsetEq = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyFragmentOffsetEq.IsNull() {
			data.Sequences[i].DenyFragmentOffsetEq = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/fragment-offset/gt"); value.Exists() && !data.Sequences[i].DenyFragmentOffsetGt.IsNull() {
			data.Sequences[i].DenyFragmentOffsetGt = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyFragmentOffsetGt.IsNull() {
			data.Sequences[i].DenyFragmentOffsetGt = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/fragment-offset/lt"); value.Exists() && !data.Sequences[i].DenyFragmentOffsetLt.IsNull() {
			data.Sequences[i].DenyFragmentOffsetLt = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyFragmentOffsetLt.IsNull() {
			data.Sequences[i].DenyFragmentOffsetLt = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/fragment-offset/neq"); value.Exists() && !data.Sequences[i].DenyFragmentOffsetNeq.IsNull() {
			data.Sequences[i].DenyFragmentOffsetNeq = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyFragmentOffsetNeq.IsNull() {
			data.Sequences[i].DenyFragmentOffsetNeq = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/fragment-offset/range/start-value"); value.Exists() && !data.Sequences[i].DenyFragmentOffsetRangeStart.IsNull() {
			data.Sequences[i].DenyFragmentOffsetRangeStart = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyFragmentOffsetRangeStart.IsNull() {
			data.Sequences[i].DenyFragmentOffsetRangeStart = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/fragment-offset/range/end-value"); value.Exists() && !data.Sequences[i].DenyFragmentOffsetRangeEnd.IsNull() {
			data.Sequences[i].DenyFragmentOffsetRangeEnd = types.Int64Value(value.Int())
		...
		if value := helpers.GetFromXPath(r, "deny/police/value"); value.Exists() && !data.Sequences[i].DenyPoliceValue.IsNull() {
			data.Sequences[i].DenyPoliceValue = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyPoliceValue.IsNull() {
			data.Sequences[i].DenyPoliceValue = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/police/unit"); value.Exists() && !data.Sequences[i].DenyPoliceUnit.IsNull() {
			data.Sequences[i].DenyPoliceUnit = types.StringValue(value.String())
		} else if data.Sequences[i].DenyPoliceUnit.IsNull() {
			data.Sequences[i].DenyPoliceUnit = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/police/peak-rate"); value.Exists() && !data.Sequences[i].DenyPolicePeakRate.IsNull() {
			data.Sequences[i].DenyPolicePeakRate = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenyPolicePeakRate.IsNull() {
			data.Sequences[i].DenyPolicePeakRate = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/police/peak-unit"); value.Exists() && !data.Sequences[i].DenyPolicePeakUnit.IsNull() {
			data.Sequences[i].DenyPolicePeakUnit = types.StringValue(value.String())
		} else if data.Sequences[i].DenyPolicePeakUnit.IsNull() {
			data.Sequences[i].DenyPolicePeakUnit = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/police/priority"); value.Exists() && !data.Sequences[i].DenyPolicePriority.IsNull() {
			data.Sequences[i].DenyPolicePriority = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "deny/nexthop1/ipv4"); value.Exists() && !data.Sequences[i].DenyNexthop1Ipv4.IsNull() {
			data.Sequences[i].DenyNexthop1Ipv4 = types.StringValue(value.String())
		} else if data.Sequences[i].DenyNexthop1Ipv4.IsNull() {
			data.Sequences[i].DenyNexthop1Ipv4 = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/nexthop1/track"); value.Exists() && !data.Sequences[i].DenyNexthop1Track.IsNull() {
			data.Sequences[i].DenyNexthop1Track = types.StringValue(value.String())
		} else if data.Sequences[i].DenyNexthop1Track.IsNull() {
			data.Sequences[i].DenyNexthop1Track = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/nexthop1/vrf"); value.Exists() && !data.Sequences[i].DenyNexthop1Vrf.IsNull() {
			data.Sequences[i].DenyNexthop1Vrf = types.StringValue(value.String())
		} else if data.Sequences[i].DenyNexthop1Vrf.IsNull() {
			data.Sequences[i].DenyNexthop1Vrf = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/nexthop2/ipv4"); value.Exists() && !data.Sequences[i].DenyNexthop2Ipv4.IsNull() {
			data.Sequences[i].DenyNexthop2Ipv4 = types.StringValue(value.String())
		} else if data.Sequences[i].DenyNexthop2Ipv4.IsNull() {
			data.Sequences[i].DenyNexthop2Ipv4 = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/nexthop2/track"); value.Exists() && !data.Sequences[i].DenyNexthop2Track.IsNull() {
			data.Sequences[i].DenyNexthop2Track = types.StringValue(value.String())
		} else if data.Sequences[i].DenyNexthop2Track.IsNull() {
			data.Sequences[i].DenyNexthop2Track = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/nexthop2/vrf"); value.Exists() && !data.Sequences[i].DenyNexthop2Vrf.IsNull() {
			data.Sequences[i].DenyNexthop2Vrf = types.StringValue(value.String())
		} else if data.Sequences[i].DenyNexthop2Vrf.IsNull() {
			data.Sequences[i].DenyNexthop2Vrf = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/nexthop3/ipv4"); value.Exists() && !data.Sequences[i].DenyNexthop3Ipv4.IsNull() {
			data.Sequences[i].DenyNexthop3Ipv4 = types.StringValue(value.String())
		} else if data.Sequences[i].DenyNexthop3Ipv4.IsNull() {
			data.Sequences[i].DenyNexthop3Ipv4 = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/nexthop3/track"); value.Exists() && !data.Sequences[i].DenyNexthop3Track.IsNull() {
			data.Sequences[i].DenyNexthop3Track = types.StringValue(value.String())
		} else if data.Sequences[i].DenyNexthop3Track.IsNull() {
			data.Sequences[i].DenyNexthop3Track = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "deny/nexthop3/vrf"); value.Exists() && !data.Sequences[i].DenyNexthop3Vrf.IsNull() {
			data.Sequences[i].DenyNexthop3Vrf = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "deny/set/qos-group"); value.Exists() && !data.Sequences[i].DenySetQosGroup.IsNull() {
			data.Sequences[i].DenySetQosGroup = types.Int64Value(value.Int())
		} else if data.Sequences[i].DenySetQosGroup.IsNull() {
			data.Sequences[i].DenySetQosGroup = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "deny/set/ttl"); value.Exists() && !data.Sequences[i].DenySetTtl.IsNull() {
			data.Sequences[i].DenySetTtl = types.Int64Value(value.Int())
		...
		for j := range data.Sequences {
			...
			if found {
				...
				if !state.Sequences[i].DenyIcmpOn.IsNull() && state.Sequences[i].DenyIcmpOn.ValueBool() && data.Sequences[j].DenyIcmpOn.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/icmp-on", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Sequences[i].DenyIcmpOff.IsNull() && state.Sequences[i].DenyIcmpOff.ValueBool() && data.Sequences[j].DenyIcmpOff.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/icmp-off", predicates))
				}
				if !state.Sequences[i].DenySetTtl.IsNull() && data.Sequences[j].DenySetTtl.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/set/ttl", predicates))
				}
				if !state.Sequences[i].DenySetQosGroup.IsNull() && data.Sequences[j].DenySetQosGroup.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/set/qos-group", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Sequences[i].DenyLogInput.IsNull() && state.Sequences[i].DenyLogInput.ValueBool() && data.Sequences[j].DenyLogInput.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/log-input", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Sequences[i].DenyLog.IsNull() && state.Sequences[i].DenyLog.ValueBool() && data.Sequences[j].DenyLog.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/log", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Sequences[i].DenyCapture.IsNull() && state.Sequences[i].DenyCapture.ValueBool() && data.Sequences[j].DenyCapture.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/capture", predicates))
				}
				if !state.Sequences[i].DenyNexthop3Vrf.IsNull() && data.Sequences[j].DenyNexthop3Vrf.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/nexthop3/vrf", predicates))
				}
				if !state.Sequences[i].DenyNexthop3Track.IsNull() && data.Sequences[j].DenyNexthop3Track.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/nexthop3/track", predicates))
				}
				if !state.Sequences[i].DenyNexthop3Ipv4.IsNull() && data.Sequences[j].DenyNexthop3Ipv4.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/nexthop3/ipv4", predicates))
				}
				if !state.Sequences[i].DenyNexthop2Vrf.IsNull() && data.Sequences[j].DenyNexthop2Vrf.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/nexthop2/vrf", predicates))
				}
				if !state.Sequences[i].DenyNexthop2Track.IsNull() && data.Sequences[j].DenyNexthop2Track.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/nexthop2/track", predicates))
				}
				if !state.Sequences[i].DenyNexthop2Ipv4.IsNull() && data.Sequences[j].DenyNexthop2Ipv4.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/nexthop2/ipv4", predicates))
				}
				if !state.Sequences[i].DenyNexthop1Vrf.IsNull() && data.Sequences[j].DenyNexthop1Vrf.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/nexthop1/vrf", predicates))
				}
				if !state.Sequences[i].DenyNexthop1Track.IsNull() && data.Sequences[j].DenyNexthop1Track.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/nexthop1/track", predicates))
				}
				if !state.Sequences[i].DenyNexthop1Ipv4.IsNull() && data.Sequences[j].DenyNexthop1Ipv4.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/nexthop1/ipv4", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Sequences[i].DenyDefault.IsNull() && state.Sequences[i].DenyDefault.ValueBool() && data.Sequences[j].DenyDefault.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/default", predicates))
				}
				if !state.Sequences[i].DenyPolicePriority.IsNull() && data.Sequences[j].DenyPolicePriority.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/police/priority", predicates))
				}
				if !state.Sequences[i].DenyPolicePeakUnit.IsNull() && data.Sequences[j].DenyPolicePeakUnit.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/police/peak-unit", predicates))
				}
				if !state.Sequences[i].DenyPolicePeakRate.IsNull() && data.Sequences[j].DenyPolicePeakRate.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/police/peak-rate", predicates))
				}
				if !state.Sequences[i].DenyPoliceUnit.IsNull() && data.Sequences[j].DenyPoliceUnit.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/police/unit", predicates))
				}
				if !state.Sequences[i].DenyPoliceValue.IsNull() && data.Sequences[j].DenyPoliceValue.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/police/value", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Sequences[i].DenyFragments.IsNull() && state.Sequences[i].DenyFragments.ValueBool() && data.Sequences[j].DenyFragments.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/fragments", predicates))
				}
				if !state.Sequences[i].DenyFragmentOffsetRangeEnd.IsNull() && data.Sequences[j].DenyFragmentOffsetRangeEnd.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/fragment-offset/range/end-value", predicates))
				}
				if !state.Sequences[i].DenyFragmentOffsetRangeStart.IsNull() && data.Sequences[j].DenyFragmentOffsetRangeStart.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/fragment-offset/range/start-value", predicates))
				}
				if !state.Sequences[i].DenyFragmentOffsetNeq.IsNull() && data.Sequences[j].DenyFragmentOffsetNeq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/fragment-offset/neq", predicates))
				}
				if !state.Sequences[i].DenyFragmentOffsetLt.IsNull() && data.Sequences[j].DenyFragmentOffsetLt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/fragment-offset/lt", predicates))
				}
				if !state.Sequences[i].DenyFragmentOffsetGt.IsNull() && data.Sequences[j].DenyFragmentOffsetGt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/fragment-offset/gt", predicates))
				}
				if !state.Sequences[i].DenyFragmentOffsetEq.IsNull() && data.Sequences[j].DenyFragmentOffsetEq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/fragment-offset/eq", predicates))
				}
				if !state.Sequences[i].DenyTtlRangeEnd.IsNull() && data.Sequences[j].DenyTtlRangeEnd.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/ttl/range/end-value", predicates))
				}
				if !state.Sequences[i].DenyTtlRangeStart.IsNull() && data.Sequences[j].DenyTtlRangeStart.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/ttl/range/start-value", predicates))
				}
				if !state.Sequences[i].DenyTtlNeq.IsNull() && data.Sequences[j].DenyTtlNeq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/ttl/neq", predicates))
				}
				if !state.Sequences[i].DenyTtlLt.IsNull() && data.Sequences[j].DenyTtlLt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/ttl/lt", predicates))
				}
				if !state.Sequences[i].DenyTtlGt.IsNull() && data.Sequences[j].DenyTtlGt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/ttl/gt", predicates))
				}
				if !state.Sequences[i].DenyTtlEq.IsNull() && data.Sequences[j].DenyTtlEq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/ttl/eq", predicates))
				}
				if !state.Sequences[i].DenyPacketLengthRangeEnd.IsNull() && data.Sequences[j].DenyPacketLengthRangeEnd.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/packet-length/range/end-value", predicates))
				}
				if !state.Sequences[i].DenyPacketLengthRangeStart.IsNull() && data.Sequences[j].DenyPacketLengthRangeStart.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/packet-length/range/start-value", predicates))
				}
				if !state.Sequences[i].DenyPacketLengthNeq.IsNull() && data.Sequences[j].DenyPacketLengthNeq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/packet-length/neq", predicates))
				}
				if !state.Sequences[i].DenyPacketLengthLt.IsNull() && data.Sequences[j].DenyPacketLengthLt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/packet-length/lt", predicates))
				}
				if !state.Sequences[i].DenyPacketLengthGt.IsNull() && data.Sequences[j].DenyPacketLengthGt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/packet-length/gt", predicates))
				}
				if !state.Sequences[i].DenyPacketLengthEq.IsNull() && data.Sequences[j].DenyPacketLengthEq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/packet-length/eq", predicates))
				}
				if !state.Sequences[i].DenyDscpRangeEnd.IsNull() && data.Sequences[j].DenyDscpRangeEnd.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/dscp/range/end-value", predicates))
				}
				if !state.Sequences[i].DenyDscpRangeStart.IsNull() && data.Sequences[j].DenyDscpRangeStart.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/dscp/range/start-value", predicates))
				}
				if !state.Sequences[i].DenyDscpNeq.IsNull() && data.Sequences[j].DenyDscpNeq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/dscp/neq", predicates))
				}
				if !state.Sequences[i].DenyDscpLt.IsNull() && data.Sequences[j].DenyDscpLt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/dscp/lt", predicates))
				}
				if !state.Sequences[i].DenyDscpGt.IsNull() && data.Sequences[j].DenyDscpGt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/dscp/gt", predicates))
				}
				if !state.Sequences[i].DenyDscpEq.IsNull() && data.Sequences[j].DenyDscpEq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/dscp/eq", predicates))
				}
				if !state.Sequences[i].DenyDscp.IsNull() && data.Sequences[j].DenyDscp.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/dscp/dscp-value", predicates))
				}
				if !state.Sequences[i].DenyIgmpType.IsNull() && data.Sequences[j].DenyIgmpType.IsNull() {
				...
				if !state.Sequences[i].DenyIcmpMessageType.IsNull() && data.Sequences[j].DenyIcmpMessageType.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/icmp/message-type", predicates))
				}
				if !state.Sequences[i].DenyIcmpMessageTypeName.IsNull() && data.Sequences[j].DenyIcmpMessageTypeName.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/icmp/message-type-name", predicates))
				}
				if !state.Sequences[i].DenyDestinationPortRangeEnd.IsNull() && data.Sequences[j].DenyDestinationPortRangeEnd.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/destination/port/range/end-value", predicates))
				}
				if !state.Sequences[i].DenyDestinationPortRangeStart.IsNull() && data.Sequences[j].DenyDestinationPortRangeStart.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/destination/port/range/start-value", predicates))
				}
				if !state.Sequences[i].DenyDestinationPortNeq.IsNull() && data.Sequences[j].DenyDestinationPortNeq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/destination/port/neq", predicates))
				}
				if !state.Sequences[i].DenyDestinationPortLt.IsNull() && data.Sequences[j].DenyDestinationPortLt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/destination/port/lt", predicates))
				}
				if !state.Sequences[i].DenyDestinationPortGt.IsNull() && data.Sequences[j].DenyDestinationPortGt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/destination/port/gt", predicates))
				}
				if !state.Sequences[i].DenyDestinationPortEq.IsNull() && data.Sequences[j].DenyDestinationPortEq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/destination/port/eq", predicates))
				}
				if !state.Sequences[i].DenyDestinationPortGroup.IsNull() && data.Sequences[j].DenyDestinationPortGroup.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/destination/port-group", predicates))
				}
				if !state.Sequences[i].DenyDestinationNetGroup.IsNull() && data.Sequences[j].DenyDestinationNetGroup.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/destination/net-group", predicates))
				}
				if !state.Sequences[i].DenyDestinationHost.IsNull() && data.Sequences[j].DenyDestinationHost.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/destination/host", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Sequences[i].DenyDestinationAny.IsNull() && state.Sequences[i].DenyDestinationAny.ValueBool() && data.Sequences[j].DenyDestinationAny.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/destination/any", predicates))
				}
				if !state.Sequences[i].DenyDestinationPrefixLength.IsNull() && data.Sequences[j].DenyDestinationPrefixLength.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/destination/prefix-length", predicates))
				}
				if !state.Sequences[i].DenyDestinationWildcardMask.IsNull() && data.Sequences[j].DenyDestinationWildcardMask.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/destination/wildcard-mask", predicates))
				}
				if !state.Sequences[i].DenyDestinationAddress.IsNull() && data.Sequences[j].DenyDestinationAddress.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/destination/address", predicates))
				}
				if !state.Sequences[i].DenySourcePortRangeEnd.IsNull() && data.Sequences[j].DenySourcePortRangeEnd.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/source/port/range/end-value", predicates))
				}
				if !state.Sequences[i].DenySourcePortRangeStart.IsNull() && data.Sequences[j].DenySourcePortRangeStart.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/source/port/range/start-value", predicates))
				}
				if !state.Sequences[i].DenySourcePortNeq.IsNull() && data.Sequences[j].DenySourcePortNeq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/source/port/neq", predicates))
				}
				if !state.Sequences[i].DenySourcePortLt.IsNull() && data.Sequences[j].DenySourcePortLt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/source/port/lt", predicates))
				}
				if !state.Sequences[i].DenySourcePortGt.IsNull() && data.Sequences[j].DenySourcePortGt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/source/port/gt", predicates))
				}
				if !state.Sequences[i].DenySourcePortEq.IsNull() && data.Sequences[j].DenySourcePortEq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/source/port/eq", predicates))
				}
				if !state.Sequences[i].DenySourcePortGroup.IsNull() && data.Sequences[j].DenySourcePortGroup.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/source/port-group", predicates))
				}
				if !state.Sequences[i].DenySourceNetGroup.IsNull() && data.Sequences[j].DenySourceNetGroup.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/source/net-group", predicates))
				}
				if !state.Sequences[i].DenySourceHost.IsNull() && data.Sequences[j].DenySourceHost.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/source/host", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Sequences[i].DenySourceAny.IsNull() && state.Sequences[i].DenySourceAny.ValueBool() && data.Sequences[j].DenySourceAny.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/source/any", predicates))
				}
				if !state.Sequences[i].DenySourcePrefixLength.IsNull() && data.Sequences[j].DenySourcePrefixLength.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/source/prefix-length", predicates))
				}
				if !state.Sequences[i].DenySourceWildcardMask.IsNull() && data.Sequences[j].DenySourceWildcardMask.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/source/wildcard-mask", predicates))
				}
				if !state.Sequences[i].DenySourceAddress.IsNull() && data.Sequences[j].DenySourceAddress.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/source/address", predicates))
				}
				if !state.Sequences[i].DenyRangeEndProtocol.IsNull() && data.Sequences[j].DenyRangeEndProtocol.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/range/end-protocol", predicates))
				}
				if !state.Sequences[i].DenyRangeStartProtocol.IsNull() && data.Sequences[j].DenyRangeStartProtocol.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/range/start-protocol", predicates))
				}
				if !state.Sequences[i].DenyCounter.IsNull() && data.Sequences[j].DenyCounter.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/counter", predicates))
				}
				if !state.Sequences[i].DenyFragmentType.IsNull() && data.Sequences[j].DenyFragmentType.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/fragment-type", predicates))
				}
				if !state.Sequences[i].DenyPrecedence.IsNull() && data.Sequences[j].DenyPrecedence.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/precedence", predicates))
				}
				if !state.Sequences[i].DenyEq.IsNull() && data.Sequences[j].DenyEq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/eq", predicates))
				}
				if !state.Sequences[i].DenyProtocol.IsNull() && data.Sequences[j].DenyProtocol.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/protocol", predicates))
				}
				if !state.Sequences[i].PermitSetTtl.IsNull() && data.Sequences[j].PermitSetTtl.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/set/ttl", predicates))
				}
				if !state.Sequences[i].PermitSetQosGroup.IsNull() && data.Sequences[j].PermitSetQosGroup.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/set/qos-group", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Sequences[i].PermitLogInput.IsNull() && state.Sequences[i].PermitLogInput.ValueBool() && data.Sequences[j].PermitLogInput.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/log-input", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Sequences[i].PermitLog.IsNull() && state.Sequences[i].PermitLog.ValueBool() && data.Sequences[j].PermitLog.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/log", predicates))
				}
				if !state.Sequences[i].PermitCounter.IsNull() && data.Sequences[j].PermitCounter.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/counter", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Sequences[i].PermitCapture.IsNull() && state.Sequences[i].PermitCapture.ValueBool() && data.Sequences[j].PermitCapture.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/capture", predicates))
				}
				if !state.Sequences[i].PermitNexthop3Vrf.IsNull() && data.Sequences[j].PermitNexthop3Vrf.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/nexthop3/vrf", predicates))
				}
				if !state.Sequences[i].PermitNexthop3Track.IsNull() && data.Sequences[j].PermitNexthop3Track.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/nexthop3/track", predicates))
				}
				if !state.Sequences[i].PermitNexthop3Ipv4.IsNull() && data.Sequences[j].PermitNexthop3Ipv4.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/nexthop3/ipv4", predicates))
				}
				if !state.Sequences[i].PermitNexthop2Vrf.IsNull() && data.Sequences[j].PermitNexthop2Vrf.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/nexthop2/vrf", predicates))
				}
				if !state.Sequences[i].PermitNexthop2Track.IsNull() && data.Sequences[j].PermitNexthop2Track.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/nexthop2/track", predicates))
				}
				if !state.Sequences[i].PermitNexthop2Ipv4.IsNull() && data.Sequences[j].PermitNexthop2Ipv4.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/nexthop2/ipv4", predicates))
				}
				if !state.Sequences[i].PermitNexthop1Vrf.IsNull() && data.Sequences[j].PermitNexthop1Vrf.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/nexthop1/vrf", predicates))
				}
				if !state.Sequences[i].PermitNexthop1Track.IsNull() && data.Sequences[j].PermitNexthop1Track.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/nexthop1/track", predicates))
				}
				if !state.Sequences[i].PermitNexthop1Ipv4.IsNull() && data.Sequences[j].PermitNexthop1Ipv4.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/nexthop1/ipv4", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Sequences[i].PermitDefault.IsNull() && state.Sequences[i].PermitDefault.ValueBool() && data.Sequences[j].PermitDefault.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/default", predicates))
				}
				if !state.Sequences[i].PermitPolicePriority.IsNull() && data.Sequences[j].PermitPolicePriority.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/police/priority", predicates))
				}
				if !state.Sequences[i].PermitPolicePeakUnit.IsNull() && data.Sequences[j].PermitPolicePeakUnit.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/police/peak-unit", predicates))
				}
				if !state.Sequences[i].PermitPolicePeakRate.IsNull() && data.Sequences[j].PermitPolicePeakRate.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/police/peak-rate", predicates))
				}
				if !state.Sequences[i].PermitPoliceUnit.IsNull() && data.Sequences[j].PermitPoliceUnit.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/police/unit", predicates))
				}
				if !state.Sequences[i].PermitPoliceValue.IsNull() && data.Sequences[j].PermitPoliceValue.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/police/value", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Sequences[i].PermitFragments.IsNull() && state.Sequences[i].PermitFragments.ValueBool() && data.Sequences[j].PermitFragments.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/fragments", predicates))
				}
				if !state.Sequences[i].PermitFragmentOffsetRangeEnd.IsNull() && data.Sequences[j].PermitFragmentOffsetRangeEnd.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/fragment-offset/range/end-value", predicates))
				}
				if !state.Sequences[i].PermitFragmentOffsetRangeStart.IsNull() && data.Sequences[j].PermitFragmentOffsetRangeStart.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/fragment-offset/range/start-value", predicates))
				}
				if !state.Sequences[i].PermitFragmentOffsetNeq.IsNull() && data.Sequences[j].PermitFragmentOffsetNeq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/fragment-offset/neq", predicates))
				}
				if !state.Sequences[i].PermitFragmentOffsetLt.IsNull() && data.Sequences[j].PermitFragmentOffsetLt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/fragment-offset/lt", predicates))
				}
				if !state.Sequences[i].PermitFragmentOffsetGt.IsNull() && data.Sequences[j].PermitFragmentOffsetGt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/fragment-offset/gt", predicates))
				}
				if !state.Sequences[i].PermitFragmentOffsetEq.IsNull() && data.Sequences[j].PermitFragmentOffsetEq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/fragment-offset/eq", predicates))
				}
				if !state.Sequences[i].PermitTtlRangeEnd.IsNull() && data.Sequences[j].PermitTtlRangeEnd.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/ttl/range/end-value", predicates))
				}
				if !state.Sequences[i].PermitTtlRangeStart.IsNull() && data.Sequences[j].PermitTtlRangeStart.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/ttl/range/start-value", predicates))
				}
				if !state.Sequences[i].PermitTtlNeq.IsNull() && data.Sequences[j].PermitTtlNeq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/ttl/neq", predicates))
				}
				if !state.Sequences[i].PermitTtlLt.IsNull() && data.Sequences[j].PermitTtlLt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/ttl/lt", predicates))
				}
				if !state.Sequences[i].PermitTtlGt.IsNull() && data.Sequences[j].PermitTtlGt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/ttl/gt", predicates))
				}
				if !state.Sequences[i].PermitTtlEq.IsNull() && data.Sequences[j].PermitTtlEq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/ttl/eq", predicates))
				}
				if !state.Sequences[i].PermitPacketLengthRangeEnd.IsNull() && data.Sequences[j].PermitPacketLengthRangeEnd.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/packet-length/range/end-value", predicates))
				}
				if !state.Sequences[i].PermitPacketLengthRangeStart.IsNull() && data.Sequences[j].PermitPacketLengthRangeStart.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/packet-length/range/start-value", predicates))
				}
				if !state.Sequences[i].PermitPacketLengthNeq.IsNull() && data.Sequences[j].PermitPacketLengthNeq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/packet-length/neq", predicates))
				}
				if !state.Sequences[i].PermitPacketLengthLt.IsNull() && data.Sequences[j].PermitPacketLengthLt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/packet-length/lt", predicates))
				}
				if !state.Sequences[i].PermitPacketLengthGt.IsNull() && data.Sequences[j].PermitPacketLengthGt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/packet-length/gt", predicates))
				}
				if !state.Sequences[i].PermitPacketLengthEq.IsNull() && data.Sequences[j].PermitPacketLengthEq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/packet-length/eq", predicates))
				}
				if !state.Sequences[i].PermitDscpRangeEnd.IsNull() && data.Sequences[j].PermitDscpRangeEnd.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/dscp/range/end-value", predicates))
				}
				if !state.Sequences[i].PermitDscpRangeStart.IsNull() && data.Sequences[j].PermitDscpRangeStart.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/dscp/range/start-value", predicates))
				}
				if !state.Sequences[i].PermitDscpNeq.IsNull() && data.Sequences[j].PermitDscpNeq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/dscp/neq", predicates))
				}
				if !state.Sequences[i].PermitDscpLt.IsNull() && data.Sequences[j].PermitDscpLt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/dscp/lt", predicates))
				}
				if !state.Sequences[i].PermitDscpGt.IsNull() && data.Sequences[j].PermitDscpGt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/dscp/gt", predicates))
				}
				if !state.Sequences[i].PermitDscpEq.IsNull() && data.Sequences[j].PermitDscpEq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/dscp/eq", predicates))
				}
				if !state.Sequences[i].PermitDscp.IsNull() && data.Sequences[j].PermitDscp.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/dscp/dscp-value", predicates))
				}
				if !state.Sequences[i].PermitIgmpType.IsNull() && data.Sequences[j].PermitIgmpType.IsNull() {
				...
				if !state.Sequences[i].PermitIcmpMessageType.IsNull() && data.Sequences[j].PermitIcmpMessageType.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/icmp/message-type", predicates))
				}
				if !state.Sequences[i].PermitIcmpMessageTypeName.IsNull() && data.Sequences[j].PermitIcmpMessageTypeName.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/icmp/message-type-name", predicates))
				}
				if !state.Sequences[i].PermitDestinationPortRangeEnd.IsNull() && data.Sequences[j].PermitDestinationPortRangeEnd.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/destination/port/range/end-value", predicates))
				}
				if !state.Sequences[i].PermitDestinationPortRangeStart.IsNull() && data.Sequences[j].PermitDestinationPortRangeStart.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/destination/port/range/start-value", predicates))
				}
				if !state.Sequences[i].PermitDestinationPortNeq.IsNull() && data.Sequences[j].PermitDestinationPortNeq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/destination/port/neq", predicates))
				}
				if !state.Sequences[i].PermitDestinationPortLt.IsNull() && data.Sequences[j].PermitDestinationPortLt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/destination/port/lt", predicates))
				}
				if !state.Sequences[i].PermitDestinationPortGt.IsNull() && data.Sequences[j].PermitDestinationPortGt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/destination/port/gt", predicates))
				}
				if !state.Sequences[i].PermitDestinationPortEq.IsNull() && data.Sequences[j].PermitDestinationPortEq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/destination/port/eq", predicates))
				}
				if !state.Sequences[i].PermitDestinationPortGroup.IsNull() && data.Sequences[j].PermitDestinationPortGroup.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/destination/port-group", predicates))
				}
				if !state.Sequences[i].PermitDestinationNetGroup.IsNull() && data.Sequences[j].PermitDestinationNetGroup.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/destination/net-group", predicates))
				}
				if !state.Sequences[i].PermitDestinationHost.IsNull() && data.Sequences[j].PermitDestinationHost.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/destination/host", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Sequences[i].PermitDestinationAny.IsNull() && state.Sequences[i].PermitDestinationAny.ValueBool() && data.Sequences[j].PermitDestinationAny.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/destination/any", predicates))
				}
				if !state.Sequences[i].PermitDestinationPrefixLength.IsNull() && data.Sequences[j].PermitDestinationPrefixLength.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/destination/prefix-length", predicates))
				}
				if !state.Sequences[i].PermitDestinationWildcardMask.IsNull() && data.Sequences[j].PermitDestinationWildcardMask.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/destination/wildcard-mask", predicates))
				}
				if !state.Sequences[i].PermitDestinationAddress.IsNull() && data.Sequences[j].PermitDestinationAddress.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/destination/address", predicates))
				}
				if !state.Sequences[i].PermitSourcePortRangeEnd.IsNull() && data.Sequences[j].PermitSourcePortRangeEnd.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/source/port/range/end-value", predicates))
				}
				if !state.Sequences[i].PermitSourcePortRangeStart.IsNull() && data.Sequences[j].PermitSourcePortRangeStart.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/source/port/range/start-value", predicates))
				}
				if !state.Sequences[i].PermitSourcePortNeq.IsNull() && data.Sequences[j].PermitSourcePortNeq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/source/port/neq", predicates))
				}
				if !state.Sequences[i].PermitSourcePortLt.IsNull() && data.Sequences[j].PermitSourcePortLt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/source/port/lt", predicates))
				}
				if !state.Sequences[i].PermitSourcePortGt.IsNull() && data.Sequences[j].PermitSourcePortGt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/source/port/gt", predicates))
				}
				if !state.Sequences[i].PermitSourcePortEq.IsNull() && data.Sequences[j].PermitSourcePortEq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/source/port/eq", predicates))
				}
				if !state.Sequences[i].PermitSourcePortGroup.IsNull() && data.Sequences[j].PermitSourcePortGroup.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/source/port-group", predicates))
				}
				if !state.Sequences[i].PermitSourceNetGroup.IsNull() && data.Sequences[j].PermitSourceNetGroup.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/source/net-group", predicates))
				}
				if !state.Sequences[i].PermitSourceHost.IsNull() && data.Sequences[j].PermitSourceHost.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/source/host", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Sequences[i].PermitSourceAny.IsNull() && state.Sequences[i].PermitSourceAny.ValueBool() && data.Sequences[j].PermitSourceAny.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/source/any", predicates))
				}
				if !state.Sequences[i].PermitSourcePrefixLength.IsNull() && data.Sequences[j].PermitSourcePrefixLength.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/source/prefix-length", predicates))
				}
				if !state.Sequences[i].PermitSourceWildcardMask.IsNull() && data.Sequences[j].PermitSourceWildcardMask.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/source/wildcard-mask", predicates))
				}
				if !state.Sequences[i].PermitSourceAddress.IsNull() && data.Sequences[j].PermitSourceAddress.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/source/address", predicates))
				}
				if !state.Sequences[i].PermitFragmentType.IsNull() && data.Sequences[j].PermitFragmentType.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/fragment-type", predicates))
				}
				if !state.Sequences[i].PermitPrecedence.IsNull() && data.Sequences[j].PermitPrecedence.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/precedence", predicates))
				}
				if !state.Sequences[i].PermitRangeEndProtocol.IsNull() && data.Sequences[j].PermitRangeEndProtocol.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/range/end-protocol", predicates))
				}
				if !state.Sequences[i].PermitRangeStartProtocol.IsNull() && data.Sequences[j].PermitRangeStartProtocol.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/range/start-protocol", predicates))
				}
				if !state.Sequences[i].PermitEq.IsNull() && data.Sequences[j].PermitEq.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/eq", predicates))
				}
				if !state.Sequences[i].PermitProtocol.IsNull() && data.Sequences[j].PermitProtocol.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/protocol", predicates))
				}
				if !state.Sequences[i].Remark.IsNull() && data.Sequences[j].Remark.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/remark", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v", predicates))
		}
	}
