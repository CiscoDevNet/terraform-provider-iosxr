...
func (data IPv4PrefixList) toBodyXML(ctx context.Context, stateArg ...*IPv4PrefixList) string {
...
func (data *IPv4PrefixList) updateFromBody(ctx context.Context, res gjson.Result) {
