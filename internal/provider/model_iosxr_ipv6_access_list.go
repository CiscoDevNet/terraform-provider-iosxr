...
func (data IPv6AccessList) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data IPv6AccessList) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
