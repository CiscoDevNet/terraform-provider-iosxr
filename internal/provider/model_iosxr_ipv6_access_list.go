...
func (data IPv6AccessList) getXPath() string {
...
func (data IPv6AccessListData) getXPath() string {
	path := "Cisco-IOS-XR-um-ipv6-access-list-cfg:/ipv6/access-lists/access-list[access-list-name=%s]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.AccessListName.ValueString()))
	return path
}
...
func (data *IPv6AccessList) updateFromBody(ctx context.Context, res gjson.Result) {
...
func (data IPv6AccessList) toBodyXML(ctx context.Context, stateArg ...*IPv6AccessList) string {
	...
	if len(data.Sequences) > 0 {
		for _, item := range data.Sequences {
			...
			if !item.PermitHeaders.IsNull() && !item.PermitHeaders.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/headers", item.PermitHeaders.ValueString())
			}
			if !item.PermitDscp.IsNull() && !item.PermitDscp.IsUnknown() {
			...
			if !item.PermitNexthop1Ipv6.IsNull() && !item.PermitNexthop1Ipv6.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/nexthop1/ipv6", item.PermitNexthop1Ipv6.ValueString())
			}
			if !item.PermitNexthop1Track.IsNull() && !item.PermitNexthop1Track.IsUnknown() {
			...
			if !item.PermitNexthop2Ipv6.IsNull() && !item.PermitNexthop2Ipv6.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/nexthop2/ipv6", item.PermitNexthop2Ipv6.ValueString())
			}
			if !item.PermitNexthop2Track.IsNull() && !item.PermitNexthop2Track.IsUnknown() {
			...
			if !item.PermitNexthop3Ipv6.IsNull() && !item.PermitNexthop3Ipv6.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/permit/nexthop3/ipv6", item.PermitNexthop3Ipv6.ValueString())
			}
			if !item.PermitNexthop3Track.IsNull() && !item.PermitNexthop3Track.IsUnknown() {
			...
			if !item.DenyHeaders.IsNull() && !item.DenyHeaders.IsUnknown() {
				body = helpers.SetFromXPath(body, basePath+"/deny/headers", item.DenyHeaders.ValueString())
			}
			if !item.DenyDscp.IsNull() && !item.DenyDscp.IsUnknown() {
...
func (data *IPv6AccessList) updateFromBodyXML(ctx context.Context, res xmldot.Result) {
	for i := range data.Sequences {
		keys := [...]string{"sequence-number"}
		keyValues := [...]string{strconv.FormatInt(data.Sequences[i].SequenceNumber.ValueInt64(), 10)}
		...
		if value := helpers.GetFromXPath(r, "permit/headers"); value.Exists() && !data.Sequences[i].PermitHeaders.IsNull() {
			data.Sequences[i].PermitHeaders = types.StringValue(value.String())
		} else if data.Sequences[i].PermitHeaders.IsNull() {
			data.Sequences[i].PermitHeaders = types.StringNull()
		}
		...
		if value := helpers.GetFromXPath(r, "permit/nexthop1/ipv6"); value.Exists() && !data.Sequences[i].PermitNexthop1Ipv6.IsNull() {
			data.Sequences[i].PermitNexthop1Ipv6 = types.StringValue(value.String())
		} else if data.Sequences[i].PermitNexthop1Ipv6.IsNull() {
			data.Sequences[i].PermitNexthop1Ipv6 = types.StringNull()
		}
		...
		if value := helpers.GetFromXPath(r, "permit/nexthop2/ipv6"); value.Exists() && !data.Sequences[i].PermitNexthop2Ipv6.IsNull() {
			data.Sequences[i].PermitNexthop2Ipv6 = types.StringValue(value.String())
		} else if data.Sequences[i].PermitNexthop2Ipv6.IsNull() {
			data.Sequences[i].PermitNexthop2Ipv6 = types.StringNull()
		}
		...
		if value := helpers.GetFromXPath(r, "permit/nexthop3/ipv6"); value.Exists() && !data.Sequences[i].PermitNexthop3Ipv6.IsNull() {
			data.Sequences[i].PermitNexthop3Ipv6 = types.StringValue(value.String())
		} else if data.Sequences[i].PermitNexthop3Ipv6.IsNull() {
			data.Sequences[i].PermitNexthop3Ipv6 = types.StringNull()
		}
		...
		if value := helpers.GetFromXPath(r, "deny/headers"); value.Exists() && !data.Sequences[i].DenyHeaders.IsNull() {
			data.Sequences[i].DenyHeaders = types.StringValue(value.String())
		} else if data.Sequences[i].DenyHeaders.IsNull() {
			data.Sequences[i].DenyHeaders = types.StringNull()
		}
...
func (data *IPv6AccessList) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *IPv6AccessListData) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *IPv6AccessList) fromBodyXML(ctx context.Context, res xmldot.Result) {
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/sequences/sequence"); value.Exists() {
		...
		value.ForEach(func(_ int, v xmldot.Result) bool {
			...
			if cValue := helpers.GetFromXPath(v, "permit/headers"); cValue.Exists() {
				item.PermitHeaders = types.StringValue(cValue.String())
			}
			...
			if cValue := helpers.GetFromXPath(v, "permit/nexthop1/ipv6"); cValue.Exists() {
				item.PermitNexthop1Ipv6 = types.StringValue(cValue.String())
			}
			...
			if cValue := helpers.GetFromXPath(v, "permit/nexthop2/ipv6"); cValue.Exists() {
				item.PermitNexthop2Ipv6 = types.StringValue(cValue.String())
			}
			...
			if cValue := helpers.GetFromXPath(v, "permit/nexthop3/ipv6"); cValue.Exists() {
				item.PermitNexthop3Ipv6 = types.StringValue(cValue.String())
			}
			...
			if cValue := helpers.GetFromXPath(v, "deny/headers"); cValue.Exists() {
				item.DenyHeaders = types.StringValue(cValue.String())
			}
...
func (data *IPv6AccessListData) fromBodyXML(ctx context.Context, res xmldot.Result) {
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/sequences/sequence"); value.Exists() {
		data.Sequences = make([]IPv6AccessListSequences, 0)
		value.ForEach(func(_ int, v xmldot.Result) bool {
			item := IPv6AccessListSequences{}
...
func (data *IPv6AccessList) getEmptyLeafsDelete(ctx context.Context, state *IPv6AccessList) []string {
...
func (data *IPv6AccessList) addDeletedItemsXML(ctx context.Context, state IPv6AccessList, body string) string {
	...
	for i := range state.Sequences {
		...
		for j := range data.Sequences {
			...
			if found {
				...
				if !state.Sequences[i].DenyHeaders.IsNull() && data.Sequences[j].DenyHeaders.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/deny/headers", predicates))
				}
				if !state.Sequences[i].DenyTcpFlagsBits.IsNull() && data.Sequences[j].DenyTcpFlagsBits.IsNull() {
				...
				if !state.Sequences[i].PermitNexthop3Ipv6.IsNull() && data.Sequences[j].PermitNexthop3Ipv6.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/nexthop3/ipv6", predicates))
				}
				if !state.Sequences[i].PermitNexthop2Vrf.IsNull() && data.Sequences[j].PermitNexthop2Vrf.IsNull() {
				...
				if !state.Sequences[i].PermitNexthop2Ipv6.IsNull() && data.Sequences[j].PermitNexthop2Ipv6.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/nexthop2/ipv6", predicates))
				}
				if !state.Sequences[i].PermitNexthop1Vrf.IsNull() && data.Sequences[j].PermitNexthop1Vrf.IsNull() {
				...
				if !state.Sequences[i].PermitNexthop1Ipv6.IsNull() && data.Sequences[j].PermitNexthop1Ipv6.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/nexthop1/ipv6", predicates))
				}
				if !state.Sequences[i].PermitPolicePriority.IsNull() && data.Sequences[j].PermitPolicePriority.IsNull() {
				...
				if !state.Sequences[i].PermitHeaders.IsNull() && data.Sequences[j].PermitHeaders.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/sequences/sequence%v/permit/headers", predicates))
				}
				if !state.Sequences[i].PermitTcpFlagsBits.IsNull() && data.Sequences[j].PermitTcpFlagsBits.IsNull() {
...
func (data *IPv6AccessList) addDeletePathsXML(ctx context.Context, body string) string {
