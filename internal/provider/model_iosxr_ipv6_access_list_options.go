...
func (data IPv6AccessListOptions) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data IPv6AccessListOptions) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
