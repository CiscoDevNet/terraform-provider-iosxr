...
func (data *L2VPNBridgeGroupBridgeDomainVFI) updateFromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get("autodiscovery.bgp"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
	...
	if value := res.Get("autodiscovery.bgp.rd.auto"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
	...
	if value := res.Get("autodiscovery.bgp.rd.two-byte-as-number"); value.Exists() && !data.AutodiscoveryBgpRdTwoByteAsNumber.IsNull() {
	...
	if value := res.Get("autodiscovery.bgp.rd.two-byte-as-assigned-number"); value.Exists() && !data.AutodiscoveryBgpRdTwoByteAsIndex.IsNull() {
	...
	if value := res.Get("autodiscovery.bgp.rd.four-byte-as-number"); value.Exists() && !data.AutodiscoveryBgpRdFourByteAsNumber.IsNull() {
	...
	if value := res.Get("autodiscovery.bgp.rd.four-byte-as-assigned-number"); value.Exists() && !data.AutodiscoveryBgpRdFourByteAsIndex.IsNull() {
	...
	if value := res.Get("autodiscovery.bgp.rd.ipv4-address"); value.Exists() && !data.AutodiscoveryBgpRdIpv4Address.IsNull() {
	...
	if value := res.Get("autodiscovery.bgp.rd.ipv4-address-assigned-number"); value.Exists() && !data.AutodiscoveryBgpRdIpv4AddressIndex.IsNull() {
	...
	for i := range data.AutodiscoveryBgpRouteTargetImportTwoByteAsFormat {
		...
		var r gjson.Result
		res.Get("autodiscovery.bgp.route-target.import.two-byte-as-rts.two-byte-as-rt").ForEach(
	...
	for i := range data.AutodiscoveryBgpRouteTargetImportFourByteAsFormat {
		...
		var r gjson.Result
		res.Get("autodiscovery.bgp.route-target.import.four-byte-as-rts.four-byte-as-rt").ForEach(
			func(_, v gjson.Result) bool {
				found := false
				for ik := range keys {
					if v.Get(keys[ik]).String() == keyValues[ik] {
	...
	for i := range data.AutodiscoveryBgpRouteTargetImportIpv4AddressFormat {
		...
		var r gjson.Result
		res.Get("autodiscovery.bgp.route-target.import.ipv4-address-rts.ipv4-address-rt").ForEach(
			func(_, v gjson.Result) bool {
				found := false
				for ik := range keys {
					if v.Get(keys[ik]).String() == keyValues[ik] {
	...
	for i := range data.AutodiscoveryBgpRouteTargetExportTwoByteAsFormat {
		...
		var r gjson.Result
		res.Get("autodiscovery.bgp.route-target.export.two-byte-as-rts.two-byte-as-rt").ForEach(
			func(_, v gjson.Result) bool {
				found := false
				for ik := range keys {
					if v.Get(keys[ik]).String() == keyValues[ik] {
	...
	for i := range data.AutodiscoveryBgpRouteTargetExportFourByteAsFormat {
		...
		var r gjson.Result
		res.Get("autodiscovery.bgp.route-target.export.four-byte-as-rts.four-byte-as-rt").ForEach(
			func(_, v gjson.Result) bool {
				found := false
				for ik := range keys {
					if v.Get(keys[ik]).String() == keyValues[ik] {
	...
	for i := range data.AutodiscoveryBgpRouteTargetExportIpv4AddressFormat {
		...
		var r gjson.Result
		res.Get("autodiscovery.bgp.route-target.export.ipv4-address-rts.ipv4-address-rt").ForEach(
			func(_, v gjson.Result) bool {
				found := false
				for ik := range keys {
					if v.Get(keys[ik]).String() == keyValues[ik] {
	...
	for i := range data.AutodiscoveryBgpRouteTargetTwoByteAsFormat {
		...
		var r gjson.Result
		res.Get("autodiscovery.bgp.route-target.two-byte-as-rts.two-byte-as-rt").ForEach(
			func(_, v gjson.Result) bool {
				found := false
				for ik := range keys {
					if v.Get(keys[ik]).String() == keyValues[ik] {
	...
	for i := range data.AutodiscoveryBgpRouteTargetFourByteAsFormat {
		...
		var r gjson.Result
		res.Get("autodiscovery.bgp.route-target.four-byte-as-rts.four-byte-as-rt").ForEach(
			func(_, v gjson.Result) bool {
				found := false
				for ik := range keys {
					if v.Get(keys[ik]).String() == keyValues[ik] {
	...
	for i := range data.AutodiscoveryBgpRouteTargetIpv4AddressFormat {
		...
		var r gjson.Result
		res.Get("autodiscovery.bgp.route-target.ipv4-address-rts.ipv4-address-rt").ForEach(
			func(_, v gjson.Result) bool {
				found := false
				for ik := range keys {
					if v.Get(keys[ik]).String() == keyValues[ik] {
	...
	if value := res.Get("autodiscovery.bgp.control-word"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
	...
	if value := res.Get("autodiscovery.bgp.signaling-protocol.bgp"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
	...
	if value := res.Get("autodiscovery.bgp.signaling-protocol.bgp.ve-id"); value.Exists() && !data.AutodiscoveryBgpSignalingProtocolBgpVeId.IsNull() {
	...
	if value := res.Get("autodiscovery.bgp.signaling-protocol.bgp.ve-range"); value.Exists() && !data.AutodiscoveryBgpSignalingProtocolBgpVeRange.IsNull() {
	...
	if value := res.Get("autodiscovery.bgp.signaling-protocol.bgp.load-balancing.flow-label.transmit"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
	...
	if value := res.Get("autodiscovery.bgp.signaling-protocol.bgp.load-balancing.flow-label.receive"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
	...
	if value := res.Get("autodiscovery.bgp.signaling-protocol.bgp.load-balancing.flow-label.both"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
	...
	if value := res.Get("autodiscovery.bgp.signaling-protocol.bgp.load-balancing.flow-label.static"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
	...
	if value := res.Get("autodiscovery.bgp.signaling-protocol.ldp"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
	...
	if value := res.Get("autodiscovery.bgp.signaling-protocol.ldp.vpls-id.two-byte-as-number"); value.Exists() && !data.AutodiscoveryBgpSignalingProtocolLdpVplsIdTwoByteAsNumber.IsNull() {
	...
	if value := res.Get("autodiscovery.bgp.signaling-protocol.ldp.vpls-id.two-byte-as-assigned-number"); value.Exists() && !data.AutodiscoveryBgpSignalingProtocolLdpVplsIdTwoByteAsFormat.IsNull() {
	...
	if value := res.Get("autodiscovery.bgp.signaling-protocol.ldp.vpls-id.ipv4-address"); value.Exists() && !data.AutodiscoveryBgpSignalingProtocolLdpVplsIdIpv4Address.IsNull() {
	...
	if value := res.Get("autodiscovery.bgp.signaling-protocol.ldp.vpls-id.ipv4-address-assigned-number"); value.Exists() && !data.AutodiscoveryBgpSignalingProtocolLdpVplsIdIpv4AddressIndex.IsNull() {
	...
	if value := res.Get("autodiscovery.bgp.signaling-protocol.ldp.vpls-id.load-balancing.flow-label.transmit"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
	...
	if value := res.Get("autodiscovery.bgp.signaling-protocol.ldp.vpls-id.load-balancing.flow-label.receive"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
	...
	if value := res.Get("autodiscovery.bgp.signaling-protocol.ldp.vpls-id.load-balancing.flow-label.both"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
	...
	if value := res.Get("autodiscovery.bgp.signaling-protocol.ldp.vpls-id.load-balancing.flow-label.static"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
	...
	if value := res.Get("autodiscovery.bgp.table-policy"); value.Exists() && !data.AutodiscoveryBgpTablePolicy.IsNull() {
	...
	if value := res.Get("autodiscovery.bgp.route-policy.export"); value.Exists() && !data.AutodiscoveryBgpRoutePolicyExport.IsNull() {
	...
	if value := res.Get("multicast.p2mp"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
	...
	if value := res.Get("multicast.p2mp.transport.rsvp-te"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
	...
	if value := res.Get("multicast.p2mp.transport.rsvp-te.attribute-set.p2mp-te"); value.Exists() && !data.MulticastP2mpTransportRsvpTeAttributeSetP2mpTe.IsNull() {
	...
	if value := res.Get("multicast.p2mp.signaling-protocol.bgp"); value.Exists() {
		// Only set to true if it was already in the plan (not null)
...
func (data L2VPNBridgeGroupBridgeDomainVFI) toBodyXML(ctx context.Context, stateArg ...*L2VPNBridgeGroupBridgeDomainVFI) string {
...
func (data *L2VPNBridgeGroupBridgeDomainVFI) updateFromBodyXML(ctx context.Context, res xmldot.Result) {
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/autodiscovery/bgp/rd/two-byte-as-number"); value.Exists() && !data.AutodiscoveryBgpRdTwoByteAsNumber.IsNull() {
		data.AutodiscoveryBgpRdTwoByteAsNumber = types.Int64Value(value.Int())
	} else if data.AutodiscoveryBgpRdTwoByteAsNumber.IsNull() {
		data.AutodiscoveryBgpRdTwoByteAsNumber = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/autodiscovery/bgp/rd/two-byte-as-assigned-number"); value.Exists() && !data.AutodiscoveryBgpRdTwoByteAsIndex.IsNull() {
		data.AutodiscoveryBgpRdTwoByteAsIndex = types.Int64Value(value.Int())
	} else if data.AutodiscoveryBgpRdTwoByteAsIndex.IsNull() {
		data.AutodiscoveryBgpRdTwoByteAsIndex = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/autodiscovery/bgp/rd/four-byte-as-number"); value.Exists() && !data.AutodiscoveryBgpRdFourByteAsNumber.IsNull() {
		data.AutodiscoveryBgpRdFourByteAsNumber = types.Int64Value(value.Int())
	} else if data.AutodiscoveryBgpRdFourByteAsNumber.IsNull() {
		data.AutodiscoveryBgpRdFourByteAsNumber = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/autodiscovery/bgp/rd/four-byte-as-assigned-number"); value.Exists() && !data.AutodiscoveryBgpRdFourByteAsIndex.IsNull() {
		data.AutodiscoveryBgpRdFourByteAsIndex = types.Int64Value(value.Int())
	} else if data.AutodiscoveryBgpRdFourByteAsIndex.IsNull() {
		data.AutodiscoveryBgpRdFourByteAsIndex = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/autodiscovery/bgp/rd/ipv4-address"); value.Exists() && !data.AutodiscoveryBgpRdIpv4Address.IsNull() {
		data.AutodiscoveryBgpRdIpv4Address = types.StringValue(value.String())
	} else if data.AutodiscoveryBgpRdIpv4Address.IsNull() {
		data.AutodiscoveryBgpRdIpv4Address = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/autodiscovery/bgp/rd/ipv4-address-assigned-number"); value.Exists() && !data.AutodiscoveryBgpRdIpv4AddressIndex.IsNull() {
		data.AutodiscoveryBgpRdIpv4AddressIndex = types.Int64Value(value.Int())
	} else if data.AutodiscoveryBgpRdIpv4AddressIndex.IsNull() {
		data.AutodiscoveryBgpRdIpv4AddressIndex = types.Int64Null()
	}
	for i := range data.AutodiscoveryBgpRouteTargetImportTwoByteAsFormat {
		...
		if value := helpers.GetFromXPath(r, "two-byte-as-number"); value.Exists() && !data.AutodiscoveryBgpRouteTargetImportTwoByteAsFormat[i].TwoByteAsNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetImportTwoByteAsFormat[i].TwoByteAsNumber = types.Int64Value(value.Int())
		} else if data.AutodiscoveryBgpRouteTargetImportTwoByteAsFormat[i].TwoByteAsNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetImportTwoByteAsFormat[i].TwoByteAsNumber = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "assigned-number"); value.Exists() && !data.AutodiscoveryBgpRouteTargetImportTwoByteAsFormat[i].AssignedNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetImportTwoByteAsFormat[i].AssignedNumber = types.Int64Value(value.Int())
	...
	for i := range data.AutodiscoveryBgpRouteTargetImportFourByteAsFormat {
		...
		if value := helpers.GetFromXPath(r, "four-byte-as-number"); value.Exists() && !data.AutodiscoveryBgpRouteTargetImportFourByteAsFormat[i].FourByteAsNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetImportFourByteAsFormat[i].FourByteAsNumber = types.Int64Value(value.Int())
		} else if data.AutodiscoveryBgpRouteTargetImportFourByteAsFormat[i].FourByteAsNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetImportFourByteAsFormat[i].FourByteAsNumber = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "assigned-number"); value.Exists() && !data.AutodiscoveryBgpRouteTargetImportFourByteAsFormat[i].AssignedNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetImportFourByteAsFormat[i].AssignedNumber = types.Int64Value(value.Int())
	...
	for i := range data.AutodiscoveryBgpRouteTargetImportIpv4AddressFormat {
		...
		if value := helpers.GetFromXPath(r, "ipv4-address"); value.Exists() && !data.AutodiscoveryBgpRouteTargetImportIpv4AddressFormat[i].Ipv4Address.IsNull() {
			data.AutodiscoveryBgpRouteTargetImportIpv4AddressFormat[i].Ipv4Address = types.StringValue(value.String())
		} else if data.AutodiscoveryBgpRouteTargetImportIpv4AddressFormat[i].Ipv4Address.IsNull() {
			data.AutodiscoveryBgpRouteTargetImportIpv4AddressFormat[i].Ipv4Address = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "assigned-number"); value.Exists() && !data.AutodiscoveryBgpRouteTargetImportIpv4AddressFormat[i].AssignedNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetImportIpv4AddressFormat[i].AssignedNumber = types.Int64Value(value.Int())
	...
	for i := range data.AutodiscoveryBgpRouteTargetExportTwoByteAsFormat {
		...
		if value := helpers.GetFromXPath(r, "two-byte-as-number"); value.Exists() && !data.AutodiscoveryBgpRouteTargetExportTwoByteAsFormat[i].TwoByteAsNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetExportTwoByteAsFormat[i].TwoByteAsNumber = types.Int64Value(value.Int())
		} else if data.AutodiscoveryBgpRouteTargetExportTwoByteAsFormat[i].TwoByteAsNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetExportTwoByteAsFormat[i].TwoByteAsNumber = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "assigned-number"); value.Exists() && !data.AutodiscoveryBgpRouteTargetExportTwoByteAsFormat[i].AssignedNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetExportTwoByteAsFormat[i].AssignedNumber = types.Int64Value(value.Int())
	...
	for i := range data.AutodiscoveryBgpRouteTargetExportFourByteAsFormat {
		...
		if value := helpers.GetFromXPath(r, "four-byte-as-number"); value.Exists() && !data.AutodiscoveryBgpRouteTargetExportFourByteAsFormat[i].FourByteAsNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetExportFourByteAsFormat[i].FourByteAsNumber = types.Int64Value(value.Int())
		} else if data.AutodiscoveryBgpRouteTargetExportFourByteAsFormat[i].FourByteAsNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetExportFourByteAsFormat[i].FourByteAsNumber = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "assigned-number"); value.Exists() && !data.AutodiscoveryBgpRouteTargetExportFourByteAsFormat[i].AssignedNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetExportFourByteAsFormat[i].AssignedNumber = types.Int64Value(value.Int())
	...
	for i := range data.AutodiscoveryBgpRouteTargetExportIpv4AddressFormat {
		...
		if value := helpers.GetFromXPath(r, "ipv4-address"); value.Exists() && !data.AutodiscoveryBgpRouteTargetExportIpv4AddressFormat[i].Ipv4Address.IsNull() {
			data.AutodiscoveryBgpRouteTargetExportIpv4AddressFormat[i].Ipv4Address = types.StringValue(value.String())
		} else if data.AutodiscoveryBgpRouteTargetExportIpv4AddressFormat[i].Ipv4Address.IsNull() {
			data.AutodiscoveryBgpRouteTargetExportIpv4AddressFormat[i].Ipv4Address = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "assigned-number"); value.Exists() && !data.AutodiscoveryBgpRouteTargetExportIpv4AddressFormat[i].AssignedNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetExportIpv4AddressFormat[i].AssignedNumber = types.Int64Value(value.Int())
	...
	for i := range data.AutodiscoveryBgpRouteTargetTwoByteAsFormat {
		...
		if value := helpers.GetFromXPath(r, "two-byte-as-number"); value.Exists() && !data.AutodiscoveryBgpRouteTargetTwoByteAsFormat[i].TwoByteAsNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetTwoByteAsFormat[i].TwoByteAsNumber = types.Int64Value(value.Int())
		} else if data.AutodiscoveryBgpRouteTargetTwoByteAsFormat[i].TwoByteAsNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetTwoByteAsFormat[i].TwoByteAsNumber = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "assigned-number"); value.Exists() && !data.AutodiscoveryBgpRouteTargetTwoByteAsFormat[i].AssignedNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetTwoByteAsFormat[i].AssignedNumber = types.Int64Value(value.Int())
	...
	for i := range data.AutodiscoveryBgpRouteTargetFourByteAsFormat {
		...
		if value := helpers.GetFromXPath(r, "four-byte-as-number"); value.Exists() && !data.AutodiscoveryBgpRouteTargetFourByteAsFormat[i].FourByteAsNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetFourByteAsFormat[i].FourByteAsNumber = types.Int64Value(value.Int())
		} else if data.AutodiscoveryBgpRouteTargetFourByteAsFormat[i].FourByteAsNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetFourByteAsFormat[i].FourByteAsNumber = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "assigned-number"); value.Exists() && !data.AutodiscoveryBgpRouteTargetFourByteAsFormat[i].AssignedNumber.IsNull() {
			data.AutodiscoveryBgpRouteTargetFourByteAsFormat[i].AssignedNumber = types.Int64Value(value.Int())
	...
	for i := range data.AutodiscoveryBgpRouteTargetIpv4AddressFormat {
		...
		if value := helpers.GetFromXPath(r, "ipv4-address"); value.Exists() && !data.AutodiscoveryBgpRouteTargetIpv4AddressFormat[i].Ipv4Address.IsNull() {
			data.AutodiscoveryBgpRouteTargetIpv4AddressFormat[i].Ipv4Address = types.StringValue(value.String())
		} else if data.AutodiscoveryBgpRouteTargetIpv4AddressFormat[i].Ipv4Address.IsNull() {
			data.AutodiscoveryBgpRouteTargetIpv4AddressFormat[i].Ipv4Address = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "assigned-number"); value.Exists() && !data.AutodiscoveryBgpRouteTargetIpv4AddressFormat[i].Index.IsNull() {
			data.AutodiscoveryBgpRouteTargetIpv4AddressFormat[i].Index = types.Int64Value(value.Int())
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/autodiscovery/bgp/signaling-protocol/bgp/ve-id"); value.Exists() && !data.AutodiscoveryBgpSignalingProtocolBgpVeId.IsNull() {
		data.AutodiscoveryBgpSignalingProtocolBgpVeId = types.Int64Value(value.Int())
	} else if data.AutodiscoveryBgpSignalingProtocolBgpVeId.IsNull() {
		data.AutodiscoveryBgpSignalingProtocolBgpVeId = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/autodiscovery/bgp/signaling-protocol/bgp/ve-range"); value.Exists() && !data.AutodiscoveryBgpSignalingProtocolBgpVeRange.IsNull() {
		data.AutodiscoveryBgpSignalingProtocolBgpVeRange = types.Int64Value(value.Int())
	} else if data.AutodiscoveryBgpSignalingProtocolBgpVeRange.IsNull() {
		data.AutodiscoveryBgpSignalingProtocolBgpVeRange = types.Int64Null()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/autodiscovery/bgp/signaling-protocol/ldp/vpls-id/two-byte-as-number"); value.Exists() && !data.AutodiscoveryBgpSignalingProtocolLdpVplsIdTwoByteAsNumber.IsNull() {
		data.AutodiscoveryBgpSignalingProtocolLdpVplsIdTwoByteAsNumber = types.Int64Value(value.Int())
	} else if data.AutodiscoveryBgpSignalingProtocolLdpVplsIdTwoByteAsNumber.IsNull() {
		data.AutodiscoveryBgpSignalingProtocolLdpVplsIdTwoByteAsNumber = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/autodiscovery/bgp/signaling-protocol/ldp/vpls-id/two-byte-as-assigned-number"); value.Exists() && !data.AutodiscoveryBgpSignalingProtocolLdpVplsIdTwoByteAsFormat.IsNull() {
		data.AutodiscoveryBgpSignalingProtocolLdpVplsIdTwoByteAsFormat = types.Int64Value(value.Int())
	} else if data.AutodiscoveryBgpSignalingProtocolLdpVplsIdTwoByteAsFormat.IsNull() {
		data.AutodiscoveryBgpSignalingProtocolLdpVplsIdTwoByteAsFormat = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/autodiscovery/bgp/signaling-protocol/ldp/vpls-id/ipv4-address"); value.Exists() && !data.AutodiscoveryBgpSignalingProtocolLdpVplsIdIpv4Address.IsNull() {
		data.AutodiscoveryBgpSignalingProtocolLdpVplsIdIpv4Address = types.StringValue(value.String())
	} else if data.AutodiscoveryBgpSignalingProtocolLdpVplsIdIpv4Address.IsNull() {
		data.AutodiscoveryBgpSignalingProtocolLdpVplsIdIpv4Address = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/autodiscovery/bgp/signaling-protocol/ldp/vpls-id/ipv4-address-assigned-number"); value.Exists() && !data.AutodiscoveryBgpSignalingProtocolLdpVplsIdIpv4AddressIndex.IsNull() {
		data.AutodiscoveryBgpSignalingProtocolLdpVplsIdIpv4AddressIndex = types.Int64Value(value.Int())
	} else if data.AutodiscoveryBgpSignalingProtocolLdpVplsIdIpv4AddressIndex.IsNull() {
		data.AutodiscoveryBgpSignalingProtocolLdpVplsIdIpv4AddressIndex = types.Int64Null()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/autodiscovery/bgp/table-policy"); value.Exists() && !data.AutodiscoveryBgpTablePolicy.IsNull() {
		data.AutodiscoveryBgpTablePolicy = types.StringValue(value.String())
	} else if data.AutodiscoveryBgpTablePolicy.IsNull() {
		data.AutodiscoveryBgpTablePolicy = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/autodiscovery/bgp/route-policy/export"); value.Exists() && !data.AutodiscoveryBgpRoutePolicyExport.IsNull() {
		data.AutodiscoveryBgpRoutePolicyExport = types.StringValue(value.String())
	} else if data.AutodiscoveryBgpRoutePolicyExport.IsNull() {
		data.AutodiscoveryBgpRoutePolicyExport = types.StringNull()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/multicast/p2mp/transport/rsvp-te/attribute-set/p2mp-te"); value.Exists() && !data.MulticastP2mpTransportRsvpTeAttributeSetP2mpTe.IsNull() {
		data.MulticastP2mpTransportRsvpTeAttributeSetP2mpTe = types.StringValue(value.String())
	} else if data.MulticastP2mpTransportRsvpTeAttributeSetP2mpTe.IsNull() {
		data.MulticastP2mpTransportRsvpTeAttributeSetP2mpTe = types.StringNull()
	}
	...
	for i := range data.Neighbors {
		...
		if value := helpers.GetFromXPath(r, "pw-id"); value.Exists() && !data.Neighbors[i].PwId.IsNull() {
			data.Neighbors[i].PwId = types.Int64Value(value.Int())
		...
		for ci := range data.Neighbors[i].StaticMacAddresses {
			...
			if value := helpers.GetFromXPath(cr, "mac-address"); value.Exists() && !data.Neighbors[i].StaticMacAddresses[ci].MacAddress.IsNull() {
				data.Neighbors[i].StaticMacAddresses[ci].MacAddress = types.StringValue(value.String())
			} else if data.Neighbors[i].StaticMacAddresses[ci].MacAddress.IsNull() {
				data.Neighbors[i].StaticMacAddresses[ci].MacAddress = types.StringNull()
			}
		}
		if value := helpers.GetFromXPath(r, "mpls/static/label/local"); value.Exists() && !data.Neighbors[i].MplsStaticLabelLocal.IsNull() {
			data.Neighbors[i].MplsStaticLabelLocal = types.Int64Value(value.Int())
		} else if data.Neighbors[i].MplsStaticLabelLocal.IsNull() {
			data.Neighbors[i].MplsStaticLabelLocal = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "mpls/static/label/remote"); value.Exists() && !data.Neighbors[i].MplsStaticLabelRemote.IsNull() {
			data.Neighbors[i].MplsStaticLabelRemote = types.Int64Value(value.Int())
		} else if data.Neighbors[i].MplsStaticLabelRemote.IsNull() {
			data.Neighbors[i].MplsStaticLabelRemote = types.Int64Null()
		}
		if value := helpers.GetFromXPath(r, "pw-class"); value.Exists() && !data.Neighbors[i].PwClass.IsNull() {
			data.Neighbors[i].PwClass = types.StringValue(value.String())
		} else if data.Neighbors[i].PwClass.IsNull() {
			data.Neighbors[i].PwClass = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "dhcp/ipv4/snoop/profile"); value.Exists() && !data.Neighbors[i].DhcpIpv4SnoopingProfile.IsNull() {
			data.Neighbors[i].DhcpIpv4SnoopingProfile = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "igmp/snooping/profile"); value.Exists() && !data.Neighbors[i].IgmpSnoopingProfile.IsNull() {
			data.Neighbors[i].IgmpSnoopingProfile = types.StringValue(value.String())
		} else if data.Neighbors[i].IgmpSnoopingProfile.IsNull() {
			data.Neighbors[i].IgmpSnoopingProfile = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "mld/snooping/profile"); value.Exists() && !data.Neighbors[i].MldSnoopingProfile.IsNull() {
			data.Neighbors[i].MldSnoopingProfile = types.StringValue(value.String())
...
func (data *L2VPNBridgeGroupBridgeDomainVFI) addDeletedItemsXML(ctx context.Context, state L2VPNBridgeGroupBridgeDomainVFI, body string) string {
	...
	for i := range state.Neighbors {
		...
		for j := range data.Neighbors {
			...
			if found {
				if !state.Neighbors[i].MldSnoopingProfile.IsNull() && data.Neighbors[j].MldSnoopingProfile.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/neighbors/neighbor%v/mld/snooping/profile", predicates))
				}
				if !state.Neighbors[i].IgmpSnoopingProfile.IsNull() && data.Neighbors[j].IgmpSnoopingProfile.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/neighbors/neighbor%v/igmp/snooping/profile", predicates))
				}
				...
				if !state.Neighbors[i].DhcpIpv4None.IsNull() && state.Neighbors[i].DhcpIpv4None.ValueBool() && data.Neighbors[j].DhcpIpv4None.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/neighbors/neighbor%v/dhcp/ipv4/none", predicates))
				}
				if !state.Neighbors[i].DhcpIpv4SnoopingProfile.IsNull() && data.Neighbors[j].DhcpIpv4SnoopingProfile.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/neighbors/neighbor%v/dhcp/ipv4/snoop/profile", predicates))
				}
				if !state.Neighbors[i].PwClass.IsNull() && data.Neighbors[j].PwClass.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/neighbors/neighbor%v/pw-class", predicates))
				}
				if !state.Neighbors[i].MplsStaticLabelRemote.IsNull() && data.Neighbors[j].MplsStaticLabelRemote.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/neighbors/neighbor%v/mpls/static/label/remote", predicates))
				}
				if !state.Neighbors[i].MplsStaticLabelLocal.IsNull() && data.Neighbors[j].MplsStaticLabelLocal.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/neighbors/neighbor%v/mpls/static/label/local", predicates))
				}
				for ci := range state.Neighbors[i].StaticMacAddresses {
					...
					if !found {
						b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/neighbors/neighbor%v/static-mac-addresses/static-mac-address%v", predicates, cpredicates))
					}
				}
				break
			}
	...
	for i := range state.AutodiscoveryBgpRouteTargetIpv4AddressFormat {
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/autodiscovery/bgp/route-target/ipv4-address-rts/ipv4-address-rt%v", predicates))
		}
	}
	for i := range state.AutodiscoveryBgpRouteTargetFourByteAsFormat {
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/autodiscovery/bgp/route-target/four-byte-as-rts/four-byte-as-rt%v", predicates))
		}
	}
	for i := range state.AutodiscoveryBgpRouteTargetTwoByteAsFormat {
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/autodiscovery/bgp/route-target/two-byte-as-rts/two-byte-as-rt%v", predicates))
		}
	}
	for i := range state.AutodiscoveryBgpRouteTargetExportIpv4AddressFormat {
		stateKeys := [...]string{"ipv4-address", "assigned-number"}
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/autodiscovery/bgp/route-target/export/ipv4-address-rts/ipv4-address-rt%v", predicates))
		}
	}
	for i := range state.AutodiscoveryBgpRouteTargetExportFourByteAsFormat {
		stateKeys := [...]string{"four-byte-as-number", "assigned-number"}
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/autodiscovery/bgp/route-target/export/four-byte-as-rts/four-byte-as-rt%v", predicates))
		}
	}
	for i := range state.AutodiscoveryBgpRouteTargetExportTwoByteAsFormat {
		stateKeys := [...]string{"two-byte-as-number", "assigned-number"}
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/autodiscovery/bgp/route-target/export/two-byte-as-rts/two-byte-as-rt%v", predicates))
		}
	}
	for i := range state.AutodiscoveryBgpRouteTargetImportIpv4AddressFormat {
		stateKeys := [...]string{"ipv4-address", "assigned-number"}
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/autodiscovery/bgp/route-target/import/ipv4-address-rts/ipv4-address-rt%v", predicates))
		}
	}
	for i := range state.AutodiscoveryBgpRouteTargetImportFourByteAsFormat {
		stateKeys := [...]string{"four-byte-as-number", "assigned-number"}
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/autodiscovery/bgp/route-target/import/four-byte-as-rts/four-byte-as-rt%v", predicates))
		}
	}
	for i := range state.AutodiscoveryBgpRouteTargetImportTwoByteAsFormat {
		stateKeys := [...]string{"two-byte-as-number", "assigned-number"}
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/autodiscovery/bgp/route-target/import/two-byte-as-rts/two-byte-as-rt%v", predicates))
		}
	}
	if !state.AutodiscoveryBgpRdIpv4AddressIndex.IsNull() && data.AutodiscoveryBgpRdIpv4AddressIndex.IsNull() {
