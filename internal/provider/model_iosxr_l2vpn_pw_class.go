...
func (data L2VPNPWClass) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data L2VPNPWClass) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
