...
func (data *LargeCommunitySet) updateFromBody(ctx context.Context, res gjson.Result) {
	if value := res.Get("large-community-set-as-text"); value.Exists() && !data.Rpl.IsNull() {
...
func (data LargeCommunitySet) toBodyXML(ctx context.Context, stateArg ...*LargeCommunitySet) string {
