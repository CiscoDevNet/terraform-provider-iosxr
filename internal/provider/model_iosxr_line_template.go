...
type LineTemplate struct {
	...
	UsersGroup                []LineTemplateUsersGroup `tfsdk:"users_group"`
...
type LineTemplateUsersGroup struct {
...
func (data LineTemplate) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XR-um-line-cfg:/line/templates/template[template-name=%s]", data.TemplateName.ValueString())
}

func (data LineTemplateData) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XR-um-line-cfg:/line/templates/template[template-name=%s]", data.TemplateName.ValueString())
}

// getXPath returns the XPath for NETCONF operations
func (data LineTemplate) getXPath() string {
	path := "Cisco-IOS-XR-um-line-cfg:/line/templates/template[template-name=%s]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.TemplateName.ValueString()))
	return path
}

func (data LineTemplateData) getXPath() string {
	path := "Cisco-IOS-XR-um-line-cfg:/line/templates/template[template-name=%s]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.TemplateName.ValueString()))
	return path
}
...
func (data LineTemplate) toBody(ctx context.Context) string {
	...
	if !data.Autocommand.IsNull() && !data.Autocommand.IsUnknown() {
		body, _ = sjson.Set(body, "autocommand", data.Autocommand.ValueString())
	}
...
func (data *LineTemplate) updateFromBody(ctx context.Context, res gjson.Result) {
	if value := res.Get("autocommand"); value.Exists() && !data.Autocommand.IsNull() {
...
func (data LineTemplate) toBodyXML(ctx context.Context, stateArg ...*LineTemplate) string {
	...
	// injected as a single raw XML sibling into the final root element produced above.
	{
		nsBody := netconf.Body{}
		if !data.AuthorizationExec.IsNull() && !data.AuthorizationExec.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-aaa-task-user-cfg:authorization/exec", data.AuthorizationExec.ValueString())
		}
		if !data.AuthorizationEventmanager.IsNull() && !data.AuthorizationEventmanager.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-aaa-task-user-cfg:authorization/eventmanager", data.AuthorizationEventmanager.ValueString())
		}
		if !data.AuthorizationCommands.IsNull() && !data.AuthorizationCommands.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-aaa-task-user-cfg:authorization/commands", data.AuthorizationCommands.ValueString())
		}
	...
	}
	{
		nsBody := netconf.Body{}
		if !data.AccountingExec.IsNull() && !data.AccountingExec.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-aaa-task-user-cfg:accounting/exec", data.AccountingExec.ValueString())
		}
		if !data.AccountingCommands.IsNull() && !data.AccountingCommands.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-aaa-task-user-cfg:accounting/commands", data.AccountingCommands.ValueString())
		}
		nsBodyXML, nsErr := helpers.BodyToNestedXML(nsBody)
		if nsErr != nil {
			// Check if the error is due to invalid path syntax (e.g., xmlns attributes)
	...
	}
	{
		nsBody := netconf.Body{}
		if !data.ExecTimeoutMinutes.IsNull() && !data.ExecTimeoutMinutes.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-line-exec-timeout-cfg:exec-timeout/timeout-in-minutes", strconv.FormatInt(data.ExecTimeoutMinutes.ValueInt64(), 10))
		}
		if !data.ExecTimeoutSeconds.IsNull() && !data.ExecTimeoutSeconds.IsUnknown() {
			nsBody = helpers.SetFromXPath(nsBody, data.getXPath()+"/Cisco-IOS-XR-um-line-exec-timeout-cfg:exec-timeout/timeout-in-seconds", strconv.FormatInt(data.ExecTimeoutSeconds.ValueInt64(), 10))
		}
		nsBodyXML, nsErr := helpers.BodyToNestedXML(nsBody)
		if nsErr != nil {
			// Check if the error is due to invalid path syntax (e.g., xmlns attributes)
...
func (data *LineTemplate) updateFromBodyXML(ctx context.Context, res xmldot.Result) {
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/autocommand"); value.Exists() && !data.Autocommand.IsNull() {
		data.Autocommand = types.StringValue(value.String())
	} else if data.Autocommand.IsNull() {
		data.Autocommand = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/access-class/ingress"); value.Exists() && !data.AccessClassIngress.IsNull() {
		data.AccessClassIngress = types.StringValue(value.String())
	} else if data.AccessClassIngress.IsNull() {
		data.AccessClassIngress = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/access-class/egress"); value.Exists() && !data.AccessClassEgress.IsNull() {
		data.AccessClassEgress = types.StringValue(value.String())
	} else if data.AccessClassEgress.IsNull() {
		data.AccessClassEgress = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/disconnect-character"); value.Exists() && !data.DisconnectCharacter.IsNull() {
		data.DisconnectCharacter = types.StringValue(value.String())
	} else if data.DisconnectCharacter.IsNull() {
		data.DisconnectCharacter = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/escape-character"); value.Exists() && !data.EscapeCharacter.IsNull() {
		data.EscapeCharacter = types.StringValue(value.String())
	} else if data.EscapeCharacter.IsNull() {
		data.EscapeCharacter = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/session-timeout/timeout-interval"); value.Exists() && !data.SessionTimeout.IsNull() {
		data.SessionTimeout = types.Int64Value(value.Int())
	} else if data.SessionTimeout.IsNull() {
		data.SessionTimeout = types.Int64Null()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-aaa-task-user-cfg:login/authentication"); value.Exists() && !data.LoginAuthentication.IsNull() {
		data.LoginAuthentication = types.StringValue(value.String())
	} else if data.LoginAuthentication.IsNull() {
		data.LoginAuthentication = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-aaa-task-user-cfg:authorization/exec"); value.Exists() && !data.AuthorizationExec.IsNull() {
		data.AuthorizationExec = types.StringValue(value.String())
	} else if data.AuthorizationExec.IsNull() {
		data.AuthorizationExec = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-aaa-task-user-cfg:authorization/eventmanager"); value.Exists() && !data.AuthorizationEventmanager.IsNull() {
		data.AuthorizationEventmanager = types.StringValue(value.String())
	} else if data.AuthorizationEventmanager.IsNull() {
		data.AuthorizationEventmanager = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-aaa-task-user-cfg:authorization/commands"); value.Exists() && !data.AuthorizationCommands.IsNull() {
		data.AuthorizationCommands = types.StringValue(value.String())
	} else if data.AuthorizationCommands.IsNull() {
		data.AuthorizationCommands = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-aaa-task-user-cfg:accounting/exec"); value.Exists() && !data.AccountingExec.IsNull() {
		data.AccountingExec = types.StringValue(value.String())
	} else if data.AccountingExec.IsNull() {
		data.AccountingExec = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-aaa-task-user-cfg:accounting/commands"); value.Exists() && !data.AccountingCommands.IsNull() {
		data.AccountingCommands = types.StringValue(value.String())
	} else if data.AccountingCommands.IsNull() {
		data.AccountingCommands = types.StringNull()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-aaa-task-user-cfg:timeout/login/response"); value.Exists() && !data.TimeoutLoginResponse.IsNull() {
		data.TimeoutLoginResponse = types.Int64Value(value.Int())
	} else if data.TimeoutLoginResponse.IsNull() {
		data.TimeoutLoginResponse = types.Int64Null()
	}
	for i := range data.UsersGroup {
		...
		if value := helpers.GetFromXPath(r, "group-name"); value.Exists() && !data.UsersGroup[i].GroupName.IsNull() {
			data.UsersGroup[i].GroupName = types.StringValue(value.String())
		} else if data.UsersGroup[i].GroupName.IsNull() {
			data.UsersGroup[i].GroupName = types.StringNull()
		}
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-line-exec-timeout-cfg:exec-timeout/timeout-in-minutes"); value.Exists() && !data.ExecTimeoutMinutes.IsNull() {
		data.ExecTimeoutMinutes = types.Int64Value(value.Int())
	} else if data.ExecTimeoutMinutes.IsNull() {
		data.ExecTimeoutMinutes = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-line-exec-timeout-cfg:exec-timeout/timeout-in-seconds"); value.Exists() && !data.ExecTimeoutSeconds.IsNull() {
		data.ExecTimeoutSeconds = types.Int64Value(value.Int())
	} else if data.ExecTimeoutSeconds.IsNull() {
		data.ExecTimeoutSeconds = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-line-general-cfg:absolute-timeout"); value.Exists() && !data.AbsoluteTimeout.IsNull() {
		data.AbsoluteTimeout = types.Int64Value(value.Int())
	} else if data.AbsoluteTimeout.IsNull() {
		data.AbsoluteTimeout = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-line-general-cfg:width"); value.Exists() && !data.Width.IsNull() {
		data.Width = types.Int64Value(value.Int())
	} else if data.Width.IsNull() {
		data.Width = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-line-general-cfg:length"); value.Exists() && !data.Length.IsNull() {
		data.Length = types.Int64Value(value.Int())
	} else if data.Length.IsNull() {
		data.Length = types.Int64Null()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/Cisco-IOS-XR-um-line-timestamp-cfg:pager"); value.Exists() && !data.Pager.IsNull() {
		data.Pager = types.StringValue(value.String())
	} else if data.Pager.IsNull() {
		data.Pager = types.StringNull()
	}
...
func (data *LineTemplate) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *LineTemplateData) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *LineTemplate) fromBodyXML(ctx context.Context, res xmldot.Result) {
...
func (data *LineTemplateData) fromBodyXML(ctx context.Context, res xmldot.Result) {
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/autocommand"); value.Exists() {
		data.Autocommand = types.StringValue(value.String())
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/access-class/ingress"); value.Exists() {
...
func (data *LineTemplate) getDeletedItems(ctx context.Context, state LineTemplate) []string {
...
func (data *LineTemplate) getEmptyLeafsDelete(ctx context.Context, state *LineTemplate) []string {
...
func (data *LineTemplate) addDeletedItemsXML(ctx context.Context, state LineTemplate, body string) string {
	...
	for i := range state.UsersGroup {
		...
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/Cisco-IOS-XR-um-aaa-task-user-cfg:users/group%v", predicates))
		}
	}
	if !state.TimeoutLoginResponse.IsNull() && data.TimeoutLoginResponse.IsNull() {
...
func (data *LineTemplate) addDeletePathsXML(ctx context.Context, body string) string {
	...
	if !data.Autocommand.IsNull() {
		b = helpers.RemoveFromXPath(b, data.getXPath()+"/autocommand")
	}
