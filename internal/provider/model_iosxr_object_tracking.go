...
type ObjectTracking struct {
	...
	BooleanAndList                               []ObjectTrackingBooleanAndList                  `tfsdk:"boolean_and_list"`
	BooleanOrList                                []ObjectTrackingBooleanOrList                   `tfsdk:"boolean_or_list"`
	ThresholdPercentage                          []ObjectTrackingThresholdPercentage             `tfsdk:"threshold_percentage"`
	...
	ThresholdWeight                              []ObjectTrackingThresholdWeight                 `tfsdk:"threshold_weight"`
	...
	LineProtocolWeight                           []ObjectTrackingLineProtocolWeight              `tfsdk:"line_protocol_weight"`
	...
	LineProtocolPercentage                       []ObjectTrackingLineProtocolPercentage          `tfsdk:"line_protocol_percentage"`
	LineProtocolBooleanAnd                       []ObjectTrackingLineProtocolBooleanAnd          `tfsdk:"line_protocol_boolean_and"`
	LineProtocolBooleanOr                        []ObjectTrackingLineProtocolBooleanOr           `tfsdk:"line_protocol_boolean_or"`
	...
	TrackDownErrorDisableInterfaces              []ObjectTrackingTrackDownErrorDisableInterfaces `tfsdk:"track_down_error_disable_interfaces"`
	TrackUpErrorDisableInterfaces                []ObjectTrackingTrackUpErrorDisableInterfaces   `tfsdk:"track_up_error_disable_interfaces"`
}

type ObjectTrackingData struct {
	Device                                       types.String                                    `tfsdk:"device"`
	Id                                           types.String                                    `tfsdk:"id"`
	TrackName                                    types.String                                    `tfsdk:"track_name"`
	DelayUp                                      types.Int64                                     `tfsdk:"delay_up"`
...
type ObjectTrackingBooleanAndList struct {
	ObjectName types.String `tfsdk:"object_name"`
	Not        types.Bool   `tfsdk:"not"`
}
type ObjectTrackingBooleanOrList struct {
	ObjectName types.String `tfsdk:"object_name"`
	Not        types.Bool   `tfsdk:"not"`
}
type ObjectTrackingThresholdPercentage struct {
	ObjectName types.String `tfsdk:"object_name"`
	Weight     types.Int64  `tfsdk:"weight"`
}
type ObjectTrackingThresholdWeight struct {
	ObjectName types.String `tfsdk:"object_name"`
	Weight     types.Int64  `tfsdk:"weight"`
}
type ObjectTrackingLineProtocolWeight struct {
	InterfaceName types.String `tfsdk:"interface_name"`
	Weight        types.Int64  `tfsdk:"weight"`
}
type ObjectTrackingLineProtocolPercentage struct {
	InterfaceName types.String `tfsdk:"interface_name"`
}
type ObjectTrackingLineProtocolBooleanAnd struct {
	InterfaceName types.String `tfsdk:"interface_name"`
}
type ObjectTrackingLineProtocolBooleanOr struct {
	InterfaceName types.String `tfsdk:"interface_name"`
}
type ObjectTrackingTrackDownErrorDisableInterfaces struct {
	InterfaceName types.String `tfsdk:"interface_name"`
	AutoRecover   types.Bool   `tfsdk:"auto_recover"`
}
type ObjectTrackingTrackUpErrorDisableInterfaces struct {
	InterfaceName types.String `tfsdk:"interface_name"`
	AutoRecover   types.Bool   `tfsdk:"auto_recover"`
}
...
func (data ObjectTracking) toBody(ctx context.Context) string {
	body := "{}"
...
func (data *ObjectTracking) updateFromBody(ctx context.Context, res []byte) {
...
func (data *ObjectTracking) fromBody(ctx context.Context, res []byte) {
	...
	if value := gjson.GetBytes(res, "type.list.boolean.and.objects.object"); value.Exists() {
		data.BooleanAndList = make([]ObjectTrackingBooleanAndList, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := ObjectTrackingBooleanAndList{}
	...
	if value := gjson.GetBytes(res, "type.list.boolean.or.objects.object"); value.Exists() {
		data.BooleanOrList = make([]ObjectTrackingBooleanOrList, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := ObjectTrackingBooleanOrList{}
			if cValue := v.Get("object-name"); cValue.Exists() {
				item.ObjectName = types.StringValue(cValue.String())
			}
			if cValue := v.Get("not"); cValue.Exists() {
	...
	if value := gjson.GetBytes(res, "type.list.threshold.percentage.objects.object"); value.Exists() {
		data.ThresholdPercentage = make([]ObjectTrackingThresholdPercentage, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := ObjectTrackingThresholdPercentage{}
			if cValue := v.Get("object-name"); cValue.Exists() {
				item.ObjectName = types.StringValue(cValue.String())
			}
	...
	if value := gjson.GetBytes(res, "type.list.threshold.weight.objects.object"); value.Exists() {
		data.ThresholdWeight = make([]ObjectTrackingThresholdWeight, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := ObjectTrackingThresholdWeight{}
			if cValue := v.Get("object-name"); cValue.Exists() {
				item.ObjectName = types.StringValue(cValue.String())
			}
			if cValue := v.Get("weight"); cValue.Exists() {
	...
	if value := gjson.GetBytes(res, "type.list.line-protocol.state.threshold.weight.interfaces.interface"); value.Exists() {
		data.LineProtocolWeight = make([]ObjectTrackingLineProtocolWeight, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := ObjectTrackingLineProtocolWeight{}
	...
	if value := gjson.GetBytes(res, "type.list.line-protocol.state.threshold.percentage.interfaces.interface"); value.Exists() {
		data.LineProtocolPercentage = make([]ObjectTrackingLineProtocolPercentage, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := ObjectTrackingLineProtocolPercentage{}
			if cValue := v.Get("interface-name"); cValue.Exists() {
				item.InterfaceName = types.StringValue(cValue.String())
			}
	...
	if value := gjson.GetBytes(res, "type.list.line-protocol.state.boolean.and.interfaces.interface"); value.Exists() {
		data.LineProtocolBooleanAnd = make([]ObjectTrackingLineProtocolBooleanAnd, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := ObjectTrackingLineProtocolBooleanAnd{}
			if cValue := v.Get("interface-name"); cValue.Exists() {
				item.InterfaceName = types.StringValue(cValue.String())
			}
	...
	if value := gjson.GetBytes(res, "type.list.line-protocol.state.boolean.or.interfaces.interface"); value.Exists() {
		data.LineProtocolBooleanOr = make([]ObjectTrackingLineProtocolBooleanOr, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := ObjectTrackingLineProtocolBooleanOr{}
			if cValue := v.Get("interface-name"); cValue.Exists() {
				item.InterfaceName = types.StringValue(cValue.String())
			}
	...
	if value := gjson.GetBytes(res, "action.track-down.error-disable.interfaces.interface"); value.Exists() {
		data.TrackDownErrorDisableInterfaces = make([]ObjectTrackingTrackDownErrorDisableInterfaces, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := ObjectTrackingTrackDownErrorDisableInterfaces{}
			if cValue := v.Get("interface-name"); cValue.Exists() {
				item.InterfaceName = types.StringValue(cValue.String())
			}
	...
	if value := gjson.GetBytes(res, "action.track-up.error-disable.interfaces.interface"); value.Exists() {
		data.TrackUpErrorDisableInterfaces = make([]ObjectTrackingTrackUpErrorDisableInterfaces, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := ObjectTrackingTrackUpErrorDisableInterfaces{}
			if cValue := v.Get("interface-name"); cValue.Exists() {
				item.InterfaceName = types.StringValue(cValue.String())
			}
			if cValue := v.Get("auto-recover"); cValue.Exists() {
...
func (data *ObjectTrackingData) fromBody(ctx context.Context, res []byte) {
	if value := gjson.GetBytes(res, "delay.up"); value.Exists() {
		data.DelayUp = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "delay.down"); value.Exists() {
...
func (data *ObjectTracking) getDeletedItems(ctx context.Context, state ObjectTracking) []string {
...
func (data *ObjectTracking) getEmptyLeafsDelete(ctx context.Context) []string {
...
func (data *ObjectTracking) getDeletePaths(ctx context.Context) []string {
