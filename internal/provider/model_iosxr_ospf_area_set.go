...
func (data OSPFAreaSet) getXPath() string {
	path := "Cisco-IOS-XR-um-route-policy-cfg:/routing-policy/sets/ospf-area-sets/ospf-area-set[set-name=%s]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.SetName.ValueString()))
	return path
}

func (data OSPFAreaSetData) getXPath() string {
	path := "Cisco-IOS-XR-um-route-policy-cfg:/routing-policy/sets/ospf-area-sets/ospf-area-set[set-name=%s]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.SetName.ValueString()))
	return path
}
...
func (data OSPFAreaSet) toBodyXML(ctx context.Context) string {
	body := netconf.Body{}
	if !data.SetName.IsNull() && !data.SetName.IsUnknown() {
		body = helpers.SetFromXPath(body, data.getXPath()+"/set-name", data.SetName.ValueString())
	}
	if !data.Rpl.IsNull() && !data.Rpl.IsUnknown() {
		body = helpers.SetFromXPath(body, data.getXPath()+"/rplospf-area-set", data.Rpl.ValueString())
	}
...
func (data *OSPFAreaSet) addDeletedItemsXML(ctx context.Context, state OSPFAreaSet, body string) string {
	...
	if !state.Rpl.IsNull() && data.Rpl.IsNull() {
		deletePath := state.getXPath() + "/rplospf-area-set"
...
func (data *OSPFAreaSet) addDeletePathsXML(ctx context.Context, body string) string {
	...
	if !data.Rpl.IsNull() {
		b = helpers.RemoveFromXPath(b, data.getXPath()+"/rplospf-area-set")
	}
