...
func (data *PerformanceMeasurementEndpointIPv6) updateFromBody(ctx context.Context, res gjson.Result) {
...
func (data PerformanceMeasurementEndpointIPv6) toBodyXML(ctx context.Context, stateArg ...*PerformanceMeasurementEndpointIPv6) string {
