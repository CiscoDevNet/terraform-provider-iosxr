...
func (data PerformanceMeasurementEndpointIPv6) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data PerformanceMeasurementEndpointIPv6) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
