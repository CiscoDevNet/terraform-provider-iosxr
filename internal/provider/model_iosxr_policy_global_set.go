...
func (data PolicyGlobalSet) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data PolicyGlobalSet) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
