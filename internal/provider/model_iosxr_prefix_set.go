...
func (data PrefixSet) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data PrefixSet) GetVersionConstraints() []helpers.FieldVersionConstraint {
...
func (data PrefixSet) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
