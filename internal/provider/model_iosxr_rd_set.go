...
func (data RDSet) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data RDSet) GetVersionConstraints() []helpers.FieldVersionConstraint {
...
func (data RDSet) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
