...
func (data *RouterBGPNeighbor) setUnknownValues() {
...
func (data *RouterBGPNeighbor) getDeletedListItems(state RouterBGPNeighbor) []string {
	deletedListItems := make([]string, 0)
	return deletedListItems
}

func (data *RouterBGPNeighbor) getEmptyLeafsDelete() []string {
