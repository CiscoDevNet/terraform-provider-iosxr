...
func (data RouterBGPNeighborAddressFamily) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data RouterBGPNeighborAddressFamily) GetVersionConstraints() []helpers.FieldVersionConstraint {
...
func (data RouterBGPNeighborAddressFamily) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
