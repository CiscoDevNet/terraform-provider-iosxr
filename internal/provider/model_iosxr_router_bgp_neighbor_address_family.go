...
func (data *RouterBGPNeighborAddressFamily) updateFromBody(ctx context.Context, res gjson.Result) {
...
func (data RouterBGPNeighborAddressFamily) toBodyXML(ctx context.Context, stateArg ...*RouterBGPNeighborAddressFamily) string {
