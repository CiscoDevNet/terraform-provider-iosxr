...
func (data RouterBGPNeighborGroup) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data RouterBGPNeighborGroup) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
