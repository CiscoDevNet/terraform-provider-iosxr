...
type RouterBGPVRFNeighborAddressFamily struct {
	...
	RoutePolicyRetentionRoutePolicyName types.String `tfsdk:"route_policy_retention_route_policy_name"`
...
func (data RouterBGPVRFNeighborAddressFamily) toBody(ctx context.Context) string {
	...
	if !data.RoutePolicyRetentionRoutePolicyName.IsNull() && !data.RoutePolicyRetentionRoutePolicyName.IsUnknown() {
		body, _ = sjson.Set(body, "route-policy.retention.route-policy-name", data.RoutePolicyRetentionRoutePolicyName.ValueString())
	}
...
func (data *RouterBGPVRFNeighborAddressFamily) updateFromBody(ctx context.Context, res []byte) {
	if value := gjson.GetBytes(res, "route-policy.retention.route-policy-name"); value.Exists() && !data.RoutePolicyRetentionRoutePolicyName.IsNull() {
		data.RoutePolicyRetentionRoutePolicyName = types.StringValue(value.String())
	} else {
		data.RoutePolicyRetentionRoutePolicyName = types.StringNull()
	}
...
func (data *RouterBGPVRFNeighborAddressFamily) fromBody(ctx context.Context, res []byte) {
	if value := gjson.GetBytes(res, "route-policy.retention.route-policy-name"); value.Exists() {
		data.RoutePolicyRetentionRoutePolicyName = types.StringValue(value.String())
	}
