...
func (data RouterHSRPInterface) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data RouterHSRPInterface) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
