...
type RouterHSRPInterfaceAddressFamilyIPv4GroupV1 struct {
	...
	SecondaryIpv4Addresses     []RouterHSRPInterfaceAddressFamilyIPv4GroupV1SecondaryIpv4Addresses `tfsdk:"secondary_ipv4_addresses"`
	TrackInterfaces            []RouterHSRPInterfaceAddressFamilyIPv4GroupV1TrackInterfaces        `tfsdk:"track_interfaces"`
	TrackObjects               []RouterHSRPInterfaceAddressFamilyIPv4GroupV1TrackObjects           `tfsdk:"track_objects"`
}

type RouterHSRPInterfaceAddressFamilyIPv4GroupV1Data struct {
	Device                     types.String                                                        `tfsdk:"device"`
	Id                         types.String                                                        `tfsdk:"id"`
	InterfaceName              types.String                                                        `tfsdk:"interface_name"`
	GroupId                    types.Int64                                                         `tfsdk:"group_id"`
...
type RouterHSRPInterfaceAddressFamilyIPv4GroupV1SecondaryIpv4Addresses struct {
	Address types.String `tfsdk:"address"`
}
type RouterHSRPInterfaceAddressFamilyIPv4GroupV1TrackInterfaces struct {
	TrackName         types.String `tfsdk:"track_name"`
	PriorityDecrement types.Int64  `tfsdk:"priority_decrement"`
}
type RouterHSRPInterfaceAddressFamilyIPv4GroupV1TrackObjects struct {
	ObjectName        types.String `tfsdk:"object_name"`
	PriorityDecrement types.Int64  `tfsdk:"priority_decrement"`
}

func (data RouterHSRPInterfaceAddressFamilyIPv4GroupV1) getPath() string {
...
func (data RouterHSRPInterfaceAddressFamilyIPv4GroupV1Data) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XR-um-router-hsrp-cfg:/router/hsrp/interfaces/interface[interface-name=%s]/address-family/ipv4/hsrp/group-number-version-1s/group-number-version-1[group-number-version-1-id=%v]", data.InterfaceName.ValueString(), data.GroupId.ValueInt64())
}

func (data RouterHSRPInterfaceAddressFamilyIPv4GroupV1) toBody(ctx context.Context) string {
	body := "{}"
...
func (data *RouterHSRPInterfaceAddressFamilyIPv4GroupV1) updateFromBody(ctx context.Context, res []byte) {
...
func (data *RouterHSRPInterfaceAddressFamilyIPv4GroupV1Data) fromBody(ctx context.Context, res []byte) {
	...
	if value := gjson.GetBytes(res, "address.secondary-ipv4-addresses.secondary-ipv4-address"); value.Exists() {
		data.SecondaryIpv4Addresses = make([]RouterHSRPInterfaceAddressFamilyIPv4GroupV1SecondaryIpv4Addresses, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := RouterHSRPInterfaceAddressFamilyIPv4GroupV1SecondaryIpv4Addresses{}
	...
	if value := gjson.GetBytes(res, "track-interfaces.track-interface"); value.Exists() {
		data.TrackInterfaces = make([]RouterHSRPInterfaceAddressFamilyIPv4GroupV1TrackInterfaces, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := RouterHSRPInterfaceAddressFamilyIPv4GroupV1TrackInterfaces{}
	...
	if value := gjson.GetBytes(res, "track-objects.track-object"); value.Exists() {
		data.TrackObjects = make([]RouterHSRPInterfaceAddressFamilyIPv4GroupV1TrackObjects, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := RouterHSRPInterfaceAddressFamilyIPv4GroupV1TrackObjects{}
...
func (data *RouterHSRPInterfaceAddressFamilyIPv4GroupV1) getDeletedListItems(ctx context.Context, state RouterHSRPInterfaceAddressFamilyIPv4GroupV1) []string {
...
func (data *RouterHSRPInterfaceAddressFamilyIPv4GroupV1) getEmptyLeafsDelete(ctx context.Context) []string {
...
func (data *RouterHSRPInterfaceAddressFamilyIPv4GroupV1) getDeletePaths(ctx context.Context) []string {
