...
func (data *RouterHSRPInterfaceAddressFamilyIPv4GroupV2) fromBody(ctx context.Context, res []byte) {
...
func (data *RouterHSRPInterfaceAddressFamilyIPv4GroupV2) getDeletedItems(ctx context.Context, state RouterHSRPInterfaceAddressFamilyIPv4GroupV2) []string {
