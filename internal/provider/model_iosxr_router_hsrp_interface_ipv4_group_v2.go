...
func (data RouterHSRPInterfaceIPv4GroupV2) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data RouterHSRPInterfaceIPv4GroupV2) GetVersionConstraints() []helpers.FieldVersionConstraint {
...
func (data RouterHSRPInterfaceIPv4GroupV2) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
