...
type RouterIGMP struct {
	Device                             types.String              `tfsdk:"device"`
	Id                                 types.String              `tfsdk:"id"`
	DeleteMode                         types.String              `tfsdk:"delete_mode"`
	AccountingMaxHistory               types.Int64               `tfsdk:"accounting_max_history"`
	...
	SsmMapStatics                      []RouterIGMPSsmMapStatics `tfsdk:"ssm_map_statics"`
...
type RouterIGMPSsmMapStatics struct {
...
func (data RouterIGMP) getPath() string {
	return "Cisco-IOS-XR-um-router-igmp-cfg:/router/igmp"
}

func (data RouterIGMPData) getPath() string {
	return "Cisco-IOS-XR-um-router-igmp-cfg:/router/igmp"
}

// getXPath returns the XPath for NETCONF operations
func (data RouterIGMP) getXPath() string {
	path := "Cisco-IOS-XR-um-router-igmp-cfg:/router/igmp"
	return path
}

func (data RouterIGMPData) getXPath() string {
	path := "Cisco-IOS-XR-um-router-igmp-cfg:/router/igmp"
	return path
}
...
func (data *RouterIGMP) updateFromBody(ctx context.Context, res gjson.Result) {
	if value := res.Get("accounting.max-history"); value.Exists() && !data.AccountingMaxHistory.IsNull() {
		data.AccountingMaxHistory = types.Int64Value(value.Int())
	} else if data.AccountingMaxHistory.IsNull() {
		data.AccountingMaxHistory = types.Int64Null()
	}
	...
	if value := res.Get("robustness-count"); value.Exists() && !data.RobustnessCount.IsNull() {
	...
	if value := res.Get("traffic.profile"); value.Exists() && !data.TrafficProfile.IsNull() {
...
func (data RouterIGMP) toBodyXML(ctx context.Context, stateArg ...*RouterIGMP) string {
	var state *RouterIGMP
	if len(stateArg) > 0 {
		state = stateArg[0]
	}
	body := netconf.Body{}
	if !data.AccountingMaxHistory.IsNull() && !data.AccountingMaxHistory.IsUnknown() {
		body = helpers.SetFromXPath(body, data.getXPath()+"/accounting/max-history", strconv.FormatInt(data.AccountingMaxHistory.ValueInt64(), 10))
	}
	if !data.NsfLifetime.IsNull() && !data.NsfLifetime.IsUnknown() {
...
func (data *RouterIGMP) updateFromBodyXML(ctx context.Context, res xmldot.Result) {
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/accounting/max-history"); value.Exists() && !data.AccountingMaxHistory.IsNull() {
		data.AccountingMaxHistory = types.Int64Value(value.Int())
	} else if data.AccountingMaxHistory.IsNull() {
		data.AccountingMaxHistory = types.Int64Null()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/robustness-count"); value.Exists() && !data.RobustnessCount.IsNull() {
		data.RobustnessCount = types.Int64Value(value.Int())
	} else if data.RobustnessCount.IsNull() {
		data.RobustnessCount = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/maximum/groups"); value.Exists() && !data.MaximumGroups.IsNull() {
		data.MaximumGroups = types.Int64Value(value.Int())
	} else if data.MaximumGroups.IsNull() {
		data.MaximumGroups = types.Int64Null()
	}
	...
	for i := range data.SsmMapStatics {
		...
		if value := helpers.GetFromXPath(r, "address"); value.Exists() && !data.SsmMapStatics[i].Address.IsNull() {
			data.SsmMapStatics[i].Address = types.StringValue(value.String())
		} else if data.SsmMapStatics[i].Address.IsNull() {
			data.SsmMapStatics[i].Address = types.StringNull()
		}
		if value := helpers.GetFromXPath(r, "access-list"); value.Exists() && !data.SsmMapStatics[i].AccessList.IsNull() {
			data.SsmMapStatics[i].AccessList = types.StringValue(value.String())
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/missed-packets/gen-query"); value.Exists() && !data.MissedPacketsGenQuery.IsNull() {
		data.MissedPacketsGenQuery = types.Int64Value(value.Int())
	} else if data.MissedPacketsGenQuery.IsNull() {
		data.MissedPacketsGenQuery = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/missed-packets/grp-spec-query"); value.Exists() && !data.MissedPacketsGrpSpecQuery.IsNull() {
		data.MissedPacketsGrpSpecQuery = types.Int64Value(value.Int())
	} else if data.MissedPacketsGrpSpecQuery.IsNull() {
		data.MissedPacketsGrpSpecQuery = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/missed-packets/ssm-query"); value.Exists() && !data.MissedPacketsSsmQuery.IsNull() {
		data.MissedPacketsSsmQuery = types.Int64Value(value.Int())
	} else if data.MissedPacketsSsmQuery.IsNull() {
		data.MissedPacketsSsmQuery = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/missed-packets/member-report"); value.Exists() && !data.MissedPacketsMemberReport.IsNull() {
		data.MissedPacketsMemberReport = types.Int64Value(value.Int())
	} else if data.MissedPacketsMemberReport.IsNull() {
		data.MissedPacketsMemberReport = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/traffic/profile"); value.Exists() && !data.TrafficProfile.IsNull() {
		data.TrafficProfile = types.StringValue(value.String())
	} else if data.TrafficProfile.IsNull() {
		data.TrafficProfile = types.StringNull()
	}
...
func (data *RouterIGMP) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(prefix + "accounting.max-history"); value.Exists() {
		data.AccountingMaxHistory = types.Int64Value(value.Int())
	}
...
func (data *RouterIGMPData) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *RouterIGMP) fromBodyXML(ctx context.Context, res xmldot.Result) {
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/accounting/max-history"); value.Exists() {
		data.AccountingMaxHistory = types.Int64Value(value.Int())
	}
...
func (data *RouterIGMPData) fromBodyXML(ctx context.Context, res xmldot.Result) {
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/accounting/max-history"); value.Exists() {
		data.AccountingMaxHistory = types.Int64Value(value.Int())
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/nsf/lifetime"); value.Exists() {
...
func (data *RouterIGMP) getDeletedItems(ctx context.Context, state RouterIGMP) []string {
	...
	if !state.AccountingMaxHistory.IsNull() && data.AccountingMaxHistory.IsNull() {
		deletedItems = append(deletedItems, fmt.Sprintf("%v/accounting/max-history", state.getPath()))
	}
	return deletedItems
}
...
func (data *RouterIGMP) getEmptyLeafsDelete(ctx context.Context, state *RouterIGMP) []string {
...
func (data *RouterIGMP) getDeletePaths(ctx context.Context) []string {
	...
	if !data.AccountingMaxHistory.IsNull() {
		deletePaths = append(deletePaths, fmt.Sprintf("%v/accounting/max-history", data.getPath()))
	}
...
func (data *RouterIGMP) addDeletedItemsXML(ctx context.Context, state RouterIGMP, body string) string {
	...
	for i := range state.SsmMapStatics {
		...
		for j := range data.SsmMapStatics {
			...
			if found {
				if !state.SsmMapStatics[i].AccessList.IsNull() && data.SsmMapStatics[j].AccessList.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/ssm/map/statics/static%v/access-list", predicates))
				}
				break
			}
		}
		if !found {
			b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/ssm/map/statics/static%v", predicates))
		}
	}
	if !state.AccessGroup.IsNull() && data.AccessGroup.IsNull() {
	...
	if !state.AccountingMaxHistory.IsNull() && data.AccountingMaxHistory.IsNull() {
		deletePath := state.getXPath() + "/accounting/max-history"
		// Check if a parent path is already marked for deletion
		parentAlreadyDeleted := false
		for dp := range deletedPaths {
			if strings.HasPrefix(deletePath, dp+"/") {
...
func (data *RouterIGMP) addDeletePathsXML(ctx context.Context, body string) string {
	...
	if !data.AccountingMaxHistory.IsNull() {
		b = helpers.RemoveFromXPath(b, data.getXPath()+"/accounting/max-history")
	}
