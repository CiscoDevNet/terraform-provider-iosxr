...
func (data *RouterIGMPInterface) fromBody(ctx context.Context, res []byte) {
	...
	if value := gjson.GetBytes(res, "static-groups.group-address"); value.Exists() {
...
func (data *RouterIGMPInterfaceData) fromBody(ctx context.Context, res []byte) {
	if value := gjson.GetBytes(res, "version"); value.Exists() {
		data.Version = types.Int64Value(value.Int())
	}
	if value := gjson.GetBytes(res, "router.enable"); value.Exists() {
...
func (data *RouterIGMPInterface) getEmptyLeafsDelete(ctx context.Context) []string {
	...
	for i := range data.StaticGroups {
		...
		for ci := range data.StaticGroups[i].GroupMasksSourceAddresses {
			...
			if !data.StaticGroups[i].GroupMasksSourceAddresses[ci].SuppressReports.IsNull() && !data.StaticGroups[i].GroupMasksSourceAddresses[ci].SuppressReports.ValueBool() {
				emptyLeafsDelete = append(emptyLeafsDelete, fmt.Sprintf("%v/static-groups/group-address%v/group-address-inc-mask-source-address/inc-mask%v/suppress-reports", data.getPath(), keyString, ckeyString))
			}
		}
		for ci := range data.StaticGroups[i].SourceAddresses {
			ckeys := [...]string{"source-address"}
			...
			if !data.StaticGroups[i].SourceAddresses[ci].SuppressReports.IsNull() && !data.StaticGroups[i].SourceAddresses[ci].SuppressReports.ValueBool() {
				emptyLeafsDelete = append(emptyLeafsDelete, fmt.Sprintf("%v/static-groups/group-address%v/group-address-source-address/source-address%v/suppress-reports", data.getPath(), keyString, ckeyString))
			}
		}
		for ci := range data.StaticGroups[i].GroupMasks {
			ckeys := [...]string{"group-mask-address"}
			...
			if !data.StaticGroups[i].GroupMasks[ci].SuppressReports.IsNull() && !data.StaticGroups[i].GroupMasks[ci].SuppressReports.ValueBool() {
				emptyLeafsDelete = append(emptyLeafsDelete, fmt.Sprintf("%v/static-groups/group-address%v/group-address-inc-mask/inc-mask%v/suppress-reports", data.getPath(), keyString, ckeyString))
			}
		}
		if !data.StaticGroups[i].SuppressReports.IsNull() && !data.StaticGroups[i].SuppressReports.ValueBool() {
			emptyLeafsDelete = append(emptyLeafsDelete, fmt.Sprintf("%v/static-groups/group-address%v/group-address-only/suppress-reports", data.getPath(), keyString))
		}
		if !data.StaticGroups[i].GroupAddressOnly.IsNull() && !data.StaticGroups[i].GroupAddressOnly.ValueBool() {
			emptyLeafsDelete = append(emptyLeafsDelete, fmt.Sprintf("%v/static-groups/group-address%v/group-address-only", data.getPath(), keyString))
		}
	}
...
func (data *RouterIGMPInterface) getDeletePaths(ctx context.Context) []string {
	...
	for i := range data.StaticGroups {
		...
		deletePaths = append(deletePaths, fmt.Sprintf("%v/static-groups/group-address%v", data.getPath(), keyString))
	}
