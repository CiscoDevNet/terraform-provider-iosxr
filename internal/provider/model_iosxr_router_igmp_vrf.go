...
func (data *RouterIGMPVRF) updateFromBody(ctx context.Context, res gjson.Result) {
...
func (data RouterIGMPVRF) toBodyXML(ctx context.Context, stateArg ...*RouterIGMPVRF) string {
