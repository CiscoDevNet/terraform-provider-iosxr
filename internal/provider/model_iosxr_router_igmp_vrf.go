...
func (data RouterIGMPVRF) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data RouterIGMPVRF) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
