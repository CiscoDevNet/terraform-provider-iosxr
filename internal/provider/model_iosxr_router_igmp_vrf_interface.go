...
type RouterIGMPVRFInterface struct {
	...
	StaticGroups                       []RouterIGMPVRFInterfaceStaticGroups `tfsdk:"static_groups"`
	JoinGroups                         []RouterIGMPVRFInterfaceJoinGroups   `tfsdk:"join_groups"`
}

type RouterIGMPVRFInterfaceData struct {
	Device                             types.String                         `tfsdk:"device"`
	Id                                 types.String                         `tfsdk:"id"`
	VrfName                            types.String                         `tfsdk:"vrf_name"`
	InterfaceName                      types.String                         `tfsdk:"interface_name"`
...
type RouterIGMPVRFInterfaceStaticGroups struct {
	...
	GroupMasks                []RouterIGMPVRFInterfaceStaticGroupsGroupMasks                `tfsdk:"group_masks"`
	SourceAddresses           []RouterIGMPVRFInterfaceStaticGroupsSourceAddresses           `tfsdk:"source_addresses"`
	GroupMasksSourceAddresses []RouterIGMPVRFInterfaceStaticGroupsGroupMasksSourceAddresses `tfsdk:"group_masks_source_addresses"`
}
type RouterIGMPVRFInterfaceJoinGroups struct {
	GroupAddress     types.String                                      `tfsdk:"group_address"`
	GroupAddressOnly types.Bool                                        `tfsdk:"group_address_only"`
	SourceAddresses  []RouterIGMPVRFInterfaceJoinGroupsSourceAddresses `tfsdk:"source_addresses"`
}
type RouterIGMPVRFInterfaceStaticGroupsGroupMasks struct {
	GroupIncMask    types.String `tfsdk:"group_inc_mask"`
	GroupCount      types.Int64  `tfsdk:"group_count"`
	SuppressReports types.Bool   `tfsdk:"suppress_reports"`
}
type RouterIGMPVRFInterfaceStaticGroupsSourceAddresses struct {
	SourceIp        types.String `tfsdk:"source_ip"`
	SuppressReports types.Bool   `tfsdk:"suppress_reports"`
}
type RouterIGMPVRFInterfaceStaticGroupsGroupMasksSourceAddresses struct {
	GroupIncMask    types.String `tfsdk:"group_inc_mask"`
	SourceIp        types.String `tfsdk:"source_ip"`
	GroupCount      types.Int64  `tfsdk:"group_count"`
	SuppressReports types.Bool   `tfsdk:"suppress_reports"`
}
type RouterIGMPVRFInterfaceJoinGroupsSourceAddresses struct {
	SourceIp types.String `tfsdk:"source_ip"`
...
func (data RouterIGMPVRFInterface) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XR-um-router-igmp-cfg:/router/igmp/vrfs/vrf[vrf-name=%s]/interfaces/interface[interface-name=%s]", data.VrfName.ValueString(), data.InterfaceName.ValueString())
}

func (data RouterIGMPVRFInterfaceData) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XR-um-router-igmp-cfg:/router/igmp/vrfs/vrf[vrf-name=%s]/interfaces/interface[interface-name=%s]", data.VrfName.ValueString(), data.InterfaceName.ValueString())
}

// getXPath returns the XPath for NETCONF operations
func (data RouterIGMPVRFInterface) getXPath() string {
	path := "Cisco-IOS-XR-um-router-igmp-cfg:/router/igmp/vrfs/vrf[vrf-name=%s]/interfaces/interface[interface-name=%s]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.VrfName.ValueString()), fmt.Sprintf("%v", data.InterfaceName.ValueString()))
	return path
}

func (data RouterIGMPVRFInterfaceData) getXPath() string {
	path := "Cisco-IOS-XR-um-router-igmp-cfg:/router/igmp/vrfs/vrf[vrf-name=%s]/interfaces/interface[interface-name=%s]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.VrfName.ValueString()), fmt.Sprintf("%v", data.InterfaceName.ValueString()))
	return path
}
...
func (data RouterIGMPVRFInterface) toBodyXML(ctx context.Context) string {
	body := netconf.Body{}
	if !data.Version.IsNull() && !data.Version.IsUnknown() {
