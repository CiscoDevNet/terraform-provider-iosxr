...
func (data RouterMLD) getPath() string {
	return "Cisco-IOS-XR-um-router-mld-cfg:/router/mld"
}

func (data RouterMLDData) getPath() string {
	return "Cisco-IOS-XR-um-router-mld-cfg:/router/mld"
}

// getXPath returns the XPath for NETCONF operations
func (data RouterMLD) getXPath() string {
	path := "Cisco-IOS-XR-um-router-mld-cfg:/router/mld"
	return path
}

func (data RouterMLDData) getXPath() string {
	path := "Cisco-IOS-XR-um-router-mld-cfg:/router/mld"
	return path
}
...
func (data RouterMLD) toBody(ctx context.Context) string {
	body := "{}"
	...
	if !data.RobustnessVariable.IsNull() && !data.RobustnessVariable.IsUnknown() {
		body, _ = sjson.Set(body, "robustness-variable", strconv.FormatInt(data.RobustnessVariable.ValueInt64(), 10))
	}
...
func (data *RouterMLD) updateFromBodyXML(ctx context.Context, res xmldot.Result) {
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/robustness-variable"); value.Exists() && !data.RobustnessVariable.IsNull() {
		data.RobustnessVariable = types.Int64Value(value.Int())
	} else if data.RobustnessVariable.IsNull() {
		data.RobustnessVariable = types.Int64Null()
	}
...
func (data *RouterMLD) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *RouterMLDData) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *RouterMLD) getEmptyLeafsDelete(ctx context.Context, state *RouterMLD) []string {
...
func (data *RouterMLD) addDeletedItemsXML(ctx context.Context, state RouterMLD, body string) string {
...
func (data *RouterMLD) addDeletePathsXML(ctx context.Context, body string) string {
	...
	if !data.RobustnessVariable.IsNull() {
		b = helpers.RemoveFromXPath(b, data.getXPath()+"/robustness-variable")
	}
	if !data.NsfLifetime.IsNull() {
