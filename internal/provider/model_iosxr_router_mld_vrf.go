...
type RouterMLDVRF struct {
	...
	SsmMapStatics                      []RouterMLDVRFSsmMapStatics `tfsdk:"ssm_map_statics"`
...
type RouterMLDVRFSsmMapStatics struct {
...
func (data RouterMLDVRF) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XR-um-router-mld-cfg:/router/mld/vrfs/vrf[vrf-name=%s]", data.VrfName.ValueString())
}

func (data RouterMLDVRFData) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XR-um-router-mld-cfg:/router/mld/vrfs/vrf[vrf-name=%s]", data.VrfName.ValueString())
}

// getXPath returns the XPath for NETCONF operations
func (data RouterMLDVRF) getXPath() string {
	path := "Cisco-IOS-XR-um-router-mld-cfg:/router/mld/vrfs/vrf[vrf-name=%s]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.VrfName.ValueString()))
	return path
}

func (data RouterMLDVRFData) getXPath() string {
	path := "Cisco-IOS-XR-um-router-mld-cfg:/router/mld/vrfs/vrf[vrf-name=%s]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.VrfName.ValueString()))
	return path
}
...
func (data RouterMLDVRF) toBodyXML(ctx context.Context) string {
	body := netconf.Body{}
	if !data.RobustnessVariable.IsNull() && !data.RobustnessVariable.IsUnknown() {
