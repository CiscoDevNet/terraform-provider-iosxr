...
func (data RouterOSPFAreaInterface) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data RouterOSPFAreaInterface) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
