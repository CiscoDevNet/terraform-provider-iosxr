...
func (data *RouterPIMVRFIPv4) fromBody(ctx context.Context, res []byte) {
...
func (data *RouterPIMVRFIPv4Data) fromBody(ctx context.Context, res []byte) {
	if value := gjson.GetBytes(res, "rp-addresses.rp-address"); value.Exists() {
		data.RpAddresses = make([]RouterPIMVRFIPv4RpAddresses, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := RouterPIMVRFIPv4RpAddresses{}
...
func (data *RouterPIMVRFIPv4) getEmptyLeafsDelete(ctx context.Context) []string {
