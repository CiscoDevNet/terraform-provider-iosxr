...
func (data RouterStaticIPv4Multicast) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data RouterStaticIPv4Multicast) GetVersionConstraints() []helpers.FieldVersionConstraint {
...
func (data RouterStaticIPv4Multicast) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
