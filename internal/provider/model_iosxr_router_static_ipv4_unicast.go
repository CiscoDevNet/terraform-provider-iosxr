...
func (data *RouterStaticIPv4Unicast) updateFromBody(ctx context.Context, res gjson.Result) {
...
func (data RouterStaticIPv4Unicast) toBodyXML(ctx context.Context, stateArg ...*RouterStaticIPv4Unicast) string {
