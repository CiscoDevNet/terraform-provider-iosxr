...
func (data RouterStaticIPv4Unicast) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data RouterStaticIPv4Unicast) GetVersionConstraints() []helpers.FieldVersionConstraint {
...
func (data RouterStaticIPv4Unicast) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
...
func (data *RouterStaticIPv4Unicast) fromBody(ctx context.Context, res []byte) {
