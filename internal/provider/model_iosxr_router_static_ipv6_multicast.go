...
func (data *RouterStaticIPv6Multicast) updateFromBody(ctx context.Context, res []byte) {
...
func (data RouterStaticIPv6Multicast) toBodyXML(ctx context.Context) string {
	body := netconf.Body{}
	if len(data.NexthopInterfaces) > 0 {
