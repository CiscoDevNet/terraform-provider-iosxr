...
type RouterStaticIPv6Multicast struct {
	...
	SrPolicies                []RouterStaticIPv6MulticastSrPolicies                `tfsdk:"sr_policies"`
...
type RouterStaticIPv6MulticastSrPolicies struct {
...
type RouterStaticIPv6MulticastVrfs struct {
	...
	SrPolicies                []RouterStaticIPv6MulticastVrfsSrPolicies                `tfsdk:"sr_policies"`
}
...
type RouterStaticIPv6MulticastVrfsSrPolicies struct {
	SrPolicyName   types.String `tfsdk:"sr_policy_name"`
	Description    types.String `tfsdk:"description"`
	Tag            types.Int64  `tfsdk:"tag"`
	DistanceMetric types.Int64  `tfsdk:"distance_metric"`
...
func (data RouterStaticIPv6Multicast) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XR-um-router-static-cfg:/router/static/address-family/ipv6/multicast/prefixes/prefix[prefix-address=%s][prefix-length=%d]", data.PrefixAddress.ValueString(), data.PrefixLength.ValueInt64())
}

func (data RouterStaticIPv6MulticastData) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XR-um-router-static-cfg:/router/static/address-family/ipv6/multicast/prefixes/prefix[prefix-address=%s][prefix-length=%d]", data.PrefixAddress.ValueString(), data.PrefixLength.ValueInt64())
}

// getXPath returns the XPath for NETCONF operations
func (data RouterStaticIPv6Multicast) getXPath() string {
	path := "Cisco-IOS-XR-um-router-static-cfg:/router/static/address-family/ipv6/multicast/prefixes/prefix[prefix-address=%s][prefix-length=%d]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.PrefixAddress.ValueString()), data.PrefixLength.ValueInt64())
	return path
}

func (data RouterStaticIPv6MulticastData) getXPath() string {
	path := "Cisco-IOS-XR-um-router-static-cfg:/router/static/address-family/ipv6/multicast/prefixes/prefix[prefix-address=%s][prefix-length=%d]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.PrefixAddress.ValueString()), data.PrefixLength.ValueInt64())
	return path
}
...
func (data RouterStaticIPv6Multicast) toBody(ctx context.Context) string {
	body := "{}"
...
func (data *RouterStaticIPv6Multicast) updateFromBody(ctx context.Context, res gjson.Result) {
...
func (data RouterStaticIPv6Multicast) toBodyXML(ctx context.Context, stateArg ...*RouterStaticIPv6Multicast) string {
...
func (data *RouterStaticIPv6Multicast) updateFromBodyXML(ctx context.Context, res xmldot.Result) {
	for i := range data.NexthopInterfaces {
		keys := [...]string{"interface-name"}
		keyValues := [...]string{data.NexthopInterfaces[i].InterfaceName.ValueString()}
...
func (data *RouterStaticIPv6Multicast) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(prefix + "nexthop-interfaces.nexthop-interface"); value.Exists() {
		data.NexthopInterfaces = make([]RouterStaticIPv6MulticastNexthopInterfaces, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := RouterStaticIPv6MulticastNexthopInterfaces{}
	...
	if value := res.Get(prefix + "nexthop-interface-addresses.nexthop-interface-address"); value.Exists() {
		data.NexthopInterfaceAddresses = make([]RouterStaticIPv6MulticastNexthopInterfaceAddresses, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := RouterStaticIPv6MulticastNexthopInterfaceAddresses{}
			if cValue := v.Get("interface-name"); cValue.Exists() {
				item.InterfaceName = types.StringValue(cValue.String())
			}
	...
	if value := res.Get(prefix + "nexthop-addresses.nexthop-address"); value.Exists() {
		data.NexthopAddresses = make([]RouterStaticIPv6MulticastNexthopAddresses, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := RouterStaticIPv6MulticastNexthopAddresses{}
			if cValue := v.Get("address"); cValue.Exists() {
				item.Address = types.StringValue(cValue.String())
			}
			if cValue := v.Get("bfd.fast-detect.minimum-interval"); cValue.Exists() {
	...
	if value := res.Get(prefix + "sr-policies.sr-policy"); value.Exists() {
		data.SrPolicies = make([]RouterStaticIPv6MulticastSrPolicies, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := RouterStaticIPv6MulticastSrPolicies{}
	...
	if value := res.Get(prefix + "vrfs.vrf"); value.Exists() {
		data.Vrfs = make([]RouterStaticIPv6MulticastVrfs, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := RouterStaticIPv6MulticastVrfs{}
			...
			if cValue := v.Get("nexthop-interfaces.nexthop-interface"); cValue.Exists() {
				item.NexthopInterfaces = make([]RouterStaticIPv6MulticastVrfsNexthopInterfaces, 0)
				cValue.ForEach(func(ck, cv gjson.Result) bool {
					cItem := RouterStaticIPv6MulticastVrfsNexthopInterfaces{}
			...
			if cValue := v.Get("nexthop-interface-addresses.nexthop-interface-address"); cValue.Exists() {
				item.NexthopInterfaceAddresses = make([]RouterStaticIPv6MulticastVrfsNexthopInterfaceAddresses, 0)
				cValue.ForEach(func(ck, cv gjson.Result) bool {
					cItem := RouterStaticIPv6MulticastVrfsNexthopInterfaceAddresses{}
					if ccValue := cv.Get("interface-name"); ccValue.Exists() {
						cItem.InterfaceName = types.StringValue(ccValue.String())
					}
			...
			if cValue := v.Get("nexthop-addresses.nexthop-address"); cValue.Exists() {
				item.NexthopAddresses = make([]RouterStaticIPv6MulticastVrfsNexthopAddresses, 0)
				cValue.ForEach(func(ck, cv gjson.Result) bool {
					cItem := RouterStaticIPv6MulticastVrfsNexthopAddresses{}
					if ccValue := cv.Get("address"); ccValue.Exists() {
						cItem.Address = types.StringValue(ccValue.String())
					}
					if ccValue := cv.Get("bfd.fast-detect.minimum-interval"); ccValue.Exists() {
			...
			if cValue := v.Get("sr-policies.sr-policy"); cValue.Exists() {
				item.SrPolicies = make([]RouterStaticIPv6MulticastVrfsSrPolicies, 0)
				cValue.ForEach(func(ck, cv gjson.Result) bool {
					cItem := RouterStaticIPv6MulticastVrfsSrPolicies{}
...
func (data *RouterStaticIPv6MulticastData) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *RouterStaticIPv6Multicast) fromBodyXML(ctx context.Context, res xmldot.Result) {
...
func (data *RouterStaticIPv6MulticastData) fromBodyXML(ctx context.Context, res xmldot.Result) {
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/nexthop-interfaces/nexthop-interface"); value.Exists() {
		data.NexthopInterfaces = make([]RouterStaticIPv6MulticastNexthopInterfaces, 0)
		value.ForEach(func(_ int, v xmldot.Result) bool {
			item := RouterStaticIPv6MulticastNexthopInterfaces{}
...
func (data *RouterStaticIPv6Multicast) getEmptyLeafsDelete(ctx context.Context, state *RouterStaticIPv6Multicast) []string {
...
func (data *RouterStaticIPv6Multicast) getDeletePaths(ctx context.Context) []string {
...
func (data *RouterStaticIPv6Multicast) addDeletedItemsXML(ctx context.Context, state RouterStaticIPv6Multicast, body string) string {
...
func (data *RouterStaticIPv6Multicast) addDeletePathsXML(ctx context.Context, body string) string {
