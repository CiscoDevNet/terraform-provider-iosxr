...
type RouterStaticIPv6Unicast struct {
	...
	SrPolicies                []RouterStaticIPv6UnicastSrPolicies                `tfsdk:"sr_policies"`
...
type RouterStaticIPv6UnicastSrPolicies struct {
...
type RouterStaticIPv6UnicastVrfs struct {
	...
	SrPolicies                []RouterStaticIPv6UnicastVrfsSrPolicies                `tfsdk:"sr_policies"`
}
...
type RouterStaticIPv6UnicastVrfsSrPolicies struct {
	SrPolicyName   types.String `tfsdk:"sr_policy_name"`
	Description    types.String `tfsdk:"description"`
	Tag            types.Int64  `tfsdk:"tag"`
	DistanceMetric types.Int64  `tfsdk:"distance_metric"`
...
func (data RouterStaticIPv6Unicast) getXPath() string {
	path := "Cisco-IOS-XR-um-router-static-cfg:/router/static/address-family/ipv6/unicast/prefixes/prefix[prefix-address=%s][prefix-length=%d]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.PrefixAddress.ValueString()), data.PrefixLength.ValueInt64())
	return path
}

func (data RouterStaticIPv6UnicastData) getXPath() string {
	path := "Cisco-IOS-XR-um-router-static-cfg:/router/static/address-family/ipv6/unicast/prefixes/prefix[prefix-address=%s][prefix-length=%d]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.PrefixAddress.ValueString()), data.PrefixLength.ValueInt64())
	return path
}
...
func (data *RouterStaticIPv6Unicast) updateFromBody(ctx context.Context, res gjson.Result) {
...
func (data RouterStaticIPv6Unicast) toBodyXML(ctx context.Context, stateArg ...*RouterStaticIPv6Unicast) string {
	var state *RouterStaticIPv6Unicast
	if len(stateArg) > 0 {
		state = stateArg[0]
	}
	body := netconf.Body{}
...
func (data *RouterStaticIPv6Unicast) updateFromBodyXML(ctx context.Context, res xmldot.Result) {
	for i := range data.NexthopInterfaces {
		keys := [...]string{"interface-name"}
		keyValues := [...]string{data.NexthopInterfaces[i].InterfaceName.ValueString()}
...
func (data *RouterStaticIPv6Unicast) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *RouterStaticIPv6UnicastData) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *RouterStaticIPv6Unicast) fromBodyXML(ctx context.Context, res xmldot.Result) {
...
func (data *RouterStaticIPv6UnicastData) fromBodyXML(ctx context.Context, res xmldot.Result) {
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/nexthop-interfaces/nexthop-interface"); value.Exists() {
		data.NexthopInterfaces = make([]RouterStaticIPv6UnicastNexthopInterfaces, 0)
		value.ForEach(func(_ int, v xmldot.Result) bool {
			item := RouterStaticIPv6UnicastNexthopInterfaces{}
...
func (data *RouterStaticIPv6Unicast) getEmptyLeafsDelete(ctx context.Context, state *RouterStaticIPv6Unicast) []string {
...
func (data *RouterStaticIPv6Unicast) addDeletedItemsXML(ctx context.Context, state RouterStaticIPv6Unicast, body string) string {
...
func (data *RouterStaticIPv6Unicast) addDeletePathsXML(ctx context.Context, body string) string {
