...
type RouterStaticVRFIPv4Unicast struct {
	...
	SrPolicies                []RouterStaticVRFIPv4UnicastSrPolicies                `tfsdk:"sr_policies"`
...
type RouterStaticVRFIPv4UnicastSrPolicies struct {
...
type RouterStaticVRFIPv4UnicastVrfs struct {
	...
	SrPolicies                []RouterStaticVRFIPv4UnicastVrfsSrPolicies                `tfsdk:"sr_policies"`
}
...
type RouterStaticVRFIPv4UnicastVrfsSrPolicies struct {
	SrPolicyName   types.String `tfsdk:"sr_policy_name"`
	Description    types.String `tfsdk:"description"`
	Tag            types.Int64  `tfsdk:"tag"`
	DistanceMetric types.Int64  `tfsdk:"distance_metric"`
...
func (data RouterStaticVRFIPv4Unicast) getXPath() string {
...
func (data RouterStaticVRFIPv4UnicastData) getXPath() string {
	path := "Cisco-IOS-XR-um-router-static-cfg:/router/static/vrfs/vrf[vrf-name=%s]/address-family/ipv4/unicast/prefixes/prefix[prefix-address=%s][prefix-length=%d]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.VrfName.ValueString()), fmt.Sprintf("%v", data.PrefixAddress.ValueString()), data.PrefixLength.ValueInt64())
	return path
}
...
func (data *RouterStaticVRFIPv4Unicast) updateFromBody(ctx context.Context, res gjson.Result) {
...
func (data RouterStaticVRFIPv4Unicast) toBodyXML(ctx context.Context, stateArg ...*RouterStaticVRFIPv4Unicast) string {
...
func (data *RouterStaticVRFIPv4Unicast) updateFromBodyXML(ctx context.Context, res xmldot.Result) {
	for i := range data.NexthopInterfaces {
		keys := [...]string{"interface-name"}
		keyValues := [...]string{data.NexthopInterfaces[i].InterfaceName.ValueString()}
...
func (data *RouterStaticVRFIPv4Unicast) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(prefix + "sr-policies.sr-policy"); value.Exists() {
		data.SrPolicies = make([]RouterStaticVRFIPv4UnicastSrPolicies, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := RouterStaticVRFIPv4UnicastSrPolicies{}
	...
	if value := res.Get(prefix + "vrfs.vrf"); value.Exists() {
		...
		value.ForEach(func(k, v gjson.Result) bool {
			...
			if cValue := v.Get("sr-policies.sr-policy"); cValue.Exists() {
				item.SrPolicies = make([]RouterStaticVRFIPv4UnicastVrfsSrPolicies, 0)
				cValue.ForEach(func(ck, cv gjson.Result) bool {
					cItem := RouterStaticVRFIPv4UnicastVrfsSrPolicies{}
...
func (data *RouterStaticVRFIPv4UnicastData) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *RouterStaticVRFIPv4Unicast) fromBodyXML(ctx context.Context, res xmldot.Result) {
...
func (data *RouterStaticVRFIPv4UnicastData) fromBodyXML(ctx context.Context, res xmldot.Result) {
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/nexthop-interfaces/nexthop-interface"); value.Exists() {
		data.NexthopInterfaces = make([]RouterStaticVRFIPv4UnicastNexthopInterfaces, 0)
		value.ForEach(func(_ int, v xmldot.Result) bool {
			item := RouterStaticVRFIPv4UnicastNexthopInterfaces{}
...
func (data *RouterStaticVRFIPv4Unicast) getEmptyLeafsDelete(ctx context.Context, state *RouterStaticVRFIPv4Unicast) []string {
...
func (data *RouterStaticVRFIPv4Unicast) addDeletedItemsXML(ctx context.Context, state RouterStaticVRFIPv4Unicast, body string) string {
...
func (data *RouterStaticVRFIPv4Unicast) addDeletePathsXML(ctx context.Context, body string) string {
