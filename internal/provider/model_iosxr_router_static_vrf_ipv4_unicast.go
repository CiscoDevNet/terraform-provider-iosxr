...
func (data RouterStaticVRFIPv4Unicast) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data RouterStaticVRFIPv4Unicast) GetVersionConstraints() []helpers.FieldVersionConstraint {
...
func (data RouterStaticVRFIPv4Unicast) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
