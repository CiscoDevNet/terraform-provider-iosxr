...
func (data RouterStaticVRFIPv6Multicast) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XR-um-router-static-cfg:/router/static/vrfs/vrf[vrf-name=%s]/address-family/ipv6/multicast/prefixes/prefix[prefix-address=%s][prefix-length=%d]", data.VrfName.ValueString(), data.PrefixAddress.ValueString(), data.PrefixLength.ValueInt64())
}

func (data RouterStaticVRFIPv6MulticastData) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XR-um-router-static-cfg:/router/static/vrfs/vrf[vrf-name=%s]/address-family/ipv6/multicast/prefixes/prefix[prefix-address=%s][prefix-length=%d]", data.VrfName.ValueString(), data.PrefixAddress.ValueString(), data.PrefixLength.ValueInt64())
}

// getXPath returns the XPath for NETCONF operations
func (data RouterStaticVRFIPv6Multicast) getXPath() string {
	path := "Cisco-IOS-XR-um-router-static-cfg:/router/static/vrfs/vrf[vrf-name=%s]/address-family/ipv6/multicast/prefixes/prefix[prefix-address=%s][prefix-length=%d]"
...
func (data RouterStaticVRFIPv6MulticastData) getXPath() string {
	path := "Cisco-IOS-XR-um-router-static-cfg:/router/static/vrfs/vrf[vrf-name=%s]/address-family/ipv6/multicast/prefixes/prefix[prefix-address=%s][prefix-length=%d]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.VrfName.ValueString()), fmt.Sprintf("%v", data.PrefixAddress.ValueString()), data.PrefixLength.ValueInt64())
	return path
}
...
func (data *RouterStaticVRFIPv6Multicast) updateFromBody(ctx context.Context, res gjson.Result) {
...
func (data RouterStaticVRFIPv6Multicast) toBodyXML(ctx context.Context, stateArg ...*RouterStaticVRFIPv6Multicast) string {
...
func (data *RouterStaticVRFIPv6Multicast) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get(prefix + "vrfs.vrf"); value.Exists() {
		...
		value.ForEach(func(k, v gjson.Result) bool {
			...
			if cValue := v.Get("nexthop-interfaces.nexthop-interface"); cValue.Exists() {
				item.NexthopInterfaces = make([]RouterStaticVRFIPv6MulticastVrfsNexthopInterfaces, 0)
...
func (data *RouterStaticVRFIPv6MulticastData) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *RouterStaticVRFIPv6Multicast) addDeletedItemsXML(ctx context.Context, state RouterStaticVRFIPv6Multicast, body string) string {
