...
type RouterStaticVRFIPv6Unicast struct {
	...
	SrPolicies                []RouterStaticVRFIPv6UnicastSrPolicies                `tfsdk:"sr_policies"`
...
type RouterStaticVRFIPv6UnicastSrPolicies struct {
...
type RouterStaticVRFIPv6UnicastVrfs struct {
	...
	SrPolicies                []RouterStaticVRFIPv6UnicastVrfsSrPolicies                `tfsdk:"sr_policies"`
}
...
type RouterStaticVRFIPv6UnicastVrfsSrPolicies struct {
	SrPolicyName   types.String `tfsdk:"sr_policy_name"`
	Description    types.String `tfsdk:"description"`
	Tag            types.Int64  `tfsdk:"tag"`
	DistanceMetric types.Int64  `tfsdk:"distance_metric"`
...
func (data RouterStaticVRFIPv6Unicast) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XR-um-router-static-cfg:/router/static/vrfs/vrf[vrf-name=%s]/address-family/ipv6/unicast/prefixes/prefix[prefix-address=%s][prefix-length=%d]", data.VrfName.ValueString(), data.PrefixAddress.ValueString(), data.PrefixLength.ValueInt64())
}

func (data RouterStaticVRFIPv6UnicastData) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XR-um-router-static-cfg:/router/static/vrfs/vrf[vrf-name=%s]/address-family/ipv6/unicast/prefixes/prefix[prefix-address=%s][prefix-length=%d]", data.VrfName.ValueString(), data.PrefixAddress.ValueString(), data.PrefixLength.ValueInt64())
}

// getXPath returns the XPath for NETCONF operations
func (data RouterStaticVRFIPv6Unicast) getXPath() string {
	path := "Cisco-IOS-XR-um-router-static-cfg:/router/static/vrfs/vrf[vrf-name=%s]/address-family/ipv6/unicast/prefixes/prefix[prefix-address=%s][prefix-length=%d]"
...
func (data RouterStaticVRFIPv6UnicastData) getXPath() string {
	path := "Cisco-IOS-XR-um-router-static-cfg:/router/static/vrfs/vrf[vrf-name=%s]/address-family/ipv6/unicast/prefixes/prefix[prefix-address=%s][prefix-length=%d]"
	path = fmt.Sprintf(path, fmt.Sprintf("%v", data.VrfName.ValueString()), fmt.Sprintf("%v", data.PrefixAddress.ValueString()), data.PrefixLength.ValueInt64())
	return path
}
...
func (data RouterStaticVRFIPv6Unicast) toBodyXML(ctx context.Context) string {
	body := netconf.Body{}
	if len(data.NexthopInterfaces) > 0 {
