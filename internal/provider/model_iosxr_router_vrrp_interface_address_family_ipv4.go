...
type RouterVRRPInterfaceAddressFamilyIPv4 struct {
	...
	SecondaryAddresses             []RouterVRRPInterfaceAddressFamilyIPv4SecondaryAddresses `tfsdk:"secondary_addresses"`
	...
	TrackInterfaces                []RouterVRRPInterfaceAddressFamilyIPv4TrackInterfaces    `tfsdk:"track_interfaces"`
	TrackObjects                   []RouterVRRPInterfaceAddressFamilyIPv4TrackObjects       `tfsdk:"track_objects"`
	BfdFastDetectPeerIpv4          types.String                                             `tfsdk:"bfd_fast_detect_peer_ipv4"`
}

type RouterVRRPInterfaceAddressFamilyIPv4Data struct {
	Device                         types.String                                             `tfsdk:"device"`
	Id                             types.String                                             `tfsdk:"id"`
	InterfaceName                  types.String                                             `tfsdk:"interface_name"`
	VrrpId                         types.Int64                                              `tfsdk:"vrrp_id"`
...
type RouterVRRPInterfaceAddressFamilyIPv4SecondaryAddresses struct {
	Address types.String `tfsdk:"address"`
}
type RouterVRRPInterfaceAddressFamilyIPv4TrackInterfaces struct {
	InterfaceName     types.String `tfsdk:"interface_name"`
	PriorityDecrement types.Int64  `tfsdk:"priority_decrement"`
}
type RouterVRRPInterfaceAddressFamilyIPv4TrackObjects struct {
	ObjectName        types.String `tfsdk:"object_name"`
	PriorityDecrement types.Int64  `tfsdk:"priority_decrement"`
}

func (data RouterVRRPInterfaceAddressFamilyIPv4) getPath() string {
...
func (data RouterVRRPInterfaceAddressFamilyIPv4Data) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XR-um-router-vrrp-cfg:/router/vrrp/interfaces/interface[interface-name=%s]/address-family/ipv4/vrrps/vrrp[vrrp-id=%d][version=%d]", data.InterfaceName.ValueString(), data.VrrpId.ValueInt64(), data.Version.ValueInt64())
}

func (data RouterVRRPInterfaceAddressFamilyIPv4) toBody(ctx context.Context) string {
	body := "{}"
...
func (data *RouterVRRPInterfaceAddressFamilyIPv4) updateFromBody(ctx context.Context, res []byte) {
...
func (data *RouterVRRPInterfaceAddressFamilyIPv4) getDeletePaths(ctx context.Context) []string {
