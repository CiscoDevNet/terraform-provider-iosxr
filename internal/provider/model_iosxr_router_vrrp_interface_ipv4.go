...
func (data RouterVRRPInterfaceIPv4) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data RouterVRRPInterfaceIPv4) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
