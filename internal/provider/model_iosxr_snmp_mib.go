...
func (data SNMPMIB) getPath() string {
	return "Cisco-IOS-XR-um-snmp-server-cfg:snmp-server-mibs"
}

func (data SNMPMIB) toBody(ctx context.Context) string {
	body := "{}"
...
func (data *SNMPMIB) updateFromBody(ctx context.Context, res []byte) {
...
func (data *SNMPMIB) fromBody(ctx context.Context, res []byte) {
...
func (data *SNMPMIB) fromPlan(ctx context.Context, plan SNMPMIB) {
	data.Device = plan.Device
}

func (data *SNMPMIB) getDeletedListItems(ctx context.Context, state SNMPMIB) []string {
	deletedListItems := make([]string, 0)
	return deletedListItems
}

func (data *SNMPMIB) getEmptyLeafsDelete(ctx context.Context) []string {
