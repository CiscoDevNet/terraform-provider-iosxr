...
func (data SNMPServerVRFHost) toBody(ctx context.Context, providerVersion string) string {
	body := "{}"
...
func (data SNMPServerVRFHost) GetVersionConstraints() []helpers.FieldVersionConstraint {
...
func (data SNMPServerVRFHost) GetRangeConstraints() []helpers.FieldRangeConstraint {
	return nil
}
