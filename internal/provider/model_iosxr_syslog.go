...
func (data Syslog) getPath() string {
	return "Cisco-IOS-XR-um-logging-cfg:/logging"
}

func (data Syslog) toBody(ctx context.Context) string {
	body := "{}"
...
func (data *Syslog) updateFromBody(ctx context.Context, res []byte) {
...
func (data *Syslog) fromBody(ctx context.Context, res []byte) {
...
func (data *Syslog) fromPlan(ctx context.Context, plan Syslog) {
...
func (data *Syslog) getEmptyLeafsDelete(ctx context.Context) []string {
