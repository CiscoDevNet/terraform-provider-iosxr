...
func (data *TPA) updateFromBodyXML(ctx context.Context, res xmldot.Result) {
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/statistics/update-frequency"); value.Exists() && !data.StatisticsUpdateFrequency.IsNull() {
		data.StatisticsUpdateFrequency = types.Int64Value(value.Int())
	} else if data.StatisticsUpdateFrequency.IsNull() {
		data.StatisticsUpdateFrequency = types.Int64Null()
	}
	...
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/statistics/max-lpts-events"); value.Exists() && !data.StatisticsMaxLptsEvents.IsNull() {
		data.StatisticsMaxLptsEvents = types.Int64Value(value.Int())
	} else if data.StatisticsMaxLptsEvents.IsNull() {
		data.StatisticsMaxLptsEvents = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/statistics/max-intf-events"); value.Exists() && !data.StatisticsMaxIntfEvents.IsNull() {
		data.StatisticsMaxIntfEvents = types.Int64Value(value.Int())
	} else if data.StatisticsMaxIntfEvents.IsNull() {
		data.StatisticsMaxIntfEvents = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/logging/kim/file-max-size-kb"); value.Exists() && !data.LoggingFileMaxSizeKb.IsNull() {
		data.LoggingFileMaxSizeKb = types.Int64Value(value.Int())
	} else if data.LoggingFileMaxSizeKb.IsNull() {
		data.LoggingFileMaxSizeKb = types.Int64Null()
	}
	if value := helpers.GetFromXPath(res, "data/"+data.getXPath()+"/logging/kim/rotation-max"); value.Exists() && !data.LoggingRotationMaxFiles.IsNull() {
		data.LoggingRotationMaxFiles = types.Int64Value(value.Int())
	} else if data.LoggingRotationMaxFiles.IsNull() {
		data.LoggingRotationMaxFiles = types.Int64Null()
	}
	for i := range data.Vrfs {
		...
		if value := helpers.GetFromXPath(r, "address-family/ipv4/update-source/dataports/interface"); value.Exists() && !data.Vrfs[i].Ipv4UpdateSourceDataports.IsNull() {
			data.Vrfs[i].Ipv4UpdateSourceDataports = types.StringValue(value.String())
		...
		if value := helpers.GetFromXPath(r, "address-family/ipv6/update-source/dataports/interface"); value.Exists() && !data.Vrfs[i].Ipv6UpdateSourceDataports.IsNull() {
			data.Vrfs[i].Ipv6UpdateSourceDataports = types.StringValue(value.String())
		...
		for ci := range data.Vrfs[i].Ipv4UpdateSourceDestinations {
			...
			if value := helpers.GetFromXPath(cr, "destination-interface"); value.Exists() && !data.Vrfs[i].Ipv4UpdateSourceDestinations[ci].DestinationInterface.IsNull() {
				data.Vrfs[i].Ipv4UpdateSourceDestinations[ci].DestinationInterface = types.StringValue(value.String())
			} else if data.Vrfs[i].Ipv4UpdateSourceDestinations[ci].DestinationInterface.IsNull() {
				data.Vrfs[i].Ipv4UpdateSourceDestinations[ci].DestinationInterface = types.StringNull()
			}
			if value := helpers.GetFromXPath(cr, "source"); value.Exists() && !data.Vrfs[i].Ipv4UpdateSourceDestinations[ci].SourceInterface.IsNull() {
				data.Vrfs[i].Ipv4UpdateSourceDestinations[ci].SourceInterface = types.StringValue(value.String())
			} else if data.Vrfs[i].Ipv4UpdateSourceDestinations[ci].SourceInterface.IsNull() {
				data.Vrfs[i].Ipv4UpdateSourceDestinations[ci].SourceInterface = types.StringNull()
			}
		}
		for ci := range data.Vrfs[i].Ipv6UpdateSourceDestinations {
			...
			if value := helpers.GetFromXPath(cr, "destination-interface"); value.Exists() && !data.Vrfs[i].Ipv6UpdateSourceDestinations[ci].DestinationInterface.IsNull() {
				data.Vrfs[i].Ipv6UpdateSourceDestinations[ci].DestinationInterface = types.StringValue(value.String())
			} else if data.Vrfs[i].Ipv6UpdateSourceDestinations[ci].DestinationInterface.IsNull() {
				data.Vrfs[i].Ipv6UpdateSourceDestinations[ci].DestinationInterface = types.StringNull()
			}
			if value := helpers.GetFromXPath(cr, "source"); value.Exists() && !data.Vrfs[i].Ipv6UpdateSourceDestinations[ci].SourceInterface.IsNull() {
				data.Vrfs[i].Ipv6UpdateSourceDestinations[ci].SourceInterface = types.StringValue(value.String())
			} else if data.Vrfs[i].Ipv6UpdateSourceDestinations[ci].SourceInterface.IsNull() {
				data.Vrfs[i].Ipv6UpdateSourceDestinations[ci].SourceInterface = types.StringNull()
			}
		}
		for ci := range data.Vrfs[i].EastWestInterfaces {
			...
			if value := helpers.GetFromXPath(cr, "east-west-interface"); value.Exists() && !data.Vrfs[i].EastWestInterfaces[ci].InterfaceName.IsNull() {
				data.Vrfs[i].EastWestInterfaces[ci].InterfaceName = types.StringValue(value.String())
			} else if data.Vrfs[i].EastWestInterfaces[ci].InterfaceName.IsNull() {
				data.Vrfs[i].EastWestInterfaces[ci].InterfaceName = types.StringNull()
			}
			if value := helpers.GetFromXPath(cr, "vrf"); value.Exists() && !data.Vrfs[i].EastWestInterfaces[ci].ReferencedVrf.IsNull() {
				data.Vrfs[i].EastWestInterfaces[ci].ReferencedVrf = types.StringValue(value.String())
			} else if data.Vrfs[i].EastWestInterfaces[ci].ReferencedVrf.IsNull() {
				data.Vrfs[i].EastWestInterfaces[ci].ReferencedVrf = types.StringNull()
			}
			if value := helpers.GetFromXPath(cr, "interface"); value.Exists() && !data.Vrfs[i].EastWestInterfaces[ci].ReferencedInterface.IsNull() {
				data.Vrfs[i].EastWestInterfaces[ci].ReferencedInterface = types.StringValue(value.String())
			} else if data.Vrfs[i].EastWestInterfaces[ci].ReferencedInterface.IsNull() {
				data.Vrfs[i].EastWestInterfaces[ci].ReferencedInterface = types.StringNull()
			}
		}
	}
			...
			if found {
				for ci := range state.Vrfs[i].EastWestInterfaces {
					...
					for cj := range data.Vrfs[j].EastWestInterfaces {
						...
						if found {
							if !state.Vrfs[i].EastWestInterfaces[ci].ReferencedInterface.IsNull() && data.Vrfs[j].EastWestInterfaces[cj].ReferencedInterface.IsNull() {
								b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/vrfs/vrf%v/east-wests/east-west%v/interface", predicates, cpredicates))
							}
							if !state.Vrfs[i].EastWestInterfaces[ci].ReferencedVrf.IsNull() && data.Vrfs[j].EastWestInterfaces[cj].ReferencedVrf.IsNull() {
								b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/vrfs/vrf%v/east-wests/east-west%v/vrf", predicates, cpredicates))
							}
							break
						}
					}
				...
				for ci := range state.Vrfs[i].Ipv6UpdateSourceDestinations {
					...
					for cj := range data.Vrfs[j].Ipv6UpdateSourceDestinations {
						...
						if found {
							if !state.Vrfs[i].Ipv6UpdateSourceDestinations[ci].SourceInterface.IsNull() && data.Vrfs[j].Ipv6UpdateSourceDestinations[cj].SourceInterface.IsNull() {
								b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/vrfs/vrf%v/address-family/ipv6/update-source/destinations/destination%v/source", predicates, cpredicates))
							}
							break
						}
					}
					if !found {
						b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/vrfs/vrf%v/address-family/ipv6/update-source/destinations/destination%v", predicates, cpredicates))
					}
				}
				for ci := range state.Vrfs[i].Ipv4UpdateSourceDestinations {
					cstateKeys := [...]string{"destination-interface"}
					...
					for cj := range data.Vrfs[j].Ipv4UpdateSourceDestinations {
						...
						if found {
							if !state.Vrfs[i].Ipv4UpdateSourceDestinations[ci].SourceInterface.IsNull() && data.Vrfs[j].Ipv4UpdateSourceDestinations[cj].SourceInterface.IsNull() {
								b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/vrfs/vrf%v/address-family/ipv4/update-source/destinations/destination%v/source", predicates, cpredicates))
							}
							break
						}
					}
					if !found {
						b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/vrfs/vrf%v/address-family/ipv4/update-source/destinations/destination%v", predicates, cpredicates))
					}
				}
				...
				if !state.Vrfs[i].Ipv6DefaultRouteMgmt.IsNull() && state.Vrfs[i].Ipv6DefaultRouteMgmt.ValueBool() && data.Vrfs[j].Ipv6DefaultRouteMgmt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/vrfs/vrf%v/address-family/ipv6/default-route/mgmt", predicates))
				}
				if !state.Vrfs[i].Ipv6UpdateSourceDataports.IsNull() && data.Vrfs[j].Ipv6UpdateSourceDataports.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/vrfs/vrf%v/address-family/ipv6/update-source/dataports/interface", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Vrfs[i].Ipv6UpdateSourceDataportsActiveManagement.IsNull() && state.Vrfs[i].Ipv6UpdateSourceDataportsActiveManagement.ValueBool() && data.Vrfs[j].Ipv6UpdateSourceDataportsActiveManagement.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/vrfs/vrf%v/address-family/ipv6/update-source/dataports/active-management", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Vrfs[i].Ipv4DefaultRouteMgmt.IsNull() && state.Vrfs[i].Ipv4DefaultRouteMgmt.ValueBool() && data.Vrfs[j].Ipv4DefaultRouteMgmt.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/vrfs/vrf%v/address-family/ipv4/default-route/mgmt", predicates))
				}
				if !state.Vrfs[i].Ipv4UpdateSourceDataports.IsNull() && data.Vrfs[j].Ipv4UpdateSourceDataports.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/vrfs/vrf%v/address-family/ipv4/update-source/dataports/interface", predicates))
				}
				// For boolean fields, only delete if state was true (presence container was set)
				if !state.Vrfs[i].Ipv4UpdateSourceDataportsActiveManagement.IsNull() && state.Vrfs[i].Ipv4UpdateSourceDataportsActiveManagement.ValueBool() && data.Vrfs[j].Ipv4UpdateSourceDataportsActiveManagement.IsNull() {
					b = helpers.RemoveFromXPath(b, fmt.Sprintf(state.getXPath()+"/vrfs/vrf%v/address-family/ipv4/update-source/dataports/active-management", predicates))
				}
				break
			}
		}
