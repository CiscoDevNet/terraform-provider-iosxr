...
func TestAccIosxrASPathSet(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		...
		ImportState:       true,
		ImportStateIdFunc: iosxrASPathSetImportStateIdFunc("iosxr_as_path_set.test"),
		Check:             resource.ComposeTestCheckFunc(checks...),
	})
...
func iosxrASPathSetImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
