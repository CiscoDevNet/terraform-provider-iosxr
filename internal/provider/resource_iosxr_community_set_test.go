...
func TestAccIosxrCommunitySet(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		...
		ImportState:       true,
		ImportStateIdFunc: iosxrCommunitySetImportStateIdFunc("iosxr_community_set.test"),
		Check:             resource.ComposeTestCheckFunc(checks...),
	})
...
func iosxrCommunitySetImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
