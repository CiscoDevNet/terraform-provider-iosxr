		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("iosxr_domain.test", "list_domain.0.domain_name", "WORD"),
					...
					resource.TestCheckResourceAttr("iosxr_domain.test", "name", "WORD"),
					resource.TestCheckResourceAttr("iosxr_domain.test", "ipv4_host.0.host_name", "WORD"),
					...
					resource.TestCheckResourceAttr("iosxr_domain.test", "name_server.0.order", "0"),
					resource.TestCheckResourceAttr("iosxr_domain.test", "ipv6_host.0.host_name", "WORD"),
					resource.TestCheckResourceAttr("iosxr_domain.test", "ipv6_host.0.ipv6_address.0", "10::10"),
					resource.TestCheckResourceAttr("iosxr_domain.test", "multicast", "WORD"),
