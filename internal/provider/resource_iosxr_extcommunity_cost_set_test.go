...
func TestAccIosxrExtcommunityCostSet(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		...
		ImportState:   true,
		ImportStateIdFunc: iosxrExtcommunityCostSetImportStateIdFunc("iosxr_extcommunity_cost_set.test"),
		Check: resource.ComposeTestCheckFunc(checks...),
	})
...
func iosxrExtcommunityCostSetImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
