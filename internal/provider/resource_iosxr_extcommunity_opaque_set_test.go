...
func TestAccIosxrExtcommunityOpaqueSet(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		...
		ImportState:       true,
		ImportStateIdFunc: iosxrExtcommunityOpaqueSetImportStateIdFunc("iosxr_extcommunity_opaque_set.test"),
		Check:             resource.ComposeTestCheckFunc(checks...),
	})
...
func iosxrExtcommunityOpaqueSetImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
