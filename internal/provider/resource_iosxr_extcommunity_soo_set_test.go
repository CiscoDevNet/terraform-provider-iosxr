...
func TestAccIosxrExtcommunitySOOSet(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		...
		ImportState:       true,
		ImportStateIdFunc: iosxrExtcommunitySOOSetImportStateIdFunc("iosxr_extcommunity_soo_set.test"),
		Check:             resource.ComposeTestCheckFunc(checks...),
	})
...
func iosxrExtcommunitySOOSetImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
