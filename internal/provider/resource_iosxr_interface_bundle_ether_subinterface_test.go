...
func TestAccIosxrInterfaceBundleEtherSubinterface(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "dampening_decay_half_life", "2"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "dampening_reuse_threshold", "10"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "shutdown", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "mtu", "9000"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "bandwidth", "100000"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "description", "My Interface Description"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "load_interval", "30"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "vrf", "VRF1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_address", "192.168.1.1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_netmask", "255.255.255.0"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_route_tag", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_algorithm", "128"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_secondaries.0.address", "192.168.2.1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_secondaries.0.netmask", "255.255.255.0"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_secondaries.0.route_tag", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_secondaries.0.algorithm", "128"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_point_to_point", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_mtu", "1500"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_redirects", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_mask_reply", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_helper_addresses.0.address", "192.168.1.1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_helper_addresses.0.vrf", "default"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_unreachables_disable", "true"))
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_verify_unicast_source_reachable_via_type", "any"))
	}
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_verify_unicast_source_reachable_via_allow_self_ping", "true"))
	}
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_verify_unicast_source_reachable_via_allow_default", "false"))
	}
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_access_group_ingress_acl1", "ACL1"))
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv4_access_group_ingress_hardware_count", "true"))
	}
	if os.Getenv("XRV9K") != "" {
	...
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_verify_unicast_source_reachable_via_allow_self_ping", "true"))
	}
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_verify_unicast_source_reachable_via_allow_default", "false"))
	}
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_access_group_ingress_acl1", "ACL2"))
	if os.Getenv("XRV9K") != "" {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_addresses.0.prefix_length", "64"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_addresses.0.zone", "0"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_addresses.0.route_tag", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_addresses.0.algorithm", "128"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_link_local_address", "fe80::1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_link_local_zone", "0"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_link_local_route_tag", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_eui64_addresses.0.address", "2001:db8:1:2::"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_eui64_addresses.0.prefix_length", "64"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_eui64_addresses.0.zone", "0"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_eui64_addresses.0.route_tag", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_eui64_addresses.0.algorithm", "128"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_autoconfig", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_dhcp", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_mtu", "1280"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_unreachables_disable", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_nd_reachable_time", "1800"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_nd_cache_limit", "1000"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_nd_dad_attempts", "3"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_nd_unicast_ra", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_nd_managed_config_flag", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_nd_other_config_flag", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_nd_ns_interval", "60000"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_nd_ra_interval_max", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ipv6_nd_ra_interval_min", "5"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "arp_gratuitous_ignore", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "proxy_arp", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "mpls_mtu", "1500"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "lldp", "true"))
	...
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_profile", "Profile-1"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_transport_ethernet", "true"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_clock_operation_one_step", "true"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_announce_interval", "2"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_announce_timeout", "5"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_announce_grant_duration", "300"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_sync_interval", "2"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_sync_grant_duration", "300"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_sync_timeout", "3000"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_delay_request_interval", "2"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_cos", "6"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_cos_event", "6"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_cos_general", "6"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_dscp", "46"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_dscp_event", "46"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_dscp_general", "46"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_ipv4_ttl", "10"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_ipv6_hop_limit", "10"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_delay_asymmetry_value", "1000"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_delay_asymmetry_unit_microseconds", "true"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_delay_response_grant_duration", "300"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_delay_response_timeout", "3000"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_unicast_grant_invalid_request_reduce", "true"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_multicast", "true"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_multicast_mixed", "true"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_multicast_target_address_mac_forwardable", "true"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_port_state_master_only", "true"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
	...
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_interop_domain", "24"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_interop_egress_conversion_priority1", "128"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_interop_egress_conversion_priority2", "128"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_interop_egress_conversion_clock_accuracy", "33"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_interop_egress_conversion_offset_scaled_log_variance", "5"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
	...
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_interop_ingress_conversion_priority2", "128"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_interop_ingress_conversion_clock_accuracy", "33"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_bundle_ether_subinterface.test", "ptp_interop_ingress_conversion_offset_scaled_log_variance", "5"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
...
func iosxrInterfaceBundleEtherSubinterfaceImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
...
const testAccIosxrInterfaceBundleEtherSubinterfacePrerequisitesConfig = `
