...
func TestAccIosxrInterfaceEthernet(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "dampening_decay_half_life", "2"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "dampening_reuse_threshold", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "dampening_suppress_threshold", "20"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "dampening_max_suppress_time", "30"))
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "service_policy_input.0.name", "PMAP-IN"))
	}
	if os.Getenv("XRV9K") != "" {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "load_interval", "30"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "vrf", "VRF1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_address", "192.168.1.1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_netmask", "255.255.255.0"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_route_tag", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_algorithm", "128"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_secondaries.0.address", "192.168.2.1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_secondaries.0.netmask", "255.255.255.0"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_secondaries.0.route_tag", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_secondaries.0.algorithm", "128"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_point_to_point", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_mtu", "1500"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_redirects", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_mask_reply", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_helper_addresses.0.address", "192.168.1.1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_helper_addresses.0.vrf", "default"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_unreachables_disable", "true"))
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_verify_unicast_source_reachable_via_type", "any"))
	}
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_verify_unicast_source_reachable_via_allow_self_ping", "true"))
	}
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_verify_unicast_source_reachable_via_allow_default", "false"))
	}
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_access_group_ingress_acl1", "ACL1"))
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_access_group_ingress_hardware_count", "true"))
	}
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_access_group_ingress_interface_statistics", "true"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_access_group_ingress_compress", "0"))
	}
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_access_group_egress_acl", "ACL1"))
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_access_group_egress_hardware_count", "true"))
	}
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_access_group_egress_interface_statistics", "true"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv4_access_group_egress_compress", "0"))
	}
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_verify_unicast_source_reachable_via_type", "any"))
	}
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_verify_unicast_source_reachable_via_allow_self_ping", "true"))
	}
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_verify_unicast_source_reachable_via_allow_default", "false"))
	}
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_access_group_ingress_acl1", "ACL2"))
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_access_group_ingress_interface_statistics", "true"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_access_group_ingress_compress", "0"))
	}
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_access_group_egress_acl", "ACL2"))
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_access_group_egress_interface_statistics", "true"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_access_group_egress_compress", "0"))
	}
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_enable", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_addresses.0.address", "2001:db8:1:1::1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_addresses.0.prefix_length", "64"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_addresses.0.zone", "0"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_addresses.0.route_tag", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_addresses.0.algorithm", "128"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_link_local_address", "fe80::1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_link_local_zone", "0"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_link_local_route_tag", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_eui64_addresses.0.address", "2001:db8:1:2::"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_eui64_addresses.0.prefix_length", "64"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_eui64_addresses.0.zone", "0"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_eui64_addresses.0.route_tag", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_eui64_addresses.0.algorithm", "128"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_autoconfig", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_dhcp", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_mtu", "1280"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_unreachables_disable", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_nd_reachable_time", "1800"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_nd_cache_limit", "1000"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_nd_dad_attempts", "3"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_nd_unicast_ra", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_nd_managed_config_flag", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_nd_other_config_flag", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_nd_ns_interval", "60000"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_nd_ra_interval_max", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_nd_ra_interval_min", "5"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_nd_ra_lifetime", "3600"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_nd_redirects", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ipv6_nd_prefix_default_no_adv", "true"))
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ethernet_cfm_mep_domains.0.domain_name", "DOMAIN1"))
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ethernet_cfm_mep_domains.0.service", "SERVICE1"))
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ethernet_cfm_mep_domains.0.mep_id", "1"))
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ethernet_cfm_mep_domains.0.propagate_remote_status", "true"))
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ethernet_cfm_mep_domains.0.cos", "5"))
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ethernet_cfm_mep_domains.0.loss_measurement_counters_priority_cos_range_start", "1"))
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ethernet_cfm_mep_domains.0.loss_measurement_counters_priority_cos_range_end", "7"))
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ethernet_cfm_mep_domains.0.sla_operation_profile_target_mep_ids.0.profile_name", "SLA-PROFILE-1"))
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ethernet_cfm_mep_domains.0.sla_operation_profile_target_mep_ids.0.mep_id", "2"))
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ethernet_cfm_mep_domains.0.sla_operation_profile_target_mac_addresses.0.profile_name", "SLA-PROFILE-2"))
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ethernet_cfm_mep_domains.0.sla_operation_profile_target_mac_addresses.0.mac_address", "00:11:22:33:44:55"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ethernet_cfm_ais_transmission_up_interval", "1s"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ethernet_cfm_ais_transmission_up_cos", "5"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ethernet_cfm_bandwidth_notifications_hold_off", "60"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ethernet_cfm_bandwidth_notifications_wait_to_restore", "30"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ethernet_cfm_bandwidth_notifications_loss_threshold", "5"))
	}
	if os.Getenv("NCS") != "" || os.Getenv("C8000") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "ethernet_cfm_bandwidth_notifications_log_changes", "true"))
	}
	if os.Getenv("FLOW") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "flow_ipv4_ingress_monitor_samplers.0.monitor_map_name", "MMAP1"))
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "flow_ipv4_ingress_monitor_samplers.0.sampler_map_name", "SMAP1"))
	}
	if os.Getenv("FLOW") != "" {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "proxy_arp", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "bundle_port_priority", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "carrier_delay_up", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "carrier_delay_down", "100"))
	if os.Getenv("XRV9K") != "" {
		checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "mac_address", "aa:bb:cc:dd:ee:ff"))
	}
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_interface_ethernet.test", "mpls_mtu", "1500"))
	...
	if os.Getenv("SKIP_MINIMUM_TEST") == "" {
		steps = append(steps, resource.TestStep{
			Config: testAccIosxrInterfaceEthernetPrerequisitesConfig + testAccIosxrInterfaceEthernetConfig_minimum(),
		})
	}
	steps = append(steps, resource.TestStep{
		Config: testAccIosxrInterfaceEthernetPrerequisitesConfig + testAccIosxrInterfaceEthernetConfig_all(),
		Check:  resource.ComposeTestCheckFunc(checks...),
	})
	steps = append(steps, resource.TestStep{
		ResourceName:      "iosxr_interface_ethernet.test",
		ImportState:       true,
		ImportStateIdFunc: iosxrInterfaceEthernetImportStateIdFunc("iosxr_interface_ethernet.test"),
		Check:             resource.ComposeTestCheckFunc(checks...),
	})
...
const testAccIosxrInterfaceEthernetPrerequisitesConfig = `
