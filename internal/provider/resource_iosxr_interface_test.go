		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("iosxr_interface.test", "input_policy.0.service_policy_name", "CORE-INPUT-POLICY"),
					resource.TestCheckResourceAttr("iosxr_interface.test", "output_policy.0.service_policy_name", "CORE-OUTPUT-POLICY"),
