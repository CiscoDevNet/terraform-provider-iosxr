...
func TestAccIosxrIPv4AccessListOptions(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		...
		ImportState:       true,
		ImportStateIdFunc: iosxrIPv4AccessListOptionsImportStateIdFunc("iosxr_ipv4_access_list_options.test"),
		Check:             resource.ComposeTestCheckFunc(checks...),
	})
...
func iosxrIPv4AccessListOptionsImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
