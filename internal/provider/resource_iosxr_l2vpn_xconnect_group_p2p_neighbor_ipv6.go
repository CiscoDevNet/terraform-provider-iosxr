...
type resourceL2VPNXconnectGroupP2PNeighborIPv6Type struct{}

func (t resourceL2VPNXconnectGroupP2PNeighborIPv6Type) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This resource can manage the L2VPN Xconnect Group P2P Neighbor IPv6 configuration.",
...
func (t resourceL2VPNXconnectGroupP2PNeighborIPv6Type) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceL2VPNXconnectGroupP2PNeighborIPv6{
		provider: provider,
	}, diags
}

type resourceL2VPNXconnectGroupP2PNeighborIPv6 struct {
	provider provider
}

func (r resourceL2VPNXconnectGroupP2PNeighborIPv6) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
	var plan L2VPNXconnectGroupP2PNeighborIPv6
...
func (r resourceL2VPNXconnectGroupP2PNeighborIPv6) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
	var state L2VPNXconnectGroupP2PNeighborIPv6
...
func (r resourceL2VPNXconnectGroupP2PNeighborIPv6) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state L2VPNXconnectGroupP2PNeighborIPv6
...
func (r resourceL2VPNXconnectGroupP2PNeighborIPv6) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state L2VPNXconnectGroupP2PNeighborIPv6
...
func (r resourceL2VPNXconnectGroupP2PNeighborIPv6) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
