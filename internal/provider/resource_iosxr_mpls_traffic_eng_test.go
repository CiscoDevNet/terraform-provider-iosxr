...
func TestAccIosxrMPLSTrafficEng(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		...
		ImportState:       true,
		ImportStateIdFunc: iosxrMPLSTrafficEngImportStateIdFunc("iosxr_mpls_traffic_eng.test"),
		Check:             resource.ComposeTestCheckFunc(checks...),
	})
...
func iosxrMPLSTrafficEngImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
