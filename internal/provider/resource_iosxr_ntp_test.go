...
func TestAccIosxrNTP(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_ntp.test", "vrfs.0.vrf_name", "ntp_vrf"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_ntp.test", "vrfs.0.ipv6_peer", "peer1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_ntp.test", "vrfs.0.ipv6_query_only", "query1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_ntp.test", "vrfs.0.ipv6_serve", "serve1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_ntp.test", "vrfs.0.ipv6_serve_only", "serve-only123"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_ntp.test", "vrfs.0.ipv4_peer", "peer1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_ntp.test", "vrfs.0.ipv4_query_only", "query1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_ntp.test", "vrfs.0.ipv4_serve", "serve1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_ntp.test", "vrfs.0.ipv4_serve_only", "serve-only123"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_ntp.test", "authenticate", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_ntp.test", "auth_keys.0.key_number", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_ntp.test", "auth_keys.0.md5_encrypted", "1212000E43"))
