...
type resourceRouterBGPAddressFamilyAggregateAddressType struct{}

func (t resourceRouterBGPAddressFamilyAggregateAddressType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This resource can manage the Router BGP Address Family Aggregate Address configuration.",
...
func (t resourceRouterBGPAddressFamilyAggregateAddressType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceRouterBGPAddressFamilyAggregateAddress{
		provider: provider,
	}, diags
}

type resourceRouterBGPAddressFamilyAggregateAddress struct {
	provider provider
}

func (r resourceRouterBGPAddressFamilyAggregateAddress) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
	var plan RouterBGPAddressFamilyAggregateAddress
...
func (r resourceRouterBGPAddressFamilyAggregateAddress) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
	var state RouterBGPAddressFamilyAggregateAddress
...
func (r resourceRouterBGPAddressFamilyAggregateAddress) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state RouterBGPAddressFamilyAggregateAddress
...
func (r resourceRouterBGPAddressFamilyAggregateAddress) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state RouterBGPAddressFamilyAggregateAddress
...
func (r resourceRouterBGPAddressFamilyAggregateAddress) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
