...
type resourceRouterBGPAddressFamilyRedistributeISISType struct{}

func (t resourceRouterBGPAddressFamilyRedistributeISISType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This resource can manage the Router BGP Address Family Redistribute ISIS configuration.",
...
func (t resourceRouterBGPAddressFamilyRedistributeISISType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceRouterBGPAddressFamilyRedistributeISIS{
		provider: provider,
	}, diags
}

type resourceRouterBGPAddressFamilyRedistributeISIS struct {
	provider provider
}

func (r resourceRouterBGPAddressFamilyRedistributeISIS) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
	var plan RouterBGPAddressFamilyRedistributeISIS
...
func (r resourceRouterBGPAddressFamilyRedistributeISIS) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
	var state RouterBGPAddressFamilyRedistributeISIS
...
func (r resourceRouterBGPAddressFamilyRedistributeISIS) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state RouterBGPAddressFamilyRedistributeISIS
...
func (r resourceRouterBGPAddressFamilyRedistributeISIS) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state RouterBGPAddressFamilyRedistributeISIS
...
func (r resourceRouterBGPAddressFamilyRedistributeISIS) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
