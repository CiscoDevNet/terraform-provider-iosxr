...
type resourceRouterBGPAddressFamilyRedistributeOSPFType struct{}

func (t resourceRouterBGPAddressFamilyRedistributeOSPFType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This resource can manage the Router BGP Address Family Redistribute OSPF configuration.",
...
func (t resourceRouterBGPAddressFamilyRedistributeOSPFType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceRouterBGPAddressFamilyRedistributeOSPF{
		provider: provider,
	}, diags
}

type resourceRouterBGPAddressFamilyRedistributeOSPF struct {
	provider provider
}

func (r resourceRouterBGPAddressFamilyRedistributeOSPF) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
	var plan RouterBGPAddressFamilyRedistributeOSPF
...
func (r resourceRouterBGPAddressFamilyRedistributeOSPF) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
	var state RouterBGPAddressFamilyRedistributeOSPF
...
func (r resourceRouterBGPAddressFamilyRedistributeOSPF) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state RouterBGPAddressFamilyRedistributeOSPF
...
func (r resourceRouterBGPAddressFamilyRedistributeOSPF) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state RouterBGPAddressFamilyRedistributeOSPF
...
func (r resourceRouterBGPAddressFamilyRedistributeOSPF) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
