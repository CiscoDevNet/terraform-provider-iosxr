...
func TestAccIosxrRouterBGPAddressFamily(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_address_family.test", "maximum_paths_ebgp_ebgp_number", "10"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_address_family.test", "maximum_paths_ibgp_ibgp_number", "10"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_address_family.test", "label_mode_route_policy", "LABEL_MODE_POLICY"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_address_family.test", "aggregate_addresses.0.address_prefix", "8"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_address_family.test", "networks.0.address_prefix", "16"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_address_family.test", "redistribute_ospf.0.ospf_router_tag", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_address_family.test", "redistribute_ospf.0.redistribute_ospf_match_internal_external_type_1_nssa_external_type_2", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_address_family.test", "redistribute_eigrp.0.eigrp_name", "EIGRP1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_address_family.test", "redistribute_eigrp.0.redistribute_eigrp_internal", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_address_family.test", "redistribute_eigrp.0.redistribute_eigrp_internal_external", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_address_family.test", "redistribute_isis.0.isis_name", "ISIS1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_address_family.test", "redistribute_isis.0.redistribute_isis_level_1_level_2_level_1_inter_area", "true"))
	...
	steps = append(steps, resource.TestStep{
		...
		ImportState:   true,
		ImportStateId: "65001,ipv4-unicast",
		Check:         resource.ComposeTestCheckFunc(checks...),
	})
