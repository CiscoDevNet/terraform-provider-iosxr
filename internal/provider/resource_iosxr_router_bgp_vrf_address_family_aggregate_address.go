...
type resourceRouterBGPVRFAddressFamilyAggregateAddressType struct{}

func (t resourceRouterBGPVRFAddressFamilyAggregateAddressType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This resource can manage the Router BGP VRF Address Family Aggregate Address configuration.",
...
func (t resourceRouterBGPVRFAddressFamilyAggregateAddressType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceRouterBGPVRFAddressFamilyAggregateAddress{
		provider: provider,
	}, diags
}

type resourceRouterBGPVRFAddressFamilyAggregateAddress struct {
	provider provider
}

func (r resourceRouterBGPVRFAddressFamilyAggregateAddress) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
	var plan RouterBGPVRFAddressFamilyAggregateAddress
...
func (r resourceRouterBGPVRFAddressFamilyAggregateAddress) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
	var state RouterBGPVRFAddressFamilyAggregateAddress
...
func (r resourceRouterBGPVRFAddressFamilyAggregateAddress) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state RouterBGPVRFAddressFamilyAggregateAddress
...
func (r resourceRouterBGPVRFAddressFamilyAggregateAddress) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state RouterBGPVRFAddressFamilyAggregateAddress
...
func (r resourceRouterBGPVRFAddressFamilyAggregateAddress) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
