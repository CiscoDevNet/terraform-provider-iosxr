...
type resourceRouterBGPVRFAddressFamilyRedistributeOSPFType struct{}

func (t resourceRouterBGPVRFAddressFamilyRedistributeOSPFType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This resource can manage the Router BGP VRF Address Family Redistribute OSPF configuration.",
...
func (t resourceRouterBGPVRFAddressFamilyRedistributeOSPFType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceRouterBGPVRFAddressFamilyRedistributeOSPF{
		provider: provider,
	}, diags
}

type resourceRouterBGPVRFAddressFamilyRedistributeOSPF struct {
	provider provider
}

func (r resourceRouterBGPVRFAddressFamilyRedistributeOSPF) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
	var plan RouterBGPVRFAddressFamilyRedistributeOSPF
...
func (r resourceRouterBGPVRFAddressFamilyRedistributeOSPF) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
	var state RouterBGPVRFAddressFamilyRedistributeOSPF
...
func (r resourceRouterBGPVRFAddressFamilyRedistributeOSPF) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state RouterBGPVRFAddressFamilyRedistributeOSPF
...
func (r resourceRouterBGPVRFAddressFamilyRedistributeOSPF) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state RouterBGPVRFAddressFamilyRedistributeOSPF
...
func (r resourceRouterBGPVRFAddressFamilyRedistributeOSPF) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
