...
func TestAccIosxrRouterBGPVRFAddressFamily(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_vrf_address_family.test", "allocate_label_route_policy_name", "ALLOCATE_LABEL_POLICY"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_vrf_address_family.test", "label_mode_per_vrf", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_vrf_address_family.test", "aggregate_addresses.0.address_prefix", "8"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_vrf_address_family.test", "networks.0.address_prefix", "16"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_vrf_address_family.test", "redistribute_ospf.0.ospf_router_tag", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_vrf_address_family.test", "redistribute_ospf.0.redistribute_ospf_match_internal_external_type_1_nssa_external_type_2", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_vrf_address_family.test", "redistribute_eigrp.0.eigrp_name", "EIGRP1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_vrf_address_family.test", "redistribute_eigrp.0.redistribute_eigrp_internal", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_vrf_address_family.test", "redistribute_eigrp.0.redistribute_eigrp_internal_external", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_vrf_address_family.test", "redistribute_isis.0.isis_name", "ISIS1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_vrf_address_family.test", "redistribute_isis.0.redistribute_isis_level_1_level_2_level_1_inter_area", "true"))
