	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportState:   true,
				ImportStateId: "Cisco-IOS-XR-um-router-bgp-cfg:router/bgp/as[as-number=123456]/vrfs/vrf[vrf-name=VRF33]/neighbors/neighbor[neighbor-address=44.44.44.44]/address-families/address-family[af-name=ipv4-labeled-unicast]",
			},
		},
	})
}
