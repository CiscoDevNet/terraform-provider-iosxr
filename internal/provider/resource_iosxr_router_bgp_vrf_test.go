		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("iosxr_router_bgp_vrf.test", "rd_two_byte_as_as_number", "65004"),
					resource.TestCheckResourceAttr("iosxr_router_bgp_vrf.test", "rd_two_byte_as_index", "1"),
					resource.TestCheckResourceAttr("iosxr_router_bgp_vrf.test", "rd_four_byte_as_as_number", "65005"),
					resource.TestCheckResourceAttr("iosxr_router_bgp_vrf.test", "rd_four_byte_as_index", "2"),
