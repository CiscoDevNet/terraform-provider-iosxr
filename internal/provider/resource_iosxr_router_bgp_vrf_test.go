...
func TestAccIosxrRouterBGPVRF(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_vrf.test", "timers_bgp_holdtime_number", "20"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_vrf.test", "timers_bgp_holdtime_minimum_acceptable_holdtime", "10"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_vrf.test", "neighbors.0.timers_holdtime_number", "20"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_bgp_vrf.test", "neighbors.0.timers_holdtime_minimum_acceptable_holdtime", "20"))
...
func testAccIosxrRouterBGPVRFConfig_all() string {
	...
	config += `	timers_bgp_holdtime_number = 20` + "\n"
	config += `	timers_bgp_holdtime_minimum_acceptable_holdtime = 10` + "\n"
	...
	config += `		timers_holdtime_minimum_acceptable_holdtime = 20` + "\n"
