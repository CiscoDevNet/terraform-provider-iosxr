...
func TestAccIosxrRouterISISInterface(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_isis_interface.test", "hello_password_levels.0.level_hello_password_text_encrypted", "060506324F41584B564B0F49584B"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_isis_interface.test", "hello_password_levels.0.level_hello_password_text_send_only", "true"))
