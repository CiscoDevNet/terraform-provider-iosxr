...
type resourceRouterOSPFRedistributeISISType struct{}

func (t resourceRouterOSPFRedistributeISISType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This resource can manage the Router OSPF Redistribute ISIS configuration.",
...
func (t resourceRouterOSPFRedistributeISISType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceRouterOSPFRedistributeISIS{
		provider: provider,
	}, diags
}

type resourceRouterOSPFRedistributeISIS struct {
	provider provider
}

func (r resourceRouterOSPFRedistributeISIS) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
	var plan RouterOSPFRedistributeISIS
...
func (r resourceRouterOSPFRedistributeISIS) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
	var state RouterOSPFRedistributeISIS
...
func (r resourceRouterOSPFRedistributeISIS) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state RouterOSPFRedistributeISIS
...
func (r resourceRouterOSPFRedistributeISIS) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state RouterOSPFRedistributeISIS
...
func (r resourceRouterOSPFRedistributeISIS) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
