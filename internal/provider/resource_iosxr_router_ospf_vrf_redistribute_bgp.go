...
type resourceRouterOSPFVRFRedistributeBGPType struct{}

func (t resourceRouterOSPFVRFRedistributeBGPType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This resource can manage the Router OSPF VRF Redistribute BGP configuration.",
...
func (t resourceRouterOSPFVRFRedistributeBGPType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceRouterOSPFVRFRedistributeBGP{
		provider: provider,
	}, diags
}

type resourceRouterOSPFVRFRedistributeBGP struct {
	provider provider
}

func (r resourceRouterOSPFVRFRedistributeBGP) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
	var plan RouterOSPFVRFRedistributeBGP
...
func (r resourceRouterOSPFVRFRedistributeBGP) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
	var state RouterOSPFVRFRedistributeBGP
...
func (r resourceRouterOSPFVRFRedistributeBGP) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state RouterOSPFVRFRedistributeBGP
...
func (r resourceRouterOSPFVRFRedistributeBGP) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state RouterOSPFVRFRedistributeBGP
...
func (r resourceRouterOSPFVRFRedistributeBGP) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
