...
type resourceRouterOSPFVRFRedistributeOSPFType struct{}

func (t resourceRouterOSPFVRFRedistributeOSPFType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This resource can manage the Router OSPF VRF Redistribute OSPF configuration.",
...
func (t resourceRouterOSPFVRFRedistributeOSPFType) NewResource(ctx context.Context, in tfsdk.Provider) (tfsdk.Resource, diag.Diagnostics) {
	provider, diags := convertProviderType(in)

	return resourceRouterOSPFVRFRedistributeOSPF{
		provider: provider,
	}, diags
}

type resourceRouterOSPFVRFRedistributeOSPF struct {
	provider provider
}

func (r resourceRouterOSPFVRFRedistributeOSPF) Create(ctx context.Context, req tfsdk.CreateResourceRequest, resp *tfsdk.CreateResourceResponse) {
	var plan RouterOSPFVRFRedistributeOSPF
...
func (r resourceRouterOSPFVRFRedistributeOSPF) Read(ctx context.Context, req tfsdk.ReadResourceRequest, resp *tfsdk.ReadResourceResponse) {
	var state RouterOSPFVRFRedistributeOSPF
...
func (r resourceRouterOSPFVRFRedistributeOSPF) Update(ctx context.Context, req tfsdk.UpdateResourceRequest, resp *tfsdk.UpdateResourceResponse) {
	var plan, state RouterOSPFVRFRedistributeOSPF
...
func (r resourceRouterOSPFVRFRedistributeOSPF) Delete(ctx context.Context, req tfsdk.DeleteResourceRequest, resp *tfsdk.DeleteResourceResponse) {
	var state RouterOSPFVRFRedistributeOSPF
...
func (r resourceRouterOSPFVRFRedistributeOSPF) ImportState(ctx context.Context, req tfsdk.ImportResourceStateRequest, resp *tfsdk.ImportResourceStateResponse) {
