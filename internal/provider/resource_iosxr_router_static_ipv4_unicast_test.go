...
func TestAccIosxrRouterStaticIPv4Unicast(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_ipv4_unicast.test", "sr_policies.0.sr_policy_name", "sr_te_policy_1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_ipv4_unicast.test", "sr_policies.0.description", "interface-description"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_ipv4_unicast.test", "sr_policies.0.tag", "103"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_ipv4_unicast.test", "sr_policies.0.distance_metric", "144"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_ipv4_unicast.test", "sr_policies.0.track", "TRACK1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_ipv4_unicast.test", "sr_policies.0.metric", "10"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_ipv4_unicast.test", "vrfs.0.sr_policies.0.sr_policy_name", "sr_te_policy_1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_ipv4_unicast.test", "vrfs.0.sr_policies.0.description", "interface-description"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_ipv4_unicast.test", "vrfs.0.sr_policies.0.tag", "103"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_ipv4_unicast.test", "vrfs.0.sr_policies.0.distance_metric", "144"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_ipv4_unicast.test", "vrfs.0.sr_policies.0.track", "TRACK1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_ipv4_unicast.test", "vrfs.0.sr_policies.0.metric", "10"))
	...
	steps = append(steps, resource.TestStep{
		...
		ImportState:       true,
		ImportStateIdFunc: iosxrRouterStaticIPv4UnicastImportStateIdFunc("iosxr_router_static_ipv4_unicast.test"),
		Check:             resource.ComposeTestCheckFunc(checks...),
	})
...
func iosxrRouterStaticIPv4UnicastImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
