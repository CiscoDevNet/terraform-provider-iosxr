...
func TestAccIosxrRouterStaticVRFIPv4Multicast(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv4_multicast.test", "nexthop_interface_addresses.0.track", "TRACK1"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv4_multicast.test", "nexthop_addresses.0.bfd_fast_detect_minimum_interval", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv4_multicast.test", "nexthop_addresses.0.bfd_fast_detect_multiplier", "3"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv4_multicast.test", "vrfs.0.nexthop_interface_addresses.0.bfd_fast_detect_minimum_interval", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv4_multicast.test", "vrfs.0.nexthop_interface_addresses.0.bfd_fast_detect_multiplier", "3"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv4_multicast.test", "vrfs.0.nexthop_interface_addresses.0.track", "TRACK1"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv4_multicast.test", "vrfs.0.nexthop_addresses.0.bfd_fast_detect_minimum_interval", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv4_multicast.test", "vrfs.0.nexthop_addresses.0.bfd_fast_detect_multiplier", "3"))
	...
	if os.Getenv("SKIP_MINIMUM_TEST") == "" {
		steps = append(steps, resource.TestStep{
			Config: testAccIosxrRouterStaticVRFIPv4MulticastPrerequisitesConfig + testAccIosxrRouterStaticVRFIPv4MulticastConfig_minimum(),
		})
	}
	steps = append(steps, resource.TestStep{
		Config: testAccIosxrRouterStaticVRFIPv4MulticastPrerequisitesConfig + testAccIosxrRouterStaticVRFIPv4MulticastConfig_all(),
		Check:  resource.ComposeTestCheckFunc(checks...),
	})
	steps = append(steps, resource.TestStep{
		ResourceName:      "iosxr_router_static_vrf_ipv4_multicast.test",
		ImportState:       true,
		ImportStateIdFunc: iosxrRouterStaticVRFIPv4MulticastImportStateIdFunc("iosxr_router_static_vrf_ipv4_multicast.test"),
		Check:             resource.ComposeTestCheckFunc(checks...),
	})
...
func iosxrRouterStaticVRFIPv4MulticastImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
