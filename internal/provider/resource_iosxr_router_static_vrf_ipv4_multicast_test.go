...
func TestAccIosxrRouterStaticVRFIPv4Multicast(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		...
		ImportState:   true,
		ImportStateId: "Cisco-IOS-XR-um-router-static-cfg:/router/static/vrfs/vrf[vrf-name=VRF2]/address-family/ipv4/multicast/prefixes/prefix[prefix-address=100.0.1.0][prefix-length=%!d(string=24)]",
	})
