...
func TestAccIosxrRouterStaticVRFIPv6Multicast(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "nexthop_interface_addresses.0.bfd_fast_detect_minimum_interval", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "nexthop_interface_addresses.0.bfd_fast_detect_multiplier", "3"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "nexthop_interface_addresses.0.track", "TRACK1"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "nexthop_addresses.0.bfd_fast_detect_minimum_interval", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "nexthop_addresses.0.bfd_fast_detect_multiplier", "3"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "sr_policies.0.sr_policy_name", "sr_te_policy_1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "sr_policies.0.description", "interface-description"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "sr_policies.0.tag", "103"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "sr_policies.0.distance_metric", "144"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "sr_policies.0.track", "TRACK1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "sr_policies.0.metric", "10"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "vrfs.0.nexthop_interface_addresses.0.track", "TRACK1"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "vrfs.0.nexthop_addresses.0.bfd_fast_detect_minimum_interval", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "vrfs.0.nexthop_addresses.0.bfd_fast_detect_multiplier", "3"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "vrfs.0.sr_policies.0.sr_policy_name", "sr_te_policy_1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "vrfs.0.sr_policies.0.description", "interface-description"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "vrfs.0.sr_policies.0.tag", "103"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "vrfs.0.sr_policies.0.distance_metric", "144"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "vrfs.0.sr_policies.0.track", "TRACK1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_router_static_vrf_ipv6_multicast.test", "vrfs.0.sr_policies.0.metric", "10"))
	var steps []resource.TestStep
	if os.Getenv("SKIP_MINIMUM_TEST") == "" {
		steps = append(steps, resource.TestStep{
			Config: testAccIosxrRouterStaticVRFIPv6MulticastPrerequisitesConfig + testAccIosxrRouterStaticVRFIPv6MulticastConfig_minimum(),
		})
	}
	steps = append(steps, resource.TestStep{
		Config: testAccIosxrRouterStaticVRFIPv6MulticastPrerequisitesConfig + testAccIosxrRouterStaticVRFIPv6MulticastConfig_all(),
		Check:  resource.ComposeTestCheckFunc(checks...),
	})
	steps = append(steps, resource.TestStep{
		ResourceName:      "iosxr_router_static_vrf_ipv6_multicast.test",
		ImportState:       true,
		ImportStateIdFunc: iosxrRouterStaticVRFIPv6MulticastImportStateIdFunc("iosxr_router_static_vrf_ipv6_multicast.test"),
		Check:             resource.ComposeTestCheckFunc(checks...),
	})
