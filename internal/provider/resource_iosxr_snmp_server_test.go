...
func TestAccIosxrSNMPServer(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "chassis_id", "Chassis1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "packetsize", "1024"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "trap_timeout", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "queue_length", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "throttle_time", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "overload_control", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "overload_throttle_rate", "20"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_snmp_authentication", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_snmp_coldstart", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_snmp_warmstart", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_snmp_all", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_l2vpn_cisco", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_vpls_all", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_vpls_status", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_vpls_full_raise", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_vpls_full_clear", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_cfm", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_l3vpn_all", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_l3vpn_vrf_up", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_l3vpn_vrf_down", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_l3vpn_mid_threshold_exceeded", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_l3vpn_max_threshold_exceeded", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_l3vpn_max_threshold_cleared", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_l3vpn_max_threshold_reissue_notif_time", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_traffic_eng_cisco", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_traffic_eng_cisco_ext_bringup_fail", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_traffic_eng_cisco_ext_insuff_bw", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_traffic_eng_cisco_ext_preempt", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_traffic_eng_cisco_ext_reroute_pending", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_traffic_eng_cisco_ext_reroute_pending_clear", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_traffic_eng_down", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_traffic_eng_p2mp_down", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_traffic_eng_p2mp_up", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_traffic_eng_reoptimize", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_traffic_eng_reroute", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_vrrp_events", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_alarm", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_cisco_entity_ext", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_entity_redundancy_all", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_entity_redundancy_switchover", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_entity_redundancy_status", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_entity_state_switchover", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_entity_state_operstatus", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_flash_insertion", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_flash_removal", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_fru_ctrl", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_ipsla", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_ldp_down", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_ldp_up", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_mpls_ldp_threshold", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_pim_neighbor_change", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_pim_interface_state_change", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_pim_invalid_message_received", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_pim_rp_mapping_change", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_power", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "traps_syslog", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "trap_source_ipv4", "Loopback0"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "trap_source_ipv6", "Loopback1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "trap_source_port", "1200"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "trap_throttle_time", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "trap_authentication_vrf_disable", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "trap_delay_timer", "30"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "ipv4_dscp", "ef"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "ipv6_dscp", "ef"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "drop_unknown_user", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "drop_report_acl_ipv4", "ACL1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "drop_report_acl_ipv6", "ACL1"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "groups.0.v3_ipv6", "ACL1"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "engine_id_local", "80000009030000C0A80101"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "engine_id_remotes.0.address", "11.11.11.11"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "engine_id_remotes.0.engine_id", "80000009030000C0A80101"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "engine_id_remotes.0.udp_port", "1100"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "users.0.v3", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "timeouts_in_qdrop", "20"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "timeouts_threshold", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "timeouts_pdu_stats", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "logging_threshold_oid_processing", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "logging_threshold_pdu_processing", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "inform_retries", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "inform_timeout", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("iosxr_snmp_server.test", "inform_pending", "10"))
