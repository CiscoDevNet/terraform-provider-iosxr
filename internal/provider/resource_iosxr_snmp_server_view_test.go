...
func TestAccIosxrSNMPServerView(t *testing.T) {
	...
	steps = append(steps, resource.TestStep{
		...
		ImportState:       true,
		ImportStateIdFunc: iosxrSNMPServerViewImportStateIdFunc("iosxr_snmp_server_view.test"),
		Check:             resource.ComposeTestCheckFunc(checks...),
	})
...
func iosxrSNMPServerViewImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
	return func(s *terraform.State) (string, error) {
		primary := s.RootModule().Resources[resourceName].Primary
		ViewName := primary.Attributes["view_name"]

		return fmt.Sprintf("%s", ViewName), nil
	}
}
